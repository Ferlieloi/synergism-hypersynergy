...
export const SPECIAL_ACTIONS = [
    ...
    { label: "C1 until no more completions within xx ms", value: 301 },
    { label: "C2 until no more completions within xx ms", value: 302 },
    { label: "C3 until no more completions within xx ms", value: 303 },
    { label: "C4 until no more completions within xx ms", value: 304 },
    { label: "C5 until no more completions within xx ms", value: 305 },
    { label: "C6 until no more completions within xx ms", value: 306 },
    { label: "C7 until no more completions within xx ms", value: 307 },
    { label: "C8 until no more completions within xx ms", value: 308 },
    { label: "C9 until no more completions within xx ms", value: 309 },
    { label: "C10 until no more completions within xx ms", value: 310 },
