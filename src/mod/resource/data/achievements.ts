import { AchievementGroups, AchievementRewards } from "../../types/data-types/hs-gamedata-api-types";
...
export const achievements: Achievement[] = [
    ...
    },
    {
        pointValue: 25,
        group: 'firstOwnedCoin',
        reward: { accelerators: (player: PlayerData) => Math.floor(player?.firstOwnedCoin / 500) }
    },
    {
        pointValue: 30,
        group: 'firstOwnedCoin',
        reward: { multipliers: (player: PlayerData) => Math.floor(player.firstOwnedCoin / 1000) }
    },
    {
        pointValue: 35,
        group: 'firstOwnedCoin',
        reward: { accelBoosts: (player: PlayerData) => Math.floor(player.firstOwnedCoin / 2000) }
    },
    {
        pointValue: 15,
    ...
    },
    {
        pointValue: 25,
        group: 'secondOwnedCoin',
        reward: { accelerators: (player: PlayerData) => Math.floor(player.secondOwnedCoin / 500) }
    },
    {
        pointValue: 30,
        group: 'secondOwnedCoin',
        reward: { multipliers: (player: PlayerData) => Math.floor(player.secondOwnedCoin / 1000) }
    },
    {
        pointValue: 35,
        group: 'secondOwnedCoin',
        reward: { accelBoosts: (player: PlayerData) => Math.floor(player.secondOwnedCoin / 2000) }
    },
    {
        pointValue: 15,
    ...
    },
    {
        pointValue: 25,
        group: 'thirdOwnedCoin',
        reward: { accelerators: (player: PlayerData) => Math.floor(player.thirdOwnedCoin / 500) }
    },
    {
        pointValue: 30,
        group: 'thirdOwnedCoin',
        reward: { multipliers: (player: PlayerData) => Math.floor(player.thirdOwnedCoin / 1000) }
    },
    {
        pointValue: 35,
        group: 'thirdOwnedCoin',
        reward: { accelBoosts: (player: PlayerData) => Math.floor(player.thirdOwnedCoin / 2000) }
    },
    {
        pointValue: 15,
    ...
    },
    {
        pointValue: 25,
        group: 'fifthOwnedCoin',
        reward: { accelerators: (player: PlayerData) => Math.floor(player.fifthOwnedCoin / 500) }
    },
    {
        pointValue: 30,
        group: 'fifthOwnedCoin',
        reward: { multipliers: (player: PlayerData) => Math.floor(player.fifthOwnedCoin / 1000) }
    },
    {
        pointValue: 35,
        group: 'fifthOwnedCoin',
        reward: { accelBoosts: (player: PlayerData) => Math.floor(player.fifthOwnedCoin / 2000) }
    },
    {
        pointValue: 5,
    ...
    },
    {
        pointValue: 10,
        group: 'prestigePointGain',
        reward: { crystalMultiplier: (player: PlayerData) => Math.max(1, Decimal.log(player.prestigePoints, Math.E)) },
    },
    {
        pointValue: 15,
        group: 'prestigePointGain',
    ...
    },
    {
        pointValue: 5,
        group: 'antCrumbs',
        reward: { antSpeed: (player: PlayerData) => Decimal.log(player.ants.crumbs.plus(10), 10) }
    },
    {
        pointValue: 15,
        group: 'antCrumbs',
    ...
    },
    {
        pointValue: 30,
        group: 'antCrumbs',
        reward: { antSpeed: (player: PlayerData) => 1 + player.ants.immortalELO / 1000, scientiaAutobuy: () => 1 }
    },
    {
        pointValue: 5,
        group: 'sacMult',
    ...
    },
    {
        pointValue: 20,
        group: 'constant',
        reward: { wowCubeGain: (player: PlayerData) => 1 + Decimal.log(player.ascendShards.add(1), 10) / 400 }
    },
    {
        pointValue: 30,
        group: 'constant',
    ...
    },
    {
        pointValue: 35,
        group: 'constant',
        reward: { wowPlatonicGain: (player: PlayerData) => 1 + 19 * Math.min(1, Decimal.log(player.ascendShards.plus(1), 10) / 100000) }
    },
    {
        pointValue: 10,
        group: 'challenge11',
    ...
    },
    {
        pointValue: 60,
        group: 'challenge11',
        reward: { ascensionCountAdditive: (player: PlayerData) => player.ascensionCounter * 2 }
    },
    {
        pointValue: 70,
        group: 'challenge11',
