...
`)}};var C=class{constructor(e){this.moduleName=e.moduleName,this.context=e.context,this.moduleColor=e.moduleColor,this.moduleType=1,this.isInitialized=!1}getName(){return this.moduleName}setModuleType(e){this.moduleType=e}},ie=class extends C{#e;#a;#t;#n;constructor(e){super(e),this.setModuleType(2),this.#e=e.moduleKind,this.#a=e.moduleScriptUrl,this.#t=e.moduleCSSUrl,this.#n=e.scriptContext}async#o(){if(!this.#a){c.error(`Could not load script for ext module ${this.moduleName} - script url missing`);return}let e=document.createElement("script");return e.type="text/javascript",e.src=this.#a,document.head.appendChild(e),new Promise((t,a)=>{e.onload=()=>t(),e.onerror=()=>a()})}async#i(){if(!this.#t){c.error(`Could not load CSS for ext module ${this.moduleName} - css url missing`);return}let e=document.createElement("link");return e.rel="stylesheet",e.href=this.#t,document.head.appendChild(e),new Promise((t,a)=>{e.onload=()=>t(),e.onerror=()=>a()})}async init(){if(this.#n in window){c.error(`Could not load ext module ${this.getName} - import conflict in window`);return}switch(this.#e){case 1:await this.#o();break;case 2:await this.#i();break;case 3:await this.#i(),await this.#o();break;default:break}this.isInitialized=!0}};var oe=class extends C{#e;#a;#t;#n;#o;constructor(e){super(e),this.#e=document.getElementById("offeringPotionHide"),this.#a=document.getElementById("obtainiumPotionHide"),this.#t={attributes:!1,childList:!0,subtree:!0},this.#n=new MutationObserver((t,a)=>{this.#i(t,a)}),this.#o=new MutationObserver((t,a)=>{this.#s(t,a)})}async init(){c.log("Initialising HSPotions module",this.context),this.observe(),this.isInitialized=!0}observe(){this.#n.observe(this.#e,this.#t),this.#o.observe(this.#a,this.#t)}#i(e,t){if(document.getElementById("offeringPotionMultiUseButton")===null){let i=document.getElementById("useofferingpotion"),o=document.getElementById("buyofferingpotion");if(!i||!o){c.warn("Could not find native buttons for use/buy offering potions",this.context);return}if(i){let n=i.cloneNode(!0);n.id="offeringPotionMultiUseButton",n.textContent="CONSUME 10x",n.addEventListener("click",()=>{for(let s=0;s<10;s++)i.click()}),i.parentNode?.insertBefore(n,i.nextSibling)}if(o){let n=o.cloneNode(!0);n.id="offeringPotionMultiBuyButton",n.textContent="BUY 10x",n.addEventListener("click",()=>{for(let s=0;s<10;s++)o.click(),setTimeout(()=>{document.getElementById("ok_confirm")?.click()},1)}),o.parentNode?.insertBefore(n,o.nextSibling)}this.#n.disconnect(),c.log("Offering potion multi buy / consume buttons injected",this.context)}}#s(e,t){if(document.getElementById("obtainiumPotionMultiUseButton")===null){let i=document.getElementById("useobtainiumpotion"),o=document.getElementById("buyobtainiumpotion");if(!i||!o){c.warn("Could not find native buttons for use/buy obtainium potions",this.context);return}if(i){let n=i.cloneNode(!0);n.id="obtainiumPotionMultiUseButton",n.textContent="CONSUME 10x",n.addEventListener("click",()=>{for(let s=0;s<10;s++)i.click()}),i.parentNode?.insertBefore(n,i.nextSibling)}if(o){let n=o.cloneNode(!0);n.id="obtainiumPotionMultiBuyButton",n.textContent="BUY 10x",n.addEventListener("click",()=>{for(let s=0;s<10;s++)o.click(),setTimeout(()=>{document.getElementById("ok_confirm")?.click()},1)}),o.parentNode?.insertBefore(n,o.nextSibling)}this.#o.disconnect(),c.log("Obtainium potion multi buy / consume buttons injected",this.context)}}};var ne=class extends C{#e;#a;#t;#n;#o="white-space: nowrap; user-select: all; -webkit-user-select: all; -moz-user-select: all; -ms-user-select: all;";constructor(e){super(e),this.#t={attributes:!1,childList:!0,subtree:!0},this.#n=new MutationObserver((t,a)=>{this.#r(t,a)})}async init(){c.log("Initialising HSCodes module",this.context);let e=this;this.#a=await f.HookElement("#promocodes"),this.#a.addEventListener("click",function(t){e.#e=document.querySelector("#promptWrapper > #prompt > label"),e.#e&&(e.#s(),e.#e.innerHTML="",e.#i())},{capture:!0}),this.#e=await f.HookElement("#promptWrapper > #prompt > label"),this.#i(),this.isInitialized=!0}#i(){this.#n?.disconnect(),this.#n?.observe(this.#e,this.#t)}#s(){this.#n?.disconnect()}#r(e,t){let a=this;try{if(this.#s(),this.#e&&this.#e.innerText.includes("synergism2021")){let i=this.#e.innerText;this.#e.innerHTML=`<div id="hs-hijack-codes-wrapper">
    ...
    "autosingEarlyCubeLoadout": {
        ...
        "settingDescription": "early cube loadout",
    ...
    "autosingLateCubeLoadout": {
        ...
        "settingDescription": "late cube loadout",
...
]`;var E=class{static#e="HSUIC";static#a(e){if(!e)return"";let t="";for(let[a,i]of e.entries())t+=`data-${a}="${i}" `;return t}static#t(e){switch(e){case 1:return"checkbox";case 2:return"color";case 3:return"number";case 4:return"text";case 5:return"select";case 6:return"state"}}static#n(e){switch(e){case 1:return"hs-panel-input-checkbox";case 2:return"hs-panel-input-color";case 3:return"hs-panel-input-number";case 4:return"hs-panel-input-text";case 5:return"hs-panel-input-select";case 6:return"hs-panel-input-state"}}static#o(e){if(!e)return"";let t="";for(let[a,i]of Object.entries(e))typeof i!==void 0&&(t+=` ${a}="${i}"`);return t}static Button(e){let t=e.class??"",a=e.text??"",i=e.id??m.domid(),o=this.#o(e.props),n=this.#a(e.data);return y.injectStyle(`#${i} {
            ${m.objectToCSS(e.styles)}
        }`),`<div class="hs-panel-btn ${t}" id="${i}"${o} ${n}>${a}</div>`}static Input(e){let t=e.class??"",a=this.#t(e.type),i=this.#n(e.type),o=e.id??m.domid(),n=this.#o(e.props),s=this.#a(e.data);return y.injectStyle(`#${o} {
            ${m.objectToCSS(e.styles)}
        }`),`<input type="${a}" class="${i} ${t}" id="${o}"${n} ${s}></input>`}static Select(e,t){let a=e.class??"",i=this.#t(e.type),o=this.#n(e.type),n=e.id??m.domid(),s=this.#o(e.props),l=this.#a(e.data);y.injectStyle(`#${n} {
            ${m.objectToCSS(e.styles)}
        }`);let u=t.map(d=>`<option value="${d.value}" ${d.selected?"selected":""}>${d.text}</option>`).join(`
`);return`<select class="${o} ${a}" id="${n}"${s} ${l}>${u}</select>`}static Div(e){let t=e.class??"",a=e.id??m.domid(),i="",o=this.#o(e.props),n=this.#a(e.data);return e.html&&(Array.isArray(e.html)?i=e.html.join(`
`):i=e.html),y.injectStyle(`#${a} {
            ${m.objectToCSS(e.styles)}
        }`),`<div class="hs-panel-div ${t}" ${a?`id="${a}"`:""}${o} ${n}>${i}</div>`}static P(e){let t=e.class??"",a=e.id??m.domid(),i="",o=this.#o(e.props),n=this.#a(e.data);return e.text&&(Array.isArray(e.text)?i=e.text.join(`
`):i=e.text),y.injectStyle(`#${a} {
            ${m.objectToCSS(e.styles)}
        }`),`<p class="hs-panel-p ${t}" ${a?`id="${a}"`:""}${o} ${n}>${i}</p>`}static Image(e){let t=e.class??"",a=e.id??m.domid(),i=this.#o(e.props),o=this.#a(e.data);if(!e.src)return c.warn("HSUIC.Image: No src provided for image component",this.#e),"";let n=e.width?e.width:p.HSUIC.defaultImageWidth,s=e.height?e.height:p.HSUIC.defaultImageHeight;return y.injectStyle(`#${a} {
            ${m.objectToCSS(e.styles)}
        }`),`<img src="${e.src}" width="${n}" height="${s}" class="hs-panel-img ${t}" ${a?`id="${a}"`:""}${i} ${o}/>`}static Grid(e){let t=e.class??"",a=e.id??m.domid(),i="",o=this.#o(e.props),n=this.#a(e.data);return e.html&&(Array.isArray(e.html)?i=e.html.join(`
`):i=e.html),y.injectStyle(`#${a} {
            display: grid;
            ${m.objectToCSS(e.styles)}
        }`),`<div class="hs-panel-div ${t}" id="${a}"${o} ${n}>${i}</div>`}static Flex(e){let t=e.class??"",a=e.id??m.domid(),i="",o=this.#o(e.props),n=this.#a(e.data);return e.html&&(Array.isArray(e.html)?i=e.html.join(`
`):i=e.html),y.injectStyle(`#${a} {
            display: flex;
            ${m.objectToCSS(e.styles)}
        }`),`<div class="hs-panel-div ${t}" id="${a}"${o} ${n}>${i}</div>`}static _modal(e){let t=e.class??"",a=e.htmlContent??"",i=e.data??[],o=e.title??"",n=e.id??m.domid(),s=this.#o(e.props),l=this.#a(e.data);return y.injectStyle(`#${n} {
            ${m.objectToCSS(e.styles)}
...
@-webkit-keyframes hs-animtext-1 {
    ...
    `).join(""),i={htmlContent:`
        ...
        `,title:"Configure Corruption Loadout"},o=await r.Modal(i);setTimeout(()=>{document.getElementById("hs-corruption-save-btn")?.addEventListener("click",()=>{Object.keys(se).forEach(n=>{let s=document.getElementById(`hs-corruption-${n}`),l=Math.max(0,Math.min(16,Number(s?.value)||0));e[n]=l}),y.removeInjectedStyle("hs-corruption-modal-styles"),r.CloseModal(o)})},0)}async function at(r,e){let t=h=>Ne.find(A=>A.value===h)?.label??null,a="hs-autosing-challenges-modal",i=[...e],o=()=>i.length===0?'<div class="hs-challenges-empty-state">No challenges added yet.</div>':i.map((h,A)=>{let b=t(h.challengeNumber),M=!!b;return`
                <div class="hs-challenge-item">
                    ...
                    <div class="hs-challenge-controls">
                        <div class="hs-challenge-btn hs-challenge-btn-edit" id="hs-challenge-edit-${A}" data-index="${A}">\u270E</div>
                        <div class="hs-challenge-btn" id="hs-challenge-up-${A}" data-index="${A}">\u2191</div>
                        <div class="hs-challenge-btn hs-challenge-btn-delete" id="hs-challenge-delete-${A}" data-index="${A}">\xD7</div>
                        <div class="hs-challenge-btn" id="hs-challenge-down-${A}" data-index="${A}">\u2193</div>
                    </div>
                </div>`}).join(""),n=()=>{let h=document.getElementById("hs-challenge-list-container");h&&(h.innerHTML=o())},s={htmlContent:`
    <div id="${a}" class="hs-challenges-modal-container">
    ...
    </div>`,title:"Configure Strategy Actions"},l=await r.Modal(s),u=null,d=()=>{let A=!!document.getElementById("hs-challenge-action-select")?.value,b=document.getElementById("hs-challenge-num-input"),M=document.getElementById("hs-challenge-completions-input"),w=document.getElementById("hs-challenge-max-time-input");[b,M,w].forEach(S=>{S&&(S.disabled=A,S.parentElement.style.opacity=A?"0.4":"1")})},g=()=>{document.getElementById("hs-challenge-num-input").value="1",document.getElementById("hs-challenge-completions-input").value="0",document.getElementById("hs-challenge-wait-input").value="0",document.getElementById("hs-challenge-max-time-input").value="1000000",document.getElementById("hs-challenge-action-select").value="",document.getElementById("hs-challenge-add-btn").textContent="Add Action/Challenge",u=null,d()};setTimeout(()=>{let h=document.getElementById(a),A=document.getElementById("hs-challenge-action-select");A?.addEventListener("change",d),h?.addEventListener("click",b=>{let M=b.target,w=M.id;if(w==="hs-challenge-add-btn"){let S=!!A.value,T={challengeNumber:Number(S?A.value:document.getElementById("hs-challenge-num-input").value),challengeCompletions:S?0:Number(document.getElementById("hs-challenge-completions-input").value),challengeWaitTime:Number(document.getElementById("hs-challenge-wait-input").value),challengeMaxTime:S?0:Number(document.getElementById("hs-challenge-max-time-input").value)};u!==null?i[u]=T:i.push(T),n(),g()}if(w.startsWith("hs-challenge-edit-")){u=Number(M.dataset.index);let S=i[u];t(S.challengeNumber)?A.value=String(S.challengeNumber):(A.value="",document.getElementById("hs-challenge-num-input").value=String(S.challengeNumber),document.getElementById("hs-challenge-completions-input").value=String(S.challengeCompletions),document.getElementById("hs-challenge-max-time-input").value=String(S.challengeMaxTime)),document.getElementById("hs-challenge-wait-input").value=String(S.challengeWaitTime),document.getElementById("hs-challenge-add-btn").textContent="Update Action",d()}if(w.startsWith("hs-challenge-delete-")&&(i.splice(Number(M.dataset.index),1),n(),g()),w.startsWith("hs-challenge-up-")){let S=Number(M.dataset.index);S>0&&([i[S],i[S-1]]=[i[S-1],i[S]],n())}if(w.startsWith("hs-challenge-down-")){let S=Number(M.dataset.index);S<i.length-1&&([i[S],i[S+1]]=[i[S+1],i[S]],n())}w==="hs-challenges-save-btn"&&(e.length=0,e.push(...i),r.CloseModal(l)),w==="hs-challenges-cancel-btn"&&r.CloseModal(l)})},0)}async function Ue(r,e,t,a,i){let o=!!i,n=e.length?e[e.length-1].endPhase:"start",s=i?.corruptions||{viscosity:0,drought:0,deflation:0,extinction:0,illiteracy:0,recession:0,dilation:0,hyperchallenged:0},l=i?.strat||[],u=N.indexOf(n),g=N.slice(u+1).map((b,M)=>`<option value="${b}" ${i?.endPhase===b||M===0?"selected":""}>${b}</option>`).join(""),h={htmlContent:`
        ...
        `,title:o?"Edit Strategy Phase":"Create Strategy Phase"},A=await r.Modal(h);setTimeout(()=>{let b=document.querySelector(".hs-phase-modal-container");b&&b.addEventListener("click",async M=>{let w=M.target;if(w.id==="hs-autosing-phase-done"){let T=document.getElementById("hs-autosing-end-phase")?.value;if(!T)return;let H={startPhase:i?i.startPhase:n,endPhase:T,corruptions:{...s},strat:[...l]};o&&a?a(H):t(H),y.removeInjectedStyle("hs-phase-modal-styles"),r.CloseModal(A)}w.id==="hs-autosing-phase-corruptions"&&await tt(r,s),w.id==="hs-autosing-phase-challenges"&&await at(r,l)})},0)}var Z=class{static async open(e,t){let a=k.getModule("HSUI");if(!a||!a.uiReady)return;let i=!!e,o=e?{strategyName:e.strategyName,strategy:JSON.parse(JSON.stringify(e.strategy))}:{strategyName:"",strategy:[]},n=()=>{for(let d=1;d<o.strategy.length;d++){let g=o.strategy[d-1],h=o.strategy[d];h.startPhase=g.endPhase}},s=()=>{let d=document.getElementById("hs-autosing-phase-list");if(d){if(o.strategy.length===0){d.innerHTML='<div class="hs-strategy-empty-state">No strategy phases added yet.</div>';return}d.innerHTML=o.strategy.map((g,h)=>`
        ...
        #hs-ratio-container {
            ...
            grid-column-gap: 0px;
            grid-row-gap: 0px;
        }`;#f;#M;#p;#v;#h;#c;#S;#A=!1;#y=!1;constructor(e){super(e),this.#n=this.#t.map(t=>`${t}Hepteract`),this.#o=this.#t.map(t=>`${t}ProgressBarText`)}async init(){let e=this;c.log("Initialising HSHepteracts module",this.context);let t=k.getModule("HSGameState");t&&(t.subscribeGameStateChange("MAIN_VIEW",(a,i)=>{a.getId()===8&&i.getId()!==8&&t.getCurrentUIView("CUBE_VIEW").getId()===7&&e.#S&&(c.debug("Hepteract forge view closed, stopping watch",this.context),f.stopWatching(e.#S))}),t.subscribeGameStateChange("CUBE_VIEW",async(a,i)=>{i.getId()===7?(c.debug("Hepteract forge view opened, starting watch",this.context),e.#h=await f.HookElement("#hepteractQuantity"),e.#S=f.watchElement(e.#h,o=>{try{let n=parseFloat(m.unfuckNumericString(o));e.#c=n}catch{c.error("Failed to parse owned hepteracts",e.context)}e.#y=!1},{greedy:!0,overrideThrottle:!0,valueParser:o=>o.querySelector("span")?.innerText})):a.getId()===7&&e.#S&&(c.debug("Hepteract forge view closed, stopping watch",this.context),f.stopWatching(e.#S))})),this.#e=await f.HookElement("#heptGrid"),this.#a=await f.HookElement("#hepteractCraftTexts"),this.#e.childNodes.forEach(a=>{if(a.nodeType===1){let i=a,o=i.id;if(e.#n.includes(o)){let n=document.querySelector(`#${o}CraftMax`),s=document.querySelector(`#${o}Cap`),l=document.querySelector(`#${o}Image`);i.addEventListener("mouseenter",async u=>{if(o in e.#s&&o==="quarkHepteract")return;let d=document.querySelector("#hepteractCostText");if(d){let h=d.innerText.match(/you\s+(.*?)\s+Hepteracts/i);if(h){let A=h[1];try{if(o in e.#s){let b=m.parseFloat2(A);e.#s[o]=b}}catch{c.warn(`Error while parsing hepteract cost for ${o}`,e.context)}}}}),n&&s&&l&&(l.addEventListener("mouseenter",async u=>{let h=u.target.id.toLowerCase().includes("quark");if(e.#c!==null&&e.#c!==void 0){let A=e.#i[o],b=e.#s[o];if(A===null||b===null)return;let M=v.getSetting("expandCostProtectionDoubleCap"),w=null;if(M.getValue(),w=A*2*b,e.#c===0)e.#w(w,"\u221E",h);else{let S=e.#c>0?w/e.#c:1;e.#w(w,S,h)}}}),l.addEventListener("click",async u=>{let g=u.target.id,h=g.toLowerCase().includes("quark");if(!g||h)return;if(e.#A||e.#y){c.debug(`Quick expand cancelled, another expand was still pending (exp ${e.#A}, wtch: ${e.#y})`,e.context);return}e.#A=!0;let A=null,b=null;if(e.#c!==null&&e.#c!==void 0){if(e.#c===0){c.info("Owned hepteracts is 0",this.context),e.#A=!1;return}let S=e.#i[o],T=e.#s[o];(S===null||T===null)&&c.warn(`Hepteract cost for ${o} not parsed yet`,e.context);let H=v.getSetting("expandCostProtectionDoubleCap"),D=null;H.getValue(),D=S*2,A=S*2*T,b=e.#c>0?A/e.#c:1,c.debug(`
                                    Current max: ${S},
                                    Cube cost: ${m.N(T)},
                                    Next hepts: ${m.N(D)},
                                    Buy cost: ${m.N(A)},
                                    Percent owned: ${m.N(b)},
                                    Double Cap: ${H.getValue()}`,this.context);let x=v.getSetting("expandCostProtection"),J=v.getSetting("expandCostProtectionNotifications"),R=!(J&&J.getValue()===!0);if(x.isEnabled()){let L=x.getCalculatedValue();if(L&&b>=L){R&&c.info(`Hept. cost protection: Cost owned ${m.N(b*100)}% >= ${L*100}%`,this.context),e.#A=!1;return}}}else{c.warn("Owned hepteracts not parsed yet",this.context),e.#y=!1,e.#A=!1;return}let M=await f.HookElement("#toggle35");if(M&&M.innerText.includes("ON")&&(c.info("Turned hepteract notification toggle OFF",this.context),M.click()),await m.hiddenAction(async()=>{s.click()},"confirm",!1,25),await m.wait(25),n.click(),A&&b&&e.#w(A,b),await m.wait(5),o!=="quarkHepteract"){let S=document.querySelector("#hepteractCostText");if(S){let H=S.innerText.match(/you\s+(.*?)\s+Hepteracts/i);if(H){let D=H[1];try{if(o in e.#s){let x=m.parseFloat2(D);e.#s[o]=x}}catch{c.warn(`Error while parsing NEW hepteract cost for ${o}`,e.context)}}}}let w=e.#h?e.#h:document.querySelector("#hepteractQuantity");if(w){let S=w.querySelector("span");if(S){let T=S.innerText,H=parseFloat(T);e.#c=H}}e.#A=!1}))}}}),document.querySelectorAll(".heptTypeImage").length>0&&y.injectStyle(`
            ...
            `),c.log("Hepteract images now serve as 'quick expand and max' buttons",this.context),c.log("Setting up hepteract ratio watch",this.context),y.injectStyle(this.#b),y.injectHTMLString(this.#g,a=>{e.#e?.parentNode?.insertBefore(a,e.#e)}),this.#f=document.querySelector("#hs-ratio-a"),this.#M=document.querySelector("#hs-ratio-b"),this.#p=document.querySelector("#hs-ratio-c"),this.#o.forEach(a=>{let i=document.querySelector(`#${a}`),o=a.substring(0,a.indexOf("ProgressBar"))+"Hepteract";i&&o?f.watchElement(i,n=>{o in e.#i?(e.#i[o]=n,Object.values(e.#i).every(s=>s>0)&&(e.#l=Math.round(e.#i.chronosHepteract/e.#i.challengeHepteract),e.#r=Math.round(e.#i.hyperrealismHepteract/e.#i.challengeHepteract),e.#d=Math.round(e.#i.acceleratorHepteract/e.#i.multiplierHepteract),e.#u=Math.round(e.#i.acceleratorBoostHepteract/e.#i.multiplierHepteract),e.#m=Math.round(e.#i.chronosHepteract/e.#i.acceleratorHepteract),this.#f&&this.#M&&this.#p&&(this.#f.innerText=`CHR/HYP/CHL: ${m.N(e.#l,0)} / ${m.N(e.#r,0)} / 1`,this.#M.innerText=`ACC/BST/MLT: ${m.N(e.#d,0)} / ${m.N(e.#u,0)} / 1`,this.#p.innerText=`CHR/ACC: ${m.N(e.#m,0)} / 1`))):c.warn(`Key ${o} not found in #boxCounts`,e.context)},{valueParser:n=>{let s=n.innerText;if(typeof s=="string"){let l=s.split("/");try{if(l&&l[1])return parseFloat(m.unfuckNumericString(l[1]))}catch{return c.warn(`Parsing failed for ${l}`,e.context),""}}return""}}):c.warn("Invalid meter or boxName",e.context)}),this.isInitialized=!0}#E(e){let t={cost:0,percentOwned:0};if(this.#c!==null&&this.#c!==void 0){if(this.#c===0){c.info("Owned hepteracts is 0",this.context);return}let a=this.#i[e],i=this.#s[e];if(a===null||i===null){c.warn(`Hepteract cost for ${e} not parsed yet`,this.context);return}let o=v.getSetting("expandCostProtectionDoubleCap"),n=null;o.getValue()?n=a*i:n=a*2*i;let s=this.#c>0?n/this.#c:1;return{cost:n,percentOwned:s}}else{c.warn("Owned hepteracts not parsed yet",this.context);return}}#w(e,t,a=!1){if(this.#a){let i=this.#a.querySelector("#hs-costText"),o;if(m.isNumeric(t)?o=m.N(t*100):o=t,i)a?i.innerText=`[${this.context}]: Total QUARK cost to max after next expand: ${m.N(e)} (ESTIMATE!)`:i.innerText=`[${this.context}]: Total HEPT cost to max after next expand: ${m.N(e)} (${o}% of owned)`;else{let n=document.createElement("div");n.id="hs-costText",a?n.innerText=`[${this.context}]: Total QUARK cost to max after next expand: ${m.N(e)} (ESTIMATE!)`:n.innerText=`[${this.context}]: Total HEPT cost to max after next expand: ${m.N(e)} (${o}% of owned)`,this.#a.appendChild(n)}}}};var Ae=class extends C{#e=[];#a;#t=3;#n=null;#o=3e3;constructor(e){super(e)}async init(){let e=this;c.log("Initialising HSTalismans module",this.context),this.#a=await f.HookElement("#buyTalismanAll"),this.#e=await f.HookElements(".fragmentBtn");let t=this.#a.cloneNode(!0);this.#a.replaceWith(t),this.#a=await f.HookElement("#buyTalismanAll"),this.#a.addEventListener("click",a=>{e.#n&&clearTimeout(e.#n),e.#e.length!==0&&(e.#e[e.#t].click(),e.#t++,e.#t>e.#e.length-1&&(e.#t=0),e.#n=setTimeout(()=>{e.#t=3},e.#o))}),c.log("Talisman BUY ALL button is now more functional",this.context),this.isInitialized=!0}};var be=class extends C{constructor(e){super(e)}async init(){c.log("Extending native prototypes with extra functionality",this.context),Element.prototype.delegateEventListener=this.#a(),Document.prototype.delegateEventListener=this.#a(),Element.prototype.removeDelegateEventListener=this.#t(),Document.prototype.removeDelegateEventListener=this.#t(),HTMLElement.prototype.transition=this.#n(),HTMLElement.prototype.clearTransitions=this.#o(),Object.typedEntries=this.#i,String.prototype.colorTag=function(e){return`<${e}>${this}</${e}>`},HTMLElement.prototype.textNodes=function(){return Array.from(this.childNodes).filter(e=>e.nodeType===Node.TEXT_NODE).map(e=>e.textContent??null).filter(e=>e!==null)},this.isInitialized=!0}#e(e,t){return`${e}:${t}`}#a(){let e=this;return function(t,a,i,o){let n=this;n._delegateListeners||(n._delegateListeners=new Map);let s=e.#e(t,a);if(o!==void 0&&o===!0&&n._delegateListeners.has(s)&&n._delegateListeners.get(s).size>0)return this;n._delegateListeners.has(s)||n._delegateListeners.set(s,new Map);let l=function(u){let d=u.target;if(d.matches(a))i.call(d,u);else{let g=n.querySelectorAll(a);for(let h of Array.from(g))if(h.contains(d)){i.call(h,u);break}}};return n._delegateListeners.get(s).set(i,{delegateHandler:l}),this.addEventListener(t,l),this}}#t(){let e=this;return function(t,a,i,o){let n=this;if(!n._delegateListeners)return this;let s=e.#e(t,a),l=n._delegateListeners.get(s);if(!l)return this;let u=l.get(i);return u&&(n.removeEventListener(t,u.delegateHandler),l.delete(i),l.size===0&&n._delegateListeners.delete(s),n._delegateListeners.size===0&&delete n._delegateListeners),this}}#n(){return function(e,t,a="linear"){let i=this,o=i.style;return t=t??p.HSPrototypes.defaultTransitionTiming,new Promise(n=>{if(Object.keys(e).length===0){n();return}let s=o.transition,l=Object.keys(e).join(", ");o.transition=`${l} ${t}ms ${a}`;let u=new Set(Object.keys(e)),d=!1,g=()=>{d||(i.removeEventListener("transitionend",A),delete i._hsTransitionEndHandler,o.transition=s,d=!0,n())},h=()=>{!d&&u.size===0&&g()},A=S=>{if(!(S instanceof TransitionEvent))return;let T=m.kebabToCamel(S.propertyName);u.has(T)&&(u.delete(T),u.size===0&&g())};this._hsTransitionEndHandler=A,i.addEventListener("transitionend",A);let b=setTimeout(()=>{d||g()},t+50);i.offsetHeight;let M=window.getComputedStyle(i),w=!1;if(Object.entries(e).forEach(([S,T])=>{let H=M.getPropertyValue(S.replace(/([A-Z])/g,"-$1").toLowerCase()),D=typeof T=="number"&&S!=="zIndex"&&S!=="opacity"?`${T}px`:String(T);H&&H!=="none"&&H!=="auto"&&H!==D?w=!0:u.delete(S),o[S]=T}),!w||u.size===0){clearTimeout(b),g();return}u.size===0&&g(),h()})}}#o(){return function(){this.style.transition="none",this._hsTransitionEndHandler&&(this.removeEventListener("transitionend",this._hsTransitionEndHandler),delete this._hsTransitionEndHandler)}}#i(e){return Object.entries(e)}};var fe=class extends C{#e;constructor(e){super(e),this.#e=new Map}async init(){}createShadow(e,t,a=!1){let i=t??m.domid(),o=this.#a(e);if(o)return o;let n=new Se(e,i,this).create(a);return n&&this.#e.set(i,n),n}getShadow(e){return this.#e.get(e)}destroyShadow(e){let t=e instanceof Se?e.name:e,a=this.getShadow(t);a&&(a._destroy(),this.#e.delete(t))}#a(e){for(let[t,a]of this.#e.entries())if(e===a.getElement())return a;return null}},Se=class{#e="HSShadow";#a;#t;#n;#o;#i;#s;#r={position:"absolute",width:"80vw",height:"80vh",left:"1vw",top:"1vh",overflowX:"auto",overflowY:"auto",zIndex:"1",backgroundColor:"rgba(125, 125, 125, 0.8)"};constructor(e,t,a){this.#t=e,this.name=t,this.#a=a,this.#s=document.createElement("div")}getElement(){return this.#t}getContainer(){return this.#s}hide(){this.#t.style.display="none",this.#s.style.display="none"}show(){this.#t.style.display="block",this.#s.style.display="block"}create(e=!1){this.#i=this.#t.style.cssText;let t=this.#t.parentNode;if(this.#o=this.#t.nextSibling,!t)return c.warn("Could not create shadow, parent is null",this.#e),null;this.#n=t;for(let[a,i]of Object.entries(this.#r))this.#s.style[a]=i;return e||this.hide(),document.body.appendChild(this.#s),this.#t.parentNode?.removeChild(this.#t),this.#s.appendChild(this.#t),this}destroySelf(){}_destroy(){this.#n&&(this.#o?this.#n.insertBefore(this.#t,this.#o):this.#n.appendChild(this.#t),this.#i&&(this.#t.style.cssText=this.#i),this.#s?.remove())}};var ye=class extends C{constructor(e){super(e)}async init(){}setData(e,t){try{let a=JSON.stringify(t);return localStorage.setItem(`${p.HSStorage.storagePrefix}${e}`,a),!0}catch(a){return a instanceof TypeError?c.warn("Data serialization error",this.context):a instanceof DOMException?c.warn("localStorage quota exceeded",this.context):c.warn(`Error saving to localStorage: ${a}`,this.context),!1}}getData(e){try{let t=localStorage.getItem(`${p.HSStorage.storagePrefix}${e}`);return t===null?(c.warn(`localStorage[${e}] is null`,this.context),null):JSON.parse(t)}catch(t){return c.warn(`Error retrieving from localStorage: ${t}`,this.context),null}}clearData(e){try{localStorage.removeItem(`${p.HSStorage.storagePrefix}${e}`)}catch(t){c.warn(`Error clearing localStorage: ${t}`,this.context)}}};var ot=`#hs-minibar-wrapper {
    width: 281px;
    display: flex;
    padding: 0px;
    gap: 4px;
...
`;var Me=class extends C{#e;#a;#t=null;#n=[];#o=null;#i=null;#s=new Map;#r;#l;#u;#d=new Map;#m=`
        #${p.HSAmbrosia.quickBarId} > .blueberryLoadoutSlot:hover {
            filter: brightness(150%);
        }
    ...
    `;#f="hs-ambrosia-idle-loadout-css";#M="hs-ambrosia-minibar-css";#p=!1;#v;#h;#c;#S=!1;#A;#y;constructor(e){super(e)}async init(){let e=this;c.log("Initializing HSAmbrosia module",this.context),this.#t=await f.HookElement("#blueberryUpgradeContainer"),this.#n=await f.HookElements(".blueberryLoadoutSlot"),this.#o=await f.HookElement("#bbLoadoutContainer"),this.#c=document.querySelector("#hs-panel-debug-gamedata-currentambrosia"),this.loadState(),c.log("Hooking stuff",this.context);for(let[t,a]of p.HSAmbrosia.ambrosiaLoadoutIcons.entries()){let i=document.querySelector(`#${a.draggableIconId}`);i&&(i.draggable=!0,i.dataset.hsid=t,i.addEventListener("dragstart",o=>{if(!o.dataTransfer)return;let n=o.currentTarget?.dataset.hsid;n&&(c.log(`Drag start ${n}`,this.context),o.dataTransfer.effectAllowed="move",o.dataTransfer.setData("hs-amb-drag",n))}))}if(!this.#o){c.warn("Could not find loadout container",this.context);return}this.#n.forEach(t=>{let a=t.id;if(a){let i=this.#T(a);if(i){let o=this.#s.get(i);o&&this.#I(i,o)}}}),this.#o.delegateEventListener("dragenter",".blueberryLoadoutSlot",t=>{t.dataTransfer&&t.dataTransfer.types.includes("hs-amb-drag")&&(t.preventDefault(),t.stopPropagation(),t.dataTransfer.effectAllowed="move")}),this.#o?.delegateEventListener("dragover",".blueberryLoadoutSlot",t=>{t.dataTransfer&&t.dataTransfer.types.includes("hs-amb-drag")&&(t.preventDefault(),t.stopPropagation(),t.dataTransfer.effectAllowed="move")}),this.#o?.delegateEventListener("drop",".blueberryLoadoutSlot",async t=>{if(t.dataTransfer&&t.dataTransfer.types.includes("hs-amb-drag")){t.preventDefault(),t.stopPropagation();let a=this.#w(t.dataTransfer.getData("hs-amb-drag")),i=t.target,o=i.id;if(!a){c.warn(`Invalid icon ID: ${a}`,this.context);return}if(!p.HSAmbrosia.ambrosiaLoadoutIcons.has(a)){c.warn(`Could not find loadout slot entry for ${a}`,this.context);return}if(!i.classList.contains("blueberryLoadoutSlot")||!o)return;let n=this.#T(o);if(!n){c.warn(`Invalid slot ID: ${o}`,this.context);return}let s=p.HSAmbrosia.ambrosiaLoadoutIcons.get(a);this.#I(n,a),this.#s.set(n,a),this.saveState(),await e.updateQuickBar()}}),this.#o?.delegateEventListener("contextmenu",".blueberryLoadoutSlot",async t=>{t.preventDefault();let a=t.target,i=a.id,o=this.#T(i);if(!o){c.warn(`Invalid slot ID: ${i}`,this.context);return}if(!this.#s.get(o)){c.warn(`No icon found for slot ID: ${i}`,this.context);return}a.classList.remove("hs-ambrosia-slot"),a.style.backgroundImage="",this.#s.delete(o),this.saveState(),await e.updateQuickBar()}),this.#o?.delegateEventListener("click",".blueberryLoadoutSlot",async t=>{let i=t.target.id,o=this.#T(i);if(!o){c.warn(`Invalid slot ID: ${i}`,this.context);return}await e.#E(o)}),this.isInitialized=!0}async#E(e){this.#r=e;let t=v.getSetting("autoLoadoutState");t&&t.setValue(`<green>${e}</green>`),this.#i||(this.#i=await f.HookElement("header"));let a=this.#i.querySelector(`#${p.HSAmbrosia.quickBarId}`);if(a){a.querySelectorAll(".blueberryLoadoutSlot").forEach(n=>{n.classList.remove("hs-ambrosia-active-slot")});let o=a.querySelector(`#${p.HSAmbrosia.quickBarLoadoutIdPrefix}-${e}`);o&&o.classList.add("hs-ambrosia-active-slot")}else c.warn("Could not find quick bar element",this.context);let i=document.querySelector("#bbLoadoutContainer");if(i){i.querySelectorAll(".blueberryLoadoutSlot").forEach(n=>{n.classList.remove("hs-ambrosia-active-slot")});let o=i.querySelector(`#${e}`);o&&o.classList.add("hs-ambrosia-active-slot")}}#w(e){return Object.values(ae).find(t=>t===e)}#T(e){return Object.values(te).find(t=>t===e)}#I(e,t){let a=document.querySelector(`#${e}`);if(!a){c.warn(`Could not find slot element for ${e}`,this.context);return}let i=p.HSAmbrosia.ambrosiaLoadoutIcons.get(t);if(!i){c.warn(`Could not find icon for ${t}`,this.context);return}a.classList.add("hs-ambrosia-slot"),a.style.backgroundImage=`url(${i.url})`}async saveState(){let e=k.getModule("HSStorage");if(e){let t=JSON.stringify(Array.from(this.#s.entries()));e.setData(p.HSAmbrosia.storageKey,t)}else c.warn("saveState - Could not find storage module",this.context)}async loadState(){let e=k.getModule("HSStorage");if(e){let a=e.getData(p.HSAmbrosia.storageKey);if(!a){c.warn("loadState - No data found",this.context);return}try{let i=JSON.parse(a);this.#s=new Map(i)}catch{c.warn("loadState - Error parsing data",this.context);return}}else c.warn("loadState - Could not find storage module",this.context);let t=v.getSetting("autoLoadoutState");t&&!this.#r?this.#r=m.removeColorTags(t.getValue()):c.warn("loadState - Could not find autoLoadoutState setting",this.context)}async createQuickBar(){let e=this;if(this.#d.forEach((t,a)=>{a.removeEventListener("click",t)}),this.#d.clear(),this.#o=await f.HookElement("#bbLoadoutContainer"),this.#i=await f.HookElement("header"),this.#o&&this.#i){let t=this.#i.querySelector("nav.navbar"),a=this.#o.cloneNode(!0);a.id=p.HSAmbrosia.quickBarId;let i=a.querySelector(".blueberryLoadoutSetting");a.querySelectorAll(".blueberryLoadoutSlot").forEach(n=>{let s=n.id;n.id=`${p.HSAmbrosia.quickBarLoadoutIdPrefix}-${s}`;let l=async function(u){await e.#G(u,s)};this.#d.set(n,l),n.addEventListener("click",l)}),i&&i.remove(),this.#i.insertBefore(a,t),y.injectStyle(this.#m,this.#g),this.#r&&await this.#E(this.#r)}}async destroyQuickBar(){this.#i||(this.#i=await f.HookElement("header"));let e=this.#i.querySelector(`#${p.HSAmbrosia.quickBarId}`);e?(this.#d.forEach((a,i)=>{i.removeEventListener("click",a)}),this.#d.clear(),e.remove(),y.removeInjectedStyle(this.#g)):c.warn("Could not find quick bar element",this.context);let t=document.querySelector("#bbLoadoutContainer");t&&t.querySelectorAll(".blueberryLoadoutSlot").forEach(a=>{a.classList.remove("hs-ambrosia-active-slot")})}async updateQuickBar(){v.getSetting("ambrosiaQuickBar").isEnabled()&&(await this.destroyQuickBar(),await this.createQuickBar(),this.#r&&await this.#E(this.#r))}async enableAutoLoadout(){let e=this,t=v.getSetting("autoLoadoutState");if(t&&t.getValue().includes("Unknown")||!this.#r){let d=v.getSetting("autoLoadout");d&&d.isEnabled()&&d.disable(),c.warn("Could not enable auto loadout - current loadout state is not known!",this.context);return}let a=[f.HookElement("#addCode"),f.HookElement("#addCodeAll"),f.HookElement("#addCodeOne"),f.HookElement("#timeCode")],o=(await Promise.allSettled(a)).map((d,g)=>d.status==="fulfilled"?d.value:null);if(o.some(d=>d===null)){c.warn("Problem with enabling auto loadout",this.context);return}let[n,s,l,u]=o;this.#l||(this.#l=async d=>{await e.#H(d)}),this.#u||(this.#u=async d=>{await e.#R(d)}),n.removeEventListener("click",this.#l,{capture:!0}),n.addEventListener("click",this.#l,{capture:!0}),s.removeEventListener("click",this.#l,{capture:!0}),s.addEventListener("click",this.#l,{capture:!0}),l.removeEventListener("click",this.#l,{capture:!0}),l.addEventListener("click",this.#l,{capture:!0}),u.removeEventListener("click",this.#u,{capture:!0}),u.addEventListener("click",this.#u,{capture:!0}),c.log("Enabled auto loadout",this.context)}async disableAutoLoadout(){let e=this,t=[f.HookElement("#addCode"),f.HookElement("#addCodeAll"),f.HookElement("#addCodeOne"),f.HookElement("#timeCode")],i=(await Promise.allSettled(t)).map((u,d)=>u.status==="fulfilled"?u.value:null);if(i.some(u=>u===null)){c.warn("Problem with disabling auto loadout",this.context);return}let[o,n,s,l]=i;this.#l&&(o.removeEventListener("click",this.#l,{capture:!0}),n.removeEventListener("click",this.#l,{capture:!0}),s.removeEventListener("click",this.#l,{capture:!0})),this.#u&&l.removeEventListener("click",this.#u,{capture:!0}),c.log("Disabled auto loadout",this.context)}async#H(e){let t=this.#r,a=v.getSetting("autoLoadoutAdd");if(t&&a){let i=this.#k(a.getValue()),o=await f.HookElement(`#${i}`);await this.#C(),await m.hiddenAction(async()=>{o.click()})}}async#R(e){let t=this.#r,a=v.getSetting("autoLoadoutTime");if(t&&a){let i=this.#k(a.getValue()),o=await f.HookElement(`#${i}`);await this.#C(),await m.hiddenAction(async()=>{o.click()})}}async#G(e,t){let a=document.querySelector(`#${t}`);a?(await this.#C(),await m.hiddenAction(async()=>{a.click()})):c.warn(`Could not find real button for ${t}`,this.context)}async#C(){let e=await f.HookElement("#blueberryToggleMode");e&&e.innerText.includes("SAVE")&&e.click()}#k(e){let t=Object.values(te).find(a=>a===`blueberryLoadout${e}`);return t||c.warn(`Could not convert loadout ${e} to slot`,this.context),t}subscribeGameDataChanges(){let e=k.getModule("HSGameData");e&&!this.gameDataSubscriptionId&&(this.gameDataSubscriptionId=e.subscribeGameDataChange(this.gameDataCallback.bind(this)),c.debug("Subscribed to game data changes",this.context))}unsubscribeGameDataChanges(){let e=k.getModule("HSGameData");e&&this.gameDataSubscriptionId&&!this.#p&&!this.#S&&(e.unsubscribeGameDataChange(this.gameDataSubscriptionId),this.gameDataSubscriptionId=void 0,c.debug("Unsubscribed from game data changes",this.context))}async gameDataCallback(){let e=k.getModule("HSGameDataAPI");if(!e)return;let t=e.getGameData();if(t&&t.blueberryTime&&t.redAmbrosiaTime){let a=t.blueberryTime,i=t.redAmbrosiaTime,o=e.R_calculateRequiredBlueberryTime(),n=e.R_calculateRequiredRedAmbrosiaTime(),s=a/o*100,l=i/n*100,u=e.calculateAmbrosiaSpeed(),d=e.calculateBlueBerries(),g=u*d,h=t.shopUpgrades.shopAmbrosiaAccelerator,A=e.calculateLuck(),b=t.singularityChallenges.noAmbrosiaUpgrades.completions>0?1:0,M=A.total/100+b,w=(A.total-100*Math.floor(A.total/100))/100,S=0,T=0,H=0,D=g/o*100,x=D+3,J=1/2+(3/5-1/2)*+(t.singularityChallenges.noAmbrosiaUpgrades.completions>=15)+(2/3-3/5)*+(t.singularityChallenges.noAmbrosiaUpgrades.completions>=19)+(3/4-2/3)*+(t.singularityChallenges.noAmbrosiaUpgrades.completions>=20);if(h>0&&g>0){let R=o/g;S=Math.min(R*J,M*.2*h),T=S*g,H=T/o*100}if(this.#p&&this.#v&&this.#h){let R=v.getSetting("ambrosiaIdleSwapNormalLoadout"),L=v.getSetting("ambrosiaIdleSwap100Loadout");if(R&&L){let P=R.getValue(),$=L.getValue();if(!Number.isInteger(parseInt(P,10))||!Number.isInteger(parseInt($,10))){let z=v.getSetting("ambrosiaIdleSwap");z&&z.disable(),c.log("Idle swap was disabled due to unconfigured loadouts",this.context);return}let ee=this.#k(R.getValue()),Q=this.#k(L.getValue()),G=x+H,O=G+x,V=100-x,j=100,Pe=p.HSAmbrosia.idleSwapMinRedTreshold,mt=Pe+p.HSAmbrosia.idleSwapMinRedTreshold,pt=p.HSAmbrosia.idleSwapMaxRedTreshold;if(s>=V&&s<=j||l>=pt&&l<=100){if(this.#r!==Q){let z=await f.HookElement(`#${Q}`);await this.#C(),await m.hiddenAction(async()=>{z.click()})}}else if((s>=G&&s<=O||l>=Pe&&l<=mt)&&this.#r!==ee){let z=await f.HookElement(`#${ee}`);await this.#C(),await m.hiddenAction(async()=>{z.click()})}}if(this.#c&&y.isModPanelOpen()){let P=document.createElement("div");for(P.innerHTML=`
                        BLUE - Value: ${a.toFixed(2)}, Max: ${o}, Percent: ${s.toFixed(2)}<br>
                        RED - Value: ${i.toFixed(2)}, Max: ${n}, Percent: ${l.toFixed(2)}<br>
                        BLUE SPD MLT: ${u.toFixed(2)}<br>
                        BLUE SPD %: ${D.toFixed(2)}<br>
                        BERRY: ${d}</br>
                        TOT BLU: ${(u*d).toFixed(2)}</br>
                        ------------------------</br>
                        ADD LUK: ${A.additive.toFixed(2)}</br>
                        RAW LUK: ${A.raw.toFixed(2)}</br>
                        TOT LUK: ${A.total.toFixed(2)}</br>
                        ------------------------</br>
                        ACC CNT: ${h}</br>
                        ...
                        blue: ${this.#A}, 
                        red: ${this.#y}`,"hs-minibars-undefined"):c.logOnce("HSAmbrosia.gameDataCallback() - berryMinibarsEnabled was false","hs-minibars-false")}}async enableIdleSwap(){let e=this,t=k.getModule("HSGameState");t?(this.#e=t.subscribeGameStateChange("MAIN_VIEW",this.#D.bind(this)),this.#a=t.subscribeGameStateChange("SINGULARITY_VIEW",async(a,i)=>{i.getId()===5?(this.#v=await f.HookElement("#ambrosiaProgressBar"),this.#h=await f.HookElement("#pixelProgressBar"),this.#p=!0,this.#x(),this.subscribeGameDataChanges()):(this.#p=!1,this.#B(),this.unsubscribeGameDataChanges())}),t.getCurrentUIView("SINGULARITY_VIEW").getId()===5&&t.getCurrentUIView("MAIN_VIEW").getId()===13&&(this.#v=await f.HookElement("#ambrosiaProgressBar"),this.#h=await f.HookElement("#pixelProgressBar"),this.#p=!0,this.#x(),this.subscribeGameDataChanges())):c.warn("HSAmbrosia.enableIdleSwap() - gameStateMod==undefined","hs-enable-idleswap-gamestate"),this.#c||(this.#c=document.querySelector("#hs-panel-debug-gamedata-currentambrosia"))}disableIdleSwap(){this.#p=!1,this.unsubscribeGameDataChanges();let e=k.getModule("HSGameState");e?(this.#e&&(e.unsubscribeGameStateChange("MAIN_VIEW",this.#e),this.#e=void 0),this.#a&&(e.unsubscribeGameStateChange("SINGULARITY_VIEW",this.#a),this.#a=void 0)):c.warnOnce("HSAmbrosia.disableIdleSwap() - gameStateMod==undefined","hs-disable-idleswap-gamestate"),this.#B()}#D(e,t){let a=k.getModule("HSGameState");a?e.getId()===13&&t.getId()!==13&&a.getCurrentUIView("SINGULARITY_VIEW").getId()===5&&(this.#p=!1):c.warnOnce("HSAmbrosia.gameStateCallbackMain() - gameStateMod==undefined","hs-amb-gamestate-cb")}#x(){if(document.querySelector(`#${p.HSAmbrosia.idleSwapIndicatorId}`))return;let t=document.createElement("div");t.id=p.HSAmbrosia.idleSwapIndicatorId,t.innerText="IDLE SWAP ENABLED WHILE IN THIS VIEW",y.injectHTMLElement(t,a=>{let i=document.querySelector("#singularityAmbrosia"),o=document.querySelector("#ambrosiaProgressBar");i?.insertBefore(a,o)}),y.injectStyle(this.#b,this.#f)}#B(){let e=document.querySelector(`#${p.HSAmbrosia.idleSwapIndicatorId}`);e&&e.remove(),y.removeInjectedStyle(this.#f)}async enableBerryMinibars(){if(this.#i||(this.#i=await f.HookElement("header")),!this.#i)return;let t=(await f.HookElement("#ambrosiaProgressBar")).cloneNode(!0),a=t.querySelector("#ambrosiaProgress"),i=t.querySelector("#ambrosiaProgressText");t.id=p.HSAmbrosia.blueBarId,a.id=p.HSAmbrosia.blueBarProgressId,i.id=p.HSAmbrosia.blueBarProgressTextId;let n=(await f.HookElement("#pixelProgressBar")).cloneNode(!0),s=n.querySelector("#pixelProgress"),l=n.querySelector("#pixelProgressText");n.id=p.HSAmbrosia.redBarId,s.id=p.HSAmbrosia.redBarProgressId,l.id=p.HSAmbrosia.redBarProgressTextId;let u=document.createElement("div");u.id=p.HSAmbrosia.barWrapperId,u.appendChild(t),u.appendChild(n);let d=v.getSetting("ambrosiaQuickBar"),g;d&&d.isEnabled()?g=this.#i.querySelector("#hs-ambrosia-quick-loadout-container"):g=this.#i.querySelector("nav.navbar"),this.#i.insertBefore(u,g),y.injectStyle(ot,this.#M),this.#A=a,this.#y=s,this.subscribeGameDataChanges(),this.#S=!0}async disableBerryMinibars(){this.#i||(this.#i=await f.HookElement("header"));let e=this.#i.querySelector(`#${p.HSAmbrosia.barWrapperId}`);e?e.remove():c.warn("Could not find bar wrapper element",this.context),y.removeInjectedStyle(this.#M),this.#S=!1,this.unsubscribeGameDataChanges()}};var ve=class extends C{constructor(e){super(e)}async init(){c.log("Initializing HSStats module",this.context),this.isInitialized=!0}};var Ee=class extends C{#e=-1;#a={CubeView:X,SingularityView:q};#t={MAIN_VIEW:{currentView:new K("unknown"),previousView:new K("unknown"),viewChangeSubscribers:new Map},CUBE_VIEW:{currentView:new X("unknown"),previousView:new X("unknown"),viewChangeSubscribers:new Map},SINGULARITY_VIEW:{currentView:new q("unknown"),previousView:new q("unknown"),viewChangeSubscribers:new Map}};#n=["buildings","upgrades","statistics","runes","challenges","research","ants","cubes","campaigns","traits","settings","shop","singularity","event","pseudoCoins"];constructor(e){super(e)}async init(){let e=this;c.log("Initializing HSGameState module",this.context);for(let t of this.#n){let a=document.querySelector(`#${t}`);f.watchElement(a,async i=>{let{view:o,state:n}=i;if(n!=="none"){let s=new K(o);if(s.getId()!==-1)e.#t.MAIN_VIEW.previousView=e.#t.MAIN_VIEW.currentView,e.#t.MAIN_VIEW.currentView=s,c.debug(`Main UI view changed ${e.#t.MAIN_VIEW.previousView.getName()} -> ${e.#t.MAIN_VIEW.currentView.getName()}`,e.context);else{c.warn(`Main UI view ${o} not found`,e.context);return}e.#t.MAIN_VIEW.viewChangeSubscribers.forEach(l=>{try{l(e.#t.MAIN_VIEW.previousView,e.#t.MAIN_VIEW.currentView)}catch(u){c.error(`Error when trying to call MAIN VIEW change subscriber callback: ${u}`,e.context)}}),this.#o(s.getId())}},{characterData:!1,childList:!1,subtree:!1,attributes:!0,attributeOldValue:!1,attributeFilter:["style"],valueParser:(i,o)=>{for(let n of o)if(n.type==="attributes"&&n.attributeName==="style"){let s=n.target,l=s.style.getPropertyValue("display");return{view:s.id,state:l}}}})}p.HSGameState.viewProperties.forEach(async(t,a)=>{for(let i of t.subViewIds){let o=document.querySelector(`#${i}`);f.watchElement(o,async n=>{let{view:s,state:l}=n;if(l!=="none"){let u;try{let g=this.#a[t.viewClassName];if(!g)throw new Error(`Class "${t.viewClassName}" not found in viewClasses for mainViewId ${a}`);u=new g(i)}catch(g){c.warn(`Failed to instantiate sub-view ${t.viewClassName}: ${g}`,e.context);return}let d=u.getViewKey();if(u.getId()!==e.#e){e.#t[d].previousView=e.#t[d].currentView,e.#t[d].currentView=u;let g=e.#t[d].previousView,h=e.#t[d].currentView;e.#t[d].viewChangeSubscribers.forEach(A=>{try{A(g,h)}catch(b){c.error(`Error when trying to call CUBE VIEW change subscriber callback: ${b}`,e.context)}}),c.debug(`Subview changed ${g.getName()} -> ${h.getName()}`,e.context)}else{c.warn(`Subview ${s} not found`,e.context);return}}},{characterData:!1,childList:!1,subtree:!1,attributes:!0,attributeOldValue:!1,attributeFilter:["style"],valueParser:(n,s)=>{for(let l of s)if(l.type==="attributes"&&l.attributeName==="style"){let u=l.target,d=u.style.getPropertyValue("display");return{view:u.id,state:d}}}})}}),this.isInitialized=!0}subscribeGameStateChange(e,t){let a=m.uuidv4();return this.#t[e].viewChangeSubscribers.set(a,t),a}unsubscribeGameStateChange(e,t){this.#t[e].viewChangeSubscribers.has(t)?this.#t[e].viewChangeSubscribers.delete(t):c.warn(`Subscription ID ${t} not found for view key ${e}`,this.context)}async#o(e){let t=this,a=p.HSGameState.viewProperties.get(e);if(!a){c.debug(`No view properties found for main view ID ${e}`,this.context);return}(await f.HookElements(a.subViewsSelector)).forEach(async o=>{let n=o.id;if(o.style.getPropertyValue("display")!=="none"){let l;try{let d=this.#a[a.viewClassName];if(!d)throw new Error(`Class "${a.viewClassName}" not found in viewClasses for mainViewId ${e}`);l=new d(n)}catch(d){c.warn(`Failed to instantiate sub-view ${a.viewClassName} for tab ${n}: ${d}`,t.context);return}let u=l.getViewKey();if(l&&l.getId()!==this.#e){t.#t[u].previousView=t.#t[u].currentView,t.#t[u].currentView=l;let d=t.#t[u].previousView,g=t.#t[u].currentView;t.#t[u].viewChangeSubscribers.forEach(h=>{try{h(d,g)}catch(A){c.error(`Error when trying to call VIEW change subscriber callback: ${A}`,t.context)}})}else c.warn(`Sub-view tab ${n} (for ${a.viewClassName}) resolved to UNKNOWN or failed to initialize.`,t.context)}})}getCurrentUIView(e){return this.#t[e].currentView}},_=class{#e;#a;constructor(e,t){this.#e=e,this.#a=t}getName(){return this.#e}getViewKey(){return this.#a}},K=class extends _{#e;constructor(e){super(e,"MAIN_VIEW"),this.#e=this.getViewEnum(e)}getViewEnum(e){switch(e){case"buildings":return 1;case"upgrades":return 2;case"statistics":return 3;case"runes":return 4;case"challenges":return 5;case"research":return 6;case"ants":return 7;case"cubes":return 8;case"campaigns":return 9;case"traits":return 10;case"settings":return 11;case"shop":return 12;case"singularity":return 13;case"event":return 14;case"pseudoCoins":return 15}return-1}getId(){return this.#e}},X=class extends _{#e;constructor(e){super(e,"CUBE_VIEW"),this.#e=this.getViewEnum(e)}getViewEnum(e){switch(e){case"cubeTab1":return 1;case"cubeTab2":return 2;case"cubeTab3":return 3;case"cubeTab4":return 4;case"cubeTab5":return 5;case"cubeTab6":return 6;case"cubeTab7":return 7}return-1}getId(){return this.#e}},q=class extends _{#e;constructor(e){super(e,"SINGULARITY_VIEW"),this.#e=this.getViewEnum(e)}getViewEnum(e){switch(e){case"singularitycontainer1":return 1;case"singularityContainer2":return 2;case"singularityContainer3":return 3;case"singularityContainer4":return 4;case"singularityContainer5":return 5}return-1}getId(){return this.#e}};var B=class{#e;constructor(e){this.#e=e}get patchName(){return this.#e}};var we=class extends B{#e=`
        ...
        }`;#a="ambrosiaViewOverflowPatch";async applyPatch(){y.injectStyle(this.#e,this.#a)}async revertPatch(){y.removeInjectedStyle(this.#a)}};var Ie=class extends B{async applyPatch(){}async revertPatch(){}};var nt=`{
...
}`;var ke=class extends B{#e;#a;async applyPatch(){let e=this;try{this.#e=JSON.parse(nt);let t=await f.HookElement("#actualShop");t&&(this.#a||(this.#a=a=>{e.#t(a)}),t.removeDelegateEventListener("mouseover","div",this.#a),t.delegateEventListener("mouseover","div",this.#a))}catch{c.error("Failed to parse shop item map"),this.#e=void 0}}#t(e){let t;if(e.target instanceof HTMLDivElement)t=e.target;else if(e.target instanceof HTMLImageElement||e.target instanceof HTMLParagraphElement||e.target instanceof HTMLButtonElement)t=e.target.parentElement;else return;if(t.id==="actualShop")return;let a=t.querySelector("img");if(a){let i=a.id,o=this.#e?.[i],n=document.querySelector("#shopHovers"),s=n.querySelector("#hs-shopHoverName");if(s)s.innerText=o||"";else{let l=document.createElement("div");l.id="hs-shopHoverName",l.innerText=o||"",n.insertBefore(l,n.querySelector("p:nth-child(2)"))}}}async revertPatch(){if(this.#a){let t=await f.HookElement("#actualShop");t&&t.removeDelegateEventListener("mouseover","div",this.#a)}let e=document.querySelector("#hs-shopHoverName");e&&e.remove()}};var Te=class extends B{async applyPatch(){let e=await f.HookElement("#buildingstab");e.style.color="red"}async revertPatch(){let e=await f.HookElement("#buildingstab");e.style.color=""}};var Ce=class extends C{#e={AmbrosiaViewOverflow:we,TestPatch:Te,ShopItemNameMapping:ke,IconSetCaching:Ie};#a={};constructor(e){super(e)}async init(){c.log("Initializing HSPatches module",this.context),this.isInitialized=!0}async applyPatch(e){let t=this.#e[e];if(!t){c.warn(`Patch "${e}" not found`,this.context);return}let a;this.#a[e]?(c.debug(`Patch "${e}" is already instantiated`,this.context),a=this.#a[e]):(a=new t(e),this.#a[e]=a),await a.applyPatch()}async revertPatch(e){let t=this.#e[e];if(!t){c.warn(`Patch "${e}" not found`,this.context);return}let a;this.#a[e]?a=this.#a[e]:(a=new t(e),this.#a[e]=a),await a.revertPatch()}};var He=class extends C{#e="Synergysave2";#a;#t;#n=!1;#o;#i;#s=`
        #savegame {
