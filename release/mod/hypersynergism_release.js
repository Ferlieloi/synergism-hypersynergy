...
]`;var H=class{static#e="HSUIC";static#t(e){if(!e)return"";let t="";for(let[a,n]of e.entries())t+=`data-${a}="${n}" `;return t}static#a(e){switch(e){case 1:return"checkbox";case 2:return"color";case 3:return"number";case 4:return"text";case 5:return"select";case 6:return"state"}}static#r(e){switch(e){case 1:return"hs-panel-input-checkbox";case 2:return"hs-panel-input-color";case 3:return"hs-panel-input-number";case 4:return"hs-panel-input-text";case 5:return"hs-panel-input-select";case 6:return"hs-panel-input-state"}}static#i(e){if(!e)return"";let t="";for(let[a,n]of Object.entries(e))typeof n!==void 0&&(t+=` ${a}="${n}"`);return t}static Button(e){let t=e.class??"",a=e.text??"",n=e.id??g.domid(),i=this.#i(e.props),r=this.#t(e.data);return y.injectStyle(`#${n} {
            ${g.objectToCSS(e.styles)}
        }`),`<div class="hs-panel-btn ${t}" id="${n}"${i} ${r}>${a}</div>`}static Input(e){let t=e.class??"",a=this.#a(e.type),n=this.#r(e.type),i=e.id??g.domid(),r=this.#i(e.props),s=this.#t(e.data);return y.injectStyle(`#${i} {
            ${g.objectToCSS(e.styles)}
        }`),`<input type="${a}" class="${n} ${t}" id="${i}"${r} ${s}></input>`}static Select(e,t){let a=e.class??"",n=this.#a(e.type),i=this.#r(e.type),r=e.id??g.domid(),s=this.#i(e.props),l=this.#t(e.data);y.injectStyle(`#${r} {
            ${g.objectToCSS(e.styles)}
        }`);let u=t.map(d=>`<option value="${d.value}" ${d.selected?"selected":""}>${d.text}</option>`).join(`
`);return`<select class="${i} ${a}" id="${r}"${s} ${l}>${u}</select>`}static Div(e){let t=e.class??"",a=e.id??g.domid(),n="",i=this.#i(e.props),r=this.#t(e.data);return e.html&&(Array.isArray(e.html)?n=e.html.join(`
`):n=e.html),y.injectStyle(`#${a} {
            ${g.objectToCSS(e.styles)}
        }`),`<div class="hs-panel-div ${t}" ${a?`id="${a}"`:""}${i} ${r}>${n}</div>`}static P(e){let t=e.class??"",a=e.id??g.domid(),n="",i=this.#i(e.props),r=this.#t(e.data);return e.text&&(Array.isArray(e.text)?n=e.text.join(`
`):n=e.text),y.injectStyle(`#${a} {
            ${g.objectToCSS(e.styles)}
        }`),`<p class="hs-panel-p ${t}" ${a?`id="${a}"`:""}${i} ${r}>${n}</p>`}static Image(e){let t=e.class??"",a=e.id??g.domid(),n=this.#i(e.props),i=this.#t(e.data);if(!e.src)return c.warn("HSUIC.Image: No src provided for image component",this.#e),"";let r=e.width?e.width:b.HSUIC.defaultImageWidth,s=e.height?e.height:b.HSUIC.defaultImageHeight;return y.injectStyle(`#${a} {
            ${g.objectToCSS(e.styles)}
        }`),`<img src="${e.src}" width="${r}" height="${s}" class="hs-panel-img ${t}" ${a?`id="${a}"`:""}${n} ${i}/>`}static Grid(e){let t=e.class??"",a=e.id??g.domid(),n="",i=this.#i(e.props),r=this.#t(e.data);return e.html&&(Array.isArray(e.html)?n=e.html.join(`
`):n=e.html),y.injectStyle(`#${a} {
            display: grid;
            ${g.objectToCSS(e.styles)}
        }`),`<div class="hs-panel-div ${t}" id="${a}"${i} ${r}>${n}</div>`}static Flex(e){let t=e.class??"",a=e.id??g.domid(),n="",i=this.#i(e.props),r=this.#t(e.data);return e.html&&(Array.isArray(e.html)?n=e.html.join(`
`):n=e.html),y.injectStyle(`#${a} {
            display: flex;
            ${g.objectToCSS(e.styles)}
        }`),`<div class="hs-panel-div ${t}" id="${a}"${i} ${r}>${n}</div>`}static _modal(e){let t=e.class??"",a=e.htmlContent??"",n=e.data??[],i=e.title??"",r=e.id??g.domid(),s=this.#i(e.props),l=this.#t(e.data);return y.injectStyle(`#${r} {
            ${g.objectToCSS(e.styles)}
...
@-webkit-keyframes hs-animtext-1 {
...
}`;var Mt=`<div id="hs-panel" class="hs-panel-closed">
    ...
    `).join(""),n={htmlContent:`
        ...
        `,title:"Configure Corruption Loadout"},i=await o.Modal(n);setTimeout(()=>{document.getElementById("hs-corruption-save-btn")?.addEventListener("click",()=>{Object.keys(xe).forEach(r=>{let s=document.getElementById(`hs-corruption-${r}`),l=Math.max(0,Math.min(16,Number(s?.value)||0));e[r]=l}),y.removeInjectedStyle("hs-corruption-modal-styles"),o.CloseModal(i)})},0)}async function Lt(o,e,t,a){let n="hs-autosing-challenges-modal",i=[...e],r=x=>Ae.find(T=>T.value===x)?.label??null,s=x=>x.challengeNumber===200&&x.ifJump!==void 0,l=x=>`${x.toLocaleString()}ms`,u=(x,T)=>{let B=(x.ifJump.ifJumpMode??"challenges")==="challenges",L;if(B)L=`
                <strong>IF</strong>
                challenge ${x.ifJump.ifJumpChallenge}
                ${x.ifJump.ifJumpOperator}
                ${x.ifJump.ifJumpValue}
            `;else{let O=x.ifJump.ifJumpMultiplier??0;L=`
                <strong>IF</strong>
    ...
    <div class="hs-challenge-item hs-if-block"
        ...
        <div class="hs-challenge-btn hs-challenge-btn-edit" id="hs-challenge-edit-${T}" data-index="${T}">\u270E</div>
        <div class="hs-challenge-btn hs-challenge-btn-delete" id="hs-challenge-delete-${T}" data-index="${T}">\xD7</div>
    </div>
    `},d=(x,T)=>`
    ...
    `,p=(x,T)=>{let R=r(x.challengeNumber),B=!!R,L=B?`<strong>${R}</strong>`:`Challenge ${x.challengeNumber}
     (${x.challengeCompletions} completions)`;return`
        <div class="hs-challenge-item" data-index="${T}">
            <div class="hs-challenge-drag-handle">\u22EE\u22EE</div>
            <div class="hs-challenge-item-text">
                ${L}
                <div class="hs-challenge-meta">
                    Wait before: ${l(x.challengeWaitBefore??0)} 
                    ${B?"":` | Wait inside: ${l(x.challengeWaitTime)}`}
                    ${B?"":` | Max: ${l(x.challengeMaxTime??-1)}`}
                </div>
            </div>
            <div class="hs-challenge-btn hs-challenge-btn-edit" id="hs-challenge-edit-${T}" data-index="${T}">\u270E</div>
            <div class="hs-challenge-btn hs-challenge-btn-delete" id="hs-challenge-delete-${T}" data-index="${T}">\xD7</div>
        </div>
        `},m=()=>{let x=[],T=new Map;i.forEach((B,L)=>{if(s(B)){let O=B.ifJump.ifJumpIndex;T.has(O)||T.set(O,[]),T.get(O).push({ifIndex:L,ifId:B.ifJump.id})}}),i.forEach((B,L)=>{T.has(L)&&T.get(L).forEach(O=>{let P=i[O.ifIndex];x.push(d(O.ifIndex,P.ifJump.id))}),s(B)?x.push(u(B,L)):x.push(p(B,L))});let R=i.length;return T.has(R)&&T.get(R).forEach(B=>{let L=i[B.ifIndex];x.push(d(B.ifIndex,L.ifJump.id))}),x.join("")},h=()=>{let x=document.getElementById("hs-challenge-list-container");x&&(x.innerHTML=m(),$(),J())},A={htmlContent:`
    <div id="${n}" class="hs-challenges-modal-container">
        <div class="hs-challenges-input-section">
            ...
            <div class="hs-challenges-input-label">Special Action:</div>
                <select id="hs-challenge-action-select" class="hs-challenges-input">
                    ...
                    ${Ae.map(x=>`<option value="${x.value}">${x.label}</option>`).join("")}
                </select>
            </div>
    ...
    </div>`,title:`Configure Strategy Actions (${t}-${a})`},w=await o.Modal(A),C=null,S=null,v=null,E=null,Y=!1,Q=null,j=(x,T)=>{let R;return function(...B){R||(x.apply(this,B),R=!0,setTimeout(()=>R=!1,T))}},J=()=>{document.querySelectorAll(".hs-challenge-item").forEach(x=>{let T=x,R=T.dataset.ifId;R&&(T.addEventListener("mouseenter",()=>{document.querySelectorAll(`[data-if-id="${R}"]`).forEach(B=>B.classList.add("hs-jump-highlight"))}),T.addEventListener("mouseleave",()=>{document.querySelectorAll(`[data-if-id="${R}"]`).forEach(B=>B.classList.remove("hs-jump-highlight"))}))})},z=x=>{let T=document.getElementById("hs-challenge-list-container");return T?Array.from(T.querySelectorAll(".hs-challenge-item")).indexOf(x):0},_=x=>{let T=document.getElementById("hs-challenge-list-container");if(!T)return 0;let R=Array.from(T.querySelectorAll(".hs-challenge-item")),B=0;for(let L=0;L<=x&&L<R.length;L++)if(!R[L].dataset.jumpFor){if(L===x)return B;B++}return Math.min(B,i.length)},$=()=>{document.querySelectorAll(".hs-challenge-item").forEach(T=>{let R=T.querySelector(".hs-challenge-drag-handle");R.addEventListener("mousedown",B=>{B.preventDefault();let L=T;if(Y=L.dataset.jumpFor!==void 0,Y)Q=Number(L.dataset.jumpFor),v=null;else if(L.dataset.index!==void 0)v=Number(L.dataset.index),Q=null;else return;S=L;let O=L.getBoundingClientRect(),P=B.clientX-O.left,X=B.clientY-O.top;E=L.cloneNode(!0),E.style.opacity="0.3",E.style.pointerEvents="none";let N=L.getBoundingClientRect().width,re=L.getBoundingClientRect().height;L.style.position="fixed",L.style.zIndex="1000",L.style.cursor="grabbing",L.style.pointerEvents="none",L.style.width=N+"px",L.style.height=re+"px",L.style.boxSizing="border-box",L.style.boxShadow="0 8px 16px rgba(0,0,0,0.3)",L.style.transform="scale(1.03)",L.style.transition="transform 0.15s ease",L.parentNode?.insertBefore(E,L);let W=(F,ae)=>{S&&(S.style.left=F-P+"px",S.style.top=ae-X+"px")};W(B.clientX,B.clientY);let V=j(F=>{let ae=document.getElementById("hs-challenge-list-container");if(ae&&(W(F.clientX,F.clientY),S)){S.style.display="none";let ut=document.elementFromPoint(F.clientX,F.clientY);if(S.style.display="",!ut)return;let pe=ut.closest(".hs-challenge-item"),Kt=ae.getBoundingClientRect(),dt=F.clientY>Kt.bottom-5;if(pe&&pe!==S&&pe!==E||dt){let pt=z(pe),Xt=z(S);if(pt===Xt)return;if(Y&&Q!==null){let k=dt?i.length:_(pt),Me=i[Q];if(s(Me)){Me.ifJump.ifJumpIndex=k;let ne=document.getElementById("hs-challenge-list-container");if(ne){let rt=ne.scrollTop;ne.innerHTML=m(),ne.scrollTop=rt;let U=document.querySelector(`[data-jump-for="${Q}"]`);U&&(S=U,E=U.cloneNode(!0),E.style.opacity="0.3",E.style.pointerEvents="none",U.style.position="fixed",U.style.zIndex="1000",U.style.cursor="grabbing",U.style.pointerEvents="none",U.style.width=U.offsetWidth+"px",U.style.boxShadow="0 8px 16px rgba(0,0,0,0.3)",U.style.transform="scale(1.03)",U.parentNode?.insertBefore(E,U),W(F.clientX,F.clientY)),$(),J()}}}else if(v!==null&&pe.dataset.index!==void 0){let k=Number(pe.dataset.index);if(k!==v){let Me=i[v];i.splice(v,1),i.splice(k,0,Me),v=k;let ne=document.getElementById("hs-challenge-list-container");if(ne){let rt=ne.scrollTop;ne.innerHTML=m(),ne.scrollTop=rt;let U=document.querySelector(`[data-index="${v}"]`);U&&!U.dataset.jumpFor&&(S=U,E=U.cloneNode(!0),E.style.opacity="0.3",E.style.pointerEvents="none",U.style.position="fixed",U.style.zIndex="1000",U.style.cursor="grabbing",U.style.pointerEvents="none",U.style.width=U.offsetWidth+"px",U.style.boxShadow="0 8px 16px rgba(0,0,0,0.3)",U.style.transform="scale(1.03)",U.parentNode?.insertBefore(E,U),W(F.clientX,F.clientY)),$(),J()}}}}}},16),de=()=>{S&&(S.style.position="",S.style.zIndex="",S.style.cursor="",S.style.pointerEvents="",S.style.width="",S.style.boxShadow="",S.style.transform="",S.style.left="",S.style.top="",S.style.transition=""),E&&E.parentNode&&E.parentNode.removeChild(E),S=null,v=null,Y=!1,Q=null,E=null,document.removeEventListener("mousemove",V),document.removeEventListener("mouseup",de),K()};document.addEventListener("mousemove",V),document.addEventListener("mouseup",de)}),R.style.cursor="grab"})},q=()=>{let x=document.getElementById("hs-challenge-action-select"),T=document.getElementById("hs-if-jump-mode"),R=!!x?.value,B=Number(x.value)===200,O=(T?.value??"challenges")==="challenges";["hs-challenge-num-input","hs-challenge-completions-input","hs-challenge-max-time-input","hs-challenge-wait-inside-input"].forEach(F=>{let ae=document.getElementById(F);ae&&(ae.disabled=R,ae.parentElement.style.opacity=R?"0.4":"1",ae.parentElement.style.display=B?"none":"")}),document.querySelectorAll(".hs-if-jump-row").forEach(F=>{F.style.display=B?"":"none"});let X=document.querySelector(".hs-if-jump-challenge-row"),N=document.getElementById("hs-if-jump-challenge"),re=X?.querySelector(".hs-challenges-input-label"),W=document.querySelector(".hs-if-jump-value-row"),V=document.getElementById("hs-if-jump-value"),de=W?.querySelector(".hs-challenges-input-label");X&&N&&re&&(B?(X.style.display="",O?(re.textContent="If Challenge",N.type="number",N.min="1",N.max="15",N.disabled=!1,N.value=N.dataset.lastChallengeValue??"1",N.style.opacity="1",N.style.cursor="",X.style.opacity="1"):(N.max==="15"&&N.value&&(N.dataset.lastChallengeValue=N.value),re.textContent="Multiplier (10^x)",N.type="number",N.min="",N.max="",N.disabled=!1,N.value===""&&(N.value=N.dataset.lastExponentValue??"0"),N.style.opacity="1",N.style.cursor="",X.style.opacity="1")):X.style.display="none"),W&&V&&de&&(B?(W.style.display="",O?(de.textContent="Value",V.type="number",V.disabled=!1,V.value=V.dataset.lastValue??"1",V.style.opacity="1",V.style.cursor="",W.style.opacity="1"):(V.type==="number"&&V.value&&!V.disabled&&(V.dataset.lastValue=V.value),de.textContent="Compare To",V.type="text",V.disabled=!0,V.value="Current C15 value",V.style.opacity="0.6",V.style.cursor="not-allowed",W.style.opacity="0.8")):W.style.display="none")},K=()=>{document.getElementById("hs-challenge-num-input").value="1",document.getElementById("hs-challenge-completions-input").value="0",document.getElementById("hs-challenge-wait-inside-input").value="0",document.getElementById("hs-challenge-wait-before-input").value="0",document.getElementById("hs-challenge-max-time-input").value="1000000",document.getElementById("hs-challenge-action-select").value="",document.getElementById("hs-if-jump-mode").value="challenges",document.getElementById("hs-challenge-add-btn").textContent="Add Action/Challenge",C=null,q()};setTimeout(()=>{let x=document.getElementById(n),T=document.getElementById("hs-challenge-action-select"),R=document.getElementById("hs-if-jump-mode");T?.addEventListener("change",q),R?.addEventListener("change",q),$(),J(),x?.addEventListener("click",B=>{let L=B.target,O=L.id;if(O==="hs-challenge-add-btn"){let P=!!T.value,X=Number(T.value)===200,N;if(X){let re=C!==null?i[C]:null,W=R.value,V=W==="challenges";N={challengeNumber:200,challengeCompletions:0,challengeWaitTime:0,challengeMaxTime:0,ifJump:{id:re?.ifJump?.id??g.uuidv4(),ifJumpMode:W,ifJumpChallenge:V?Number(document.getElementById("hs-if-jump-challenge").value):15,ifJumpOperator:document.getElementById("hs-if-jump-operator").value,ifJumpValue:V?Number(document.getElementById("hs-if-jump-value").value):0,ifJumpMultiplier:V?0:Number(document.getElementById("hs-if-jump-challenge").value),ifJumpIndex:re?.ifJump?.ifJumpIndex??i.length+1}}}else N={challengeNumber:Number(P?T.value:document.getElementById("hs-challenge-num-input").value),challengeCompletions:P?0:Number(document.getElementById("hs-challenge-completions-input").value),challengeWaitTime:Number(document.getElementById("hs-challenge-wait-inside-input").value),challengeWaitBefore:Number(document.getElementById("hs-challenge-wait-before-input").value),challengeMaxTime:P?0:Number(document.getElementById("hs-challenge-max-time-input").value)};C!==null?i[C]=N:i.push(N),h(),K()}if(O.startsWith("hs-challenge-edit-")){C=Number(L.dataset.index);let P=i[C],X=r(P.challengeNumber);if(s(P)){T.value=String(200);let N=P.ifJump?.ifJumpMode??"challenges";R.value=N,N==="challenges"?(document.getElementById("hs-if-jump-challenge").value=String(P.ifJump?.ifJumpChallenge??1),document.getElementById("hs-if-jump-value").value=String(P.ifJump?.ifJumpValue??1)):document.getElementById("hs-if-jump-challenge").value=String(P.ifJump?.ifJumpMultiplier??0),document.getElementById("hs-if-jump-operator").value=P.ifJump?.ifJumpOperator??">",document.getElementById("hs-challenge-wait-inside-input").value=String(P.challengeWaitTime),document.getElementById("hs-challenge-wait-before-input").value=String(P.challengeWaitBefore??0),document.getElementById("hs-challenge-add-btn").textContent="Update Action",q();return}X?T.value=String(P.challengeNumber):(T.value="",document.getElementById("hs-challenge-num-input").value=String(P.challengeNumber),document.getElementById("hs-challenge-completions-input").value=String(P.challengeCompletions),document.getElementById("hs-challenge-max-time-input").value=String(P.challengeMaxTime)),document.getElementById("hs-challenge-wait-inside-input").value=String(P.challengeWaitTime),document.getElementById("hs-challenge-wait-before-input").value=String(P.challengeWaitBefore??0),document.getElementById("hs-challenge-add-btn").textContent="Update Action",q()}O.startsWith("hs-challenge-delete-")&&(i.splice(Number(L.dataset.index),1),h(),K()),O==="hs-challenges-save-btn"&&(e.length=0,e.push(...i),o.CloseModal(w)),O==="hs-challenges-cancel-btn"&&o.CloseModal(w)})},0)}async function lt(o,e,t,a,n){let i=!!n,r=e.length?e[e.length-1].endPhase:"start",s=n?.corruptions||{viscosity:0,drought:0,deflation:0,extinction:0,illiteracy:0,recession:0,dilation:0,hyperchallenge:0},l=n?.strat||[],u=oe.indexOf(r),p=oe.slice(u+1).map((A,w)=>`<option value="${A}" ${n?.endPhase===A||w===0?"selected":""}>${A}</option>`).join(""),m={htmlContent:`
        ...
        `,title:i?`Edit Strategy Phase ${n.startPhase}-${n.endPhase}`:"Create Strategy Phase"},h=await o.Modal(m);setTimeout(()=>{let A=document.querySelector(".hs-phase-modal-container");A&&A.addEventListener("click",async w=>{let C=w.target;if(C.id==="hs-autosing-phase-done"){let v=document.getElementById("hs-autosing-end-phase")?.value;if(!v)return;let E={startPhase:n?n.startPhase:r,endPhase:v,corruptions:{...s},strat:[...l]};i&&a?a(E):t(E),y.removeInjectedStyle("hs-phase-modal-styles"),o.CloseModal(h)}C.id==="hs-autosing-phase-corruptions"&&await Dt(o,s),C.id==="hs-autosing-phase-challenges"&&await Lt(o,l,n?.startPhase??"error",n?.endPhase??"error")})},0)}var me=class{static async open(e,t){let a=D.getModule("HSUI");if(!a||!a.uiReady)return;let n=!!e,i=e?{strategyName:e.strategyName,strategy:JSON.parse(JSON.stringify(e.strategy))}:{strategyName:"",strategy:[]},r=()=>{for(let d=1;d<i.strategy.length;d++){let p=i.strategy[d-1],m=i.strategy[d];m.startPhase=p.endPhase}},s=()=>{let d=document.getElementById("hs-autosing-phase-list");if(d){if(i.strategy.length===0){d.innerHTML='<div class="hs-strategy-empty-state">No strategy phases added yet.</div>';return}d.innerHTML=i.strategy.map((p,m)=>`
                    <div class="hs-strategy-phase-item">
                        <div class="hs-strategy-phase-text">
                            Phase ${m+1}: ${p.startPhase} <span class="hs-strategy-phase-arrow">\u2192</span> <strong>${p.endPhase}</strong>
                        </div>
            ...
            `,title:n?"Edit Autosing Strategy":"Create Autosing Strategy"},u=await a.Modal(l);setTimeout(()=>{let d=document.querySelector(".hs-strategy-modal-container");d&&(s(),d.addEventListener("click",async p=>{let m=p.target,h=m.dataset.action,A=m.dataset.phaseIndex;if(m.id==="hs-autosing-add-phase-btn")await lt(a,i.strategy,w=>{i.strategy.push(w),r(),s()});else if(m.id==="hs-autosing-create-btn"){let w=document.getElementById("hs-strategy-error"),C=document.getElementById("hs-autosing-strategy-name");i.strategyName=C?.value||"Unnamed Strategy";try{n?(I.saveStrategiesToStorage(i,e.strategyName),y.Notify(`Strategy "${i.strategyName}" updated`,{notificationType:"success"})):(I.saveStrategiesToStorage(i),y.Notify(`Strategy "${i.strategyName}" created`,{notificationType:"success"})),a.CloseModal(u)}catch(S){w&&(w.textContent=S.message,w.style.display="block")}}else if(h==="edit"&&A!==void 0){let w=parseInt(A),C=i.strategy[w];await lt(a,i.strategy.slice(0,w),()=>{},S=>{i.strategy[w]=S,r(),s()},C)}else if(h==="delete"&&A!==void 0){let w=parseInt(A);i.strategy.splice(w,1),r(),s()}}))},0)}};var Te=class{#e={syncNotificationOpacity:async e=>{let t=document.querySelector("#notification"),a=e.contextName??"HSSettings";if(e.disable&&e.disable===!0)t.style.removeProperty("opacity");else{let n=e.value;t&&n&&n>=0&&n<=1&&(t.style.opacity=n.toString())}},logTimestamp:async e=>{e.disable&&e.disable===!0?c.setTimestampDisplay(!1):c.setTimestampDisplay(!0)},reactiveMouseHover:async e=>{let t=e.contextName??"HSSettings";e.disable&&e.disable===!0&&ce.clearInterval("hover")},autoClick:async e=>{let t=e.contextName??"HSSettings";e.disable&&e.disable===!0&&ce.clearInterval("click")},ambrosiaQuickBarAction:async e=>{let t=e.contextName??"HSSettings",a=D.getModule("HSAmbrosia");a&&(e.disable&&e.disable===!0?await a.hideQuickBar():await a.showQuickBar())},ambrosiaMinibarAction:async e=>{let t=e.contextName??"HSSettings",a=D.getModule("HSAmbrosia");a&&(e.disable&&e.disable===!0?await a.disableBerryMinibars():await a.enableBerryMinibars())},patch:async e=>{let t=e.contextName??"HSSettings";if(!e.patchConfig||!e.patchConfig.patchName){c.error("No patch config provided for setting action",t);return}let a=D.getModule("HSPatches");a&&(e.disable&&e.disable===!0?(console.log("Disabling patch",e.patchConfig.patchName,t),await a.revertPatch(e.patchConfig.patchName)):(console.log("Enabling patch",e.patchConfig.patchName,t),await a.applyPatch(e.patchConfig.patchName)))},useGameData:async e=>{let t=e.contextName??"HSSettings",a=D.getModule("HSGameData");a&&(e.disable&&e.disable===!0?a.disableGDS():a.enableGDS())},autoLoadout:async e=>{let t=e.contextName??"HSSettings",a=D.getModule("HSAmbrosia");a&&(e.disable&&e.disable===!0?await a.disableAutoLoadout():await a.enableAutoLoadout())},ambrosiaIdleSwapAction:async e=>{let t=e.contextName??"HSSettings",a=D.getModule("HSAmbrosia");a&&(e.disable&&e.disable===!0?await a.disableIdleSwap():await a.enableIdleSwap())},startAutosingAction:async e=>{let t=e.contextName??"HSSettings",a=D.getModule("HSAutosing");a&&(e.disable&&e.disable===!0?await a.disableAutoSing():await a.enableAutoSing())},createAutosingStrategy:async e=>{let t=e.contextName??"HSSettings";await me.open()},editAutosingStrategy:async e=>{let t=e.contextName??"HSSettings";await I.editSelectedStrategy()},deleteAutosingStrategy:async e=>{let t=e.contextName??"HSSettings";await I.deleteSelectedStrategy()},exportAutosingStrategy:async e=>{let t=e.contextName??"HSSettings";await I.exportSelectedStrategy()},importAutosingStrategy:async e=>{let t=e.contextName??"HSSettings";await I.importStrategy()},hideMaxedGQUpgradesAction:async e=>{let t=e.contextName??"HSSettings",a=D.getModule("HSQOLButtons");a&&(a.gqUpgradesInitialized=!1)},hideMaxedOctUpgradesAction:async e=>{let t=e.contextName??"HSSettings",a=D.getModule("HSQOLButtons");a&&(a.octUpgradesInitialized=!1)}};constructor(){}getAction(e){let t=this;return e in this.#e?a=>{t.#e[e](a)}:null}};var ie=class{constructor(e,t,a,n){this.context="HSSetting";this.definition=e,this.settingAction=t,this.#e=a,this.#t=n,this.definition.defaultValue=this.definition.settingValue}#e;#t;getDefinition(){return this.definition}setDefinition(e){this.definition=e}enable(){this.#a(!0)}disable(){this.#a(!1)}async handleToggle(e){let t=!this.definition.enabled,a=this.definition.enabled!==t,n=I.getSetting("useGameData");if(!b.HSSettings.gameDataCheckBlacklist.includes(this.definition.settingName)&&n&&this.definition.usesGameData&&a&&t&&!n.isEnabled()){c.warn(`Enable GDS before enabling ${this.definition.settingDescription}!`);return}if(this.definition.settingName==="useGameData"&&a&&!t){let r=I.getSettings();for(let[s,l]of Object.entries(r)){let u=l.getDefinition();b.HSSettings.gameDataCheckBlacklist.includes(s)||"usesGameData"in u&&u.usesGameData===!0&&l.isEnabled()&&l.definition.settingName!=="startAutosing"&&l.disable()}}if(c.log(`${this.definition.settingName}: ${this.definition.enabled} -> ${!this.definition.enabled}`,this.context),!a)return;this.definition.enabled=t,this.definition.settingType==="boolean"&&(this.definition.settingValue=t,this.definition.calculatedSettingValue=t);let i=e.target;t?(i.innerText=this.#e,i.classList.remove("hs-disabled")):(i.innerText=this.#t,i.classList.add("hs-disabled")),this.handleSettingAction("state",t)}#a(e){let t=this.definition.enabled!==e;if(!t)return;if(this.definition.settingName==="useGameData"&&t&&!e){let n=I.getSettings();for(let[i,r]of Object.entries(n)){let s=r.getDefinition();b.HSSettings.gameDataCheckBlacklist.includes(i)||"usesGameData"in s&&s.usesGameData===!0&&r.isEnabled()&&r.definition.settingName!=="startAutosing"&&r.disable()}}c.log(`${this.definition.settingName}: ${this.definition.enabled} -> ${e}`,this.context),this.definition.enabled=e;let a=document.querySelector(`#${this.definition.settingControl?.controlEnabledId}`);e&&a?(a.innerText=this.#e,a.classList.remove("hs-disabled")):(a.innerText=this.#t,a.classList.add("hs-disabled")),this.handleSettingAction("state",e),I.saveSettingsToStorage()}async initialAction(e,t){await this.handleSettingAction(e,t)}async handleSettingAction(e,t){if(this.settingAction){let a=this.settingAction,n={contextName:this.context,value:this.definition.calculatedSettingValue??null};this.definition.patchConfig&&this.definition.patchConfig.patchName&&(n.patchConfig=this.definition.patchConfig),a&&a instanceof Function&&(e==="state"?t?await a({...n,disable:!1}):await a({...n,disable:!0}):await a({...n,disable:!1}))}}hasControls(){return"settingControl"in this.definition}isEnabled(){return this.definition.enabled}getCalculatedValue(){return this.definition.calculatedSettingValue}toString(){return JSON.stringify(this.definition)}},ke=class extends ie{constructor(e,t,a,n){super(e,t,a,n),this.definition.enabled=!0,this.definition.settingValue=null,this.definition.calculatedSettingValue=null}getValue(){return null}setValue(e){}async handleChange(e){c.log(`Button pressed: ${this.definition.settingName}`,this.context),await this.handleSettingAction("value")}async initialAction(e,t){}enable(){}disable(){}},He=class extends ie{constructor(e,t,a,n){super(e,t,a,n),this.definition.settingValueMultiplier&&(this.definition.calculatedSettingValue=this.definition.settingValue*this.definition.settingValueMultiplier)}getValue(){return this.definition.settingValue}setValue(e){return this.definition.settingValue=e}async handleChange(e){let t=parseFloat(e.target.value);c.log(`${this.definition.settingName}: ${this.definition.settingValue} -> ${t}`,this.context),this.definition.settingValue=t,this.definition.calculatedSettingValue=t*this.definition.settingValueMultiplier,await super.handleSettingAction("value")}},De=class extends ie{constructor(e,t,a,n){super(e,t,a,n)}getValue(){return this.definition.settingValue}setValue(e){return this.definition.settingValue=e}async handleChange(e){let t=e.target.value;c.log(`${this.definition.settingName}: ${this.definition.settingValue} -> ${t}`,this.context),this.definition.settingValue=t,this.definition.calculatedSettingValue=t,await super.handleSettingAction("value")}},Le=class extends ie{constructor(e,t,a,n){super(e,t,a,n)}getValue(){return this.definition.enabled}setValue(e){this.definition.settingValue=e,this.definition.calculatedSettingValue=e,this.definition.enabled=e}async handleChange(e){}},Be=class extends ie{constructor(e,t,a,n){super(e,t,a,n),this.definition.settingValueMultiplier&&(this.definition.calculatedSettingValue=this.definition.settingValue*this.definition.settingValueMultiplier)}getValue(){return this.definition.settingValue}setValue(e){}async handleChange(e){let t=parseFloat(e.target.value);c.log(`${this.definition.settingName}: ${this.definition.settingValue} -> ${t}`,this.context),this.definition.settingValue=t,this.definition.calculatedSettingValue=t*this.definition.settingValueMultiplier,await super.handleSettingAction("value")}},Re=class extends ie{constructor(e,t,a,n){super(e,t,a,n)}getValue(){return this.definition.settingValue}setValue(e){}async handleChange(e){let t=e.target.value;c.log(`${this.definition.settingName}: ${this.definition.settingValue} -> ${t}`,this.context),this.definition.settingValue=t,this.definition.calculatedSettingValue=t,await super.handleSettingAction("value")}},Ge=class extends ie{constructor(e,t,a,n){super(e,t,a,n)}getValue(){return g.removeColorTags(this.definition.settingValue)}getDisplayValue(){return g.parseColorTags(this.definition.settingValue)}setValue(e){this.definition.settingValue=e,this.definition.calculatedSettingValue=e;let t=document.querySelector(`#${this.definition.settingControl?.controlId}`);t&&(t.innerHTML=this.getDisplayValue()),I.saveSettingsToStorage()}async handleChange(e){}};var Bt="data:image/png;base64,";var I=class o extends G{static#e="";static#t={};static#a;static#r;static#i=!1;static#n=!1;static#o="\u2713";static#s="\u2717";static#l=[];#u;constructor(e){super(e),o.#e=this.context,this.#u=new Te,c.log("Parsing mod settings",this.context);try{c.log("Parsing control groups",this.context),o.#a=JSON.parse(bt)}catch(t){c.error(`Error parsing control groups ${t}`,this.context),o.#i=!1}try{c.log("Parsing control pages",this.context),o.#r=JSON.parse(ft)}catch(t){c.error(`Error parsing control pages ${t}`,this.context),o.#i=!1}try{c.log("Parsing settings.json",this.context);let t=this.#c(),a;"useGameData"in t?a=t.useGameData.enabled:a=!1;for(let[n,i]of Object.typedEntries(t)){(i.settingType==="boolean"||g.isBoolean(i.settingValue))&&(i.settingValue=!1),i.usesGameData&&i.enabled&&!a&&(b.HSSettings.gameDataCheckBlacklist.includes(n)||(c.info(`Disabled ${i.settingDescription} on load because GDS is not on`,this.context),i.enabled=!1)),this.#m(i,o.#a);let r="settingAction"in i?i.settingAction:void 0,s=r?this.#u.getAction(r):null;if(i.settingType==="numeric")"settingValueMultiplier"in i||(i.settingValueMultiplier=1),o.#t[n]=new He(i,s,o.#o,o.#s);else if(i.settingType==="string")o.#t[n]=new De(i,s,o.#o,o.#s);else if(i.settingType==="boolean")o.#t[n]=new Le(i,s,o.#o,o.#s);else if(i.settingType==="selectnumeric")"settingValueMultiplier"in i||(i.settingValueMultiplier=1),o.#t[n]=new Be(i,s,o.#o,o.#s);else if(i.settingType==="selectstring")o.#t[n]=new Re(i,s,o.#o,o.#s);else if(i.settingType==="state")o.#t[n]=new Ge(i,s,o.#o,o.#s);else if(i.settingType==="button")o.#t[n]=new ke(i,s,o.#o,o.#s);else throw new Error(`Could not parse setting ${n.toString()} (settingType: ${i.settingType}, settingValue: ${i.settingValue})`)}o.saveSettingsToStorage(),o.#i=!0}catch(t){c.error(`Error parsing mod settings ${t}`,this.context),o.#i=!1}}async init(){this.#A(o.#l),this.isInitialized=!0}static async syncSettings(){if(c.log("Syncing mod settings",o.#e),!o.#i){c.error("Could not sync settings - settings not parsed yet",o.#e);return}for(let[e,t]of Object.typedEntries(o.#t)){c.debug(`Syncing ${e} settings`,o.#e);let a=t.getDefinition(),n=t.hasControls()?a.settingControl:void 0;if(n){let i=n.controlType,r=n.controlOptions;if(i==="text"||i==="number"){let s=document.querySelector(`#${n.controlId}`);s&&(i==="number"&&r?("min"in r&&s.setAttribute("min",r.min.toString()),"max"in r&&s.setAttribute("max",r.max.toString()),"step"in r&&s.setAttribute("step",r.step.toString())):i==="text"&&r&&"placeholder"in r&&s.setAttribute("placeholder",r.placeholder),s.value=g.asString(a.settingValue),s.addEventListener("change",async l=>{await this.#S(l,t)}))}else if(i==="select"){let s=g.asString(a.settingValue),l=document.querySelector(`#${n.controlId}`);l&&(Array.from(l.options).some(d=>d.value===s)?l.value=s:(l.value="",c.warn(`Setting value ${s} does not exist in select options for setting ${e}`,o.#e)),l.addEventListener("change",async d=>{await this.#S(d,t)}))}else if(i==="state"){let s=g.parseColorTags(g.asString(a.settingValue)),l=document.querySelector(`#${n.controlId}`);l&&(l.innerHTML=s)}else if(i==="button"){let s=document.querySelector(`#${n.controlId}`);s&&s.addEventListener("click",async l=>{await this.#S(l,t)})}if(n.controlEnabledId){let s=document.querySelector(`#${n.controlEnabledId}`);s&&(a.enabled?(s.innerText=o.#o,s.classList.remove("hs-disabled")):(s.innerText=o.#s,s.classList.add("hs-disabled")),s.addEventListener("click",async l=>{await this.#b(l,t)}))}await t.initialAction("state",a.enabled)}}c.log("Finished syncing mod settings",o.#e),this.#n=!0}static autoBuildSettingsUI(){let e=this;if(!o.#i)return c.error("Could not sync settings - settings not parsed yet",o.#e),{didBuild:!1,navHTML:"",pagesHTML:""};let t=[],a=!0,n=Object.entries(o.#t).sort((p,m)=>{let h=p[1].getDefinition().settingControl?.controlGroup,A=m[1].getDefinition().settingControl?.controlGroup;return h&&A?(o.#a[h].order||0)-(o.#a[A].order||0):h?-1:A?1:0}),i=Object.entries(o.#r).sort((p,m)=>{let h=p[1].order,A=m[1].order;return h&&A?(h||0)-(A||0):h?-1:A?1:0}),r=[];for(let[p,m]of i)n.some(A=>A[1].getDefinition().settingControl?.controlPage===p)&&r.push(H.Div({class:"hs-panel-subtab",id:`hs-panel-settings-subtab-${p}`,data:new Map([["subtab",p],["color",m.pageColor||""]]),styles:{border:m.pageColor?`1px solid ${m.pageColor}`:"1px solid gray"},html:m.pageName}));let s=H.Div({class:"hs-panel-subtabs",html:r}),l=new Map,u=null;for(let[p,m]of n){let h=m.getDefinition(),A=h.settingControl,w=h.settingBlockId||void 0,C="";if(h.usesGameData&&(C=H.Image({class:"hs-panel-setting-block-gamedata-icon",src:Bt,width:18,height:18,props:{title:b.HSSettings.gameDataRequiredTooltip}})),A){let S=l.get(A.controlPage)||[],v=[];if(!u||u!==A.controlGroup){u=A.controlGroup;let E=o.#a[u];S.push(H.Div({html:E.groupName,styles:{borderBottom:"1px solid limegreen",gridColumn:"span 2",marginBottom:"15px"}}))}if(A.controlType==="switch")v=[H.Div({class:"hs-panel-setting-block-text-wrapper",styles:{display:"flex",flexDirection:"row",alignItems:"center"},html:[H.P({class:"hs-panel-setting-block-text",props:{title:h.settingHelpText},text:h.settingDescription,styles:{margin:"0"}}),C]})],A.controlEnabledId&&v.push(H.Button({class:"hs-panel-setting-block-btn hs-panel-settings-block-btn-standalone",id:A.controlEnabledId,text:""}));else if(A.controlType==="button")v=[H.Button({id:A.controlId,text:h.settingDescription||"Error: No button text"})];else{let E=null;switch(A.controlType){case"text":E=4;break;case"number":E=3;break;case"select":E=5;break;case"state":E=6;break;default:E=null}if(E){if(v=[H.Div({class:"hs-panel-setting-block-text-wrapper",styles:{display:"flex",flexDirection:"row",alignItems:"center"},html:[H.P({class:"hs-panel-setting-block-text",props:{title:h.settingHelpText},text:h.settingDescription,styles:{margin:"0"}}),C]})],E===3||E===4)v.push(H.Input({class:"hs-panel-setting-block-num-input",id:A.controlId,type:E}));else if(E===5)if(A.selectOptions)v.push(H.Select({class:"hs-panel-setting-block-select-input",id:A.controlId,type:E},A.selectOptions));else{c.error(`Error autobuilding settings UI, ${h.settingName} does not have selectOptions defined`,e.#e),a=!1;break}else E===6&&v.push(H.P({class:"hs-panel-setting-block-state",id:A.controlId,text:""}));A.controlEnabledId&&v.push(H.Button({class:"hs-panel-setting-block-btn",id:A.controlEnabledId,text:""}))}else{c.error("Error autobuilding settings UI, control type resolution failed (how??)",e.#e),a=!1;break}}S.push(H.Div({id:w,class:"hs-panel-setting-block",html:v})),l.set(A.controlPage,S)}else{c.error(`Error autobuilding settings UI, controls not defined for setting ${p}`,e.#e),a=!1;break}}for(let[p,m]of l.entries())l.set(p,[H.Div({class:"hs-panel-settings-grid",id:`settings-grid-${p}`,html:m})]);let d=[];for(let[p,m]of l.entries())d.push(m.join(""));return{didBuild:a,navHTML:s,pagesHTML:d.join("")}}static validateStrategy(e){if(!e)throw new Error("Strategy is undefined");if(!("strategyName"in e))throw new Error("Strategy is missing strategyName property");if(!("strategy"in e))throw new Error("Strategy is missing strategy property");if(!Array.isArray(e.strategy))throw new Error("Strategy.strategy must be an array");let t=e.strategy;if(t.length===0)throw new Error("Strategy has no components");let a=[...oe];for(let n=0;n<t.length;n++){let i=t[n],{startPhase:r,endPhase:s,corruptions:l,strat:u}=i;if(!l)throw new Error(`Component ${n+1} (${r} \u2192 ${s}) has no corruptions defined`);if(!Array.isArray(u)||u.length===0)throw new Error(`Component ${n+1} (${r} \u2192 ${s}) must have at least one challenge`);if(a[0]!==r)throw new Error(`Component ${n+1} must start at "${a[0]}", got "${r}"`);let d=a.indexOf(s);if(d===-1)throw new Error(`Component ${n+1} ends at "${s}", which is not valid or already consumed`);a=a.slice(d)}if(a.length>1)throw new Error(`Uncovered phases: ${a.join(", ")}`)}#m(e,t){if(!e)throw new Error("Setting is undefined (wtf)");let a=["text","number","switch","select","state","button"],n=["numeric","string","boolean","selectnumeric","selectstring","state","button"];if(!("settingName"in e))throw new Error("Setting is missing settingName property");let i=e.settingName;if(!("enabled"in e))throw new Error(`Setting '${i}' is missing enabled property`);if(!("settingDescription"in e))throw new Error(`Setting '${i}' is missing settingDescription property`);if(!("settingValue"in e))throw new Error(`Setting '${i}' is missing settingValue property`);if(!("settingType"in e))throw new Error(`Setting '${i}' is missing settingType property`);if(!n.includes(e.settingType))throw new Error(`Setting '${i}' has invalid settingType property`);let r=e.settingType;if(r==="numeric"){if(!g.isNumeric(e.settingValue))throw new Error(`Setting '${i}' has invalid settingValue property for settingType ${r}`)}else if(r==="string"){if(!g.isString(e.settingValue))throw new Error(`Setting '${i}' has invalid settingValue property for settingType ${r}`)}else if(r==="boolean"){if(!g.isBoolean(e.settingValue))throw new Error(`Setting '${i}' has invalid settingValue property for settingType ${r}`)}else if(r==="selectnumeric"){if(!g.isString(e.settingValue)&&!g.isNumeric(e.settingValue))throw new Error(`Setting '${i}' has invalid settingValue property for settingType ${r}`)}else if(r==="selectstring"&&!g.isString(e.settingValue)&&!g.isNumeric(e.settingValue))throw new Error(`Setting '${i}' has invalid settingValue property for settingType ${r}`);if("settingControl"in e&&e.settingControl){let s=e.settingControl;if(s.controlType!=="switch"&&!("controlId"in s))throw new Error(`Setting '${i}' has settingControl defined and it is not type'switch', but it is missing controlId property`);if(!("controlType"in s))throw new Error(`Setting '${i}' has settingControl defined, but it is missing controlType property`);if(!("controlGroup"in s))throw new Error(`Setting '${i}' has settingControl defined, but it is missing controlGroup property`);if(!a.includes(s.controlType))throw new Error(`Setting '${i}' has invalid controlType property`);if(!(s.controlGroup in t))throw new Error(`Setting '${i}' has invalid controlGroup property`)}}static getSetting(e){return this.#t[e]}static getSettings(){return this.#t}static getStrategies(){return this.#l}static#p(){let e={};for(let[t,a]of Object.typedEntries(this.#t)){let n={...a.getDefinition()},i=b.HSSettings.serializationBlackList;for(let r of i)n[r]&&delete n[r];e[t]=n}return JSON.stringify(e)}static saveStrategiesToStorage(e,t){let a=D.getModule("HSStorage");if(!a)throw new Error("Could not find Storage Module");let n=a.getData(b.HSSettings.strategiesKey);if(Array.isArray(n)||(n=[]),!e&&t){let i=n.filter(r=>r.strategyName!==t);o.#l=o.#l.filter(r=>r.strategyName!==t),a.setData(b.HSSettings.strategiesKey,i),this.#M(t),c.debug("<green>Strategy removed</green>",this.#e);return}if(e){this.validateStrategy(e);let i=!!t;if(n.some(u=>u.strategyName!==e.strategyName?!1:i?u.strategyName!==t:!0))throw new Error(`Strategy with name "${e.strategyName}" already exists.`);let s=n;i&&(s=n.filter(u=>u.strategyName!==t),this.#M(t),o.#l=o.#l.filter(u=>u.strategyName!==t)),s=s.concat(e),o.#l.push(e);let l=a.setData(b.HSSettings.strategiesKey,s.filter(u=>u.strategyName!=="default_strategy"));this.#g(e),l?c.debug(`<green>Strategy ${i?"updated":"saved"} to localStorage</green>`,this.#e):c.warn("Could not save Strategy to localStorage",this.#e)}}static async deleteSelectedStrategy(){let e=o.getSetting("autosingStrategy"),t=e.getValue();if(!t||t===""){y.Notify("Please select a strategy to delete",{notificationType:"warning"});return}let a=e.getDefinition().settingControl;if(!a?.selectOptions)return;let n=a.selectOptions.find(r=>r.value.toString()===t);if(!n)return;let i=n.text;if(i=="default_strategy"){y.Notify("cannot delete default strategy");return}confirm(`Are you sure you want to delete strategy "${i}"?`)&&(o.saveStrategiesToStorage(void 0,i),y.Notify(`Strategy "${i}" deleted`,{notificationType:"success"}))}static async exportSelectedStrategy(){let e=o.getSetting("autosingStrategy"),t=e.getValue();if(!t||t===""){y.Notify("Please select a strategy to export",{notificationType:"warning"});return}let a=e.getDefinition().settingControl;if(!a?.selectOptions)return;let n=a.selectOptions.find(l=>l.value.toString()===t);if(!n)return;let i=n.text,s=o.getStrategies().find(l=>l.strategyName===i);if(!s){y.Notify("Strategy not found",{notificationType:"error"});return}try{let l=JSON.stringify(s,null,2);await navigator.clipboard.writeText(l),y.Notify(`Strategy "${i}" copied to clipboard`,{notificationType:"success"})}catch(l){y.Notify("Failed to copy strategy to clipboard",{notificationType:"error"}),c.log(`Export failed: ${l}`,"HSAutosing")}}static async importStrategy(){let e=D.getModule("HSUI");if(e){let t=await e.Modal({title:"Import Strategy",htmlContent:`
        ...
        `}),a=document.querySelector(`#${t} #import-strategy-cancel`);a&&(a.dataset.close=t);let n=document.querySelector(`#${t} #import-strategy-submit`),i=document.querySelector(`#${t} #import-strategy-name`),r=document.querySelector(`#${t} #import-strategy-json`);if(r.addEventListener("input",()=>{if(!i.value.trim())try{let s=JSON.parse(r.value);s&&typeof s.strategyName=="string"&&s.strategyName.trim()&&(i.value=s.strategyName.trim())}catch{}}),!n||!i||!r){y.Notify("Failed to create import modal",{notificationType:"error"});return}n.addEventListener("click",async()=>{let s=i.value.trim(),l=r.value.trim();if(!s){y.Notify("Please enter a strategy name",{notificationType:"warning"});return}if(o.getStrategies().some(p=>p.strategyName===s)){y.Notify(`Strategy "${s}" already exists`,{notificationType:"warning"});return}let d;try{d=JSON.parse(l)}catch{y.Notify("Invalid JSON format",{notificationType:"error"});return}this.validateStrategy(d),d.strategyName=s;try{o.saveStrategiesToStorage(d),y.Notify(`Strategy "${s}" imported successfully`,{notificationType:"success"});let p=document.querySelector(`#${t}`);p&&(await p.transition({opacity:0}),p.parentElement?.removeChild(p))}catch(p){y.Notify("Failed to save strategy",{notificationType:"error"}),c.log(`Import failed: ${p}`,"HSAutosing")}})}else y.Notify("Failed to find HSUI",{notificationType:"error"})}static async editSelectedStrategy(){let e=o.getSetting("autosingStrategy"),t=e.getValue();if(!t||t===""){y.Notify("Please select a strategy to edit",{notificationType:"warning"});return}let a=e.getDefinition().settingControl;if(!a?.selectOptions)return;let n=a.selectOptions.find(s=>s.value.toString()===t);if(!n)return;let r=o.getStrategies().find(s=>s.strategyName===n.text);if(!r){y.Notify("Cannot edit selected strategy",{notificationType:"error"});return}if(r.strategyName=="default_strategy"){y.Notify("cannot edit default strategy");return}await me.open(r,t)}static saveSettingsToStorage(){let e=D.getModule("HSStorage");if(e){let t=this.#p();e.setData(b.HSSettings.storageKey,t)?c.debug("<green>Settings saved to localStorage</green>",this.#e):c.warn("Could not save settings to localStorage",this.#e)}}#d(){let e=JSON.parse(St);for(let t of e)t&&o.validateStrategy(t);return e}#h(){let e=JSON.parse(At);for(let[t,a]of Object.typedEntries(e))if(a){if((a.settingType==="boolean"||g.isBoolean(a.settingValue))&&(a.settingValue=!1),(a.settingType==="selectnumeric"||a.settingType==="selectstring")&&("settingValue"in a||(a.settingValue=""),"settingControl"in a&&a.settingControl)){let n=a.settingControl;"selectOptions"in n&&n.selectOptions&&(n.selectOptions.find(r=>r.value==="")||n.selectOptions.unshift({text:"None",value:""}))}(a.settingType==="numeric"||a.settingType==="selectnumeric"||g.isNumeric(a.settingValue))&&("settingValueMultiplier"in a||(a.settingValueMultiplier=1)),a.settingType==="state"&&("settingValue"in a||(a.settingValue="<red>null</red>")),this.#m(a,o.#a)}return e}#f(){let e=D.getModule("HSStorage");if(!e)return c.warn("Could not find HSStorage module",this.context),null;let t=e.getData(b.HSSettings.strategiesKey);return t?Array.isArray(t)?t:[t]:null}#v(){let e=D.getModule("HSStorage");if(e){let t=e.getData(b.HSSettings.storageKey);return t?JSON.parse(t):(c.warn("Could not load settings from localStorage",this.context),null)}else return c.warn("Could not find HSStorage module",this.context),null}#A(e){for(let t of e)if(t.strategyName===void 0)throw new Error("Strategy name is missing. Cannot add strategy to options.");for(let t of e)o.#g(t)}static#M(e){let a=this.getSetting("autosingStrategy").getDefinition().settingControl;if(!a?.selectOptions)return;let n=a.selectOptions.findIndex(i=>i.text===e);if(n!==-1){let i=a.selectOptions[n].value;a.selectOptions.splice(n,1);let r=document.querySelector(`#${a.controlId}`);if(r){let s=r.querySelector(`option[value="${i}"]`);s&&s.remove()}}}static#g(e){let a=this.getSetting("autosingStrategy").getDefinition().settingControl;if(!a?.selectOptions)return;let n=a.selectOptions.length>0?Math.max(...a.selectOptions.map(r=>Number(r.value)))+1:1;a.selectOptions.push({text:e.strategyName,value:n});let i=document.querySelector(`#${a.controlId}`);if(i){let r=document.createElement("option");r.value=String(n),r.textContent=e.strategyName,i.appendChild(r)}}#c(){let e=this.#h(),t=this.#d();o.#l.push(...t);try{let a=this.#v(),n=this.#f();n&&o.#l.push(...n);let i=JSON.parse(JSON.stringify(e));return a?(c.log("<green>Found settings from localStorage!</green>",this.context),Object.keys(e).forEach(r=>{r in a&&Object.keys(a[r]).forEach(s=>{if(s in e[r]){let l=a[r][s];if(l!==null&&typeof l=="object"&&!Array.isArray(l)&&typeof e[r][s]=="object"&&!Array.isArray(e[r][s])){let u={...e[r][s]};Object.keys(l).forEach(d=>{d in u&&(u[d]=l[d])}),i[r][s]=u}else i[r][s]=l}})}),i):e}catch(a){return c.error("Error while resolving settings",this.context),console.log(a),e}}static async#S(e,t){await t.handleChange(e),this.saveSettingsToStorage()}static async#b(e,t){await t.handleToggle(e),this.saveSettingsToStorage()}static dumpToConsole(){console.log("------------------ HYPERSYNERGISM CURRENT SETTINGS DUMP START ------------------"),this.#t?console.log(this.#t):console.log("NO SETTINGS FOUND (wtf)"),console.log("------------------ HYPERSYNERGISM CURRENT SETTINGS DUMP END ------------------")}};var Ne=class extends G{#e;#t;#a=["chronos","hyperrealism","quark","challenge","abyss","accelerator","acceleratorBoost","multiplier"];#r=[];#i=[];#n={chronosHepteract:0,hyperrealismHepteract:0,quarkHepteract:0,challengeHepteract:0,abyssHepteract:0,acceleratorHepteract:0,acceleratorBoostHepteract:0,multiplierHepteract:0};#o={chronosHepteract:null,hyperrealismHepteract:null,quarkHepteract:100,challengeHepteract:null,abyssHepteract:null,acceleratorHepteract:null,acceleratorBoostHepteract:null,multiplierHepteract:null};#s=0;#l=0;#u=0;#m=0;#p=0;#d=`
        ...
        #hs-ratio-container {
            ...
            grid-column-gap: 0px;
            grid-row-gap: 0px;
        }`;#f;#v;#A;#M;#g;#c;#S;#b=!1;#y=!1;constructor(e){super(e),this.#r=this.#a.map(t=>`${t}Hepteract`),this.#i=this.#a.map(t=>`${t}ProgressBarText`)}async init(){let e=this;c.log("Initialising HSHepteracts module",this.context);let t=D.getModule("HSGameState");t&&(t.subscribeGameStateChange("MAIN_VIEW",(a,n)=>{a.getId()===8&&n.getId()!==8&&t.getCurrentUIView("CUBE_VIEW").getId()===7&&e.#S&&(c.debug("Hepteract forge view closed, stopping watch",this.context),M.stopWatching(e.#S))}),t.subscribeGameStateChange("CUBE_VIEW",async(a,n)=>{n.getId()===7?(c.debug("Hepteract forge view opened, starting watch",this.context),e.#g=await M.HookElement("#hepteractQuantity"),e.#S=M.watchElement(e.#g,i=>{try{let r=parseFloat(g.unfuckNumericString(i));e.#c=r}catch{c.error("Failed to parse owned hepteracts",e.context)}e.#y=!1},{greedy:!0,overrideThrottle:!0,valueParser:i=>i.querySelector("span")?.innerText})):a.getId()===7&&e.#S&&(c.debug("Hepteract forge view closed, stopping watch",this.context),M.stopWatching(e.#S))})),this.#e=await M.HookElement("#heptGrid"),this.#t=await M.HookElement("#hepteractCraftTexts"),this.#e.childNodes.forEach(a=>{if(a.nodeType===1){let n=a,i=n.id;if(e.#r.includes(i)){let r=document.querySelector(`#${i}CraftMax`),s=document.querySelector(`#${i}Cap`),l=document.querySelector(`#${i}Image`);n.addEventListener("mouseenter",async u=>{if(i in e.#o&&i==="quarkHepteract")return;let d=document.querySelector("#hepteractCostText");if(d){let m=d.innerText.match(/you\s+(.*?)\s+Hepteracts/i);if(m){let h=m[1];try{if(i in e.#o){let A=g.parseFloat2(h);e.#o[i]=A}}catch{c.warn(`Error while parsing hepteract cost for ${i}`,e.context)}}}}),r&&s&&l&&(l.addEventListener("mouseenter",async u=>{let m=u.target.id.toLowerCase().includes("quark");if(e.#c!==null&&e.#c!==void 0){let h=e.#n[i],A=e.#o[i];if(h===null||A===null)return;let w=I.getSetting("expandCostProtectionDoubleCap"),C=null;if(w.getValue(),C=h*2*A,e.#c===0)e.#w(C,"\u221E",m);else{let S=e.#c>0?C/e.#c:1;e.#w(C,S,m)}}}),l.addEventListener("click",async u=>{let p=u.target.id,m=p.toLowerCase().includes("quark");if(!p||m)return;if(e.#b||e.#y){c.debug(`Quick expand cancelled, another expand was still pending (exp ${e.#b}, wtch: ${e.#y})`,e.context);return}e.#b=!0;let h=null,A=null;if(e.#c!==null&&e.#c!==void 0){if(e.#c===0){c.info("Owned hepteracts is 0",this.context),e.#b=!1;return}let S=e.#n[i],v=e.#o[i];(S===null||v===null)&&c.warn(`Hepteract cost for ${i} not parsed yet`,e.context);let E=I.getSetting("expandCostProtectionDoubleCap"),Y=null;E.getValue(),Y=S*2,h=S*2*v,A=e.#c>0?h/e.#c:1,c.debug(`
                                    Current max: ${S},
                                    Cube cost: ${g.N(v)},
                                    Next hepts: ${g.N(Y)},
                                    Buy cost: ${g.N(h)},
                                    Percent owned: ${g.N(A)},
                                    Double Cap: ${E.getValue()}`,this.context);let Q=I.getSetting("expandCostProtection"),j=I.getSetting("expandCostProtectionNotifications"),J=!(j&&j.getValue()===!0);if(Q.isEnabled()){let z=Q.getCalculatedValue();if(z&&A>=z){J&&c.info(`Hept. cost protection: Cost owned ${g.N(A*100)}% >= ${z*100}%`,this.context),e.#b=!1;return}}}else{c.warn("Owned hepteracts not parsed yet",this.context),e.#y=!1,e.#b=!1;return}let w=await M.HookElement("#toggle35");if(w&&w.innerText.includes("ON")&&(c.info("Turned hepteract notification toggle OFF",this.context),w.click()),await g.hiddenAction(async()=>{s.click()},"confirm",!1,25),await g.wait(25),r.click(),h&&A&&e.#w(h,A),await g.wait(5),i!=="quarkHepteract"){let S=document.querySelector("#hepteractCostText");if(S){let E=S.innerText.match(/you\s+(.*?)\s+Hepteracts/i);if(E){let Y=E[1];try{if(i in e.#o){let Q=g.parseFloat2(Y);e.#o[i]=Q}}catch{c.warn(`Error while parsing NEW hepteract cost for ${i}`,e.context)}}}}let C=e.#g?e.#g:document.querySelector("#hepteractQuantity");if(C){let S=C.querySelector("span");if(S){let v=S.innerText,E=parseFloat(v);e.#c=E}}e.#b=!1}))}}}),document.querySelectorAll(".heptTypeImage").length>0&&y.injectStyle(`
            ...
            `),c.log("Hepteract images now serve as 'quick expand and max' buttons",this.context),c.log("Setting up hepteract ratio watch",this.context),y.injectStyle(this.#h),y.injectHTMLString(this.#d,a=>{e.#e?.parentNode?.insertBefore(a,e.#e)}),this.#f=document.querySelector("#hs-ratio-a"),this.#v=document.querySelector("#hs-ratio-b"),this.#A=document.querySelector("#hs-ratio-c"),this.#i.forEach(a=>{let n=document.querySelector(`#${a}`),i=a.substring(0,a.indexOf("ProgressBar"))+"Hepteract";n&&i?M.watchElement(n,r=>{i in e.#n?(e.#n[i]=r,Object.values(e.#n).every(s=>s>0)&&(e.#l=Math.round(e.#n.chronosHepteract/e.#n.challengeHepteract),e.#s=Math.round(e.#n.hyperrealismHepteract/e.#n.challengeHepteract),e.#m=Math.round(e.#n.acceleratorHepteract/e.#n.multiplierHepteract),e.#u=Math.round(e.#n.acceleratorBoostHepteract/e.#n.multiplierHepteract),e.#p=Math.round(e.#n.chronosHepteract/e.#n.acceleratorHepteract),this.#f&&this.#v&&this.#A&&(this.#f.innerText=`CHR/HYP/CHL: ${g.N(e.#l,0)} / ${g.N(e.#s,0)} / 1`,this.#v.innerText=`ACC/BST/MLT: ${g.N(e.#m,0)} / ${g.N(e.#u,0)} / 1`,this.#A.innerText=`CHR/ACC: ${g.N(e.#p,0)} / 1`))):c.warn(`Key ${i} not found in #boxCounts`,e.context)},{valueParser:r=>{let s=r.innerText;if(typeof s=="string"){let l=s.split("/");try{if(l&&l[1])return parseFloat(g.unfuckNumericString(l[1]))}catch{return c.warn(`Parsing failed for ${l}`,e.context),""}}return""}}):c.warn("Invalid meter or boxName",e.context)}),this.isInitialized=!0}#E(e){let t={cost:0,percentOwned:0};if(this.#c!==null&&this.#c!==void 0){if(this.#c===0){c.info("Owned hepteracts is 0",this.context);return}let a=this.#n[e],n=this.#o[e];if(a===null||n===null){c.warn(`Hepteract cost for ${e} not parsed yet`,this.context);return}let i=I.getSetting("expandCostProtectionDoubleCap"),r=null;i.getValue()?r=a*n:r=a*2*n;let s=this.#c>0?r/this.#c:1;return{cost:r,percentOwned:s}}else{c.warn("Owned hepteracts not parsed yet",this.context);return}}#w(e,t,a=!1){if(this.#t){let n=this.#t.querySelector("#hs-costText"),i;if(g.isNumeric(t)?i=g.N(t*100):i=t,n)a?n.innerText=`[${this.context}]: Total QUARK cost to max after next expand: ${g.N(e)} (ESTIMATE!)`:n.innerText=`[${this.context}]: Total HEPT cost to max after next expand: ${g.N(e)} (${i}% of owned)`;else{let r=document.createElement("div");r.id="hs-costText",a?r.innerText=`[${this.context}]: Total QUARK cost to max after next expand: ${g.N(e)} (ESTIMATE!)`:r.innerText=`[${this.context}]: Total HEPT cost to max after next expand: ${g.N(e)} (${i}% of owned)`,this.#t.appendChild(r)}}}};var Pe=class extends G{#e=[];#t;#a=3;#r=null;#i=3e3;constructor(e){super(e)}async init(){let e=this;c.log("Initialising HSTalismans module",this.context),this.#t=await M.HookElement("#buyTalismanAll"),this.#e=await M.HookElements(".fragmentBtn");let t=this.#t.cloneNode(!0);this.#t.replaceWith(t),this.#t=await M.HookElement("#buyTalismanAll"),this.#t.addEventListener("click",a=>{e.#r&&clearTimeout(e.#r),e.#e.length!==0&&(e.#e[e.#a].click(),e.#a++,e.#a>e.#e.length-1&&(e.#a=0),e.#r=setTimeout(()=>{e.#a=3},e.#i))}),c.log("Talisman BUY ALL button is now more functional",this.context),this.isInitialized=!0}};var Ue=class extends G{constructor(e){super(e)}async init(){c.log("Extending native prototypes with extra functionality",this.context),Element.prototype.delegateEventListener=this.#t(),Document.prototype.delegateEventListener=this.#t(),Element.prototype.removeDelegateEventListener=this.#a(),Document.prototype.removeDelegateEventListener=this.#a(),HTMLElement.prototype.transition=this.#r(),HTMLElement.prototype.clearTransitions=this.#i(),Object.typedEntries=this.#n,String.prototype.colorTag=function(e){return`<${e}>${this}</${e}>`},HTMLElement.prototype.textNodes=function(){return Array.from(this.childNodes).filter(e=>e.nodeType===Node.TEXT_NODE).map(e=>e.textContent??null).filter(e=>e!==null)},this.isInitialized=!0}#e(e,t){return`${e}:${t}`}#t(){let e=this;return function(t,a,n,i){let r=this;r._delegateListeners||(r._delegateListeners=new Map);let s=e.#e(t,a);if(i!==void 0&&i===!0&&r._delegateListeners.has(s)&&r._delegateListeners.get(s).size>0)return this;r._delegateListeners.has(s)||r._delegateListeners.set(s,new Map);let l=function(u){let d=u.target;if(d.matches(a))n.call(d,u);else{let p=r.querySelectorAll(a);for(let m of Array.from(p))if(m.contains(d)){n.call(m,u);break}}};return r._delegateListeners.get(s).set(n,{delegateHandler:l}),this.addEventListener(t,l),this}}#a(){let e=this;return function(t,a,n,i){let r=this;if(!r._delegateListeners)return this;let s=e.#e(t,a),l=r._delegateListeners.get(s);if(!l)return this;let u=l.get(n);return u&&(r.removeEventListener(t,u.delegateHandler),l.delete(n),l.size===0&&r._delegateListeners.delete(s),r._delegateListeners.size===0&&delete r._delegateListeners),this}}#r(){return function(e,t,a="linear"){let n=this,i=n.style;return t=t??b.HSPrototypes.defaultTransitionTiming,new Promise(r=>{if(Object.keys(e).length===0){r();return}let s=i.transition,l=Object.keys(e).join(", ");i.transition=`${l} ${t}ms ${a}`;let u=new Set(Object.keys(e)),d=!1,p=()=>{d||(n.removeEventListener("transitionend",h),delete n._hsTransitionEndHandler,i.transition=s,d=!0,r())},m=()=>{!d&&u.size===0&&p()},h=S=>{if(!(S instanceof TransitionEvent))return;let v=g.kebabToCamel(S.propertyName);u.has(v)&&(u.delete(v),u.size===0&&p())};this._hsTransitionEndHandler=h,n.addEventListener("transitionend",h);let A=setTimeout(()=>{d||p()},t+50);n.offsetHeight;let w=window.getComputedStyle(n),C=!1;if(Object.entries(e).forEach(([S,v])=>{let E=w.getPropertyValue(S.replace(/([A-Z])/g,"-$1").toLowerCase()),Y=typeof v=="number"&&S!=="zIndex"&&S!=="opacity"?`${v}px`:String(v);E&&E!=="none"&&E!=="auto"&&E!==Y?C=!0:u.delete(S),i[S]=v}),!C||u.size===0){clearTimeout(A),p();return}u.size===0&&p(),m()})}}#i(){return function(){this.style.transition="none",this._hsTransitionEndHandler&&(this.removeEventListener("transitionend",this._hsTransitionEndHandler),delete this._hsTransitionEndHandler)}}#n(e){return Object.entries(e)}};var Qe=class extends G{#e;constructor(e){super(e),this.#e=new Map}async init(){}createShadow(e,t,a=!1){let n=t??g.domid(),i=this.#t(e);if(i)return i;let r=new Oe(e,n,this).create(a);return r&&this.#e.set(n,r),r}getShadow(e){return this.#e.get(e)}destroyShadow(e){let t=e instanceof Oe?e.name:e,a=this.getShadow(t);a&&(a._destroy(),this.#e.delete(t))}#t(e){for(let[t,a]of this.#e.entries())if(e===a.getElement())return a;return null}},Oe=class{#e="HSShadow";#t;#a;#r;#i;#n;#o;#s={position:"absolute",width:"80vw",height:"80vh",left:"1vw",top:"1vh",overflowX:"auto",overflowY:"auto",zIndex:"1",backgroundColor:"rgba(125, 125, 125, 0.8)"};constructor(e,t,a){this.#a=e,this.name=t,this.#t=a,this.#o=document.createElement("div")}getElement(){return this.#a}getContainer(){return this.#o}hide(){this.#a.style.display="none",this.#o.style.display="none"}show(){this.#a.style.display="block",this.#o.style.display="block"}create(e=!1){this.#n=this.#a.style.cssText;let t=this.#a.parentNode;if(this.#i=this.#a.nextSibling,!t)return c.warn("Could not create shadow, parent is null",this.#e),null;this.#r=t;for(let[a,n]of Object.entries(this.#s))this.#o.style[a]=n;return e||this.hide(),document.body.appendChild(this.#o),this.#a.parentNode?.removeChild(this.#a),this.#o.appendChild(this.#a),this}destroySelf(){}_destroy(){this.#r&&(this.#i?this.#r.insertBefore(this.#a,this.#i):this.#r.appendChild(this.#a),this.#n&&(this.#a.style.cssText=this.#n),this.#o?.remove())}};var Ve=class extends G{constructor(e){super(e)}async init(){}setData(e,t){try{let a=JSON.stringify(t);return localStorage.setItem(`${b.HSStorage.storagePrefix}${e}`,a),!0}catch(a){return a instanceof TypeError?c.warn("Data serialization error",this.context):a instanceof DOMException?c.warn("localStorage quota exceeded",this.context):c.warn(`Error saving to localStorage: ${a}`,this.context),!1}}getData(e){try{let t=localStorage.getItem(`${b.HSStorage.storagePrefix}${e}`);return t===null?(c.warn(`localStorage[${e}] is null`,this.context),null):JSON.parse(t)}catch(t){return c.warn(`Error retrieving from localStorage: ${t}`,this.context),null}}clearData(e){try{localStorage.removeItem(`${b.HSStorage.storagePrefix}${e}`)}catch(t){c.warn(`Error clearing localStorage: ${t}`,this.context)}}};var Rt=`#hs-minibar-wrapper {
    width: 281px;
    display: flex;
    padding: 0px;
    gap: 4px;
...
`;var Ye=class extends G{#e;#t;#a=null;#r=[];#i=null;#n=null;#o=new Map;#s;#l;#u;#m=new Map;#p=`
    ...
    `;#f="hs-ambrosia-idle-loadout-css";#v="hs-ambrosia-minibar-css";#A=!1;#M;#g;#c;#S=!1;#b;#y;constructor(e){super(e)}async init(){let e=this;c.log("Initializing HSAmbrosia module",this.context),this.#a=await M.HookElement("#blueberryUpgradeContainer"),this.#r=await M.HookElements(".blueberryLoadoutSlot"),this.#i=await M.HookElement("#bbLoadoutContainer"),this.#c=document.querySelector("#hs-panel-debug-gamedata-currentambrosia"),this.loadState(),await this.#L(),c.log("Hooking stuff",this.context);for(let[t,a]of b.HSAmbrosia.ambrosiaLoadoutIcons.entries()){let n=document.querySelector(`#${a.draggableIconId}`);n&&(n.draggable=!0,n.dataset.hsid=t,n.addEventListener("dragstart",i=>{if(!i.dataTransfer)return;let r=i.currentTarget?.dataset.hsid;r&&(c.log(`Drag start ${r}`,this.context),i.dataTransfer.effectAllowed="move",i.dataTransfer.setData("hs-amb-drag",r))}))}if(!this.#i){c.warn("Could not find loadout container",this.context);return}this.#r.forEach(t=>{let a=t.id;if(a){let n=this.#x(a);if(n){let i=this.#o.get(n);i&&this.#N(n,i)}}}),this.#i.delegateEventListener("dragenter",".blueberryLoadoutSlot",t=>{t.dataTransfer&&t.dataTransfer.types.includes("hs-amb-drag")&&(t.preventDefault(),t.stopPropagation(),t.dataTransfer.effectAllowed="move")}),this.#i?.delegateEventListener("dragover",".blueberryLoadoutSlot",t=>{t.dataTransfer&&t.dataTransfer.types.includes("hs-amb-drag")&&(t.preventDefault(),t.stopPropagation(),t.dataTransfer.effectAllowed="move")}),this.#i?.delegateEventListener("drop",".blueberryLoadoutSlot",async t=>{if(t.dataTransfer&&t.dataTransfer.types.includes("hs-amb-drag")){t.preventDefault(),t.stopPropagation();let a=this.#G(t.dataTransfer.getData("hs-amb-drag")),n=t.target,i=n.id;if(!a){c.warn(`Invalid icon ID: ${a}`,this.context);return}if(!b.HSAmbrosia.ambrosiaLoadoutIcons.has(a)){c.warn(`Could not find loadout slot entry for ${a}`,this.context);return}if(!n.classList.contains("blueberryLoadoutSlot")||!i)return;let r=this.#x(i);if(!r){c.warn(`Invalid slot ID: ${i}`,this.context);return}let s=b.HSAmbrosia.ambrosiaLoadoutIcons.get(a);this.#N(r,a),this.#o.set(r,a),this.saveState(),await e.updateQuickBar()}}),this.#i?.delegateEventListener("contextmenu",".blueberryLoadoutSlot",async t=>{t.preventDefault();let a=t.target,n=a.id,i=this.#x(n);if(!i){c.warn(`Invalid slot ID: ${n}`,this.context);return}if(!this.#o.get(i)){c.warn(`No icon found for slot ID: ${n}`,this.context);return}a.classList.remove("hs-ambrosia-slot"),a.style.backgroundImage="",this.#o.delete(i),this.saveState(),await e.updateQuickBar()}),this.#i?.delegateEventListener("click",".blueberryLoadoutSlot",async t=>{let n=t.target.id,i=this.#x(n);if(!i){c.warn(`Invalid slot ID: ${n}`,this.context);return}await e.#w(i)}),this.#n=await M.HookElement("header"),this.#n&&(await this.#E(),await this.#R()),this.isInitialized=!0}async disableBerryMinibars(){this.#n||(this.#n=await M.HookElement("header"));let e=this.#n?.querySelector(`#${b.HSAmbrosia.barWrapperId}`);e?(e.style.display="none",y.removeInjectedStyle(this.#v)):c.warn("Could not find bar wrapper element",this.context),this.#S=!1,this.unsubscribeGameDataChanges()}async enableBerryMinibars(){if(this.#n||(this.#n=await M.HookElement("header")),!this.#n)return;let e=this.#n.querySelector(`#${b.HSAmbrosia.barWrapperId}`);e?(e.style.display="block",y.injectStyle(Rt,this.#v),this.subscribeGameDataChanges(),this.#S=!0):c.warn("Could not find minibar wrapper",this.context)}async#E(){if(!this.#n)return;if(this.#n.querySelector(`#${b.HSAmbrosia.barWrapperId}`)){c.warn("Minibar wrapper already exists",this.context);return}let t=(await M.HookElement("#ambrosiaProgressBar")).cloneNode(!0),a=t.querySelector("#ambrosiaProgress"),n=t.querySelector("#ambrosiaProgressText");t.id=b.HSAmbrosia.blueBarId,a.id=b.HSAmbrosia.blueBarProgressId,n.id=b.HSAmbrosia.blueBarProgressTextId;let r=(await M.HookElement("#pixelProgressBar")).cloneNode(!0),s=r.querySelector("#pixelProgress"),l=r.querySelector("#pixelProgressText");r.id=b.HSAmbrosia.redBarId,s.id=b.HSAmbrosia.redBarProgressId,l.id=b.HSAmbrosia.redBarProgressTextId;let u=document.createElement("div");u.id=b.HSAmbrosia.barWrapperId,u.style.display="none",u.appendChild(t),u.appendChild(r);let p=this.#n.querySelector("#hs-ambrosia-quickbar-wrapper")||this.#n.querySelector("nav.navbar");this.#n.insertBefore(u,p),this.#b=a,this.#y=s}async#w(e){this.#s=e;let t=I.getSetting("autoLoadoutState");t&&t.setValue(`<green>${e}</green>`),this.#n||(this.#n=await M.HookElement("header"));let a=this.#n.querySelector(`#${b.HSAmbrosia.quickBarId}`);if(a){a.querySelectorAll(".blueberryLoadoutSlot").forEach(r=>{r.classList.remove("hs-ambrosia-active-slot")});let i=a.querySelector(`[data-original-id="${e}"]`);i&&i.classList.add("hs-ambrosia-active-slot")}else c.warn("Could not find quick bar element",this.context);let n=document.querySelector("#bbLoadoutContainer");if(n){n.querySelectorAll(".blueberryLoadoutSlot").forEach(r=>{r.classList.remove("hs-ambrosia-active-slot")});let i=n.querySelector(`#${e}`);i&&i.classList.add("hs-ambrosia-active-slot")}}async#R(){if(!this.#n)return;let e=this;if(this.#n.querySelector(`#${b.HSAmbrosia.quickBarId}`)){c.debug("Quickbar wrapper already exists",this.context);return}if(this.#i){let a=this.#n.querySelector("nav.navbar"),n=this.#i.cloneNode(!0);n.id=b.HSAmbrosia.quickBarId,n.style.display="none";let i=n.querySelector(".blueberryLoadoutSetting");n.querySelectorAll(".blueberryLoadoutSlot").forEach(s=>{let l=s.id;s.dataset.originalId=l,s.id=`${b.HSAmbrosia.quickBarLoadoutIdPrefix}-${l}`;let u=async function(d){await e.#U(d,l)};this.#m.set(s,u),s.addEventListener("click",u)}),i&&i.remove(),this.#n.insertBefore(n,a),y.injectStyle(this.#p,this.#d),await this.#C(),this.#s&&await this.#w(this.#s)}}async showQuickBar(){this.#n||(this.#n=await M.HookElement("header"));let e=this.#n?.querySelector(`#${b.HSAmbrosia.quickBarId}`);e?(e.style.display="",y.injectStyle(this.#p,this.#d),await this.#C(),this.#s&&await this.#w(this.#s)):c.warn("Could not find quickbar wrapper",this.context)}async hideQuickBar(){this.#n||(this.#n=await M.HookElement("header"));let e=this.#n?.querySelector(`#${b.HSAmbrosia.quickBarId}`);e&&(e.style.display="none",y.removeInjectedStyle(this.#d))}async#C(){let e=this.#n?.querySelector(`#${b.HSAmbrosia.quickBarId}`);if(!e)return;e.querySelectorAll(".blueberryLoadoutSlot").forEach(a=>{let n=a.dataset.originalId;if(!n)return;let i=this.#x(n);if(!i)return;let r=this.#o.get(i);if(r){let s=b.HSAmbrosia.ambrosiaLoadoutIcons.get(r);s&&(a.classList.add("hs-ambrosia-slot"),a.style.backgroundImage=`url(${s.url})`)}else a.classList.remove("hs-ambrosia-slot"),a.style.backgroundImage=""}),this.#s&&await this.#w(this.#s)}#D(e,t){let a=`${b.HSAmbrosia.quickBarLoadoutIdPrefix} -${e} `,n=document.querySelector(`#${a} `);if(!n){c.warn(`Could not find quickbar slot element for ${e}`,this.context);return}let i=b.HSAmbrosia.ambrosiaLoadoutIcons.get(t);if(!i){c.warn(`Could not find icon for ${t}`,this.context);return}n.classList.add("hs-ambrosia-slot"),n.style.backgroundImage=`url(${i.url})`}#G(e){return Object.values(Ee).find(t=>t===e)}#x(e){return Object.values(we).find(t=>t===e)}#N(e,t){let a=document.querySelector(`#${e} `);if(!a){c.warn(`Could not find slot element for ${e}`,this.context);return}let n=b.HSAmbrosia.ambrosiaLoadoutIcons.get(t);if(!n){c.warn(`Could not find icon for ${t}`,this.context);return}a.classList.add("hs-ambrosia-slot"),a.style.backgroundImage=`url(${n.url})`}async saveState(){let e=D.getModule("HSStorage");if(e){let t=JSON.stringify(Array.from(this.#o.entries()));e.setData(b.HSAmbrosia.storageKey,t)}else c.warn("saveState - Could not find storage module",this.context)}async loadState(){let e=D.getModule("HSStorage");if(e){let a=e.getData(b.HSAmbrosia.storageKey);if(!a){c.warn("loadState - No data found",this.context);return}try{let n=JSON.parse(a);this.#o=new Map(n)}catch{c.warn("loadState - Error parsing data",this.context);return}}else c.warn("loadState - Could not find storage module",this.context);let t=I.getSetting("autoLoadoutState");t&&!this.#s?this.#s=g.removeColorTags(t.getValue()):c.warn("loadState - Could not find autoLoadoutState setting",this.context)}async#L(){let e=await M.HookElement("#importBlueberriesButton");if(!e||document.getElementById("hs-ambrosia-extra-btn"))return;let t=document.createElement("button");t.id="hs-ambrosia-extra-btn",t.className="ambrosiaLoadoutBtn",t.textContent="Quick Import",e.parentElement?.insertBefore(t,e.nextSibling),t.addEventListener("click",()=>this.#B())}async updateQuickBar(){I.getSetting("ambrosiaQuickBar").isEnabled()&&await this.#C()}async enableAutoLoadout(){let e=this,t=I.getSetting("autoLoadoutState");if(t&&t.getValue().includes("Unknown")||!this.#s){let d=I.getSetting("autoLoadout");d&&d.isEnabled()&&d.disable(),c.warn("Could not enable auto loadout - current loadout state is not known!",this.context);return}let a=[M.HookElement("#addCode"),M.HookElement("#addCodeAll"),M.HookElement("#addCodeOne"),M.HookElement("#timeCode")],i=(await Promise.allSettled(a)).map((d,p)=>d.status==="fulfilled"?d.value:null);if(i.some(d=>d===null)){c.warn("Problem with enabling auto loadout",this.context);return}let[r,s,l,u]=i;this.#l||(this.#l=async d=>{await e.#k(d)}),this.#u||(this.#u=async d=>{await e.#P(d)}),r.removeEventListener("click",this.#l,{capture:!0}),r.addEventListener("click",this.#l,{capture:!0}),s.removeEventListener("click",this.#l,{capture:!0}),s.addEventListener("click",this.#l,{capture:!0}),l.removeEventListener("click",this.#l,{capture:!0}),l.addEventListener("click",this.#l,{capture:!0}),u.removeEventListener("click",this.#u,{capture:!0}),u.addEventListener("click",this.#u,{capture:!0}),c.log("Enabled auto loadout",this.context)}async disableAutoLoadout(){let e=this,t=[M.HookElement("#addCode"),M.HookElement("#addCodeAll"),M.HookElement("#addCodeOne"),M.HookElement("#timeCode")],n=(await Promise.allSettled(t)).map((u,d)=>u.status==="fulfilled"?u.value:null);if(n.some(u=>u===null)){c.warn("Problem with disabling auto loadout",this.context);return}let[i,r,s,l]=n;this.#l&&(i.removeEventListener("click",this.#l,{capture:!0}),r.removeEventListener("click",this.#l,{capture:!0}),s.removeEventListener("click",this.#l,{capture:!0})),this.#u&&l.removeEventListener("click",this.#u,{capture:!0}),c.log("Disabled auto loadout",this.context)}async#k(e){let t=this.#s,a=I.getSetting("autoLoadoutAdd");if(t&&a){let n=this.#T(a.getValue()),i=await M.HookElement(`#${n} `);await this.#I(),await g.hiddenAction(async()=>{i.click()})}}async#P(e){let t=this.#s,a=I.getSetting("autoLoadoutTime");if(t&&a){let n=this.#T(a.getValue()),i=await M.HookElement(`#${n} `);await this.#I(),await g.hiddenAction(async()=>{i.click()})}}async#U(e,t){let a=document.querySelector(`#${t} `);a?(await this.#I(),await g.hiddenAction(async()=>{a.click()})):c.warn(`Could not find real button for ${t}`,this.context)}async#I(){let e=await M.HookElement("#blueberryToggleMode");e&&e.innerText.includes("SAVE")&&e.click()}#T(e){let t=Object.values(we).find(a=>a===`blueberryLoadout${e}`);return t||c.warn(`Could not convert loadout ${e} to slot`,this.context),t}subscribeGameDataChanges(){let e=D.getModule("HSGameData");e&&!this.gameDataSubscriptionId&&(this.gameDataSubscriptionId=e.subscribeGameDataChange(this.gameDataCallback.bind(this)),c.debug("Subscribed to game data changes",this.context))}unsubscribeGameDataChanges(){let e=D.getModule("HSGameData");e&&this.gameDataSubscriptionId&&!this.#A&&!this.#S&&(e.unsubscribeGameDataChange(this.gameDataSubscriptionId),this.gameDataSubscriptionId=void 0,c.debug("Unsubscribed from game data changes",this.context))}async gameDataCallback(){let e=D.getModule("HSGameDataAPI");if(!e)return;let t=e.getGameData();if(t&&t.blueberryTime&&t.redAmbrosiaTime){let a=t.blueberryTime,n=t.redAmbrosiaTime,i=e.R_calculateRequiredBlueberryTime(),r=e.R_calculateRequiredRedAmbrosiaTime(),s=a/i*100,l=n/r*100,u=e.calculateAmbrosiaSpeed(),d=e.calculateBlueBerries(),p=u*d,m=t.shopUpgrades.shopAmbrosiaAccelerator,h=e.calculateLuck(),A=t.singularityChallenges.noAmbrosiaUpgrades.completions>0?1:0,w=h.total/100+A,C=(h.total-100*Math.floor(h.total/100))/100,S=0,v=0,E=0,Y=p/i*100,Q=Y,j=1/2+(3/5-1/2)*+(t.singularityChallenges.noAmbrosiaUpgrades.completions>=15)+(2/3-3/5)*+(t.singularityChallenges.noAmbrosiaUpgrades.completions>=19)+(3/4-2/3)*+(t.singularityChallenges.noAmbrosiaUpgrades.completions>=20);if(m>0&&p>0){let J=i/p;S=Math.min(J*j,w*.2*m),v=1,E=v/i*100}if(this.#A&&this.#M&&this.#g){let J=I.getSetting("ambrosiaIdleSwapNormalLoadout"),z=I.getSetting("ambrosiaIdleSwap100Loadout");if(J&&z){let _=J.getValue(),$=z.getValue();if(!Number.isInteger(parseInt(_,10))||!Number.isInteger(parseInt($,10))){let N=I.getSetting("ambrosiaIdleSwap");N&&N.disable(),c.log("Idle swap was disabled due to unconfigured loadouts",this.context);return}let q=this.#T(J.getValue()),K=this.#T(z.getValue()),x=Q+E,T=x+Q,R=100-Q,B=100,L=b.HSAmbrosia.idleSwapMinRedTreshold,O=L+b.HSAmbrosia.idleSwapMinRedTreshold,P=b.HSAmbrosia.idleSwapMaxRedTreshold;if(s>=R&&s<=B||l>=P&&l<=100){if(this.#s!==K){let N=await M.HookElement(`#${K} `);await this.#I(),await g.hiddenAction(async()=>{N.click()})}}else if((s>=x&&s<=T||l>=L&&l<=O)&&this.#s!==q){let N=await M.HookElement(`#${q} `);await this.#I(),await g.hiddenAction(async()=>{N.click()})}}if(this.#c&&y.isModPanelOpen()){let _=document.createElement("div");for(_.innerHTML=`
        ...
        HSAmbrosia.gameDataCallback() - minibar element(s) undefined.
            blue: ${this.#b},
        red: ${this.#y} `,"hs-minibars-undefined"):c.logOnce("HSAmbrosia.gameDataCallback() - berryMinibarsEnabled was false","hs-minibars-false")}}async enableIdleSwap(){let e=this,t=D.getModule("HSGameState");t?(this.#e=t.subscribeGameStateChange("MAIN_VIEW",this.#V.bind(this)),this.#t=t.subscribeGameStateChange("SINGULARITY_VIEW",async(a,n)=>{n.getId()===5?(this.#M=await M.HookElement("#ambrosiaProgressBar"),this.#g=await M.HookElement("#pixelProgressBar"),this.#A=!0,this.#Q(),this.subscribeGameDataChanges()):(this.#A=!1,this.#H(),this.unsubscribeGameDataChanges())}),t.getCurrentUIView("SINGULARITY_VIEW").getId()===5&&t.getCurrentUIView("MAIN_VIEW").getId()===13&&(this.#M=await M.HookElement("#ambrosiaProgressBar"),this.#g=await M.HookElement("#pixelProgressBar"),this.#A=!0,this.#Q(),this.subscribeGameDataChanges())):c.warn("HSAmbrosia.enableIdleSwap() - gameStateMod==undefined","hs-enable-idleswap-gamestate"),this.#c||(this.#c=document.querySelector("#hs-panel-debug-gamedata-currentambrosia"))}disableIdleSwap(){this.#A=!1,this.unsubscribeGameDataChanges();let e=D.getModule("HSGameState");e?(this.#e&&(e.unsubscribeGameStateChange("MAIN_VIEW",this.#e),this.#e=void 0),this.#t&&(e.unsubscribeGameStateChange("SINGULARITY_VIEW",this.#t),this.#t=void 0)):c.warnOnce("HSAmbrosia.disableIdleSwap() - gameStateMod==undefined","hs-disable-idleswap-gamestate"),this.#H()}#V(e,t){let a=D.getModule("HSGameState");a?e.getId()===13&&t.getId()!==13&&a.getCurrentUIView("SINGULARITY_VIEW").getId()===5&&(this.#A=!1):c.warnOnce("HSAmbrosia.gameStateCallbackMain() - gameStateMod==undefined","hs-amb-gamestate-cb")}#Q(){if(document.querySelector(`#${b.HSAmbrosia.idleSwapIndicatorId} `))return;let t=document.createElement("div");t.id=b.HSAmbrosia.idleSwapIndicatorId,t.innerText="IDLE SWAP ENABLED WHILE IN THIS VIEW",y.injectHTMLElement(t,a=>{let n=document.querySelector("#singularityAmbrosia"),i=document.querySelector("#ambrosiaProgressBar");n?.insertBefore(a,i)}),y.injectStyle(this.#h,this.#f)}#H(){let e=document.querySelector(`#${b.HSAmbrosia.idleSwapIndicatorId} `);e&&e.remove(),y.removeInjectedStyle(this.#f)}async#B(){let e=null;try{e=document.querySelector(".blueberryLoadoutSlot.hs-ambrosia-active-slot");let t=await navigator.clipboard.readText();if(!t||typeof t!="string"){y.Notify("Clipboard does not contain valid loadout data",{notificationType:"warning"});return}let a=t.split(`
`).map(u=>u.trim());if(a.length===0||a.length>16){y.Notify(`Invalid number of loadouts: ${a.length}. Expected 1 - 16.`,{notificationType:"warning"});return}let n=document.getElementById("importBlueberries"),i=await M.HookElement("#blueberryToggleMode");if(!n)throw new Error("Import input element not found");if(!i)throw new Error("Mode toggle button not found");i.innerText.includes("LOAD ")&&i.click();let s=0,l=0;g.startDialogWatcher();for(let u=0;u<a.length;u++){let d=a[u],p=u+1;if(!d){l++;continue}let m=document.getElementById(`blueberryLoadout${p}`);if(!m){console.warn(`Loadout button ${p} not found`);continue}let h=new Blob([d],{type:"application/json"}),A=new File([h],"quick-import.json",{type:"application/json"}),w=new DataTransfer;w.items.add(A),n.files=w.files;let C=new Event("change",{bubbles:!0});n.dispatchEvent(C),await g.sleep(50),m.click(),await g.sleep(50),s++}i.click(),y.Notify(`Imported ${s} loadout(s), skipped ${l} empty slot(s)`,{notificationType:"success"})}catch(t){let a=t instanceof Error?t.message:typeof t=="string"?t:"Unknown error";console.error("Quick Import error:",t),c.error(`Quick Import failed: ${a} `,this.context,!0),y.Notify("Quick Import failed",{notificationType:"error"})}finally{await g.stopDialogWatcher(),e&&e.click()}}};var Je=class extends G{constructor(e){super(e)}async init(){c.log("Initializing HSStats module",this.context),this.isInitialized=!0}};var Fe=class extends G{#e=-1;#t={CubeView:Se,SingularityView:ye};#a={MAIN_VIEW:{currentView:new fe("unknown"),previousView:new fe("unknown"),viewChangeSubscribers:new Map},CUBE_VIEW:{currentView:new Se("unknown"),previousView:new Se("unknown"),viewChangeSubscribers:new Map},SINGULARITY_VIEW:{currentView:new ye("unknown"),previousView:new ye("unknown"),viewChangeSubscribers:new Map}};#r=["buildings","upgrades","statistics","runes","challenges","research","ants","cubes","campaigns","traits","settings","shop","singularity","event","pseudoCoins"];constructor(e){super(e)}async init(){let e=this;c.log("Initializing HSGameState module",this.context);for(let t of this.#r){let a=document.querySelector(`#${t}`);M.watchElement(a,async n=>{let{view:i,state:r}=n;if(r!=="none"){let s=new fe(i);if(s.getId()!==-1)e.#a.MAIN_VIEW.previousView=e.#a.MAIN_VIEW.currentView,e.#a.MAIN_VIEW.currentView=s,c.debug(`Main UI view changed ${e.#a.MAIN_VIEW.previousView.getName()} -> ${e.#a.MAIN_VIEW.currentView.getName()}`,e.context);else{c.warn(`Main UI view ${i} not found`,e.context);return}e.#a.MAIN_VIEW.viewChangeSubscribers.forEach(l=>{try{l(e.#a.MAIN_VIEW.previousView,e.#a.MAIN_VIEW.currentView)}catch(u){c.error(`Error when trying to call MAIN VIEW change subscriber callback: ${u}`,e.context)}}),this.#i(s.getId())}},{characterData:!1,childList:!1,subtree:!1,attributes:!0,attributeOldValue:!1,attributeFilter:["style"],valueParser:(n,i)=>{for(let r of i)if(r.type==="attributes"&&r.attributeName==="style"){let s=r.target,l=s.style.getPropertyValue("display");return{view:s.id,state:l}}}})}b.HSGameState.viewProperties.forEach(async(t,a)=>{for(let n of t.subViewIds){let i=document.querySelector(`#${n}`);M.watchElement(i,async r=>{let{view:s,state:l}=r;if(l!=="none"){let u;try{let p=this.#t[t.viewClassName];if(!p)throw new Error(`Class "${t.viewClassName}" not found in viewClasses for mainViewId ${a}`);u=new p(n)}catch(p){c.warn(`Failed to instantiate sub-view ${t.viewClassName}: ${p}`,e.context);return}let d=u.getViewKey();if(u.getId()!==e.#e){e.#a[d].previousView=e.#a[d].currentView,e.#a[d].currentView=u;let p=e.#a[d].previousView,m=e.#a[d].currentView;e.#a[d].viewChangeSubscribers.forEach(h=>{try{h(p,m)}catch(A){c.error(`Error when trying to call CUBE VIEW change subscriber callback: ${A}`,e.context)}}),c.debug(`Subview changed ${p.getName()} -> ${m.getName()}`,e.context)}else{c.warn(`Subview ${s} not found`,e.context);return}}},{characterData:!1,childList:!1,subtree:!1,attributes:!0,attributeOldValue:!1,attributeFilter:["style"],valueParser:(r,s)=>{for(let l of s)if(l.type==="attributes"&&l.attributeName==="style"){let u=l.target,d=u.style.getPropertyValue("display");return{view:u.id,state:d}}}})}}),this.isInitialized=!0}subscribeGameStateChange(e,t){let a=g.uuidv4();return this.#a[e].viewChangeSubscribers.set(a,t),a}unsubscribeGameStateChange(e,t){this.#a[e].viewChangeSubscribers.has(t)?this.#a[e].viewChangeSubscribers.delete(t):c.warn(`Subscription ID ${t} not found for view key ${e}`,this.context)}async#i(e){let t=this,a=b.HSGameState.viewProperties.get(e);if(!a){c.debug(`No view properties found for main view ID ${e}`,this.context);return}(await M.HookElements(a.subViewsSelector)).forEach(async i=>{let r=i.id;if(i.style.getPropertyValue("display")!=="none"){let l;try{let d=this.#t[a.viewClassName];if(!d)throw new Error(`Class "${a.viewClassName}" not found in viewClasses for mainViewId ${e}`);l=new d(r)}catch(d){c.warn(`Failed to instantiate sub-view ${a.viewClassName} for tab ${r}: ${d}`,t.context);return}let u=l.getViewKey();if(l&&l.getId()!==this.#e){t.#a[u].previousView=t.#a[u].currentView,t.#a[u].currentView=l;let d=t.#a[u].previousView,p=t.#a[u].currentView;t.#a[u].viewChangeSubscribers.forEach(m=>{try{m(d,p)}catch(h){c.error(`Error when trying to call VIEW change subscriber callback: ${h}`,t.context)}})}else c.warn(`Sub-view tab ${r} (for ${a.viewClassName}) resolved to UNKNOWN or failed to initialize.`,t.context)}})}getCurrentUIView(e){return this.#a[e].currentView}},ve=class{#e;#t;constructor(e,t){this.#e=e,this.#t=t}getName(){return this.#e}getViewKey(){return this.#t}},fe=class extends ve{#e;constructor(e){super(e,"MAIN_VIEW"),this.#e=this.getViewEnum(e)}getViewEnum(e){switch(e){case"buildings":return 1;case"upgrades":return 2;case"statistics":return 3;case"runes":return 4;case"challenges":return 5;case"research":return 6;case"ants":return 7;case"cubes":return 8;case"campaigns":return 9;case"traits":return 10;case"settings":return 11;case"shop":return 12;case"singularity":return 13;case"event":return 14;case"pseudoCoins":return 15}return-1}getId(){return this.#e}},Se=class extends ve{#e;constructor(e){super(e,"CUBE_VIEW"),this.#e=this.getViewEnum(e)}getViewEnum(e){switch(e){case"cubeTab1":return 1;case"cubeTab2":return 2;case"cubeTab3":return 3;case"cubeTab4":return 4;case"cubeTab5":return 5;case"cubeTab6":return 6;case"cubeTab7":return 7}return-1}getId(){return this.#e}},ye=class extends ve{#e;constructor(e){super(e,"SINGULARITY_VIEW"),this.#e=this.getViewEnum(e)}getViewEnum(e){switch(e){case"singularitycontainer1":return 1;case"singularityContainer2":return 2;case"singularityContainer3":return 3;case"singularityContainer4":return 4;case"singularityContainer5":return 5}return-1}getId(){return this.#e}};var ee=class{#e;constructor(e){this.#e=e}get patchName(){return this.#e}};var ze=class extends ee{#e=`
        ...
        }`;#t="ambrosiaViewOverflowPatch";async applyPatch(){y.injectStyle(this.#e,this.#t)}async revertPatch(){y.removeInjectedStyle(this.#t)}};var We=class extends ee{async applyPatch(){}async revertPatch(){}};var Nt=`{
...
}`;var Ze=class extends ee{#e;#t;async applyPatch(){let e=this;try{this.#e=JSON.parse(Nt);let t=await M.HookElement("#actualShop");t&&(this.#t||(this.#t=a=>{e.#a(a)}),t.removeDelegateEventListener("mouseover","div",this.#t),t.delegateEventListener("mouseover","div",this.#t))}catch{c.error("Failed to parse shop item map"),this.#e=void 0}}#a(e){let t;if(e.target instanceof HTMLDivElement)t=e.target;else if(e.target instanceof HTMLImageElement||e.target instanceof HTMLParagraphElement||e.target instanceof HTMLButtonElement)t=e.target.parentElement;else return;if(t.id==="actualShop")return;let a=t.querySelector("img");if(a){let n=a.id,i=this.#e?.[n],r=document.querySelector("#shopHovers"),s=r.querySelector("#hs-shopHoverName");if(s)s.innerText=i||"";else{let l=document.createElement("div");l.id="hs-shopHoverName",l.innerText=i||"",r.insertBefore(l,r.querySelector("p:nth-child(2)"))}}}async revertPatch(){if(this.#t){let t=await M.HookElement("#actualShop");t&&t.removeDelegateEventListener("mouseover","div",this.#t)}let e=document.querySelector("#hs-shopHoverName");e&&e.remove()}};var je=class extends ee{async applyPatch(){let e=await M.HookElement("#buildingstab");e.style.color="red"}async revertPatch(){let e=await M.HookElement("#buildingstab");e.style.color=""}};var Ke=class extends G{#e={AmbrosiaViewOverflow:ze,TestPatch:je,ShopItemNameMapping:Ze,IconSetCaching:We};#t={};constructor(e){super(e)}async init(){c.log("Initializing HSPatches module",this.context),this.isInitialized=!0}async applyPatch(e){let t=this.#e[e];if(!t){c.warn(`Patch "${e}" not found`,this.context);return}let a;this.#t[e]?(c.debug(`Patch "${e}" is already instantiated`,this.context),a=this.#t[e]):(a=new t(e),this.#t[e]=a),await a.applyPatch()}async revertPatch(e){let t=this.#e[e];if(!t){c.warn(`Patch "${e}" not found`,this.context);return}let a;this.#t[e]?a=this.#t[e]:(a=new t(e),this.#t[e]=a),await a.revertPatch()}};var Xe=class extends G{#e="Synergysave2";#t;#a;#r=!1;#i;#n;#o=`
        #savegame {
    ...
    }`},{pointValue:40,group:"reincarnationCount"},{pointValue:44,group:"reincarnationCount"},{pointValue:48,group:"reincarnationCount"},{pointValue:52,group:"reincarnationCount"},{pointValue:56,group:"reincarnationCount"},{pointValue:60,group:"reincarnationCount"},{pointValue:3,group:"sacCount",reward:"{ freeAntUpgrades: () => 1 }"},{pointValue:6,group:"sacCount",reward:"{ antSacrificeCountMultiplier: () => 2, hicAutobuy: () => 1 }"},{pointValue:9,group:"sacCount",reward:"{ autoAntSacrifice: () => 1 }"},{pointValue:12,group:"sacCount",reward:"{ antELOAdditiveMultiplier: () => 0.01, praemoenioAutobuy: () => 1 }"},{pointValue:15,group:"sacCount",reward:"{ antELOAdditive: () => 25 }"},{pointValue:17,group:"sacCount",reward:"{ antSpeed2UpgradeImprover: () => achievementLevel, phylacteriumAutobuy: () => 1 }"},{pointValue:19,group:"sacCount"},{pointValue:21,group:"sacCount"},{pointValue:23,group:"sacCount"},{pointValue:25,group:"sacCount",reward:"{ preserveAnthillCountSingularity: () => 1 }"},{pointValue:40,group:"sacCount"}];var he=class extends qe{constructor(t){super(t);this.#e={R_AmbrosiaGenerationShopUpgrade:{value:void 0,cachedBy:[]},R_AmbrosiaGenerationSingularityUpgrade:{value:void 0,cachedBy:[]},R_AmbrosiaGenerationOcteractUpgrade:{value:void 0,cachedBy:[]},R_SingularityMilestoneBlueberries:{value:void 0,cachedBy:[]},R_DilatedFiveLeafBonus:{value:void 0,cachedBy:[]},R_SingularityAmbrosiaLuckMilestoneBonus:{value:void 0,cachedBy:[]},R_AmbrosiaLuckShopUpgrade:{value:void 0,cachedBy:[]},R_AmbrosiaLuckSingularityUpgrade:{value:void 0,cachedBy:[]},R_AmbrosiaLuckOcteractUpgrade:{value:void 0,cachedBy:[]},R_TotalCubes:{value:void 0,cachedBy:[]},AMB_ambrosiaTutorial:{value:void 0,cachedBy:[]},AMB_ambrosiaQuarks1:{value:void 0,cachedBy:[]},AMB_ambrosiaCubes1:{value:void 0,cachedBy:[]},AMB_ambrosiaLuck1:{value:void 0,cachedBy:[]},AMB_ambrosiaQuarkCube1:{value:void 0,cachedBy:[]},AMB_ambrosiaLuckCube1:{value:void 0,cachedBy:[]},AMB_ambrosiaCubeQuark1:{value:void 0,cachedBy:[]},AMB_ambrosiaLuckQuark1:{value:void 0,cachedBy:[]},AMB_ambrosiaCubeLuck1:{value:void 0,cachedBy:[]},AMB_ambrosiaQuarkLuck1:{value:void 0,cachedBy:[]},AMB_ambrosiaQuarks2:{value:void 0,cachedBy:[]},AMB_ambrosiaCubes2:{value:void 0,cachedBy:[]},AMB_ambrosiaLuck2:{value:void 0,cachedBy:[]},AMB_ambrosiaQuarks3:{value:void 0,cachedBy:[]},AMB_ambrosiaCubes3:{value:void 0,cachedBy:[]},AMB_ambrosiaLuck3:{value:void 0,cachedBy:[]},AMB_ambrosiaLuck4:{value:void 0,cachedBy:[]},AMB_ambrosiaPatreon:{value:void 0,cachedBy:[]},AMB_ambrosiaObtainium1:{value:void 0,cachedBy:[]},AMB_ambrosiaOffering1:{value:void 0,cachedBy:[]},AMB_ambrosiaHyperflux:{value:void 0,cachedBy:[]},AMB_ambrosiaBaseOffering1:{value:void 0,cachedBy:[]},AMB_ambrosiaBaseObtainium1:{value:void 0,cachedBy:[]},AMB_ambrosiaBaseOffering2:{value:void 0,cachedBy:[]},AMB_ambrosiaBaseObtainium2:{value:void 0,cachedBy:[]},AMB_ambrosiaSingReduction1:{value:void 0,cachedBy:[]},AMB_ambrosiaSingReduction2:{value:void 0,cachedBy:[]},AMB_ambrosiaInfiniteShopUpgrades1:{value:void 0,cachedBy:[]},AMB_ambrosiaInfiniteShopUpgrades2:{value:void 0,cachedBy:[]},AMB_ambrosiaTalismanBonusRuneLevel:{value:void 0,cachedBy:[]},AMB_ambrosiaRuneOOMBonus:{value:void 0,cachedBy:[]},REDAMB_blueberryGenerationSpeed:{value:void 0,cachedBy:[]},REDAMB_blueberryGenerationSpeed2:{value:void 0,cachedBy:[]},REDAMB_freeLevelsRow2:{value:void 0,cachedBy:[]},REDAMB_freeLevelsRow3:{value:void 0,cachedBy:[]},REDAMB_freeLevelsRow4:{value:void 0,cachedBy:[]},REDAMB_freeLevelsRow5:{value:void 0,cachedBy:[]},REDAMB_regularLuck:{value:void 0,cachedBy:[]},REDAMB_regularLuck2:{value:void 0,cachedBy:[]},REDAMB_viscount:{value:void 0,cachedBy:[]},R_CampaignAmbrosiaSpeedBonus:{value:void 0,cachedBy:[]},R_CampaignLuckBonus:{value:void 0,cachedBy:[]},R_CookieUpgrade29Luck:{value:void 0,cachedBy:[]},R_SumOfExaltCompletions:{value:void 0,cachedBy:[]},R_NumberOfThresholds:{value:void 0,cachedBy:[]},R_ToNextThreshold:{value:void 0,cachedBy:[]},R_RequiredBlueberryTime:{value:void 0,cachedBy:[]},R_RequiredRedAmbrosiaTime:{value:void 0,cachedBy:[]},EVENTBUFF_Quark:{value:void 0,cachedBy:[]},EVENTBUFF_GoldenQuark:{value:void 0,cachedBy:[]},EVENTBUFF_Cubes:{value:void 0,cachedBy:[]},EVENTBUFF_PowderConversion:{value:void 0,cachedBy:[]},EVENTBUFF_AscensionSpeed:{value:void 0,cachedBy:[]},EVENTBUFF_GlobalSpeed:{value:void 0,cachedBy:[]},EVENTBUFF_AscensionScore:{value:void 0,cachedBy:[]},EVENTBUFF_AntSacrifice:{value:void 0,cachedBy:[]},EVENTBUFF_Offering:{value:void 0,cachedBy:[]},EVENTBUFF_Obtainium:{value:void 0,cachedBy:[]},EVENTBUFF_Octeract:{value:void 0,cachedBy:[]},EVENTBUFF_BlueberryTime:{value:void 0,cachedBy:[]},EVENTBUFF_AmbrosiaLuck:{value:void 0,cachedBy:[]},EVENTBUFF_OneMind:{value:void 0,cachedBy:[]},R_RawAscensionSpeedMult:{value:void 0,cachedBy:[]},R_HepteractEffective:{value:void 0,cachedBy:[]},R_AllShopTablets:{value:void 0,cachedBy:[]},R_LimitedAscensionsDebuff:{value:void 0,cachedBy:[]},R_SingularityDebuff:{value:void 0,cachedBy:[]},R_SingularityReductions:{value:void 0,cachedBy:[]},R_EffectiveSingularities:{value:void 0,cachedBy:[]},R_AscensionSpeedExponentSpread:{value:void 0,cachedBy:[]},R_RedAmbrosiaLuck:{value:void 0,cachedBy:[]},R_LuckConversion:{value:void 0,cachedBy:[]}};this.#a=Ot;this.#r=Qt;this.#i=Vt;this.R_calculateNumberOfThresholds=()=>{if(!this.gameData)return 0;let t=this.gameData,a="R_NumberOfThresholds",n=b.HSAmbrosia.R_digitReduction,i=[t.lifetimeAmbrosia],r=this.#n(a,i);if(r)return r;let s=t.lifetimeAmbrosia>0?1+Math.floor(Math.log10(t.lifetimeAmbrosia)):0,u=Math.floor(t.lifetimeAmbrosia/Math.pow(10,s-1))>=3?1:0,d=Math.max(0,2*(s-n)-1+u);return this.#o(a,{value:d,cachedBy:i}),d};this.R_calculateToNextThreshold=()=>{if(!this.gameData)return 0;let t=this.gameData,a="R_ToNextThreshold",n=b.HSAmbrosia.R_digitReduction,i=[t.lifetimeAmbrosia],r=this.#n(a,i);if(r)return r;let s=this.R_calculateNumberOfThresholds(),l;s===0?l=1e4-t.lifetimeAmbrosia:s%2===0?l=Math.pow(10,s/2+n)-t.lifetimeAmbrosia:l=3*Math.pow(10,(s-1)/2+n)-t.lifetimeAmbrosia;let u=l;return this.#o(a,{value:u,cachedBy:i}),u};this.R_calculateRequiredBlueberryTime=()=>{if(!this.gameData)return 0;let t=this.gameData,a="R_RequiredBlueberryTime",n=b.HSAmbrosia.R_TIME_PER_AMBROSIA,i=[t.lifetimeAmbrosia],r=this.#n(a,i);if(r)return r;let s=n;s+=Math.floor(t.lifetimeAmbrosia/500);let u=1-.004*t.singularityChallenges.noAmbrosiaUpgrades.completions*t.shopUpgrades.shopAmbrosiaAccelerator;s*=u,s=Math.ceil(s);let d=this.R_calculateNumberOfThresholds(),m=Math.pow(2,d)*s;return this.#o(a,{value:m,cachedBy:i}),m};this.R_calculateRequiredRedAmbrosiaTime=()=>{if(!this.gameData)return 0;let t=this.gameData,a="R_RequiredRedAmbrosiaTime",n=b.HSAmbrosia.R_TIME_PER_RED_AMBROSIA,i=[t.lifetimeRedAmbrosia,t.singularityChallenges.limitedTime.completions],r=this.#n(a,i);if(r)return r;let s=1-.01*t.singularityChallenges.limitedTime.completions,l=n;l+=200*t.lifetimeRedAmbrosia;let u=1e6*+s;l*=+s;let d=Math.min(u,l);return this.#o(a,{value:d,cachedBy:i}),d};this.R_calculateHepteractEffective=t=>{if(!this.gameData)return 0;let a=this.gameData,n="R_HepteractEffective",i=[a.hepteracts[t].BAL,a.platonicUpgrades[19],a.goldenQuarkUpgrades.singQuarkHepteract.level,a.goldenQuarkUpgrades.singQuarkHepteract2.level,a.goldenQuarkUpgrades.singQuarkHepteract3.level,a.shopUpgrades.improveQuarkHept,a.shopUpgrades.improveQuarkHept2,a.shopUpgrades.improveQuarkHept3,a.shopUpgrades.improveQuarkHept4,a.shopUpgrades.improveQuarkHept5],r=this.#n(n,i);if(r)return r;let s=Math.min(a.hepteracts[t].BAL,this.#i[t].LIMIT),l=0;if(t==="chronos"&&(l+=1/750*a.platonicUpgrades[19]),t==="quark"){l+=+a.goldenQuarkUpgrades.singQuarkHepteract.level/100,l+=+a.goldenQuarkUpgrades.singQuarkHepteract2.level/100,l+=+a.goldenQuarkUpgrades.singQuarkHepteract3.level/100,l+=+a.octUpgrades.octeractImprovedQuarkHept.level/100,l+=a.shopUpgrades.improveQuarkHept/100,l+=a.shopUpgrades.improveQuarkHept2/100,l+=a.shopUpgrades.improveQuarkHept3/100,l+=a.shopUpgrades.improveQuarkHept4/100,l+=a.shopUpgrades.improveQuarkHept5/5e3;let u=a.hepteracts[t].BAL,d;return 1e3<u&&u<=1e3*Math.pow(2,10)?d=s*Math.pow(u/1e3,1/2+l):1e3*Math.pow(2,10)<u&&u<=1e3*Math.pow(2,18)?d=s*Math.pow(Math.pow(2,10),1/2+l)*Math.pow(u/(1e3*Math.pow(2,10)),1/4+l/2):1e3*Math.pow(2,18)<u&&u<=1e3*Math.pow(2,44)?d=s*Math.pow(Math.pow(2,10),1/2+l)*Math.pow(Math.pow(2,8),1/4+l/2)*Math.pow(u/(1e3*Math.pow(2,18)),1/6+l/3):1e3*Math.pow(2,44)<u?d=s*Math.pow(Math.pow(2,10),1/2+l)*Math.pow(Math.pow(2,8),1/4+l/2)*Math.pow(Math.pow(2,26),1/6+l/3)*Math.pow(u/(1e3*Math.pow(2,44)),1/12+l/6):d=0,this.#o(n,{value:d,cachedBy:i}),d}return a.hepteracts[t].BAL>this.#i[t].LIMIT&&(s*=Math.pow(a.hepteracts[t].BAL/this.#i[t].LIMIT,this.#i[t].DR+l)),this.#o(n,{value:s,cachedBy:i}),s};this.#t={...this.#e}}#e;#t;#a;#r;#i;#n(t,a){if(!(t in this.#e))return c.debug(`Could not find cache for '${t}'`),!1;let n=this.#e[t];if(n.value===void 0||n.cachedBy.length===0)return b.Debug.calculationCacheDebugMode&&console.log(`Cache missed (reason: null value or empty cache) for ${t} with value ${n.value}`),!1;if(n.cachedBy.length!==a.length)return b.Debug.calculationCacheDebugMode&&console.warn(`Cache missed (reason: cache length mismatch) for ${t} with value ${n.value}`),!1;for(let i=0;i<n.cachedBy.length;i++)if(!a.includes(n.cachedBy[i]))return b.Debug.calculationCacheDebugMode&&console.log(`Cache missed (reason: calc var mismatch) for ${t} (${n.cachedBy[i]})`),!1;return b.Debug.calculationCacheDebugMode&&console.log(`Hit cache for ${t} with value ${n.value}`),n.value}#o(t,a){if(a.cachedBy.length===0||a.value===null||a.value===void 0){b.Debug.calculationCacheDebugMode&&console.warn(`Rejected cache update for ${t} (value: ${a.value}, cachedBy: ${a.cachedBy.length})`);return}this.#e[t]=a}clearCache(){this.#e={...this.#t}}dumpCache(){console.table(this.#e)}#s(t,a,n,i,r){let s=0,l=i(s,a);for(;t>=l&&(t-=l,s+=1,l=i(s,a),!(s>=n)););return r(s)}#l(t,a,n,i,r){let s=0,l=i(s,a);for(;t>=l&&(t-=l,s+=1,l=i(s,a),!(s>=n)););return r(s)}R_calculateConsumableEventBuff(t){if(!this.eventData)return 0;let a=this.eventData,n=`EVENTBUFF_${g.eventBuffNumToName(t)}`,i=[a.HAPPY_HOUR_BELL.amount,t],r=this.#n(n,i);if(r)return r;let{HAPPY_HOUR_BELL:s}=this.eventData,l=s.amount-1;if(s.amount===0)return this.#o(n,{value:0,cachedBy:i}),0;let u=0;switch(t){case 0:u=s?.25+.025*l:0;break;case 1:u=0;break;case 2:u=s?.5+.05*l:0;break;case 3:u=0;break;case 4:u=0;break;case 5:u=0;break;case 6:u=0;break;case 7:u=0;break;case 8:u=s?.5+.05*l:0;break;case 9:u=s?.5+.05*l:0;break;case 10:u=0;break;case 13:u=0;break;case 11:u=s?.1+.01*l:0;break;case 12:u=s?.1+.01*l:0;break}return this.#o(n,{value:u,cachedBy:i}),u}R_calculateAmbrosiaGenerationShopUpgrade(t=!0){if(!this.gameData)return 0;let a=this.gameData,n="R_AmbrosiaGenerationShopUpgrade",i=[a.shopUpgrades.shopAmbrosiaGeneration1,a.shopUpgrades.shopAmbrosiaGeneration2,a.shopUpgrades.shopAmbrosiaGeneration3,a.shopUpgrades.shopAmbrosiaGeneration4],r=this.#n(n,i);if(r)return r;let s=[1+a.shopUpgrades.shopAmbrosiaGeneration1/100,1+a.shopUpgrades.shopAmbrosiaGeneration2/100,1+a.shopUpgrades.shopAmbrosiaGeneration3/100,1+a.shopUpgrades.shopAmbrosiaGeneration4/1e3],l=s.reduce((u,d)=>u*d);return this.#o(n,{value:l,cachedBy:i}),t?l:s}R_calculateAmbrosiaGenerationSingularityUpgrade(t=!0){if(!this.gameData)return 0;let a=this.gameData,n="R_AmbrosiaGenerationSingularityUpgrade",i=[a.goldenQuarkUpgrades.singAmbrosiaGeneration.level,a.goldenQuarkUpgrades.singAmbrosiaGeneration2.level,a.goldenQuarkUpgrades.singAmbrosiaGeneration3.level,a.goldenQuarkUpgrades.singAmbrosiaGeneration4.level],r=this.#n(n,i);if(r)return r;let s=[1+a.goldenQuarkUpgrades.singAmbrosiaGeneration.level/100,1+a.goldenQuarkUpgrades.singAmbrosiaGeneration2.level/100,1+a.goldenQuarkUpgrades.singAmbrosiaGeneration3.level/100,1+2*a.goldenQuarkUpgrades.singAmbrosiaGeneration4.level/100],l=s.reduce((u,d)=>u*d);return this.#o(n,{value:l,cachedBy:i}),t?l:s}R_calculateAmbrosiaGenerationOcteractUpgrade(t=!0){if(!this.gameData)return 0;let a=this.gameData,n="R_AmbrosiaGenerationOcteractUpgrade",i=[a.octUpgrades.octeractAmbrosiaGeneration.level,a.octUpgrades.octeractAmbrosiaGeneration2.level,a.octUpgrades.octeractAmbrosiaGeneration3.level,a.octUpgrades.octeractAmbrosiaGeneration4.level],r=this.#n(n,i);if(r)return r;let s=[1+a.octUpgrades.octeractAmbrosiaGeneration.level/100,1+a.octUpgrades.octeractAmbrosiaGeneration2.level/100,1+a.octUpgrades.octeractAmbrosiaGeneration3.level/100,1+2*a.octUpgrades.octeractAmbrosiaGeneration4.level/100],l=s.reduce((u,d)=>u*d);return this.#o(n,{value:l,cachedBy:i}),t?l:s}R_calculateSingularityMilestoneBlueberries(){if(!this.gameData)return 0;let t=this.gameData,a="R_SingularityMilestoneBlueberries",n=[t.highestSingularityCount],i=this.#n(a,n);if(i)return i;let r=0;t.highestSingularityCount>=270?r=5:t.highestSingularityCount>=256?r=4:t.highestSingularityCount>=192?r=3:t.highestSingularityCount>=128?r=2:t.highestSingularityCount>=64&&(r=1);let s=r;return this.#o(a,{value:s,cachedBy:n}),s}R_calculateDilatedFiveLeafBonus(){if(!this.gameData)return 0;let t=this.gameData,a="R_DilatedFiveLeafBonus",n=[t.highestSingularityCount],i=this.#n(a,n);if(i)return i;let r=[100,150,200,225,250,255,260,265,269,272],s=r.length/100;for(let u=0;u<r.length;u++)if(t.highestSingularityCount<r[u]){s=u/100;break}let l=s;return this.#o(a,{value:l,cachedBy:n}),l}R_calculateSingularityAmbrosiaLuckMilestoneBonus(){if(!this.gameData)return 0;let t=this.gameData,a="R_SingularityAmbrosiaLuckMilestoneBonus",n=[t.highestSingularityCount],i=this.#n(a,n);if(i)return i;let r=0,s=[35,42,49,56,63,70,77],l=[135,142,149,156,163,170,177];for(let d of s)t.highestSingularityCount>=d&&(r+=5);for(let d of l)t.highestSingularityCount>=d&&(r+=6);let u=r;return this.#o(a,{value:u,cachedBy:n}),u}R_calculateAmbrosiaLuckShopUpgrade(t=!0){if(!this.gameData)return 0;let a=this.gameData,n="R_AmbrosiaLuckShopUpgrade",i=[a.shopUpgrades.shopAmbrosiaLuck1,a.shopUpgrades.shopAmbrosiaLuck2,a.shopUpgrades.shopAmbrosiaLuck3,a.shopUpgrades.shopAmbrosiaLuck4],r=this.#n(n,i);if(r)return r;let s=[2*a.shopUpgrades.shopAmbrosiaLuck1,2*a.shopUpgrades.shopAmbrosiaLuck2,2*a.shopUpgrades.shopAmbrosiaLuck3,.6*a.shopUpgrades.shopAmbrosiaLuck4],l=s.reduce((u,d)=>u+d,0);return this.#o(n,{value:l,cachedBy:i}),t?l:s}R_calculateAmbrosiaLuckSingularityUpgrade(t=!0){if(!this.gameData)return 0;let a=this.gameData,n="R_AmbrosiaLuckSingularityUpgrade",i=[a.goldenQuarkUpgrades.singAmbrosiaLuck.level,a.goldenQuarkUpgrades.singAmbrosiaLuck2.level,a.goldenQuarkUpgrades.singAmbrosiaLuck3.level,a.goldenQuarkUpgrades.singAmbrosiaLuck4.level],r=this.#n(n,i);if(r)return r;let s=[+a.goldenQuarkUpgrades.singAmbrosiaLuck.level*4,+a.goldenQuarkUpgrades.singAmbrosiaLuck2.level*2,+a.goldenQuarkUpgrades.singAmbrosiaLuck3.level*3,+a.goldenQuarkUpgrades.singAmbrosiaLuck4.level*5],l=s.reduce((u,d)=>u+d,0);return this.#o(n,{value:l,cachedBy:i}),t?l:s}R_calculateAmbrosiaLuckOcteractUpgrade(t=!0){if(!this.gameData)return 0;let a=this.gameData,n="R_AmbrosiaLuckOcteractUpgrade",i=[a.octUpgrades.octeractAmbrosiaLuck.level,a.octUpgrades.octeractAmbrosiaLuck2.level,a.octUpgrades.octeractAmbrosiaLuck3.level,a.octUpgrades.octeractAmbrosiaLuck4.level],r=this.#n(n,i);if(r)return r;let s=[+a.octUpgrades.octeractAmbrosiaLuck.level*4,+a.octUpgrades.octeractAmbrosiaLuck2.level*2,+a.octUpgrades.octeractAmbrosiaLuck3.level*3,+a.octUpgrades.octeractAmbrosiaLuck4.level*5],l=s.reduce((u,d)=>u+d,0);return this.#o(n,{value:l,cachedBy:i}),t?l:s}R_calculateTotalCubes(){if(!this.gameData)return 0;let t=this.gameData,a="R_TotalCubes",n=[t.wowCubes,t.wowTesseracts,t.wowHypercubes,t.wowPlatonicCubes,t.wowAbyssals,t.wowOcteracts],i=this.#n(a,n);if(i)return i;let r=Math.floor(Math.log10(Number(t.wowCubes)+1))+Math.floor(Math.log10(Number(t.wowTesseracts)+1))+Math.floor(Math.log10(Number(t.wowHypercubes)+1))+Math.floor(Math.log10(Number(t.wowPlatonicCubes)+1))+Math.floor(Math.log10(t.wowAbyssals+1))+Math.floor(Math.log10(t.wowOcteracts+1))+6;return this.#o(a,{value:r,cachedBy:n}),r}R_calculateAmbrosiaUpgradeValue(t){if(!this.gameData)return 0;let a=this.gameData,n=`REDAMB_${t}`;if(!(t in a.ambrosiaUpgrades)||!(t in this.#r))return 0;let i=[a.ambrosiaUpgrades[t].ambrosiaInvested],r=this.#n(n,i);if(r)return r;let s=this.#r[t],u=this.#s(a.ambrosiaUpgrades[t].ambrosiaInvested,s.costPerLevel,s.maxLevel,s.costFunction,s.levelFunction);return this.#o(n,{value:u,cachedBy:i}),u}R_calculateSynergismLevel(){if(!this.gameData)return 0;let t=this.gameData,a=0;a+=ct.reduce((n,i,r)=>n+(t.achievements[r]?i.pointValue:0),0)}R_calculateRedAmbrosiaUpgradeValue(t){if(!this.gameData)return 0;let a=this.gameData,n=`REDAMB_${t}`;if(!(t in a.redAmbrosiaUpgrades)||!(t in this.#a))return 0;let i=[a.redAmbrosiaUpgrades[t]],r=this.#n(n,i);if(r)return r;let s=this.#a[t],u=this.#l(a.redAmbrosiaUpgrades[t],s.costPerLevel,s.maxLevel,s.costFunction,s.levelFunction);return this.#o(n,{value:u,cachedBy:i}),u}R_calculateCampaignAmbrosiaSpeedBonus(){let t="R_CampaignAmbrosiaSpeedBonus",a=this.campaignData?.tokens??0,n=[a],i=this.#n(t,n);if(i)return i;let r;a<2e3?r=1:r=1+.02*1/2e3*Math.min(a-2e3,2e3)+.03*(1-Math.exp(-Math.max(a-4e3,0)/2e3));let s=r;return this.#o(t,{value:s,cachedBy:n}),s}R_calculateCampaignLuckBonus(){let t="R_CampaignLuckBonus",a=this.campaignData?.tokens??0,n=[a],i=this.#n(t,n);if(i)return i;let r;a<2e3?r=0:r=10+40/2e3*Math.min(a-2e3,2e3)+50*(1-Math.exp(-Math.max(a-4e3,0)/2500));let s=r;return this.#o(t,{value:s,cachedBy:n}),s}R_calculateCookieUpgrade29Luck(){if(!this.gameData)return 0;let t=this.gameData,a="R_CookieUpgrade29Luck",i=[t.cubeUpgrades[79]??0,t.lifetimeRedAmbrosia],r=this.#n(a,i);if(r)return r;let s;t.cubeUpgrades[79]===0||t.lifetimeRedAmbrosia===0?s=0:s=10*Math.pow(Math.log10(t.lifetimeRedAmbrosia),2);let l=s;return this.#o(a,{value:l,cachedBy:i}),l}R_calculateSumOfExaltCompletions(){if(!this.gameData)return 0;let t=this.gameData,a="R_SumOfExaltCompletions",n=[...Object.values(t.singularityChallenges).map(l=>l.completions)],i=this.#n(a,n);if(i)return i;let r=0;for(let l of Object.values(t.singularityChallenges))r+=l.completions;let s=r;return this.#o(a,{value:s,cachedBy:n}),s}getCorruptionTotalLevel(){if(!this.gameData)return 0;let a=this.gameData.corruptions.used;return Object.values(a).reduce((i,r)=>i+r,0)}R_calculateFreeShopInfinityUpgrades(t=!0){return this.R_calculateAllShopTablets(t)}R_calculateAllShopTablets(t=!0){if(!this.gameData)return 0;let a=this.gameData,n="R_AllShopTablets",i=[a.highestSingularityCount,a.goldenQuarkUpgrades.singInfiniteShopUpgrades.level,a.octUpgrades.octeractInfiniteShopUpgrades.level,a.shopUpgrades.shopInfiniteShopUpgrades,...a.singularityChallenges.noAmbrosiaUpgrades.enabled?[]:[this.R_calculateRedAmbrosiaUpgradeValue("freeLevelsRow4"),this.R_calculateRedAmbrosiaUpgradeValue("freeLevelsRow5")]],r=this.#n(n,i);if(r)return r;let s=()=>a.highestSingularityCount>=280?Math.floor(.8*(a.highestSingularityCount-200)):a.highestSingularityCount>=250?Math.floor(.5*(a.highestSingularityCount-200)):0,l=[this.R_calculateRedAmbrosiaUpgradeValue("infiniteShopUpgrades"),s(),+a.goldenQuarkUpgrades.singInfiniteShopUpgrades.level,+a.octUpgrades.octeractInfiniteShopUpgrades.level,Math.floor(.005*a.shopUpgrades.shopInfiniteShopUpgrades*this.R_calculateSumOfExaltCompletions()),...a.singularityChallenges.noAmbrosiaUpgrades.enabled?[]:[+this.R_calculateRedAmbrosiaUpgradeValue("freeLevelsRow4"),+this.R_calculateRedAmbrosiaUpgradeValue("freeLevelsRow5")]],u=l.reduce((d,p)=>d+p,0);return this.#o(n,{value:u,cachedBy:i}),t?u:l}R_calculateLimitedAscensionsDebuff(){if(!this.gameData)return 0;let t=this.gameData,a="R_LimitedAscensionsDebuff";if(!t.singularityChallenges.limitedAscensions.enabled)return 1;let n=[t.ascensionCount,t.singularityChallenges.limitedAscensions.completions],i=this.#n(a,n);if(i)return i;let r=t.ascensionCount-Math.max(0,20-t.singularityChallenges.limitedAscensions.completions);r=Math.max(0,r);let s=Math.pow(2,r);return this.#o(a,{value:s,cachedBy:n}),s}R_calculateSingularityReductions(t=!0){if(!this.gameData)return 0;let a=this.gameData,n="R_SingularityReductions",i=[a.insideSingularityChallenge?1:0,this.R_calculateAmbrosiaUpgradeValue("ambrosiaSingReduction2"),this.R_calculateAmbrosiaUpgradeValue("ambrosiaSingReduction1"),a.shopUpgrades.shopSingularityPenaltyDebuff],r=this.#n(n,i);if(r)return r;let s;a.insideSingularityChallenge?s=this.R_calculateAmbrosiaUpgradeValue("ambrosiaSingReduction2"):s=this.R_calculateAmbrosiaUpgradeValue("ambrosiaSingReduction1");let l=[a.shopUpgrades.shopSingularityPenaltyDebuff,s],u=l.reduce((d,p)=>d+p,0);return this.#o(n,{value:u,cachedBy:i}),t?u:l}R_calculateEffectiveSingularities(t=-1){if(!this.gameData)return 0;let a=this.gameData,n="R_EffectiveSingularities",i=[t,a.insideSingularityChallenge?1:0,a.singularityChallenges.noOcteracts.completions],r=this.#n(n,i);if(r)return r;let s=t===-1?a.singularityCount:t;return s*=Math.min(4.75,.75*t/10+1),a.insideSingularityChallenge&&a.singularityChallenges.noOcteracts.enabled&&(s*=Math.pow(a.singularityChallenges.noOcteracts.completions+1,3)),t>10&&(s*=1.5,s*=Math.min(4,1.25*t/10-.25)),t>25&&(s*=2.5,s*=Math.min(6,1.5*t/25-.5)),t>36&&(s*=4,s*=Math.min(5,t/18-1),s*=Math.pow(1.1,Math.min(t-36,64))),t>50&&(s*=5,s*=Math.min(8,2*t/50-1),s*=Math.pow(1.1,Math.min(t-50,50))),t>100&&(s*=2,s*=t/25,s*=Math.pow(1.1,t-100)),t>150&&(s*=2,s*=Math.pow(1.05,t-150)),t>200&&(s*=1.5,s*=Math.pow(1.275,t-200)),t>215&&(s*=1.25,s*=Math.pow(1.2,t-215)),t>230&&(s*=2),t>269&&(s*=3,s*=Math.pow(3,t-269)),this.#o(n,{value:s,cachedBy:i}),s}R_calculateSingularityDebuff(t,a=-1){if(!this.gameData)return 1;let n=this.gameData;if(a===-1&&(a=n.singularityCount),a===0||n.runes.antiquities>0)return 1;let i=a-this.R_calculateSingularityReductions();if(i<1)return 1;let r=this.R_calculateEffectiveSingularities(i),s=1;s*=1-Math.min(300,n.shopUpgrades.shopHorseShoe*this.R_calculateHorseShoeLevel())/1e3;let l;if(t==="Offering")l=i<150?Math.sqrt(r)+1:Math.pow(r,2/3)/400;else if(t==="Global Speed")l=1+Math.sqrt(r)/4;else if(t==="Obtainium")l=i<150?Math.sqrt(r)+1:Math.pow(r,2/3)/400;else if(t==="Researches")l=1+Math.sqrt(r)/2;else if(t==="Ascension Speed")l=s*(i<150?1+Math.sqrt(r)/5:1+Math.pow(r,.75)/1e4);else if(t==="Cubes"){let u=i>100?Math.pow(1.02,i-100):1;l=i<150?1+Math.sqrt(r)*u/4:1+Math.pow(r,.75)*u/1e3}else t==="Platonic Costs"?l=i>36?1+Math.pow(r,3/10)/12:1:t==="Hepteract Costs"?l=i>50?1+Math.pow(r,11/50)/25:1:l=Math.cbrt(r+1);return l}R_calculateAscensionSpeedExponentSpread(t=!0){if(!this.gameData)return 0;let a=this.gameData,n="R_AscensionSpeedExponentSpread",i=[a.goldenQuarkUpgrades.singAscensionSpeed.level,a.goldenQuarkUpgrades.singAscensionSpeed2.level,a.shopUpgrades.chronometerInfinity],r=this.#n(n,i);if(r)return r;let s=[a.goldenQuarkUpgrades.singAscensionSpeed.level>0?.03:0,a.goldenQuarkUpgrades.singAscensionSpeed2.level*.001,.001*Math.floor((a.shopUpgrades.chronometerInfinity+this.R_calculateFreeShopInfinityUpgrades())/40)],l=s.reduce((u,d)=>u+d,0);return this.#o(n,{value:l,cachedBy:i}),t?l:s}calculateChallenge15Reward(t){if(!this.gameData)return c.errorOnce("<red>calculateChallenge15Reward() GAMEDATA WAS NULL</red>",this.context),0;let a=this.gameData,n=a.challenge15Exponent?a.challenge15Exponent:a.highestChallenge15Exponent?a.highestChallenge15Exponent:0;return n===0?0:Yt[t](n)}R_calculateRawAscensionSpeedMult(t=!0){if(!this.gameData)return 0;let a=this.gameData,n="R_RawAscensionSpeedMult",i=a.cubeUpgrades[59]??0,r=[a.shopUpgrades.chronometer,a.shopUpgrades.chronometer2,a.shopUpgrades.chronometer3,a.achievements[262],a.achievements[263],a.platonicUpgrades[15],a.singularityCount,a.shopUpgrades.chronometerZ,a.octUpgrades.octeractImprovedAscensionSpeed.level,a.octUpgrades.octeractImprovedAscensionSpeed2.level,a.singularityChallenges.limitedAscensions.completions,a.singularityChallenges.limitedTime.completions,a.shopUpgrades.shopChronometerS,i,a.insideSingularityChallenge?1:0],s=this.#n(n,r),l=[this.R_calculateMortuus2AscensionSpeed(),this.R_calculatePolymathAscSpeed(),1+1.2/100*a.shopUpgrades.chronometer,1+.6/100*a.shopUpgrades.chronometer2,1+1.5/100*a.shopUpgrades.chronometer3,1+.6/1e3*this.R_calculateHepteractEffective("chronos"),1+.002*this.getCorruptionTotalLevel()*a.platonicUpgrades[15],this.calculateChallenge15Reward("ascensionSpeed"),1+1/400*i,1+.5*(a.goldenQuarkUpgrades.intermediatePack.level>0?1:0),1+1/1e3*a.singularityCount*a.shopUpgrades.chronometerZ,1+ +a.octUpgrades.octeractImprovedAscensionSpeed.level/2e3*a.singularityCount,1+ +a.octUpgrades.octeractImprovedAscensionSpeed2.level/2e3*a.singularityCount,Math.pow(1.006,a.shopUpgrades.chronometerInfinity+this.R_calculateFreeShopInfinityUpgrades()),Math.pow(1+.1*a.singularityChallenges.limitedAscensions.completions/100,1+Math.max(0,Math.floor(Math.log10(a.ascensionCount)))),1+.06*a.singularityChallenges.limitedTime.completions,Math.max(Math.pow(1.01,(a.singularityCount-200)*a.shopUpgrades.shopChronometerS),1),1/this.R_calculateLimitedAscensionsDebuff(),1/this.R_calculateSingularityDebuff("Ascension Speed"),1+this.R_calculateConsumableEventBuff(4)],u=l.reduce((d,p)=>d*p,1);return this.#o(n,{value:u,cachedBy:r}),t?u:l}R_calculateAscensionSpeedMult(){let t=this.R_calculateRawAscensionSpeedMult(),a=this.R_calculateAscensionSpeedExponentSpread();return t<1?t=Math.pow(t,1-a):t=Math.pow(t,1+a),t}R_calculateFreeAntUpgradeLevels(){if(!this.gameData)return 1;let t=this.gameData,a=(i,r)=>{let s=0;switch(i){case"transcend":return s+=Math.min(100,r),s+=1/20*(Math.min(1e3,Math.max(100,r))-100),s+=1/100*(Math.max(1e3,r)-1e3),s;case"reincarnation":return s+=Math.min(25,r),s+=1/2*(Math.min(75,Math.max(25,r))-25),s+=1/10*(Math.max(75,r)-75),s;case"ascension":return s+=Math.min(10,r),s+=1/2*(Math.max(10,r)-10),s}},n=0;return n+=a("reincarnation",t.challengecompletions[9]),n+=Math.round(2e3*(1-Math.pow(.999,t.constantUpgrades[6]??0))),n+=12*a("ascension",t.challengecompletions[11]),n+=2*t.researches[97],n+=2*t.researches[98],n+=t.researches[102],n+=2*t.researches[132],n+=Math.floor(1/200*t.researches[200]),n+=this.R_calculateAchievementReward(),n*=this.calculateChallenge15Reward("bonusAntLevel"),t.currentChallenge.ascension===11&&(n+=Math.floor(3*t.challengecompletions[8]+5*t.challengecompletions[9])),n}R_calculateAchievementReward(){if(!this.gameData)return 1;let t=this.gameData,a=ct.map((i,r)=>{if(i.reward&&i.reward.includes("freeAntUpgrades")){let s=i.reward.match(/freeAntUpgrades:\s*\(\)\s*=>\s*(\d+)/);if(s)return{index:r,freeAntUpgrades:Number(s[1])}}return null}).filter(i=>i!==null),n=0;return a.forEach(i=>{t.achievements[i.index]===1&&(n+=i.freeAntUpgrades)}),n}R_calculatePolymathAscSpeed(){if(!this.gameData)return 1;let t=this.gameData,a=(S,v)=>{let E=(R,B)=>{let{mantissa:L,exponent:O}=Y(R);return(L*B).toExponential()+"e"+O},Y=R=>{let B=R.match(/^([\d.]+)e\+?(-?\d+)$/i);return B?{mantissa:parseFloat(B[1]),exponent:parseInt(B[2],10)}:{mantissa:parseFloat(R),exponent:0}},Q=S,j=1;v>=120&&(j*=(v-90)/30),v>=150&&(j*=(v-120)/30),v>=180&&(j*=(v-170)/10),Q=E(S,j);let J=R=>(Math.floor(R)||0).toExponential(),z=E(J(Math.pow(v,3)/8+1),parseFloat(Q)),_=v>=30?E(J(Math.pow(v-30,3)/32+1),parseFloat(Q)):"0e0",$=v>=60?E(J(Math.pow(v-60,3)/384+1),parseFloat(Q)):"0e0",q=v>=90?E(J(Math.pow(v-90,3)/500+1),parseFloat(Q)):"0e0",K=v>=120?E(J(Math.pow(v-120,3)/375+1),parseFloat(Q)):"0e0",x=v>=150?E(J(Math.pow(v-150,3)/192+1),parseFloat(Q)):"0e0",T=v>=150?E(J(Math.pow(v-150,3)/1280+1),parseFloat(Q)):"0e0";return{shard:z,commonFragment:_,uncommonFragment:$,rareFragment:q,epicFragment:K,legendaryFragment:x,mythicalFragment:T}},n=0;t.singularityChallenges.noOcteracts.enabled||t.singularityChallenges.sadisticPrequel.enabled||(n+=t.octUpgrades.octeractTalismanLevelCap1.level,n+=t.octUpgrades.octeractTalismanLevelCap2.level,n+=t.octUpgrades.octeractTalismanLevelCap3.level,n+=t.octUpgrades.octeractTalismanLevelCap4.level);let i=180,r=i;r+=6*Math.min(10,t.challengecompletions[13]),r+=3*(Math.max(10,t.challengecompletions[13])-10),r+=Math.floor(t.researches[200]/400),r+=t.singularityChallenges.taxmanLastStand.completions*25,r+=n;let s=[1,1.04,1.08,1.12,1.16,1.2,1.25,1.3,1.325,1.35,1.4],l={shard:t.talismans.polymath.shard.toString(),commonFragment:t.talismans.polymath.commonFragment.toString(),uncommonFragment:t.talismans.polymath.uncommonFragment.toString(),rareFragment:t.talismans.polymath.rareFragment.toString(),epicFragment:t.talismans.polymath.epicFragment.toString(),legendaryFragment:t.talismans.polymath.legendaryFragment.toString(),mythicalFragment:t.talismans.polymath.mythicalFragment.toString()},u=0,d=S=>a(1e16.toString(),S),p=S=>{let v=S.match(/^([\d.]+)e\+?(-?\d+)$/i);return v?Math.log10(parseFloat(v[1]))+parseInt(v[2],10):Math.log10(parseFloat(S))},m={};for(let S in l)m[S]=p(l[S]);let h=!0;for(;h&&u<r;){let S=d(u),v=!0;for(let E in S){let Y=p(S[E]);if(m[E]<Y){v=!1;break}}if(!v)break;for(let E in S){let Y=p(S[E]);m[E]=Math.log10(Math.pow(10,m[E])-Math.pow(10,Y))}u+=1}let A=u/i,w=0;A>=1&&(A>=2&&(w+=1),A>=4&&(w+=1),A>=8&&(w+=1));let C=1+Math.min(6,Math.floor(6*A))+w;return C=Math.min(C,s.length-1),s[C]??1}R_calculateMortuus2AscensionSpeed(){if(!this.gameData)return 0;let t=this.gameData,a=t.ants.upgrades[15],n=this.R_calculateFreeAntUpgradeLevels(),i;return t.currentChallenge.ascension===11?i=Math.min(t.ants.upgrades[15],n):i=t.ants.upgrades[15]+Math.min(t.ants.upgrades[15],n),2-Math.pow(.996,i)}R_calculateHorseShoeLevel(){if(!this.gameData)return 0;let t=this.gameData,a=t.runes.horseShoe.toString(),n=1/20;n+=.005*t.singularityChallenges.taxmanLastStand.completions;let i=t.shopUpgrades.shopHorseShoe>0?3:0,r=1,l=((d,p)=>{let m=S=>{let v=S.match(/^([\d.]+)e\+?(-?\d+)$/i);return v?{m:parseFloat(v[1]),e:parseInt(v[2],10)}:{m:parseFloat(S),e:0}},h=m(d),A=m(p),w=h.e-A.e,C=h.m/A.m;if(w<0||w===0&&C<1){let S=C*Math.pow(10,w);return Math.log10(1+S)}return Math.log10(C)+w})(a,"1e500"),u=Math.floor(n*l*r)+i;return Math.max(0,u)}R_calculateCashGrabBonus(t){if(!this.gameData)return 0;let a=this.gameData;return 1+a.shopUpgrades.shopCashGrabUltra*t*Math.min(1,Math.pow(a.lifetimeAmbrosia/1e7,1/3))}R_calculateEXUltraBonus(t){if(!this.gameData)return 0;let a=this.gameData;return 1+t*Math.min(a.shopUpgrades.shopEXUltra,Math.floor(a.lifetimeAmbrosia/1e3)/125)}calculateAmbrosiaSpeed(t=!0){if(!this.gameData)return 0;let a=this.gameData;if(!this.pseudoData)return 0;let n=this.pseudoData;if(!this.meData)return 0;let i=this.meData,r=n?.playerUpgrades.find(w=>w.internalName==="AMBROSIA_GENERATION_BUFF")?.level,s=r?1+r*.05:1,l=this.R_calculateCampaignAmbrosiaSpeedBonus(),u=100*(1+i.globalBonus/100)*(1+i.personalBonus/100)-100,d=this.R_calculateRedAmbrosiaUpgradeValue("blueberryGenerationSpeed"),p=this.R_calculateRedAmbrosiaUpgradeValue("blueberryGenerationSpeed2"),m=a.cubeUpgrades[76]??1,h=[+a.visitedAmbrosiaSubtab,s,l,this.R_calculateAmbrosiaGenerationShopUpgrade(),this.R_calculateAmbrosiaGenerationSingularityUpgrade(),this.R_calculateAmbrosiaGenerationOcteractUpgrade(),1+this.R_calculateAmbrosiaUpgradeValue("ambrosiaPatreon")*u/100,1+a.singularityChallenges.oneChallengeCap.completions/100,1+a.singularityChallenges.noAmbrosiaUpgrades.completions/50,d,p,1+.01*m*this.R_calculateNumberOfThresholds(),this.R_calculateCashGrabBonus(Ut),this.isEvent?1+this.R_calculateConsumableEventBuff(11):1],A=h.reduce((w,C)=>w*C,1);return t?A:h}calculateBlueBerries(t=!0){let a=this.getGameData();if(!a)return 0;let n=0;a.singularityChallenges.noAmbrosiaUpgrades.completions>=20?n=3:a.singularityChallenges.noAmbrosiaUpgrades.completions>=10?n=2:a.singularityChallenges.noAmbrosiaUpgrades.completions>0&&(n=1);let i=[+(a.singularityChallenges.noSingularityUpgrades.completions>0),+a.goldenQuarkUpgrades.blueberries.level,+a.octUpgrades.octeractBlueberries.level,+this.R_calculateRedAmbrosiaUpgradeValue("blueberries"),this.R_calculateSingularityMilestoneBlueberries(),n],r=i.reduce((s,l)=>s+l,0);return t?r:i}calculateLuck(t=!0,a=!1){let n=this.getGameData(),i=this.getPseudoData();if(!n)return{additive:0,raw:0,total:0};if(!i)return{additive:0,raw:0,total:0};let r=n.cubeUpgrades[77]??0,s=[1,n.singularityChallenges.noSingularityUpgrades.completions>=30?.05:0,this.R_calculateDilatedFiveLeafBonus(),n.shopUpgrades.shopAmbrosiaLuckMultiplier4/100,n.singularityChallenges.noAmbrosiaUpgrades.completions/200,.001*r,this.isEvent?this.R_calculateConsumableEventBuff(12):0],l=i.playerUpgrades.find(x=>x.internalName==="AMBROSIA_LUCK_BUFF")?.level,u=l?l*20:0,d=this.R_calculateCampaignLuckBonus(),p=this.R_calculateRedAmbrosiaUpgradeValue("freeLevelsRow2"),m=this.R_calculateRedAmbrosiaUpgradeValue("freeLevelsRow3"),h=this.R_calculateRedAmbrosiaUpgradeValue("freeLevelsRow4"),A=this.R_calculateRedAmbrosiaUpgradeValue("freeLevelsRow5"),w={2:p,3:m,4:h,5:A},C=(x,T)=>a?w[T]:x+w[T],S=this.R_calculateAmbrosiaUpgradeValue("ambrosiaLuck1"),v=this.R_calculateAmbrosiaUpgradeValue("ambrosiaLuck2"),E=this.R_calculateAmbrosiaUpgradeValue("ambrosiaLuck3"),Y=this.R_calculateTotalCubes(),Q=this.R_calculateAmbrosiaUpgradeValue("ambrosiaCubeLuck1"),j=this.R_calculateAmbrosiaUpgradeValue("ambrosiaQuarkLuck1"),J=this.R_calculateRedAmbrosiaUpgradeValue("regularLuck"),z=this.R_calculateRedAmbrosiaUpgradeValue("regularLuck2"),_=this.R_calculateRedAmbrosiaUpgradeValue("viscount"),$=[100,u,d,this.R_calculateSingularityAmbrosiaLuckMilestoneBonus(),this.R_calculateAmbrosiaLuckShopUpgrade(),this.R_calculateAmbrosiaLuckSingularityUpgrade(),this.R_calculateAmbrosiaLuckOcteractUpgrade(),2*C(S,2)+12*Math.floor(C(S,2)/10),(3+.3*Math.floor(C(S,2)/10))*C(v,4)+40*Math.floor(C(v,4)/10),this.calculateBlueBerries()*C(E,5),this.R_calculateTotalCubes()*.02*C(Q,3),.02*C(j,3)*Math.floor(Math.pow(Math.log10(Number(n.worlds)+1)+1,2)),n.highestSingularityCount>=131?131:0,n.highestSingularityCount>=269?269:0,n.shopUpgrades.shopOcteractAmbrosiaLuck*(1+Math.floor(Math.log10(n.totalWowOcteracts+1))),n.singularityChallenges.noAmbrosiaUpgrades.completions*15,J,z,_,2*r,this.R_calculateCookieUpgrade29Luck(),n.shopUpgrades.shopAmbrosiaUltra*this.R_calculateSumOfExaltCompletions(),Math.max(0,(this.R_calculateSynergismLevel()??-229)*4),this.R_calculateHorseShoeLevel()],q=[0],K=[];if(a?K=$:K=[...$,...q],t){let x=s.reduce((R,B)=>R+B,0),T=K.reduce((R,B)=>R+B,0);return{additive:x,raw:T,total:x*T}}else return{additive:s,raw:K}}R_calculateLuckConversion(t=!0){if(!this.gameData)return 0;let a=this.gameData,n="R_LuckConversion",i=this.R_calculateRedAmbrosiaUpgradeValue("conversionImprovement1"),r=this.R_calculateRedAmbrosiaUpgradeValue("conversionImprovement2"),s=this.R_calculateRedAmbrosiaUpgradeValue("conversionImprovement3"),l=this.R_calculateHorseShoeLevel(),u=[a.shopUpgrades.shopRedLuck1,a.shopUpgrades.shopRedLuck2,a.shopUpgrades.shopRedLuck3,i,r,s,l],d=this.#n(n,u);if(d)return d;let p=[20,i,r,s,-.01*Math.floor(a.shopUpgrades.shopRedLuck1/20),-.01*Math.floor(a.shopUpgrades.shopRedLuck2/20),-.01*Math.floor(a.shopUpgrades.shopRedLuck3/20),-.5*l/(l+50)],m=p.reduce((h,A)=>h+A,0);return this.#o(n,{value:m,cachedBy:u}),t?m:p}R_calculateRedAmbrosiaLuck(t=!0){if(!this.gameData||!this.pseudoData)return 0;let a=this.gameData,n=this.pseudoData,i="R_RedAmbrosiaLuck",r=n.playerUpgrades.find(w=>w.internalName==="RED_LUCK_BUFF")?.level??0,s=this.calculateLuck(),l=this.R_calculateRedAmbrosiaUpgradeValue("redLuck"),u=this.R_calculateRedAmbrosiaUpgradeValue("viscount"),d=this.R_calculateHorseShoeLevel(),p=[r,s.total,l,u,a.singularityChallenges.noAmbrosiaUpgrades.completions,a.shopUpgrades.shopRedLuck1,a.shopUpgrades.shopRedLuck2,a.shopUpgrades.shopRedLuck3,d],m=this.#n(i,p);if(m)return m;let h=[100,r,Math.floor((s.total-100)/this.R_calculateLuckConversion()),l,a.singularityChallenges.noAmbrosiaUpgrades.completions*4,a.shopUpgrades.shopRedLuck1*.05,a.shopUpgrades.shopRedLuck2*.075,a.shopUpgrades.shopRedLuck3*.1,u,d*.2,Math.max(0,this.R_calculateSynergismLevel()??-259)],A=h.reduce((w,C)=>w+C,0);return this.#o(i,{value:A,cachedBy:p}),t?A:h}calculateGoldenRevolution(){if(!this.gameData)return 0;let t=this.gameData,a=t.highestSingularityCount>=100?1-.5*t.highestSingularityCount/250:1}async dumpDataForHeater(){let t=D.getModule("HSGameData");if(t)await t.forceUpdateAllData();else{c.error("Failed to acquire game data for heater export",this.context),y.Notify("Failed to acquire game data for heater export",{position:"top",notificationType:"error"});return}if(!this.gameData)return 0;let a=this.gameData;try{let{additive:n,raw:i,total:r}=this.calculateLuck(!0),s=this.calculateLuck(!0,!0),l=(r-100*Math.floor(r/100))/100,u=(s.total-100*Math.floor(s.total/100))/100,d=this.calculateBlueBerries(),p=this.calculateAmbrosiaSpeed(),m=d*p;return{...this.gameData,hs_data:{lifeTimeAmbrosia:a.lifetimeAmbrosia,lifeTimeRedAmbrosia:a.lifetimeRedAmbrosia,quarks:a.worlds,platonic4x4:a.platonicUpgrades[19],baseLuck:i,luckMult:n,totalLuck:r,luckConversion:this.R_calculateLuckConversion(),totalCubes:this.R_calculateTotalCubes(),transcription:.55+a.octUpgrades.octeractOneMindImprover.level/150,ascSpeed:this.R_calculateAscensionSpeedMult(),blueberries:d,bonusRow2:this.R_calculateRedAmbrosiaUpgradeValue("freeLevelsRow2"),bonusRow3:this.R_calculateRedAmbrosiaUpgradeValue("freeLevelsRow3"),bonusRow4:this.R_calculateRedAmbrosiaUpgradeValue("freeLevelsRow4"),bonusRow5:this.R_calculateRedAmbrosiaUpgradeValue("freeLevelsRow5"),spread:this.R_calculateAscensionSpeedExponentSpread(),totalInfinityVouchers:this.R_calculateAllShopTablets(),tokens:this.campaignData?.tokens,maxTokens:this.campaignData?.maxTokens,isAtMaxTokens:this.campaignData?.isAtMaxTokens,isEvent:this.isEvent,bellStacks:this.eventData?.HAPPY_HOUR_BELL.amount,personalQuarkBonus:this.meData?.bonus.quarkBonus,blueAmbrosiaBarValue:a.blueberryTime,redAmbrosiaBarValue:a.redAmbrosiaTime,blueAmbrosiaBarMax:this.R_calculateRequiredBlueberryTime(),redAmbrosiaBarMax:this.R_calculateRequiredRedAmbrosiaTime(),ambrosiaSpeedMult:p,ambrosiaSpeed:m,ambrosiaGainChance:l,trueAmbrosiaGainChance:u,ambrosiaAcceleratorCount:a.shopUpgrades.shopAmbrosiaAccelerator,pseudoCoinUpgrades:{ambrosiaGenerationBuffLevel:this.pseudoData?.playerUpgrades.find(A=>A.internalName==="AMBROSIA_GENERATION_BUFF")?.level,ambrosiaLuckBuffLevel:this.pseudoData?.playerUpgrades.find(A=>A.internalName==="AMBROSIA_LUCK_BUFF")?.level,baseObtainiumBuffLevel:this.pseudoData?.playerUpgrades.find(A=>A.internalName==="BASE_OBTAINIUM_BUFF")?.level,baseOfferingBuffLevel:this.pseudoData?.playerUpgrades.find(A=>A.internalName==="BASE_OFFERING_BUFF")?.level,cubeBuffLevel:this.pseudoData?.playerUpgrades.find(A=>A.internalName==="CUBE_BUFF")?.level,redAmbrosiaGenerationBuffLevel:this.pseudoData?.playerUpgrades.find(A=>A.internalName==="RED_GENERATION_BUFF")?.level,redAmbrosiaLuckBuffLevel:this.pseudoData?.playerUpgrades.find(A=>A.internalName==="RED_LUCK_BUFF")?.level},redAmbrosiaUpgrades:{tutorial:this.R_calculateRedAmbrosiaUpgradeValue("tutorial"),conversionImprovement1:this.R_calculateRedAmbrosiaUpgradeValue("conversionImprovement1"),conversionImprovement2:this.R_calculateRedAmbrosiaUpgradeValue("conversionImprovement2"),conversionImprovement3:this.R_calculateRedAmbrosiaUpgradeValue("conversionImprovement3"),freeTutorialLevels:this.R_calculateRedAmbrosiaUpgradeValue("freeTutorialLevels"),freeLevelsRow2:this.R_calculateRedAmbrosiaUpgradeValue("freeLevelsRow2"),freeLevelsRow3:this.R_calculateRedAmbrosiaUpgradeValue("freeLevelsRow3"),freeLevelsRow4:this.R_calculateRedAmbrosiaUpgradeValue("freeLevelsRow4"),freeLevelsRow5:this.R_calculateRedAmbrosiaUpgradeValue("freeLevelsRow5"),blueberryGenerationSpeed:this.R_calculateRedAmbrosiaUpgradeValue("blueberryGenerationSpeed"),blueberryGenerationSpeed2:this.R_calculateRedAmbrosiaUpgradeValue("blueberryGenerationSpeed2"),regularLuck:this.R_calculateRedAmbrosiaUpgradeValue("regularLuck"),regularLuck2:this.R_calculateRedAmbrosiaUpgradeValue("regularLuck2"),redGenerationSpeed:this.R_calculateRedAmbrosiaUpgradeValue("redGenerationSpeed"),redLuck:this.R_calculateRedAmbrosiaUpgradeValue("redLuck"),redAmbrosiaCube:this.R_calculateRedAmbrosiaUpgradeValue("redAmbrosiaCube"),redAmbrosiaObtainium:this.R_calculateRedAmbrosiaUpgradeValue("redAmbrosiaObtainium"),redAmbrosiaOffering:this.R_calculateRedAmbrosiaUpgradeValue("redAmbrosiaOffering"),redAmbrosiaCubeImprover:this.R_calculateRedAmbrosiaUpgradeValue("redAmbrosiaCubeImprover"),viscount:this.R_calculateRedAmbrosiaUpgradeValue("viscount"),infiniteShopUpgrades:this.R_calculateRedAmbrosiaUpgradeValue("infiniteShopUpgrades"),redAmbrosiaAccelerator:this.R_calculateRedAmbrosiaUpgradeValue("redAmbrosiaAccelerator"),salvageYinYang:this.R_calculateRedAmbrosiaUpgradeValue("salvageYinYang"),blueberries:this.R_calculateRedAmbrosiaUpgradeValue("blueberries")},isInsideSingularityChallenge:a.insideSingularityChallenge}}}catch(n){let i=n instanceof Error?`${n.message}
${n.stack}`:String(n);c.error(`Failed to calculate game data for heater export
${i}`,this.context),y.Notify("Failed to calculate game data for heater export",{position:"top",notificationType:"error"});return}}};var _e=class extends G{#e=new Map;#t=[5e3,15e3,3e4,6e4];constructor(e){super(e)}async init(){c.log("Initializing HSWebsocket module",this.context),this.isInitialized=!0}#a(e){let t=this.#e.get(e);if(!t){c.warn(`Tried to reconnect websocket ${e} but it doesn't exist`,this.context);return}this.#e.delete(e),this.registerWebSocket(e,t.regParams)}registerWebSocket(e,t){let a=this;if(this.#e.has(e)){c.warn(`Tried to register websocket ${e} again`,this.context);return}if(!t.url){c.error(`Tried to register websocket ${e} without a URL`,this.context);return}let n={socket:new WebSocket(t.url),reconnectionTries:0,onClose:t.onClose??g.Noop,onOpen:t.onOpen??g.Noop,onMessage:t.onMessage??g.Noop,onRetriesFailed:t.onRetriesFailed??g.Noop,regParams:t},i=async l=>{let u=a.#e.get(e);console.log("WS CLOSED",e,{code:l.code,reason:l.reason,wasClean:l.wasClean,tries:u?.reconnectionTries});let d=a.#t[++n.reconnectionTries];d!==void 0?(c.log(`Reconnecting ${e} in ${d}ms (attempt ${n.reconnectionTries})`,a.context),setTimeout(()=>{a.#a(e)},d)):(c.warn(`WebSocket ${e} failed to reconnect after ${n.reconnectionTries} tries`),await(n.onRetriesFailed??g.Noop)()),await(n.onClose??g.Noop)(l)},r=async l=>{let u=a.#e.get(e);if(!u){c.warnOnce(`wsOnOpen(): Socket ${e} not found`,a.context);return}let d;try{d=JSON.parse(l.data)}catch(p){c.warn(`Failed to parse WebSocket message for ${e}: ${p}`,this.context),d=void 0}await(u.onMessage??g.Noop)(d)},s=async l=>{let u=a.#e.get(e);if(!u){c.warnOnce(`wsOnOpen(): Socket ${e} not found`,a.context);return}u.reconnectionTries=0,c.log(`WebSocket ${e} connected successfully`,a.context),await(u.onOpen??g.Noop)(l)};n.socket.onclose=i,n.socket.onopen=s,n.socket.onmessage=r,this.#e.set(e,n),c.log(`Registered websocket ${e}`,this.context)}unregisterWebSocket(e){let t=this.#e.get(e);t?((t.socket.readyState===WebSocket.OPEN||t.socket.readyState===WebSocket.CONNECTING)&&t.socket.close(),this.#e.delete(e),c.log(`Unregistered websocket ${e}`,this.context)):c.debug(`Could not unregister websocket (Maybe you're not logged in?) ${e}`,this.context)}getWebSocket(e){return this.#e.get(e)}};var $e=class o extends G{static#e;constructor(e){super(e),o.#e=e.context}async init(){let e=this;this.isInitialized=!0}};var tt=oa(Ft()),te=9e15,et=(function(){for(var o=[],e=-323;e<=308;e++)o.push(+("1e"+e));return function(t){return o[t+323]}})(),f=function(o){return o instanceof se?o:new se(o)},Z=function(o,e){return new se().fromMantissaExponent(o,e)},ue=function(o,e){return new se().fromMantissaExponent_noNormalize(o,e)};function xa(o,e,t,a){var n=e.mul(t.pow(a));return se.floor(o.div(n).mul(t.sub(1)).add(1).log10()/t.log10())}function Ta(o,e,t,a){return e.mul(t.pow(a)).mul(se.sub(1,t.pow(o))).div(se.sub(1,t))}var se=(function(){function o(e){this.mantissa=NaN,this.exponent=NaN,e===void 0?(this.m=0,this.e=0):e instanceof o?this.fromDecimal(e):typeof e=="number"?this.fromNumber(e):this.fromString(e)}return Object.defineProperty(o.prototype,"m",{get:function(){return this.mantissa},set:function(e){this.mantissa=e},enumerable:!1,configurable:!0}),Object.defineProperty(o.prototype,"e",{get:function(){return this.exponent},set:function(e){this.exponent=e},enumerable:!1,configurable:!0}),Object.defineProperty(o.prototype,"s",{get:function(){return this.sign()},set:function(e){if(e===0)return this.e=0,void(this.m=0);this.sgn()!==e&&(this.m=-this.m)},enumerable:!1,configurable:!0}),o.fromMantissaExponent=function(e,t){return new o().fromMantissaExponent(e,t)},o.fromMantissaExponent_noNormalize=function(e,t){return new o().fromMantissaExponent_noNormalize(e,t)},o.fromDecimal=function(e){return new o().fromDecimal(e)},o.fromNumber=function(e){return new o().fromNumber(e)},o.fromString=function(e){return new o().fromString(e)},o.fromValue=function(e){return new o().fromValue(e)},o.fromValue_noAlloc=function(e){return e instanceof o?e:new o(e)},o.abs=function(e){return f(e).abs()},o.neg=function(e){return f(e).neg()},o.negate=function(e){return f(e).neg()},o.negated=function(e){return f(e).neg()},o.sign=function(e){return f(e).sign()},o.sgn=function(e){return f(e).sign()},o.round=function(e){return f(e).round()},o.floor=function(e){return f(e).floor()},o.ceil=function(e){return f(e).ceil()},o.trunc=function(e){return f(e).trunc()},o.add=function(e,t){return f(e).add(t)},o.plus=function(e,t){return f(e).add(t)},o.sub=function(e,t){return f(e).sub(t)},o.subtract=function(e,t){return f(e).sub(t)},o.minus=function(e,t){return f(e).sub(t)},o.mul=function(e,t){return f(e).mul(t)},o.multiply=function(e,t){return f(e).mul(t)},o.times=function(e,t){return f(e).mul(t)},o.div=function(e,t){return f(e).div(t)},o.divide=function(e,t){return f(e).div(t)},o.recip=function(e){return f(e).recip()},o.reciprocal=function(e){return f(e).recip()},o.reciprocate=function(e){return f(e).reciprocate()},o.cmp=function(e,t){return f(e).cmp(t)},o.compare=function(e,t){return f(e).cmp(t)},o.eq=function(e,t){return f(e).eq(t)},o.equals=function(e,t){return f(e).eq(t)},o.neq=function(e,t){return f(e).neq(t)},o.notEquals=function(e,t){return f(e).notEquals(t)},o.lt=function(e,t){return f(e).lt(t)},o.lte=function(e,t){return f(e).lte(t)},o.gt=function(e,t){return f(e).gt(t)},o.gte=function(e,t){return f(e).gte(t)},o.max=function(e,t){return f(e).max(t)},o.min=function(e,t){return f(e).min(t)},o.clamp=function(e,t,a){return f(e).clamp(t,a)},o.clampMin=function(e,t){return f(e).clampMin(t)},o.clampMax=function(e,t){return f(e).clampMax(t)},o.cmp_tolerance=function(e,t,a){return f(e).cmp_tolerance(t,a)},o.compare_tolerance=function(e,t,a){return f(e).cmp_tolerance(t,a)},o.eq_tolerance=function(e,t,a){return f(e).eq_tolerance(t,a)},o.equals_tolerance=function(e,t,a){return f(e).eq_tolerance(t,a)},o.neq_tolerance=function(e,t,a){return f(e).neq_tolerance(t,a)},o.notEquals_tolerance=function(e,t,a){return f(e).notEquals_tolerance(t,a)},o.lt_tolerance=function(e,t,a){return f(e).lt_tolerance(t,a)},o.lte_tolerance=function(e,t,a){return f(e).lte_tolerance(t,a)},o.gt_tolerance=function(e,t,a){return f(e).gt_tolerance(t,a)},o.gte_tolerance=function(e,t,a){return f(e).gte_tolerance(t,a)},o.log10=function(e){return f(e).log10()},o.absLog10=function(e){return f(e).absLog10()},o.pLog10=function(e){return f(e).pLog10()},o.log=function(e,t){return f(e).log(t)},o.log2=function(e){return f(e).log2()},o.ln=function(e){return f(e).ln()},o.logarithm=function(e,t){return f(e).logarithm(t)},o.pow10=function(e){return Number.isInteger(e)?ue(1,e):Z(Math.pow(10,e%1),Math.trunc(e))},o.pow=function(e,t){return typeof e=="number"&&e===10&&typeof t=="number"&&Number.isInteger(t)?ue(1,t):f(e).pow(t)},o.exp=function(e){return f(e).exp()},o.sqr=function(e){return f(e).sqr()},o.sqrt=function(e){return f(e).sqrt()},o.cube=function(e){return f(e).cube()},o.cbrt=function(e){return f(e).cbrt()},o.dp=function(e){return f(e).dp()},o.decimalPlaces=function(e){return f(e).dp()},o.affordGeometricSeries=function(e,t,a,n){return xa(f(e),f(t),f(a),n)},o.sumGeometricSeries=function(e,t,a,n){return Ta(e,f(t),f(a),n)},o.affordArithmeticSeries=function(e,t,a,n){return(function(i,r,s,l){var u=r.add(l.mul(s)).sub(s.div(2)),d=u.pow(2);return u.neg().add(d.add(s.mul(i).mul(2)).sqrt()).div(s).floor()})(f(e),f(t),f(a),f(n))},o.sumArithmeticSeries=function(e,t,a,n){return(function(i,r,s,l){var u=r.add(l.mul(s));return i.div(2).mul(u.mul(2).plus(i.sub(1).mul(s)))})(f(e),f(t),f(a),f(n))},o.efficiencyOfPurchase=function(e,t,a){return(function(n,i,r){return n.div(i).add(n.div(r))})(f(e),f(t),f(a))},o.randomDecimalForTesting=function(e){if(20*Math.random()<1)return ue(0,0);var t=10*Math.random();10*Math.random()<1&&(t=Math.round(t)),t*=Math.sign(2*Math.random()-1);var a=Math.floor(Math.random()*e*2)-e;return Z(t,a)},o.prototype.normalize=function(){if(this.m>=1&&this.m<10)return this;if(this.m===0)return this.m=0,this.e=0,this;var e=Math.floor(Math.log10(Math.abs(this.m)));return this.m=e===-324?10*this.m/1e-323:this.m/et(e),this.e+=e,this},o.prototype.fromMantissaExponent=function(e,t){return isFinite(e)&&isFinite(t)?(this.m=e,this.e=t,this.normalize(),this):(e=Number.NaN,t=Number.NaN,this)},o.prototype.fromMantissaExponent_noNormalize=function(e,t){return this.m=e,this.e=t,this},o.prototype.fromDecimal=function(e){return this.m=e.m,this.e=e.e,this},o.prototype.fromNumber=function(e){return isNaN(e)?(this.m=Number.NaN,this.e=Number.NaN):e===Number.POSITIVE_INFINITY?(this.m=1,this.e=te):e===Number.NEGATIVE_INFINITY?(this.m=-1,this.e=te):e===0?(this.m=0,this.e=0):(this.e=Math.floor(Math.log10(Math.abs(e))),this.m=this.e===-324?10*e/1e-323:e/et(this.e),this.normalize()),this},o.prototype.fromString=function(e){if(e.indexOf("e")!==-1){var t=e.split("e");this.m=parseFloat(t[0]),this.e=parseFloat(t[1]),this.normalize()}else if(e==="NaN")this.m=Number.NaN,this.e=Number.NaN;else if(this.fromNumber(parseFloat(e)),isNaN(this.m))throw Error("[DecimalError] Invalid argument: "+e);return this},o.prototype.fromValue=function(e){return e instanceof o?this.fromDecimal(e):typeof e=="number"?this.fromNumber(e):typeof e=="string"?this.fromString(e):(this.m=0,this.e=0,this)},o.prototype.toNumber=function(){if(!isFinite(this.e))return Number.NaN;if(this.e>308)return this.m>0?Number.POSITIVE_INFINITY:Number.NEGATIVE_INFINITY;if(this.e<-324)return 0;if(this.e===-324)return this.m>0?5e-324:-5e-324;var e=this.m*et(this.e);if(!isFinite(e)||this.e<0)return e;var t=Math.round(e);return Math.abs(t-e)<1e-10?t:e},o.prototype.mantissaWithDecimalPlaces=function(e){if(isNaN(this.m)||isNaN(this.e))return Number.NaN;if(this.m===0)return 0;var t=e+1,a=Math.ceil(Math.log10(Math.abs(this.m))),n=Math.round(this.m*Math.pow(10,t-a))*Math.pow(10,a-t);return parseFloat(n.toFixed(Math.max(t-a,0)))},o.prototype.toString=function(){return isNaN(this.m)||isNaN(this.e)?"NaN":this.e>=te?this.m>0?"Infinity":"-Infinity":this.e<=-te||this.m===0?"0":this.e<21&&this.e>-7?this.toNumber().toString():this.m+"e"+(this.e>=0?"+":"")+this.e},o.prototype.toExponential=function(e){if(isNaN(this.m)||isNaN(this.e))return"NaN";if(this.e>=te)return this.m>0?"Infinity":"-Infinity";if(this.e<=-te||this.m===0)return"0"+(e>0?(0,tt.default)(".",e+1,"0"):"")+"e+0";if(this.e>-324&&this.e<308)return this.toNumber().toExponential(e);isFinite(e)||(e=17);var t=e+1,a=Math.max(1,Math.ceil(Math.log10(Math.abs(this.m))));return(Math.round(this.m*Math.pow(10,t-a))*Math.pow(10,a-t)).toFixed(Math.max(t-a,0))+"e"+(this.e>=0?"+":"")+this.e},o.prototype.toFixed=function(e){return isNaN(this.m)||isNaN(this.e)?"NaN":this.e>=te?this.m>0?"Infinity":"-Infinity":this.e<=-te||this.m===0?"0"+(e>0?(0,tt.default)(".",e+1,"0"):""):this.e>=17?this.m.toString().replace(".","").padEnd(this.e+1,"0")+(e>0?(0,tt.default)(".",e+1,"0"):""):this.toNumber().toFixed(e)},o.prototype.toPrecision=function(e){return this.e<=-7?this.toExponential(e-1):e>this.e?this.toFixed(e-this.e-1):this.toExponential(e-1)},o.prototype.valueOf=function(){return this.toString()},o.prototype.toJSON=function(){return this.toString()},o.prototype.toStringWithDecimalPlaces=function(e){return this.toExponential(e)},o.prototype.abs=function(){return ue(Math.abs(this.m),this.e)},o.prototype.neg=function(){return ue(-this.m,this.e)},o.prototype.negate=function(){return this.neg()},o.prototype.negated=function(){return this.neg()},o.prototype.sign=function(){return Math.sign(this.m)},o.prototype.sgn=function(){return this.sign()},o.prototype.round=function(){return this.e<-1?new o(0):this.e<17?new o(Math.round(this.toNumber())):this},o.prototype.floor=function(){return this.e<-1?Math.sign(this.m)>=0?new o(0):new o(-1):this.e<17?new o(Math.floor(this.toNumber())):this},o.prototype.ceil=function(){return this.e<-1?Math.sign(this.m)>0?new o(1):new o(0):this.e<17?new o(Math.ceil(this.toNumber())):this},o.prototype.trunc=function(){return this.e<0?new o(0):this.e<17?new o(Math.trunc(this.toNumber())):this},o.prototype.add=function(e){var t,a,n=f(e);if(this.m===0)return n;if(n.m===0)return this;if(this.e>=n.e?(t=this,a=n):(t=n,a=this),t.e-a.e>17)return t;var i=Math.round(1e14*t.m+1e14*a.m*et(a.e-t.e));return Z(i,t.e-14)},o.prototype.plus=function(e){return this.add(e)},o.prototype.sub=function(e){return this.add(f(e).neg())},o.prototype.subtract=function(e){return this.sub(e)},o.prototype.minus=function(e){return this.sub(e)},o.prototype.mul=function(e){if(typeof e=="number")return e<1e307&&e>-1e307?Z(this.m*e,this.e):Z(1e-307*this.m*e,this.e+307);var t=typeof e=="string"?new o(e):e;return Z(this.m*t.m,this.e+t.e)},o.prototype.multiply=function(e){return this.mul(e)},o.prototype.times=function(e){return this.mul(e)},o.prototype.div=function(e){return this.mul(f(e).recip())},o.prototype.divide=function(e){return this.div(e)},o.prototype.divideBy=function(e){return this.div(e)},o.prototype.dividedBy=function(e){return this.div(e)},o.prototype.recip=function(){return Z(1/this.m,-this.e)},o.prototype.reciprocal=function(){return this.recip()},o.prototype.reciprocate=function(){return this.recip()},o.prototype.cmp=function(e){var t=f(e);if(this.m===0){if(t.m===0)return 0;if(t.m<0)return 1;if(t.m>0)return-1}if(t.m===0){if(this.m<0)return-1;if(this.m>0)return 1}if(this.m>0)return t.m<0||this.e>t.e?1:this.e<t.e?-1:this.m>t.m?1:this.m<t.m?-1:0;if(this.m<0)return t.m>0||this.e>t.e?-1:this.e<t.e||this.m>t.m?1:this.m<t.m?-1:0;throw Error("Unreachable code")},o.prototype.compare=function(e){return this.cmp(e)},o.prototype.eq=function(e){var t=f(e);return this.e===t.e&&this.m===t.m},o.prototype.equals=function(e){return this.eq(e)},o.prototype.neq=function(e){return!this.eq(e)},o.prototype.notEquals=function(e){return this.neq(e)},o.prototype.lt=function(e){var t=f(e);return this.m===0?t.m>0:t.m===0?this.m<=0:this.e===t.e?this.m<t.m:this.m>0?t.m>0&&this.e<t.e:t.m>0||this.e>t.e},o.prototype.lte=function(e){return!this.gt(e)},o.prototype.gt=function(e){var t=f(e);return this.m===0?t.m<0:t.m===0?this.m>0:this.e===t.e?this.m>t.m:this.m>0?t.m<0||this.e>t.e:t.m<0&&this.e<t.e},o.prototype.gte=function(e){return!this.lt(e)},o.prototype.max=function(e){var t=f(e);return this.lt(t)?t:this},o.prototype.min=function(e){var t=f(e);return this.gt(t)?t:this},o.prototype.clamp=function(e,t){return this.max(e).min(t)},o.prototype.clampMin=function(e){return this.max(e)},o.prototype.clampMax=function(e){return this.min(e)},o.prototype.cmp_tolerance=function(e,t){var a=f(e);return this.eq_tolerance(a,t)?0:this.cmp(a)},o.prototype.compare_tolerance=function(e,t){return this.cmp_tolerance(e,t)},o.prototype.eq_tolerance=function(e,t){var a=f(e);return o.lte(this.sub(a).abs(),o.max(this.abs(),a.abs()).mul(t))},o.prototype.equals_tolerance=function(e,t){return this.eq_tolerance(e,t)},o.prototype.neq_tolerance=function(e,t){return!this.eq_tolerance(e,t)},o.prototype.notEquals_tolerance=function(e,t){return this.neq_tolerance(e,t)},o.prototype.lt_tolerance=function(e,t){var a=f(e);return!this.eq_tolerance(a,t)&&this.lt(a)},o.prototype.lte_tolerance=function(e,t){var a=f(e);return this.eq_tolerance(a,t)||this.lt(a)},o.prototype.gt_tolerance=function(e,t){var a=f(e);return!this.eq_tolerance(a,t)&&this.gt(a)},o.prototype.gte_tolerance=function(e,t){var a=f(e);return this.eq_tolerance(a,t)||this.gt(a)},o.prototype.log10=function(){return this.e+Math.log10(this.m)},o.prototype.absLog10=function(){return this.e+Math.log10(Math.abs(this.m))},o.prototype.pLog10=function(){return this.m<=0||this.e<0?0:this.log10()},o.prototype.log=function(e){return Math.LN10/Math.log(e)*this.log10()},o.prototype.log2=function(){return 3.321928094887362*this.log10()},o.prototype.ln=function(){return 2.302585092994045*this.log10()},o.prototype.logarithm=function(e){return this.log(e)},o.prototype.pow=function(e){var t,a=e instanceof o?e.toNumber():e,n=this.e*a;if(Number.isSafeInteger(n)&&(t=Math.pow(this.m,a),isFinite(t)&&t!==0))return Z(t,n);var i=Math.trunc(n),r=n-i;if(t=Math.pow(10,a*Math.log10(this.m)+r),isFinite(t)&&t!==0)return Z(t,i);var s=o.pow10(a*this.absLog10());return this.sign()===-1?Math.abs(a%2)===1?s.neg():Math.abs(a%2)===0?s:new o(Number.NaN):s},o.prototype.pow_base=function(e){return f(e).pow(this)},o.prototype.factorial=function(){var e=this.toNumber()+1;return o.pow(e/Math.E*Math.sqrt(e*Math.sinh(1/e)+1/(810*Math.pow(e,6))),e).mul(Math.sqrt(2*Math.PI/e))},o.prototype.exp=function(){var e=this.toNumber();return-706<e&&e<709?o.fromNumber(Math.exp(e)):o.pow(Math.E,e)},o.prototype.sqr=function(){return Z(Math.pow(this.m,2),2*this.e)},o.prototype.sqrt=function(){return this.m<0?new o(Number.NaN):this.e%2!=0?Z(3.16227766016838*Math.sqrt(this.m),Math.floor(this.e/2)):Z(Math.sqrt(this.m),Math.floor(this.e/2))},o.prototype.cube=function(){return Z(Math.pow(this.m,3),3*this.e)},o.prototype.cbrt=function(){var e=1,t=this.m;t<0&&(e=-1,t=-t);var a=e*Math.pow(t,1/3),n=this.e%3;return Z(n===1||n===-1?2.154434690031883*a:n!==0?4.641588833612778*a:a,Math.floor(this.e/3))},o.prototype.sinh=function(){return this.exp().sub(this.negate().exp()).div(2)},o.prototype.cosh=function(){return this.exp().add(this.negate().exp()).div(2)},o.prototype.tanh=function(){return this.sinh().div(this.cosh())},o.prototype.asinh=function(){return o.ln(this.add(this.sqr().add(1).sqrt()))},o.prototype.acosh=function(){return o.ln(this.add(this.sqr().sub(1).sqrt()))},o.prototype.atanh=function(){return this.abs().gte(1)?Number.NaN:o.ln(this.add(1).div(new o(1).sub(this)))/2},o.prototype.ascensionPenalty=function(e){return e===0?this:this.pow(Math.pow(10,-e))},o.prototype.egg=function(){return this.add(9)},o.prototype.lessThanOrEqualTo=function(e){return this.cmp(e)<1},o.prototype.lessThan=function(e){return this.cmp(e)<0},o.prototype.greaterThanOrEqualTo=function(e){return this.cmp(e)>-1},o.prototype.greaterThan=function(e){return this.cmp(e)>0},o.prototype.decimalPlaces=function(){return this.dp()},o.prototype.dp=function(){if(!isFinite(this.mantissa))return NaN;if(this.exponent>=17)return 0;for(var e=this.mantissa,t=-this.exponent,a=1;Math.abs(Math.round(e*a)/a-e)>1e-10;)a*=10,t++;return t>0?t:0},Object.defineProperty(o,"MAX_VALUE",{get:function(){return ka},enumerable:!1,configurable:!0}),Object.defineProperty(o,"MIN_VALUE",{get:function(){return Ha},enumerable:!1,configurable:!0}),Object.defineProperty(o,"NUMBER_MAX_VALUE",{get:function(){return Da},enumerable:!1,configurable:!0}),Object.defineProperty(o,"NUMBER_MIN_VALUE",{get:function(){return La},enumerable:!1,configurable:!0}),o})(),ka=ue(1,te),Ha=ue(1,-te),Da=f(Number.MAX_VALUE),La=f(Number.MIN_VALUE),le=se;var at=class{constructor(){this.timerDisplay=null;this.timerHeader=null;this.timerContent=null;this.isMinimized=!1;this.isDragging=!1;this.isResizing=!1;this.dragOffset={x:0,y:0};this.resizeStart={width:0,height:0,x:0,y:0};this.timestamps=[];this.quarksHistory=[];this.goldenQuarksHistory=[];this.startTime=0;this.currentSingularityStart=0;this.currentPhaseStart=0;this._currentPhaseName="";this.phaseHistory=new Map;this.currentSingularityPhases=new Map;this.lastRecordedPhaseName=null;this.liveTimerInterval=null;this.currentLiveTime=0;this.singularityBundles=[];this.previousQuarks=0;this.previousGoldenQuarks=0;this.exportButton=null;this.dynamicContent=null;this.createTimerDisplay(),this.setupDragAndResize()}setCurrentPhase(e){this._currentPhaseName=e,this.updateDisplay()}getCurrentPhase(){return this._currentPhaseName}createTimerDisplay(){this.timerDisplay=document.createElement("div"),this.timerDisplay.id="hs-autosing-timer-display",this.timerDisplay.style.cssText=`
        position: fixed;
        top: 10px;
        right: 10px;
        background: rgba(0, 0, 0, 0.9);
...
`;let u=g.hashCode(`${i}${l}${e}`);if(this.#r!==u)this.#a.appendChild(n);else{let p=this.#a.querySelector("div:last-child");if(p)try{let m=p.innerHTML.match(/\(x(\d+)\)/);if(m){let h=m[0],A=parseInt(m[1],10);p.innerHTML=p.innerHTML.replace(h,`(x${A+1})`)}else p.innerHTML+=" (x2)"}catch(m){console.log(m)}}let d=this.#a.querySelectorAll(".hs-ui-log-line");if(d&&d.length>b.HSLogger.logSize){let p=this.#a.querySelector(".hs-ui-log-line:first-child");p&&p.parentElement?.removeChild(p)}o.scrollToBottom(),this.#r=u}}static#l(e,t){let a=b.HSLogger.logLevel;if(a===1||t)return!0;if(a===6)return!1;switch(e){case 1:return a===4||a===5;case 2:return a===2||a===8;case 3:return a===2||a===3;case 4:return a===7||a===5;case 5:return!1}}static scrollToBottom(){this.#t&&this.#a&&(this.#a.scrollTop=this.#a.scrollHeight)}static log(e,t="HSMain",a=!1){this.#l(1,a)&&(console.log(`[${t}]: ${g.removeColorTags(e)}`),this.#s(e,t,1))}static info(e,t="HSMain",a=!1){this.#l(4,a)&&(console.log(`[${t}]: ${g.removeColorTags(e)}`),this.#s(e,t,4))}static warn(e,t="HSMain",a=!1){this.#l(2,a)&&(console.warn(`[${t}]: ${g.removeColorTags(e)}`),this.#s(e,t,2))}static error(e,t="HSMain",a=!1){this.#l(3,a)&&(console.error(`[${t}]: ${g.removeColorTags(e)}`),this.#s(e,t,3))}static debug(e,t="HSMain",a=!1){let n=I.getSetting("showDebugLogs");n&&n.getValue()&&(console.log(`DBG [${t}]: ${g.removeColorTags(e)}`),this.#s(e,t,5))}static clear(){this.#t&&(this.#a.innerHTML="",o.log("Log cleared",this.#e))}static logOnce(e,t){!this.#n.has(t)||!this.#n.get(t)?.logged?(this.#n.set(t,{logged:!0,timestamp:Date.now(),level:1,count:0}),this.log(e,"Once",!0)):this.#n.get(t).count++,this.#u()}static warnOnce(e,t){!this.#n.has(t)||!this.#n.get(t)?.logged?(this.#n.set(t,{logged:!0,timestamp:Date.now(),level:2,count:0}),this.warn(e,"Once",!0)):this.#n.get(t).count++,this.#u()}static errorOnce(e,t){!this.#n.has(t)||!this.#n.get(t)?.logged?(this.#n.set(t,{logged:!0,timestamp:Date.now(),level:3,count:0}),this.error(e,"Once",!0)):this.#n.get(t).count++,this.#u()}static#u(){}static setTimestampDisplay(e){e?this.#i=!0:this.#i=!1;let t=this.#a.querySelectorAll(".hs-ui-log-line");if(t)for(let a of Array.from(t)){let n=a.querySelector(".hs-log-ts");n&&(e?n.classList.remove("hs-log-ts-hidden"):n.classList.add("hs-log-ts-hidden"))}}};var Wt="data:image/png;base64,";var Zt="data:image/png;base64,";var jt=` #hs-ambrosia-quick-loadout-container {
 ...
 #hs-add-10-btn {
    border: 2px solid green;
    border-right: none;
 }`;var it=class{#e="HSMain";#t;#a;#r;constructor(e){this.#t=new D("HSModuleManager",e)}async preprocessModules(){await this.#t.preprocessModules()}async init(){c.log("Initialising Hypersynergism modules",this.#e),await this.#t.initModules(),c.log("Building UI Panel",this.#e),this.#i(),c.log("Injecting style overrides",this.#e),this.#n(),await I.syncSettings(),await y.Notify(`Hypersynergism v${b.General.currentModVersion} loaded`,{position:"top",notificationType:"success"}),this.#a=setInterval(async()=>{let e=await ge.getLatestRelease();e&&c.debug(`Latest release: ${e.name} (${e.version})`,this.#e)},b.PrivateAPI.checkIntervalMs)}#i(){let e=D.getModule("HSUI");e&&(e.updateTitle(`Hypersynergism v${b.General.currentModVersion}`),this.#o(e),this.#s(e),this.#l(e),e.renameTab(2,"Tools"),e.renameTab(3,"Settings"),e.renameTab(4,"Debug"))}#n(){y.injectStyle(jt,"hs-override-css")}#o(e){let t=he.getCalculationDefinitions({toolingSupport:"true"}).map(s=>({text:s.supportsReduce?`${s.calculationName} (C)`:s.calculationName,value:s.supportsReduce?`${s.fnName}|c`:s.fnName}));e.replaceTabContents(2,H.Grid({html:[H.Div({html:"Export tools",styles:{borderBottom:"1px solid limegreen",gridColumn:"span 2"}}),H.Div({id:"hs-panel-amb-heater-p",html:`Export an extended save file string for the <a href="${b.General.heaterUrl}" class="hs-link" target="_blank">Ambrosia Heater.</a>`,styles:{gridColumn:"span 2"}}),H.Button({id:"hs-panel-amb-heater-btn",text:"Ambrosia heater"}),H.Div({html:"References",styles:{borderBottom:"1px solid limegreen",gridColumn:"span 2"}}),H.Button({id:"hs-panel-cor-ref-btn",text:"Corruption Ref."}),H.Button({id:"hs-panel-cor-ref-btn-2",text:"Crpt. Onemind"}),H.Div({html:"Mod links",styles:{borderBottom:"1px solid limegreen",gridColumn:"span 2"}}),H.Button({id:"hs-panel-mod-github-btn",text:"Mod Github"}),H.Button({id:"hs-panel-mod-wiki-btn",text:"Mod Wiki"}),H.Button({id:"hs-panel-mod-wiki_features-btn",text:"Mod Features"}),H.Button({id:"hs-panel-mod-website-btn",text:"Mod Website"}),H.Div({html:"Other tools",styles:{borderBottom:"1px solid limegreen",gridColumn:"span 2"}}),H.Button({id:"hs-panel-dump-settings-btn",text:"Dump Settings"}),H.Button({id:"hs-panel-dump-gamedata-btn",text:"Dump Game vars"}),H.Button({id:"hs-panel-clear-settings-btn",text:"CLEAR SETTINGS",styles:{borderColor:"red"}}),H.Button({id:"hs-panel-check-version-btn",text:"CHECK VERSION"}),H.Div({html:"Testing tools",styles:{borderBottom:"1px solid limegreen",gridColumn:"span 2"}}),H.Button({id:"hs-panel-test-notify-btn",text:"Notify test"}),H.Button({id:"hs-panel-test-notify-long-btn",text:"Notify test 2"}),H.Div({html:"Calculation tools",styles:{borderBottom:"1px solid limegreen",gridColumn:"span 2"}}),H.Div({id:"hs-panel-calc-tools-p",html:`Execute supported calculations and see their results. Calculations denoted with "(C)" support "calculating by components",
                        meaning that the calculation results can be output as an array of components that make up the calculations.<br><br>
                        Note that calculating by components always clears the calculation cache first.`,styles:{gridColumn:"span 2",fontSize:"10pt"}}),H.Select({class:"hs-panel-setting-block-select-input",id:"hs-panel-test-calc-sel",type:4,styles:{gridColumn:"span 2"}},t),H.Button({id:"hs-panel-test-calc-redu-btn",text:"Calculate reduced",styles:{width:"auto"}}),H.Button({id:"hs-panel-test-calc-comps-btn",text:"Calculate components",styles:{width:"auto"}}),H.Button({id:"hs-panel-test-calc-cache-clear-btn",text:"Clear cache"}),H.Button({id:"hs-panel-test-calc-cache-dump-btn",text:"Dump cache"}),H.Div({id:"hs-panel-test-calc-latest",styles:{gridColumn:"span 2"}})],styles:{gridTemplateColumns:"repeat(2, 1fr)",gridTemplateRows:"1fr",columnGap:"5px",rowGap:"10px",padding:"5px"}})),document.querySelector("#hs-panel-amb-heater-btn")?.addEventListener("click",async()=>{let s=D.getModule("HSGameDataAPI");if(s){let l=await s.dumpDataForHeater();if(l){let u=JSON.stringify(l),d=btoa(u),p=g.base64WithCRLF(d);await navigator.clipboard.writeText(p),y.Notify("Ambrosia heater data copied to clipboard",{position:"top",notificationType:"success"})}}}),document.querySelector("#hs-panel-cor-ref-btn")?.addEventListener("click",()=>{e.Modal({htmlContent:`<img class="hs-modal-img" src="${Wt}" />`,needsToLoad:!0})}),document.querySelector("#hs-panel-cor-ref-btn-2")?.addEventListener("click",()=>{e.Modal({htmlContent:`<img class="hs-modal-img" src="${Zt}" />`,needsToLoad:!0})}),document.querySelector("#hs-panel-mod-github-btn")?.addEventListener("click",()=>{window.open(b.General.modGithubUrl,"_blank")}),document.querySelector("#hs-panel-mod-wiki-btn")?.addEventListener("click",()=>{window.open(b.General.modWikiUrl,"_blank")}),document.querySelector("#hs-panel-mod-wiki_features-btn")?.addEventListener("click",()=>{window.open(b.General.modWikiFeaturesUrl,"_blank")}),document.querySelector("#hs-panel-mod-website-btn")?.addEventListener("click",()=>{window.open(b.General.modWebsiteUrl,"_blank")}),document.querySelector("#hs-panel-dump-settings-btn")?.addEventListener("click",()=>{I.dumpToConsole()}),document.querySelector("#hs-panel-dump-gamedata-btn")?.addEventListener("click",()=>{let s=D.getModule("HSGameDataAPI");s&&(console.log("----- GAME DATA -----"),console.log(s.getGameData()),console.log("----- PSEUDO DATA -----"),console.log(s.getPseudoData()),console.log("----- CAMPAIGN DATA -----"),console.log(s.getCampaignData()),console.log("----- ME DATA -----"),console.log(s.getMeData()),console.log("----- EVENT DATA -----"),console.log(s.getEventData()))}),document.querySelector("#hs-panel-clear-settings-btn")?.addEventListener("click",()=>{let s=D.getModule("HSStorage");s&&(s.clearData(b.HSSettings.storageKey),c.info("Stored settings cleared",this.#e))}),document.querySelector("#hs-panel-check-version-btn")?.addEventListener("click",async()=>{await g.isLatestVersion()?y.Notify("You are using the latest version of Hypersynergism!",{position:"top",notificationType:"success"}):y.Notify("You are not using the latest version of Hypersynergism!",{position:"top",notificationType:"warning"})}),document.querySelector("#hs-panel-test-calc-redu-btn")?.addEventListener("click",()=>{let s=D.getModule("HSGameDataAPI"),l=document.querySelector("#hs-panel-test-calc-sel");if(s&&l){let u=l.value.split("|")[0];if(typeof s[u]=="function"){let d=s[u]();console.log(`--- CALCULATED ${u} ---`),console.log(d);let p=document.querySelector("#hs-panel-test-calc-latest");p&&(p.innerText=`Last calc result: ${g.N(d)}`)}else c.warn(`${u} is not a function`,this.#e)}else c.warn("dataModule or calculation select was null",this.#e)}),document.querySelector("#hs-panel-test-calc-comps-btn")?.addEventListener("click",()=>{let s=D.getModule("HSGameDataAPI"),l=document.querySelector("#hs-panel-test-calc-sel");if(s&&l){let u=l.value.split("|"),d=u[0],p=u.includes("c");if(typeof s[d]=="function")if(p){s.clearCache();let m=s[d](!1),h=document.querySelector("#hs-panel-test-calc-latest");h&&(h.innerText=`Last calc result: [${m.toString().split(",").join(", ")}]`),console.log(`--- CALCULATED ${d} ---`),console.log(m)}else c.warn(`${d} cannot be calculated by components`,this.#e);else c.warn(`${d} is not a function`,this.#e)}else c.warn("dataModule or calculation select was null",this.#e)}),document.querySelector("#hs-panel-test-calc-cache-clear-btn")?.addEventListener("click",()=>{let s=D.getModule("HSGameDataAPI");s&&(c.info("Cleared calculation cache",this.#e),s.clearCache())}),document.querySelector("#hs-panel-test-calc-cache-dump-btn")?.addEventListener("click",()=>{let s=D.getModule("HSGameDataAPI");s&&(c.info("Calculation cache dump",this.#e),s.dumpCache())});let a=["topLeft","top","topRight","right","bottomRight","bottom","bottomLeft","left"],n=["default","warning","error","success"],i=-1,r=-1;document.querySelector("#hs-panel-test-notify-btn")?.addEventListener("click",async()=>{i++,r++,i>a.length-1&&(i=0),r>n.length-1&&(r=0),await y.Notify("Test notification",{position:a[i],notificationType:n[r]})}),document.querySelector("#hs-panel-test-notify-long-btn")?.addEventListener("click",async()=>{i++,r++,i>a.length-1&&(i=0),r>n.length-1&&(r=0),await y.Notify("This is a really very extremely long test notification which tests if the notification works with a long notification test notification ",{position:a[i],notificationType:n[r]})})}#s(e){let t=I.autoBuildSettingsUI();t.didBuild&&(e.replaceTabContents(3,[t.navHTML,t.pagesHTML].join("")),document.delegateEventListener("click",".hs-panel-setting-block-gamedata-icon",a=>{let n=document.querySelector("#hs-panel-settings-subtab-gamedata"),i=n.dataset.color,r=document.querySelector("#settings-grid-gamedata"),s=document.querySelectorAll(".hs-panel-settings-grid"),l=document.querySelectorAll(".hs-panel-subtab");n&&r&&s&&l&&(s.forEach(d=>{d.classList.remove("open")}),l.forEach(d=>{d.style.backgroundColor=""}),r.classList.add("open"),i&&i.length>0&&(n.style.backgroundColor=i)),document.querySelector("#hs-setting-block-gamedata").scrollIntoView({block:"start",behavior:"smooth"})}),document.delegateEventListener("click",".hs-panel-subtab",a=>{let n=a.target,i=n.dataset.subtab,r=n.dataset.color;if(i){let s=`#settings-grid-${i}`,l=document.querySelector(s),u=document.querySelectorAll(".hs-panel-settings-grid"),d=document.querySelectorAll(".hs-panel-subtab");l&&u&&d&&(u.forEach(p=>{p.classList.remove("open")}),d.forEach(p=>{p.style.backgroundColor=""}),l.classList.add("open"),r&&r.length>0&&(n.style.backgroundColor=r))}}))}#l(e){e.replaceTabContents(4,H.Grid({html:[H.Div({html:"Mouse",styles:{borderBottom:"1px solid limegreen",gridColumn:"span 2"}}),H.Div({id:"hs-panel-debug-mousepos"}),H.Div({html:"Game Data",styles:{borderBottom:"1px solid limegreen",gridColumn:"span 2"}}),H.Div({id:"hs-panel-debug-gamedata-currentambrosia",styles:{gridColumn:"span 2"}})],styles:{gridTemplateColumns:"repeat(2, 1fr)",gridTemplateRows:"1fr",columnGap:"5px",rowGap:"5px"}}))}};(async()=>{let o=[{className:"HSPrototypes",context:"HSPrototypes",moduleColor:"crimson",loadOrder:1,initImmediate:!0},{className:"HSUI",context:"HSUI",moduleColor:"royalblue",loadOrder:2,initImmediate:!0},{className:"HSStorage",context:"HSStorage",moduleColor:"wheat",loadOrder:3,initImmediate:!0},{className:"HSSettings",context:"HSSettings",moduleColor:"slategray",loadOrder:4},{className:"HSDebug",context:"HSDebug",moduleColor:"#ff2020",loadOrder:5,initImmediate:!0},{className:"HSWebSocket",context:"HSWebSocket",moduleColor:"#FC427B",loadOrder:6},{className:"HSShadowDOM",context:"HSShadowDOM",moduleColor:"hotpink"},{className:"HSCodes",context:"HSCodes",moduleColor:"darkgoldenrod"},{className:"HSHepteracts",context:"HSHepteracts",moduleColor:"slateblue"},{className:"HSTalismans",context:"HSTalismans",moduleColor:"cyan"},{className:"HSMouse",context:"HSMouse",moduleColor:"gold"},{className:"HSAmbrosia",context:"HSAmbrosia",moduleColor:"blueviolet"},{className:"HSStats",context:"HSStats",moduleColor:"lawngreen"},{className:"HSGameState",context:"HSGameState",moduleColor:"indianred"},{className:"HSPatches",context:"HSPatches",moduleColor:"#487eb0"},{className:"HSGameData",context:"HSGameData",moduleColor:"#fbc531"},{className:"HSGameDataAPI",context:"HSGameDataAPI",moduleColor:"#fbc531"},{className:"HSAutosing",context:"HSAutosing",moduleColor:"#00ff7f"},{className:"HSQOLButtons",context:"HSQOLButtons",moduleColor:"#c0c0c0"},{className:"Chartist",context:"Chartist",moduleColor:"#e8d7bf",moduleType:2,moduleKind:3,moduleScriptUrl:"https://cdn.jsdelivr.net/npm/chartist@1.3.1/dist/index.umd.min.js",moduleCSSUrl:"https://cdn.jsdelivr.net/npm/chartist@1.3.1/dist/index.min.css",scriptContext:"Chartist"}],e=new it(o);await e.preprocessModules(),window.hypersynergism=e})();})();
