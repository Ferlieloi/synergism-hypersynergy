...
`)}static getCorruptions(e){let t=a=>{let n=document.getElementById(a);return n?parseInt(n.textContent||"0",10):0};return e==="current"?{viscosity:t("corrCurrentviscosity"),drought:t("corrCurrentdrought"),deflation:t("corrCurrentdeflation"),extinction:t("corrCurrentextinction"),illiteracy:t("corrCurrentilliteracy"),recession:t("corrCurrentrecession"),dilation:t("corrCurrentdilation"),hyperchallenge:t("corrCurrenthyperchallenge")}:{viscosity:t("corrNextviscosity"),drought:t("corrNextdrought"),deflation:t("corrNextdeflation"),extinction:t("corrNextextinction"),illiteracy:t("corrNextilliteracy"),recession:t("corrNextrecession"),dilation:t("corrNextdilation"),hyperchallenge:t("corrNexthyperchallenge")}}static isBiggerThan1000(e){let t=e.trim().toLowerCase();if(/[a-df-z]/.test(t))return!0;if(t.includes("e")){let a=t.split("e");return/[a-df-z]/.test(a[1])?!0:parseInt(a[1],10)>=3}return parseFloat(t)>1e3}};var L=class{constructor(e){this.moduleName=e.moduleName,this.context=e.context,this.moduleColor=e.moduleColor,this.moduleType=1,this.isInitialized=!1}getName(){return this.moduleName}setModuleType(e){this.moduleType=e}},Ae=class extends L{#e;#t;#a;#r;constructor(e){super(e),this.setModuleType(2),this.#e=e.moduleKind,this.#t=e.moduleScriptUrl,this.#a=e.moduleCSSUrl,this.#r=e.scriptContext}async#i(){if(!this.#t){c.error(`Could not load script for ext module ${this.moduleName} - script url missing`);return}let e=document.createElement("script");return e.type="text/javascript",e.src=this.#t,document.head.appendChild(e),new Promise((t,a)=>{e.onload=()=>t(),e.onerror=()=>a()})}async#n(){if(!this.#a){c.error(`Could not load CSS for ext module ${this.moduleName} - css url missing`);return}let e=document.createElement("link");return e.rel="stylesheet",e.href=this.#a,document.head.appendChild(e),new Promise((t,a)=>{e.onload=()=>t(),e.onerror=()=>a()})}async init(){if(this.#r in window){c.error(`Could not load ext module ${this.getName} - import conflict in window`);return}switch(this.#e){case 1:await this.#i();break;case 2:await this.#n();break;case 3:await this.#n(),await this.#i();break;default:break}this.isInitialized=!0}};var be=class extends L{#e;#t;#a;#r;#i;constructor(e){super(e),this.#e=document.getElementById("offeringPotionHide"),this.#t=document.getElementById("obtainiumPotionHide"),this.#a={attributes:!1,childList:!0,subtree:!0},this.#r=new MutationObserver((t,a)=>{this.#n(t,a)}),this.#i=new MutationObserver((t,a)=>{this.#o(t,a)})}async init(){c.log("Initialising HSPotions module",this.context),this.observe(),this.isInitialized=!0}observe(){this.#r.observe(this.#e,this.#a),this.#i.observe(this.#t,this.#a)}#n(e,t){if(document.getElementById("offeringPotionMultiUseButton")===null){let n=document.getElementById("useofferingpotion"),o=document.getElementById("buyofferingpotion");if(!n||!o){c.warn("Could not find native buttons for use/buy offering potions",this.context);return}if(n){let i=n.cloneNode(!0);i.id="offeringPotionMultiUseButton",i.textContent="CONSUME 10x",i.addEventListener("click",()=>{for(let r=0;r<10;r++)n.click()}),n.parentNode?.insertBefore(i,n.nextSibling)}if(o){let i=o.cloneNode(!0);i.id="offeringPotionMultiBuyButton",i.textContent="BUY 10x",i.addEventListener("click",()=>{for(let r=0;r<10;r++)o.click(),setTimeout(()=>{document.getElementById("ok_confirm")?.click()},1)}),o.parentNode?.insertBefore(i,o.nextSibling)}this.#r.disconnect(),c.log("Offering potion multi buy / consume buttons injected",this.context)}}#o(e,t){if(document.getElementById("obtainiumPotionMultiUseButton")===null){let n=document.getElementById("useobtainiumpotion"),o=document.getElementById("buyobtainiumpotion");if(!n||!o){c.warn("Could not find native buttons for use/buy obtainium potions",this.context);return}if(n){let i=n.cloneNode(!0);i.id="obtainiumPotionMultiUseButton",i.textContent="CONSUME 10x",i.addEventListener("click",()=>{for(let r=0;r<10;r++)n.click()}),n.parentNode?.insertBefore(i,n.nextSibling)}if(o){let i=o.cloneNode(!0);i.id="obtainiumPotionMultiBuyButton",i.textContent="BUY 10x",i.addEventListener("click",()=>{for(let r=0;r<10;r++)o.click(),setTimeout(()=>{document.getElementById("ok_confirm")?.click()},1)}),o.parentNode?.insertBefore(i,o.nextSibling)}this.#i.disconnect(),c.log("Obtainium potion multi buy / consume buttons injected",this.context)}}};var fe=class extends L{#e;#t;#a;#r;#i="white-space: nowrap; user-select: all; -webkit-user-select: all; -moz-user-select: all; -ms-user-select: all;";constructor(e){super(e),this.#a={attributes:!1,childList:!0,subtree:!0},this.#r=new MutationObserver((t,a)=>{this.#s(t,a)})}async init(){c.log("Initialising HSCodes module",this.context);let e=this;this.#t=await S.HookElement("#promocodes"),this.#t.addEventListener("click",function(t){e.#e=document.querySelector("#promptWrapper > #prompt > label"),e.#e&&(e.#o(),e.#e.innerHTML="",e.#n())},{capture:!0}),this.#e=await S.HookElement("#promptWrapper > #prompt > label"),this.#n(),this.isInitialized=!0}#n(){this.#r?.disconnect(),this.#r?.observe(this.#e,this.#a)}#o(){this.#r?.disconnect()}#s(e,t){let a=this;try{if(this.#o(),this.#e&&this.#e.innerText.includes("synergism2021")){let n=this.#e.innerText;this.#e.innerHTML=`<div id="hs-hijack-codes-wrapper">
...
}`;var lt=`[
    {
        ...
        }`),`<div class="hs-panel-btn ${t}" id="${n}"${o} ${i}>${a}</div>`}static Input(e){let t=e.class??"",a=this.#a(e.type),n=this.#r(e.type),o=e.id??p.domid(),i=this.#i(e.props),r=this.#t(e.data);return y.injectStyle(`#${o} {
            ${p.objectToCSS(e.styles)}
        }`),`<input type="${a}" class="${n} ${t}" id="${o}"${i} ${r}></input>`}static Select(e,t){let a=e.class??"",n=this.#a(e.type),o=this.#r(e.type),i=e.id??p.domid(),r=this.#i(e.props),l=this.#t(e.data);y.injectStyle(`#${i} {
            ${p.objectToCSS(e.styles)}
        }`);let u=t.map(g=>`<option value="${g.value}" ${g.selected?"selected":""}>${g.text}</option>`).join(`
`);return`<select class="${o} ${a}" id="${i}"${r} ${l}>${u}</select>`}static Div(e){let t=e.class??"",a=e.id??p.domid(),n="",o=this.#i(e.props),i=this.#t(e.data);return e.html&&(Array.isArray(e.html)?n=e.html.join(`
...
`):n=e.text),y.injectStyle(`#${a} {
            ${p.objectToCSS(e.styles)}
        }`),`<p class="hs-panel-p ${t}" ${a?`id="${a}"`:""}${o} ${i}>${n}</p>`}static Image(e){let t=e.class??"",a=e.id??p.domid(),n=this.#i(e.props),o=this.#t(e.data);if(!e.src)return c.warn("HSUIC.Image: No src provided for image component",this.#e),"";let i=e.width?e.width:A.HSUIC.defaultImageWidth,r=e.height?e.height:A.HSUIC.defaultImageHeight;return y.injectStyle(`#${a} {
            ${p.objectToCSS(e.styles)}
        }`),`<img src="${e.src}" width="${i}" height="${r}" class="hs-panel-img ${t}" ${a?`id="${a}"`:""}${n} ${o}/>`}static Grid(e){let t=e.class??"",a=e.id??p.domid(),n="",o=this.#i(e.props),i=this.#t(e.data);return e.html&&(Array.isArray(e.html)?n=e.html.join(`
`):n=e.html),y.injectStyle(`#${a} {
            display: grid;
            ${p.objectToCSS(e.styles)}
...
`):n=e.html),y.injectStyle(`#${a} {
            display: flex;
            ${p.objectToCSS(e.styles)}
        }`),`<div class="hs-panel-div ${t}" id="${a}"${o} ${i}>${n}</div>`}static _modal(e){let t=e.class??"",a=e.htmlContent??"",n=e.data??[],o=e.title??"",i=e.id??p.domid(),r=this.#i(e.props),l=this.#t(e.data);return y.injectStyle(`#${i} {
            ${p.objectToCSS(e.styles)}
                ...
                </div>`}};var ut=`.hs-panel-body::-webkit-scrollbar,
...
@-webkit-keyframes hs-animtext-1 {
    ...
    `).join(""),n={htmlContent:`
        ...
        `,title:"Configure Corruption Loadout"},o=await s.Modal(n);setTimeout(()=>{document.getElementById("hs-corruption-save-btn")?.addEventListener("click",()=>{Object.keys(Se).forEach(i=>{let r=document.getElementById(`hs-corruption-${i}`),l=Math.max(0,Math.min(16,Number(r?.value)||0));e[i]=l}),y.removeInjectedStyle("hs-corruption-modal-styles"),s.CloseModal(o)})},0)}async function vt(s,e,t,a){let n="hs-autosing-challenges-modal",o=[...e],i=k=>ie.find(C=>C.value===k)?.label??null,r=k=>k.challengeNumber===200&&k.ifJump!==void 0,l=k=>`${k.toLocaleString()}ms`,u=(k,C)=>`
    ...
    `,d=(k,C)=>{let R=i(k.challengeNumber),B=!!R,H=B?`<strong>${R}</strong>`:`Challenge ${k.challengeNumber}
         (${k.challengeCompletions} completions)`;return`
            ...
            `},m=()=>{let k=[],C=new Map;o.forEach((B,H)=>{if(r(B)){let G=B.ifJump.ifJumpIndex;C.has(G)||C.set(G,[]),C.get(G).push({ifIndex:H,ifId:B.ifJump.id})}}),o.forEach((B,H)=>{C.has(H)&&C.get(H).forEach(G=>{let W=o[G.ifIndex];k.push(g(G.ifIndex,W.ifJump.id))}),r(B)?k.push(u(B,H)):k.push(d(B,H))});let R=o.length;return C.has(R)&&C.get(R).forEach(B=>{let H=o[B.ifIndex];k.push(g(B.ifIndex,H.ifJump.id))}),k.join("")},b=()=>{let k=document.getElementById("hs-challenge-list-container");k&&(k.innerHTML=m(),F(),Q())},h={htmlContent:`
    <div id="${n}" class="hs-challenges-modal-container">
    ...
    </div>`,title:`Configure Strategy Actions (${t}-${a})`},w=await s.Modal(h),E=null,f=null,v=null,M=null,P=!1,U=null,V=(k,C)=>{let R;return function(...B){R||(k.apply(this,B),R=!0,setTimeout(()=>R=!1,C))}},Q=()=>{document.querySelectorAll(".hs-challenge-item").forEach(k=>{let C=k,R=C.dataset.ifId;R&&(C.addEventListener("mouseenter",()=>{document.querySelectorAll(`[data-if-id="${R}"]`).forEach(B=>B.classList.add("hs-jump-highlight"))}),C.addEventListener("mouseleave",()=>{document.querySelectorAll(`[data-if-id="${R}"]`).forEach(B=>B.classList.remove("hs-jump-highlight"))}))})},O=k=>{let C=document.getElementById("hs-challenge-list-container");return C?Array.from(C.querySelectorAll(".hs-challenge-item")).indexOf(k):0},J=k=>{let C=document.getElementById("hs-challenge-list-container");if(!C)return 0;let R=Array.from(C.querySelectorAll(".hs-challenge-item")),B=0;for(let H=0;H<=k&&H<R.length;H++)if(!R[H].dataset.jumpFor){if(H===k)return B;B++}return Math.min(B,o.length)},F=()=>{document.querySelectorAll(".hs-challenge-item").forEach(C=>{let R=C.querySelector(".hs-challenge-drag-handle");R.addEventListener("mousedown",B=>{B.preventDefault();let H=C;if(P=H.dataset.jumpFor!==void 0,P)U=Number(H.dataset.jumpFor),v=null;else if(H.dataset.index!==void 0)v=Number(H.dataset.index),U=null;else return;f=H;let G=H.getBoundingClientRect(),W=B.clientX-G.left,$=B.clientY-G.top;M=H.cloneNode(!0),M.style.opacity="0.3",M.style.pointerEvents="none";let j=H.getBoundingClientRect().width,Gt=H.getBoundingClientRect().height;H.style.position="fixed",H.style.zIndex="1000",H.style.cursor="grabbing",H.style.pointerEvents="none",H.style.width=j+"px",H.style.height=Gt+"px",H.style.boxSizing="border-box",H.style.boxShadow="0 8px 16px rgba(0,0,0,0.3)",H.style.transform="scale(1.03)",H.style.transition="transform 0.15s ease",H.parentNode?.insertBefore(M,H);let ge=(Z,de)=>{f&&(f.style.left=Z-W+"px",f.style.top=de-$+"px")};ge(B.clientX,B.clientY);let $e=V(Z=>{let de=document.getElementById("hs-challenge-list-container");if(de&&(ge(Z.clientX,Z.clientY),f)){f.style.display="none";let tt=document.elementFromPoint(Z.clientX,Z.clientY);if(f.style.display="",!tt)return;let te=tt.closest(".hs-challenge-item"),Nt=de.getBoundingClientRect(),at=Z.clientY>Nt.bottom-5;if(te&&te!==f&&te!==M||at){let nt=O(te),Ut=O(f);if(nt===Ut)return;if(P&&U!==null){let T=at?o.length:J(nt),pe=o[U];if(r(pe)){pe.ifJump.ifJumpIndex=T;let X=document.getElementById("hs-challenge-list-container");if(X){let Ke=X.scrollTop;X.innerHTML=m(),X.scrollTop=Ke;let N=document.querySelector(`[data-jump-for="${U}"]`);N&&(f=N,M=N.cloneNode(!0),M.style.opacity="0.3",M.style.pointerEvents="none",N.style.position="fixed",N.style.zIndex="1000",N.style.cursor="grabbing",N.style.pointerEvents="none",N.style.width=N.offsetWidth+"px",N.style.boxShadow="0 8px 16px rgba(0,0,0,0.3)",N.style.transform="scale(1.03)",N.parentNode?.insertBefore(M,N),ge(Z.clientX,Z.clientY)),F(),Q()}}}else if(v!==null&&te.dataset.index!==void 0){let T=Number(te.dataset.index);if(T!==v){let pe=o[v];o.splice(v,1),o.splice(T,0,pe),v=T;let X=document.getElementById("hs-challenge-list-container");if(X){let Ke=X.scrollTop;X.innerHTML=m(),X.scrollTop=Ke;let N=document.querySelector(`[data-index="${v}"]`);N&&!N.dataset.jumpFor&&(f=N,M=N.cloneNode(!0),M.style.opacity="0.3",M.style.pointerEvents="none",N.style.position="fixed",N.style.zIndex="1000",N.style.cursor="grabbing",N.style.pointerEvents="none",N.style.width=N.offsetWidth+"px",N.style.boxShadow="0 8px 16px rgba(0,0,0,0.3)",N.style.transform="scale(1.03)",N.parentNode?.insertBefore(M,N),ge(Z.clientX,Z.clientY)),F(),Q()}}}}}},16),et=()=>{f&&(f.style.position="",f.style.zIndex="",f.style.cursor="",f.style.pointerEvents="",f.style.width="",f.style.boxShadow="",f.style.transform="",f.style.left="",f.style.top="",f.style.transition=""),M&&M.parentNode&&M.parentNode.removeChild(M),f=null,v=null,P=!1,U=null,M=null,document.removeEventListener("mousemove",$e),document.removeEventListener("mouseup",et),Y()};document.addEventListener("mousemove",$e),document.addEventListener("mouseup",et)}),R.style.cursor="grab"})},z=()=>{let k=document.getElementById("hs-challenge-action-select"),C=!!k?.value,R=Number(k.value)===200;["hs-challenge-num-input","hs-challenge-completions-input","hs-challenge-max-time-input"].forEach(H=>{let G=document.getElementById(H);G&&(G.disabled=C,G.parentElement.style.opacity=C?"0.4":"1",G.parentElement.style.display=R?"none":"")}),document.querySelectorAll(".hs-if-jump-row").forEach(H=>{H.style.display=R?"":"none"})},Y=()=>{document.getElementById("hs-challenge-num-input").value="1",document.getElementById("hs-challenge-completions-input").value="0",document.getElementById("hs-challenge-wait-input").value="0",document.getElementById("hs-challenge-max-time-input").value="1000000",document.getElementById("hs-challenge-action-select").value="",document.getElementById("hs-challenge-add-btn").textContent="Add Action/Challenge",E=null,z()};setTimeout(()=>{let k=document.getElementById(n),C=document.getElementById("hs-challenge-action-select");C?.addEventListener("change",z),F(),Q(),k?.addEventListener("click",R=>{let B=R.target,H=B.id;if(H==="hs-challenge-add-btn"){let G=!!C.value,W=Number(C.value)===200,$;if(W){let j=E!==null?o[E]:null;$={challengeNumber:200,challengeCompletions:0,challengeWaitTime:0,challengeMaxTime:0,ifJump:{id:p.uuidv4(),ifJumpChallenge:Number(document.getElementById("hs-if-jump-challenge").value),ifJumpOperator:document.getElementById("hs-if-jump-operator").value,ifJumpValue:Number(document.getElementById("hs-if-jump-value").value),ifJumpIndex:j?.ifJump?.ifJumpIndex??o.length+1}}}else $={challengeNumber:Number(G?C.value:document.getElementById("hs-challenge-num-input").value),challengeCompletions:G?0:Number(document.getElementById("hs-challenge-completions-input").value),challengeWaitTime:Number(document.getElementById("hs-challenge-wait-input").value),challengeMaxTime:G?0:Number(document.getElementById("hs-challenge-max-time-input").value)};E!==null?o[E]=$:o.push($),b(),Y()}if(H.startsWith("hs-challenge-edit-")){E=Number(B.dataset.index);let G=o[E],W=i(G.challengeNumber);if(r(G)){C.value=String(200),document.getElementById("hs-if-jump-challenge").value=String(G.ifJump?.ifJumpChallenge),document.getElementById("hs-if-jump-operator").value=G.ifJump?.ifJumpOperator??">",document.getElementById("hs-if-jump-value").value=String(G.ifJump?.ifJumpValue),document.getElementById("hs-challenge-add-btn").textContent="Update Action",z();return}W?C.value=String(G.challengeNumber):(C.value="",document.getElementById("hs-challenge-num-input").value=String(G.challengeNumber),document.getElementById("hs-challenge-completions-input").value=String(G.challengeCompletions),document.getElementById("hs-challenge-max-time-input").value=String(G.challengeMaxTime)),document.getElementById("hs-challenge-wait-input").value=String(G.challengeWaitTime),document.getElementById("hs-challenge-add-btn").textContent="Update Action",z()}H.startsWith("hs-challenge-delete-")&&(o.splice(Number(B.dataset.index),1),b(),Y()),H==="hs-challenges-save-btn"&&(e.length=0,e.push(...o),s.CloseModal(w)),H==="hs-challenges-cancel-btn"&&s.CloseModal(w)})},0)}async function qe(s,e,t,a,n){let o=!!n,i=e.length?e[e.length-1].endPhase:"start",r=n?.corruptions||{viscosity:0,drought:0,deflation:0,extinction:0,illiteracy:0,recession:0,dilation:0,hyperchallenge:0},l=n?.strat||[],u=q.indexOf(i),d=q.slice(u+1).map((h,w)=>`<option value="${h}" ${n?.endPhase===h||w===0?"selected":""}>${h}</option>`).join(""),m={htmlContent:`
        ...
        `,title:o?`Edit Strategy Phase ${n.startPhase}-${n.endPhase}`:"Create Strategy Phase"},b=await s.Modal(m);setTimeout(()=>{let h=document.querySelector(".hs-phase-modal-container");h&&h.addEventListener("click",async w=>{let E=w.target;if(E.id==="hs-autosing-phase-done"){let v=document.getElementById("hs-autosing-end-phase")?.value;if(!v)return;let M={startPhase:n?n.startPhase:i,endPhase:v,corruptions:{...r},strat:[...l]};o&&a?a(M):t(M),y.removeInjectedStyle("hs-phase-modal-styles"),s.CloseModal(b)}E.id==="hs-autosing-phase-corruptions"&&await yt(s,r),E.id==="hs-autosing-phase-challenges"&&await vt(s,l,n?.startPhase??"error",n?.endPhase??"error")})},0)}var ne=class{static async open(e,t){let a=D.getModule("HSUI");if(!a||!a.uiReady)return;let n=!!e,o=e?{strategyName:e.strategyName,strategy:JSON.parse(JSON.stringify(e.strategy))}:{strategyName:"",strategy:[]},i=()=>{for(let g=1;g<o.strategy.length;g++){let d=o.strategy[g-1],m=o.strategy[g];m.startPhase=d.endPhase}},r=()=>{let g=document.getElementById("hs-autosing-phase-list");if(g){if(o.strategy.length===0){g.innerHTML='<div class="hs-strategy-empty-state">No strategy phases added yet.</div>';return}g.innerHTML=o.strategy.map((d,m)=>`
            ...
            `,title:n?"Edit Autosing Strategy":"Create Autosing Strategy"},u=await a.Modal(l);setTimeout(()=>{let g=document.querySelector(".hs-strategy-modal-container");g&&(r(),g.addEventListener("click",async d=>{let m=d.target,b=m.dataset.action,h=m.dataset.phaseIndex;if(m.id==="hs-autosing-add-phase-btn")await qe(a,o.strategy,w=>{o.strategy.push(w),i(),r()});else if(m.id==="hs-autosing-create-btn"){let w=document.getElementById("hs-strategy-error"),E=document.getElementById("hs-autosing-strategy-name");o.strategyName=E?.value||"Unnamed Strategy";try{n?(I.saveStrategiesToStorage(o,e.strategyName),y.Notify(`Strategy "${o.strategyName}" updated`,{notificationType:"success"})):(I.saveStrategiesToStorage(o),y.Notify(`Strategy "${o.strategyName}" created`,{notificationType:"success"})),a.CloseModal(u)}catch(f){w&&(w.textContent=f.message,w.style.display="block")}}else if(b==="edit"&&h!==void 0){let w=parseInt(h),E=o.strategy[w];await qe(a,o.strategy.slice(0,w),()=>{},f=>{o.strategy[w]=f,i(),r()},E)}else if(b==="delete"&&h!==void 0){let w=parseInt(h);o.strategy.splice(w,1),i(),r()}}))},0)}};var ye=class{#e={syncNotificationOpacity:async e=>{let t=document.querySelector("#notification"),a=e.contextName??"HSSettings";if(e.disable&&e.disable===!0)t.style.removeProperty("opacity");else{let n=e.value;t&&n&&n>=0&&n<=1&&(t.style.opacity=n.toString())}},logTimestamp:async e=>{e.disable&&e.disable===!0?c.setTimestampDisplay(!1):c.setTimestampDisplay(!0)},reactiveMouseHover:async e=>{let t=e.contextName??"HSSettings";e.disable&&e.disable===!0&&ee.clearInterval("hover")},autoClick:async e=>{let t=e.contextName??"HSSettings";e.disable&&e.disable===!0&&ee.clearInterval("click")},ambrosiaQuickBarAction:async e=>{let t=e.contextName??"HSSettings",a=D.getModule("HSAmbrosia");a&&(e.disable&&e.disable===!0?await a.destroyQuickBar():await a.createQuickBar())},ambrosiaMinibarAction:async e=>{let t=e.contextName??"HSSettings",a=D.getModule("HSAmbrosia");a&&(e.disable&&e.disable===!0?await a.disableBerryMinibars():await a.enableBerryMinibars())},patch:async e=>{let t=e.contextName??"HSSettings";if(!e.patchConfig||!e.patchConfig.patchName){c.error("No patch config provided for setting action",t);return}let a=D.getModule("HSPatches");a&&(e.disable&&e.disable===!0?(console.log("Disabling patch",e.patchConfig.patchName,t),await a.revertPatch(e.patchConfig.patchName)):(console.log("Enabling patch",e.patchConfig.patchName,t),await a.applyPatch(e.patchConfig.patchName)))},useGameData:async e=>{let t=e.contextName??"HSSettings",a=D.getModule("HSGameData");a&&(e.disable&&e.disable===!0?a.disableGDS():a.enableGDS())},autoLoadout:async e=>{let t=e.contextName??"HSSettings",a=D.getModule("HSAmbrosia");a&&(e.disable&&e.disable===!0?await a.disableAutoLoadout():await a.enableAutoLoadout())},ambrosiaIdleSwapAction:async e=>{let t=e.contextName??"HSSettings",a=D.getModule("HSAmbrosia");a&&(e.disable&&e.disable===!0?await a.disableIdleSwap():await a.enableIdleSwap())},startAutosingAction:async e=>{let t=e.contextName??"HSSettings",a=D.getModule("HSAutosing");a&&(e.disable&&e.disable===!0?await a.disableAutoSing():await a.enableAutoSing())},createAutosingStrategy:async e=>{let t=e.contextName??"HSSettings";await ne.open()},editAutosingStrategy:async e=>{let t=e.contextName??"HSSettings";await I.editSelectedStrategy()},deleteAutosingStrategy:async e=>{let t=e.contextName??"HSSettings";await I.deleteSelectedStrategy()},exportAutosingStrategy:async e=>{let t=e.contextName??"HSSettings";await I.exportSelectedStrategy()},importAutosingStrategy:async e=>{let t=e.contextName??"HSSettings";await I.importStrategy()}};constructor(){}getAction(e){let t=this;return e in this.#e?a=>{t.#e[e](a)}:null}};var _=class{constructor(e,t,a,n){this.context="HSSetting";this.definition=e,this.settingAction=t,this.#e=a,this.#t=n,this.definition.defaultValue=this.definition.settingValue}#e;#t;getDefinition(){return this.definition}setDefinition(e){this.definition=e}enable(){this.#a(!0)}disable(){this.#a(!1)}async handleToggle(e){let t=!this.definition.enabled,a=this.definition.enabled!==t,n=I.getSetting("useGameData");if(!A.HSSettings.gameDataCheckBlacklist.includes(this.definition.settingName)&&n&&this.definition.usesGameData&&a&&t&&!n.isEnabled()){c.warn(`Enable GDS before enabling ${this.definition.settingDescription}!`);return}if(this.definition.settingName==="useGameData"&&a&&!t){let i=I.getSettings();for(let[r,l]of Object.entries(i)){let u=l.getDefinition();A.HSSettings.gameDataCheckBlacklist.includes(r)||"usesGameData"in u&&u.usesGameData===!0&&l.isEnabled()&&l.definition.settingName!=="startAutosing"&&l.disable()}}if(c.log(`${this.definition.settingName}: ${this.definition.enabled} -> ${!this.definition.enabled}`,this.context),!a)return;this.definition.enabled=t,this.definition.settingType==="boolean"&&(this.definition.settingValue=t,this.definition.calculatedSettingValue=t);let o=e.target;t?(o.innerText=this.#e,o.classList.remove("hs-disabled")):(o.innerText=this.#t,o.classList.add("hs-disabled")),this.handleSettingAction("state",t)}#a(e){let t=this.definition.enabled!==e;if(!t)return;if(this.definition.settingName==="useGameData"&&t&&!e){let n=I.getSettings();for(let[o,i]of Object.entries(n)){let r=i.getDefinition();A.HSSettings.gameDataCheckBlacklist.includes(o)||"usesGameData"in r&&r.usesGameData===!0&&i.isEnabled()&&i.definition.settingName!=="startAutosing"&&i.disable()}}c.log(`${this.definition.settingName}: ${this.definition.enabled} -> ${e}`,this.context),this.definition.enabled=e;let a=document.querySelector(`#${this.definition.settingControl?.controlEnabledId}`);e&&a?(a.innerText=this.#e,a.classList.remove("hs-disabled")):(a.innerText=this.#t,a.classList.add("hs-disabled")),this.handleSettingAction("state",e),I.saveSettingsToStorage()}async initialAction(e,t){await this.handleSettingAction(e,t)}async handleSettingAction(e,t){if(this.settingAction){let a=this.settingAction,n={contextName:this.context,value:this.definition.calculatedSettingValue??null};this.definition.patchConfig&&this.definition.patchConfig.patchName&&(n.patchConfig=this.definition.patchConfig),a&&a instanceof Function&&(e==="state"?t?await a({...n,disable:!1}):await a({...n,disable:!0}):await a({...n,disable:!1}))}}hasControls(){return"settingControl"in this.definition}isEnabled(){return this.definition.enabled}getCalculatedValue(){return this.definition.calculatedSettingValue}toString(){return JSON.stringify(this.definition)}},ve=class extends _{constructor(e,t,a,n){super(e,t,a,n),this.definition.enabled=!0,this.definition.settingValue=null,this.definition.calculatedSettingValue=null}getValue(){return null}setValue(e){}async handleChange(e){c.log(`Button pressed: ${this.definition.settingName}`,this.context),await this.handleSettingAction("value")}async initialAction(e,t){}enable(){}disable(){}},Me=class extends _{constructor(e,t,a,n){super(e,t,a,n),this.definition.settingValueMultiplier&&(this.definition.calculatedSettingValue=this.definition.settingValue*this.definition.settingValueMultiplier)}getValue(){return this.definition.settingValue}setValue(e){return this.definition.settingValue=e}async handleChange(e){let t=parseFloat(e.target.value);c.log(`${this.definition.settingName}: ${this.definition.settingValue} -> ${t}`,this.context),this.definition.settingValue=t,this.definition.calculatedSettingValue=t*this.definition.settingValueMultiplier,await super.handleSettingAction("value")}},we=class extends _{constructor(e,t,a,n){super(e,t,a,n)}getValue(){return this.definition.settingValue}setValue(e){return this.definition.settingValue=e}async handleChange(e){let t=e.target.value;c.log(`${this.definition.settingName}: ${this.definition.settingValue} -> ${t}`,this.context),this.definition.settingValue=t,this.definition.calculatedSettingValue=t,await super.handleSettingAction("value")}},Ee=class extends _{constructor(e,t,a,n){super(e,t,a,n)}getValue(){return this.definition.enabled}setValue(e){this.definition.settingValue=e,this.definition.calculatedSettingValue=e,this.definition.enabled=e}async handleChange(e){}},Ce=class extends _{constructor(e,t,a,n){super(e,t,a,n),this.definition.settingValueMultiplier&&(this.definition.calculatedSettingValue=this.definition.settingValue*this.definition.settingValueMultiplier)}getValue(){return this.definition.settingValue}setValue(e){}async handleChange(e){let t=parseFloat(e.target.value);c.log(`${this.definition.settingName}: ${this.definition.settingValue} -> ${t}`,this.context),this.definition.settingValue=t,this.definition.calculatedSettingValue=t*this.definition.settingValueMultiplier,await super.handleSettingAction("value")}},Ie=class extends _{constructor(e,t,a,n){super(e,t,a,n)}getValue(){return this.definition.settingValue}setValue(e){}async handleChange(e){let t=e.target.value;c.log(`${this.definition.settingName}: ${this.definition.settingValue} -> ${t}`,this.context),this.definition.settingValue=t,this.definition.calculatedSettingValue=t,await super.handleSettingAction("value")}},ke=class extends _{constructor(e,t,a,n){super(e,t,a,n)}getValue(){return p.removeColorTags(this.definition.settingValue)}getDisplayValue(){return p.parseColorTags(this.definition.settingValue)}setValue(e){this.definition.settingValue=e,this.definition.calculatedSettingValue=e;let t=document.querySelector(`#${this.definition.settingControl?.controlId}`);t&&(t.innerHTML=this.getDisplayValue()),I.saveSettingsToStorage()}async handleChange(e){}};var Mt="data:image/png;base64,";var I=class s extends L{static#e="";static#t={};static#a;static#r;static#i=!1;static#n=!1;static#o="\u2713";static#s="\u2717";static#l=[];#u;constructor(e){super(e),s.#e=this.context,this.#u=new ye,c.log("Parsing mod settings",this.context);try{c.log("Parsing control groups",this.context),s.#a=JSON.parse(rt)}catch(t){c.error(`Error parsing control groups ${t}`,this.context),s.#i=!1}try{c.log("Parsing control pages",this.context),s.#r=JSON.parse(st)}catch(t){c.error(`Error parsing control pages ${t}`,this.context),s.#i=!1}try{c.log("Parsing settings.json",this.context);let t=this.#c(),a;"useGameData"in t?a=t.useGameData.enabled:a=!1;for(let[n,o]of Object.typedEntries(t)){(o.settingType==="boolean"||p.isBoolean(o.settingValue))&&(o.settingValue=!1),o.usesGameData&&o.enabled&&!a&&(A.HSSettings.gameDataCheckBlacklist.includes(n)||(c.info(`Disabled ${o.settingDescription} on load because GDS is not on`,this.context),o.enabled=!1)),this.#g(o,s.#a);let i="settingAction"in o?o.settingAction:void 0,r=i?this.#u.getAction(i):null;if(o.settingType==="numeric")"settingValueMultiplier"in o||(o.settingValueMultiplier=1),s.#t[n]=new Me(o,r,s.#o,s.#s);else if(o.settingType==="string")s.#t[n]=new we(o,r,s.#o,s.#s);else if(o.settingType==="boolean")s.#t[n]=new Ee(o,r,s.#o,s.#s);else if(o.settingType==="selectnumeric")"settingValueMultiplier"in o||(o.settingValueMultiplier=1),s.#t[n]=new Ce(o,r,s.#o,s.#s);else if(o.settingType==="selectstring")s.#t[n]=new Ie(o,r,s.#o,s.#s);else if(o.settingType==="state")s.#t[n]=new ke(o,r,s.#o,s.#s);else if(o.settingType==="button")s.#t[n]=new ve(o,r,s.#o,s.#s);else throw new Error(`Could not parse setting ${n.toString()} (settingType: ${o.settingType}, settingValue: ${o.settingValue})`)}s.saveSettingsToStorage(),s.#i=!0}catch(t){c.error(`Error parsing mod settings ${t}`,this.context),s.#i=!1}}async init(){this.#h(s.#l),this.isInitialized=!0}static async syncSettings(){if(c.log("Syncing mod settings",s.#e),!s.#i){c.error("Could not sync settings - settings not parsed yet",s.#e);return}for(let[e,t]of Object.typedEntries(s.#t)){c.debug(`Syncing ${e} settings`,s.#e);let a=t.getDefinition(),n=t.hasControls()?a.settingControl:void 0;if(n){let o=n.controlType,i=n.controlOptions;if(o==="text"||o==="number"){let r=document.querySelector(`#${n.controlId}`);r&&(o==="number"&&i?("min"in i&&r.setAttribute("min",i.min.toString()),"max"in i&&r.setAttribute("max",i.max.toString()),"step"in i&&r.setAttribute("step",i.step.toString())):o==="text"&&i&&"placeholder"in i&&r.setAttribute("placeholder",i.placeholder),r.value=p.asString(a.settingValue),r.addEventListener("change",async l=>{await this.#S(l,t)}))}else if(o==="select"){let r=p.asString(a.settingValue),l=document.querySelector(`#${n.controlId}`);l&&(Array.from(l.options).some(g=>g.value===r)?l.value=r:(l.value="",c.warn(`Setting value ${r} does not exist in select options for setting ${e}`,s.#e)),l.addEventListener("change",async g=>{await this.#S(g,t)}))}else if(o==="state"){let r=p.parseColorTags(p.asString(a.settingValue)),l=document.querySelector(`#${n.controlId}`);l&&(l.innerHTML=r)}else if(o==="button"){let r=document.querySelector(`#${n.controlId}`);r&&r.addEventListener("click",async l=>{await this.#S(l,t)})}if(n.controlEnabledId){let r=document.querySelector(`#${n.controlEnabledId}`);r&&(a.enabled?(r.innerText=s.#o,r.classList.remove("hs-disabled")):(r.innerText=s.#s,r.classList.add("hs-disabled")),r.addEventListener("click",async l=>{await this.#A(l,t)}))}await t.initialAction("state",a.enabled)}}c.log("Finished syncing mod settings",s.#e),this.#n=!0}static autoBuildSettingsUI(){let e=this;if(!s.#i)return c.error("Could not sync settings - settings not parsed yet",s.#e),{didBuild:!1,navHTML:"",pagesHTML:""};let t=[],a=!0,n=Object.entries(s.#t).sort((d,m)=>{let b=d[1].getDefinition().settingControl?.controlGroup,h=m[1].getDefinition().settingControl?.controlGroup;return b&&h?(s.#a[b].order||0)-(s.#a[h].order||0):b?-1:h?1:0}),o=Object.entries(s.#r).sort((d,m)=>{let b=d[1].order,h=m[1].order;return b&&h?(b||0)-(h||0):b?-1:h?1:0}),i=[];for(let[d,m]of o)n.some(h=>h[1].getDefinition().settingControl?.controlPage===d)&&i.push(x.Div({class:"hs-panel-subtab",id:`hs-panel-settings-subtab-${d}`,data:new Map([["subtab",d],["color",m.pageColor||""]]),styles:{border:m.pageColor?`1px solid ${m.pageColor}`:"1px solid gray"},html:m.pageName}));let r=x.Div({class:"hs-panel-subtabs",html:i}),l=new Map,u=null;for(let[d,m]of n){let b=m.getDefinition(),h=b.settingControl,w=b.settingBlockId||void 0,E="";if(b.usesGameData&&(E=x.Image({class:"hs-panel-setting-block-gamedata-icon",src:Mt,width:18,height:18,props:{title:A.HSSettings.gameDataRequiredTooltip}})),h){let f=l.get(h.controlPage)||[],v=[];if(!u||u!==h.controlGroup){u=h.controlGroup;let M=s.#a[u];f.push(x.Div({html:M.groupName,styles:{borderBottom:"1px solid limegreen",gridColumn:"span 2",marginBottom:"15px"}}))}if(h.controlType==="switch")v=[x.Div({class:"hs-panel-setting-block-text-wrapper",styles:{display:"flex",flexDirection:"row",alignItems:"center"},html:[x.P({class:"hs-panel-setting-block-text",props:{title:b.settingHelpText},text:b.settingDescription,styles:{margin:"0"}}),E]})],h.controlEnabledId&&v.push(x.Button({class:"hs-panel-setting-block-btn hs-panel-settings-block-btn-standalone",id:h.controlEnabledId,text:""}));else if(h.controlType==="button")v=[x.Button({id:h.controlId,text:b.settingDescription||"Error: No button text"})];else{let M=null;switch(h.controlType){case"text":M=4;break;case"number":M=3;break;case"select":M=5;break;case"state":M=6;break;default:M=null}if(M){if(v=[x.Div({class:"hs-panel-setting-block-text-wrapper",styles:{display:"flex",flexDirection:"row",alignItems:"center"},html:[x.P({class:"hs-panel-setting-block-text",props:{title:b.settingHelpText},text:b.settingDescription,styles:{margin:"0"}}),E]})],M===3||M===4)v.push(x.Input({class:"hs-panel-setting-block-num-input",id:h.controlId,type:M}));else if(M===5)if(h.selectOptions)v.push(x.Select({class:"hs-panel-setting-block-select-input",id:h.controlId,type:M},h.selectOptions));else{c.error(`Error autobuilding settings UI, ${b.settingName} does not have selectOptions defined`,e.#e),a=!1;break}else M===6&&v.push(x.P({class:"hs-panel-setting-block-state",id:h.controlId,text:""}));h.controlEnabledId&&v.push(x.Button({class:"hs-panel-setting-block-btn",id:h.controlEnabledId,text:""}))}else{c.error("Error autobuilding settings UI, control type resolution failed (how??)",e.#e),a=!1;break}}f.push(x.Div({id:w,class:"hs-panel-setting-block",html:v})),l.set(h.controlPage,f)}else{c.error(`Error autobuilding settings UI, controls not defined for setting ${d}`,e.#e),a=!1;break}}for(let[d,m]of l.entries())l.set(d,[x.Div({class:"hs-panel-settings-grid",id:`settings-grid-${d}`,html:m})]);let g=[];for(let[d,m]of l.entries())g.push(m.join(""));return{didBuild:a,navHTML:r,pagesHTML:g.join("")}}static validateStrategy(e){if(!e)throw new Error("Strategy is undefined");if(!("strategyName"in e))throw new Error("Strategy is missing strategyName property");if(!("strategy"in e))throw new Error("Strategy is missing strategy property");if(!Array.isArray(e.strategy))throw new Error("Strategy.strategy must be an array");let t=e.strategy;if(t.length===0)throw new Error("Strategy has no components");let a=[...q];for(let n=0;n<t.length;n++){let o=t[n],{startPhase:i,endPhase:r,corruptions:l,strat:u}=o;if(!l)throw new Error(`Component ${n+1} (${i} \u2192 ${r}) has no corruptions defined`);if(!Array.isArray(u)||u.length===0)throw new Error(`Component ${n+1} (${i} \u2192 ${r}) must have at least one challenge`);if(a[0]!==i)throw new Error(`Component ${n+1} must start at "${a[0]}", got "${i}"`);let g=a.indexOf(r);if(g===-1)throw new Error(`Component ${n+1} ends at "${r}", which is not valid or already consumed`);a=a.slice(g)}if(a.length>1)throw new Error(`Uncovered phases: ${a.join(", ")}`)}#g(e,t){if(!e)throw new Error("Setting is undefined (wtf)");let a=["text","number","switch","select","state","button"],n=["numeric","string","boolean","selectnumeric","selectstring","state","button"];if(!("settingName"in e))throw new Error("Setting is missing settingName property");let o=e.settingName;if(!("enabled"in e))throw new Error(`Setting '${o}' is missing enabled property`);if(!("settingDescription"in e))throw new Error(`Setting '${o}' is missing settingDescription property`);if(!("settingValue"in e))throw new Error(`Setting '${o}' is missing settingValue property`);if(!("settingType"in e))throw new Error(`Setting '${o}' is missing settingType property`);if(!n.includes(e.settingType))throw new Error(`Setting '${o}' has invalid settingType property`);let i=e.settingType;if(i==="numeric"){if(!p.isNumeric(e.settingValue))throw new Error(`Setting '${o}' has invalid settingValue property for settingType ${i}`)}else if(i==="string"){if(!p.isString(e.settingValue))throw new Error(`Setting '${o}' has invalid settingValue property for settingType ${i}`)}else if(i==="boolean"){if(!p.isBoolean(e.settingValue))throw new Error(`Setting '${o}' has invalid settingValue property for settingType ${i}`)}else if(i==="selectnumeric"){if(!p.isString(e.settingValue)&&!p.isNumeric(e.settingValue))throw new Error(`Setting '${o}' has invalid settingValue property for settingType ${i}`)}else if(i==="selectstring"&&!p.isString(e.settingValue)&&!p.isNumeric(e.settingValue))throw new Error(`Setting '${o}' has invalid settingValue property for settingType ${i}`);if("settingControl"in e&&e.settingControl){let r=e.settingControl;if(r.controlType!=="switch"&&!("controlId"in r))throw new Error(`Setting '${o}' has settingControl defined and it is not type'switch', but it is missing controlId property`);if(!("controlType"in r))throw new Error(`Setting '${o}' has settingControl defined, but it is missing controlType property`);if(!("controlGroup"in r))throw new Error(`Setting '${o}' has settingControl defined, but it is missing controlGroup property`);if(!a.includes(r.controlType))throw new Error(`Setting '${o}' has invalid controlType property`);if(!(r.controlGroup in t))throw new Error(`Setting '${o}' has invalid controlGroup property`)}}static getSetting(e){return this.#t[e]}static getSettings(){return this.#t}static getStrategies(){return this.#l}static#m(){let e={};for(let[t,a]of Object.typedEntries(this.#t)){let n={...a.getDefinition()},o=A.HSSettings.serializationBlackList;for(let i of o)n[i]&&delete n[i];e[t]=n}return JSON.stringify(e)}static saveStrategiesToStorage(e,t){let a=D.getModule("HSStorage");if(!a)throw new Error("Could not find Storage Module");let n=a.getData(A.HSSettings.strategiesKey);if(Array.isArray(n)||(n=[]),!e&&t){let o=n.filter(i=>i.strategyName!==t);s.#l=s.#l.filter(i=>i.strategyName!==t),a.setData(A.HSSettings.strategiesKey,o),this.#M(t),c.debug("<green>Strategy removed</green>",this.#e);return}if(e){this.validateStrategy(e);let o=!!t;if(n.some(u=>u.strategyName!==e.strategyName?!1:o?u.strategyName!==t:!0))throw new Error(`Strategy with name "${e.strategyName}" already exists.`);let r=n;o&&(r=n.filter(u=>u.strategyName!==t),this.#M(t),s.#l=s.#l.filter(u=>u.strategyName!==t)),r=r.concat(e),s.#l.push(e);let l=a.setData(A.HSSettings.strategiesKey,r.filter(u=>u.strategyName!=="default_strategy"));this.#p(e),l?c.debug(`<green>Strategy ${o?"updated":"saved"} to localStorage</green>`,this.#e):c.warn("Could not save Strategy to localStorage",this.#e)}}static async deleteSelectedStrategy(){let e=s.getSetting("autosingStrategy"),t=e.getValue();if(!t||t===""){y.Notify("Please select a strategy to delete",{notificationType:"warning"});return}let a=e.getDefinition().settingControl;if(!a?.selectOptions)return;let n=a.selectOptions.find(i=>i.value.toString()===t);if(!n)return;let o=n.text;if(o=="default_strategy"){y.Notify("cannot delete default strategy");return}confirm(`Are you sure you want to delete strategy "${o}"?`)&&(s.saveStrategiesToStorage(void 0,o),y.Notify(`Strategy "${o}" deleted`,{notificationType:"success"}))}static async exportSelectedStrategy(){let e=s.getSetting("autosingStrategy"),t=e.getValue();if(!t||t===""){y.Notify("Please select a strategy to export",{notificationType:"warning"});return}let a=e.getDefinition().settingControl;if(!a?.selectOptions)return;let n=a.selectOptions.find(l=>l.value.toString()===t);if(!n)return;let o=n.text,r=s.getStrategies().find(l=>l.strategyName===o);if(!r){y.Notify("Strategy not found",{notificationType:"error"});return}try{let l=JSON.stringify(r,null,2);await navigator.clipboard.writeText(l),y.Notify(`Strategy "${o}" copied to clipboard`,{notificationType:"success"})}catch(l){y.Notify("Failed to copy strategy to clipboard",{notificationType:"error"}),c.log(`Export failed: ${l}`,"HSAutosing")}}static async importStrategy(){let e=D.getModule("HSUI");if(e){let t=await e.Modal({title:"Import Strategy",htmlContent:`
        ...
        `}),a=document.querySelector(`#${t} #import-strategy-cancel`);a&&(a.dataset.close=t);let n=document.querySelector(`#${t} #import-strategy-submit`),o=document.querySelector(`#${t} #import-strategy-name`),i=document.querySelector(`#${t} #import-strategy-json`);if(!n||!o||!i){y.Notify("Failed to create import modal",{notificationType:"error"});return}n.addEventListener("click",async()=>{let r=o.value.trim(),l=i.value.trim();if(!r){y.Notify("Please enter a strategy name",{notificationType:"warning"});return}if(s.getStrategies().some(d=>d.strategyName===r)){y.Notify(`Strategy "${r}" already exists`,{notificationType:"warning"});return}let g;try{g=JSON.parse(l)}catch{y.Notify("Invalid JSON format",{notificationType:"error"});return}this.validateStrategy(g),g.strategyName=r;try{s.saveStrategiesToStorage(g),y.Notify(`Strategy "${r}" imported successfully`,{notificationType:"success"});let d=document.querySelector(`#${t}`);d&&(await d.transition({opacity:0}),d.parentElement?.removeChild(d))}catch(d){y.Notify("Failed to save strategy",{notificationType:"error"}),c.log(`Import failed: ${d}`,"HSAutosing")}})}else y.Notify("Failed to find HSUI",{notificationType:"error"})}static async editSelectedStrategy(){let e=s.getSetting("autosingStrategy"),t=e.getValue();if(!t||t===""){y.Notify("Please select a strategy to edit",{notificationType:"warning"});return}let a=e.getDefinition().settingControl;if(!a?.selectOptions)return;let n=a.selectOptions.find(r=>r.value.toString()===t);if(!n)return;let i=s.getStrategies().find(r=>r.strategyName===n.text);if(!i){y.Notify("Cannot edit selected strategy",{notificationType:"error"});return}if(i.strategyName=="default_strategy"){y.Notify("cannot edit default strategy");return}await ne.open(i,t)}static saveSettingsToStorage(){let e=D.getModule("HSStorage");if(e){let t=this.#m();e.setData(A.HSSettings.storageKey,t)?c.debug("<green>Settings saved to localStorage</green>",this.#e):c.warn("Could not save settings to localStorage",this.#e)}}#d(){let e=JSON.parse(lt);for(let t of e)t&&s.validateStrategy(t);return e}#b(){let e=JSON.parse(it);for(let[t,a]of Object.typedEntries(e))if(a){if((a.settingType==="boolean"||p.isBoolean(a.settingValue))&&(a.settingValue=!1),(a.settingType==="selectnumeric"||a.settingType==="selectstring")&&("settingValue"in a||(a.settingValue=""),"settingControl"in a&&a.settingControl)){let n=a.settingControl;"selectOptions"in n&&n.selectOptions&&(n.selectOptions.find(i=>i.value==="")||n.selectOptions.unshift({text:"None",value:""}))}(a.settingType==="numeric"||a.settingType==="selectnumeric"||p.isNumeric(a.settingValue))&&("settingValueMultiplier"in a||(a.settingValueMultiplier=1)),a.settingType==="state"&&("settingValue"in a||(a.settingValue="<red>null</red>")),this.#g(a,s.#a)}return e}#f(){let e=D.getModule("HSStorage");if(!e)return c.warn("Could not find HSStorage module",this.context),null;let t=e.getData(A.HSSettings.strategiesKey);return t?Array.isArray(t)?t:[t]:null}#v(){let e=D.getModule("HSStorage");if(e){let t=e.getData(A.HSSettings.storageKey);return t?JSON.parse(t):(c.warn("Could not load settings from localStorage",this.context),null)}else return c.warn("Could not find HSStorage module",this.context),null}#h(e){for(let t of e)if(t.strategyName===void 0)throw new Error("Strategy name is missing. Cannot add strategy to options.");for(let t of e)s.#p(t)}static#M(e){let a=this.getSetting("autosingStrategy").getDefinition().settingControl;if(!a?.selectOptions)return;let n=a.selectOptions.findIndex(o=>o.text===e);if(n!==-1){let o=a.selectOptions[n].value;a.selectOptions.splice(n,1);let i=document.querySelector(`#${a.controlId}`);if(i){let r=i.querySelector(`option[value="${o}"]`);r&&r.remove()}}}static#p(e){let a=this.getSetting("autosingStrategy").getDefinition().settingControl;if(!a?.selectOptions)return;let n=a.selectOptions.length>0?Math.max(...a.selectOptions.map(i=>Number(i.value)))+1:1;a.selectOptions.push({text:e.strategyName,value:n});let o=document.querySelector(`#${a.controlId}`);if(o){let i=document.createElement("option");i.value=String(n),i.textContent=e.strategyName,o.appendChild(i)}}#c(){let e=this.#b(),t=this.#d();s.#l.push(...t);try{let a=this.#v(),n=this.#f();n&&s.#l.push(...n);let o=JSON.parse(JSON.stringify(e));return a?(c.log("<green>Found settings from localStorage!</green>",this.context),Object.keys(e).forEach(i=>{i in a&&Object.keys(a[i]).forEach(r=>{if(r in e[i]){let l=a[i][r];if(l!==null&&typeof l=="object"&&!Array.isArray(l)&&typeof e[i][r]=="object"&&!Array.isArray(e[i][r])){let u={...e[i][r]};Object.keys(l).forEach(g=>{g in u&&(u[g]=l[g])}),o[i][r]=u}else o[i][r]=l}})}),o):e}catch(a){return c.error("Error while resolving settings",this.context),console.log(a),e}}static async#S(e,t){await t.handleChange(e),this.saveSettingsToStorage()}static async#A(e,t){await t.handleToggle(e),this.saveSettingsToStorage()}static dumpToConsole(){console.log("------------------ HYPERSYNERGISM CURRENT SETTINGS DUMP START ------------------"),this.#t?console.log(this.#t):console.log("NO SETTINGS FOUND (wtf)"),console.log("------------------ HYPERSYNERGISM CURRENT SETTINGS DUMP END ------------------")}};var Te=class extends L{#e;#t;#a=["chronos","hyperrealism","quark","challenge","abyss","accelerator","acceleratorBoost","multiplier"];#r=[];#i=[];#n={chronosHepteract:0,hyperrealismHepteract:0,quarkHepteract:0,challengeHepteract:0,abyssHepteract:0,acceleratorHepteract:0,acceleratorBoostHepteract:0,multiplierHepteract:0};#o={chronosHepteract:null,hyperrealismHepteract:null,quarkHepteract:100,challengeHepteract:null,abyssHepteract:null,acceleratorHepteract:null,acceleratorBoostHepteract:null,multiplierHepteract:null};#s=0;#l=0;#u=0;#g=0;#m=0;#d=`
        ...
        #hs-ratio-container {
            ...
            grid-column-gap: 0px;
            grid-row-gap: 0px;
        }`;#f;#v;#h;#M;#p;#c;#S;#A=!1;#y=!1;constructor(e){super(e),this.#r=this.#a.map(t=>`${t}Hepteract`),this.#i=this.#a.map(t=>`${t}ProgressBarText`)}async init(){let e=this;c.log("Initialising HSHepteracts module",this.context);let t=D.getModule("HSGameState");t&&(t.subscribeGameStateChange("MAIN_VIEW",(a,n)=>{a.getId()===8&&n.getId()!==8&&t.getCurrentUIView("CUBE_VIEW").getId()===7&&e.#S&&(c.debug("Hepteract forge view closed, stopping watch",this.context),S.stopWatching(e.#S))}),t.subscribeGameStateChange("CUBE_VIEW",async(a,n)=>{n.getId()===7?(c.debug("Hepteract forge view opened, starting watch",this.context),e.#p=await S.HookElement("#hepteractQuantity"),e.#S=S.watchElement(e.#p,o=>{try{let i=parseFloat(p.unfuckNumericString(o));e.#c=i}catch{c.error("Failed to parse owned hepteracts",e.context)}e.#y=!1},{greedy:!0,overrideThrottle:!0,valueParser:o=>o.querySelector("span")?.innerText})):a.getId()===7&&e.#S&&(c.debug("Hepteract forge view closed, stopping watch",this.context),S.stopWatching(e.#S))})),this.#e=await S.HookElement("#heptGrid"),this.#t=await S.HookElement("#hepteractCraftTexts"),this.#e.childNodes.forEach(a=>{if(a.nodeType===1){let n=a,o=n.id;if(e.#r.includes(o)){let i=document.querySelector(`#${o}CraftMax`),r=document.querySelector(`#${o}Cap`),l=document.querySelector(`#${o}Image`);n.addEventListener("mouseenter",async u=>{if(o in e.#o&&o==="quarkHepteract")return;let g=document.querySelector("#hepteractCostText");if(g){let m=g.innerText.match(/you\s+(.*?)\s+Hepteracts/i);if(m){let b=m[1];try{if(o in e.#o){let h=p.parseFloat2(b);e.#o[o]=h}}catch{c.warn(`Error while parsing hepteract cost for ${o}`,e.context)}}}}),i&&r&&l&&(l.addEventListener("mouseenter",async u=>{let m=u.target.id.toLowerCase().includes("quark");if(e.#c!==null&&e.#c!==void 0){let b=e.#n[o],h=e.#o[o];if(b===null||h===null)return;let w=I.getSetting("expandCostProtectionDoubleCap"),E=null;if(w.getValue(),E=b*2*h,e.#c===0)e.#E(E,"\u221E",m);else{let f=e.#c>0?E/e.#c:1;e.#E(E,f,m)}}}),l.addEventListener("click",async u=>{let d=u.target.id,m=d.toLowerCase().includes("quark");if(!d||m)return;if(e.#A||e.#y){c.debug(`Quick expand cancelled, another expand was still pending (exp ${e.#A}, wtch: ${e.#y})`,e.context);return}e.#A=!0;let b=null,h=null;if(e.#c!==null&&e.#c!==void 0){if(e.#c===0){c.info("Owned hepteracts is 0",this.context),e.#A=!1;return}let f=e.#n[o],v=e.#o[o];(f===null||v===null)&&c.warn(`Hepteract cost for ${o} not parsed yet`,e.context);let M=I.getSetting("expandCostProtectionDoubleCap"),P=null;M.getValue(),P=f*2,b=f*2*v,h=e.#c>0?b/e.#c:1,c.debug(`
                                    Current max: ${f},
                                    Cube cost: ${p.N(v)},
                                    Next hepts: ${p.N(P)},
                                    Buy cost: ${p.N(b)},
                                    Percent owned: ${p.N(h)},
                                    Double Cap: ${M.getValue()}`,this.context);let U=I.getSetting("expandCostProtection"),V=I.getSetting("expandCostProtectionNotifications"),Q=!(V&&V.getValue()===!0);if(U.isEnabled()){let O=U.getCalculatedValue();if(O&&h>=O){Q&&c.info(`Hept. cost protection: Cost owned ${p.N(h*100)}% >= ${O*100}%`,this.context),e.#A=!1;return}}}else{c.warn("Owned hepteracts not parsed yet",this.context),e.#y=!1,e.#A=!1;return}let w=await S.HookElement("#toggle35");if(w&&w.innerText.includes("ON")&&(c.info("Turned hepteract notification toggle OFF",this.context),w.click()),await p.hiddenAction(async()=>{r.click()},"confirm",!1,25),await p.wait(25),i.click(),b&&h&&e.#E(b,h),await p.wait(5),o!=="quarkHepteract"){let f=document.querySelector("#hepteractCostText");if(f){let M=f.innerText.match(/you\s+(.*?)\s+Hepteracts/i);if(M){let P=M[1];try{if(o in e.#o){let U=p.parseFloat2(P);e.#o[o]=U}}catch{c.warn(`Error while parsing NEW hepteract cost for ${o}`,e.context)}}}}let E=e.#p?e.#p:document.querySelector("#hepteractQuantity");if(E){let f=E.querySelector("span");if(f){let v=f.innerText,M=parseFloat(v);e.#c=M}}e.#A=!1}))}}}),document.querySelectorAll(".heptTypeImage").length>0&&y.injectStyle(`
...
`;var Re=class extends L{#e;#t;#a=null;#r=[];#i=null;#n=null;#o=new Map;#s;#l;#u;#g=new Map;#m=`
    ...
    `;#f="hs-ambrosia-idle-loadout-css";#v="hs-ambrosia-minibar-css";#h=!1;#M;#p;#c;#S=!1;#A;#y;constructor(e){super(e)}async init(){let e=this;c.log("Initializing HSAmbrosia module",this.context),this.#a=await S.HookElement("#blueberryUpgradeContainer"),this.#r=await S.HookElements(".blueberryLoadoutSlot"),this.#i=await S.HookElement("#bbLoadoutContainer"),this.#c=document.querySelector("#hs-panel-debug-gamedata-currentambrosia"),this.loadState(),await this.#x(),c.log("Hooking stuff",this.context);for(let[t,a]of A.HSAmbrosia.ambrosiaLoadoutIcons.entries()){let n=document.querySelector(`#${a.draggableIconId}`);n&&(n.draggable=!0,n.dataset.hsid=t,n.addEventListener("dragstart",o=>{if(!o.dataTransfer)return;let i=o.currentTarget?.dataset.hsid;i&&(c.log(`Drag start ${i}`,this.context),o.dataTransfer.effectAllowed="move",o.dataTransfer.setData("hs-amb-drag",i))}))}if(!this.#i){c.warn("Could not find loadout container",this.context);return}this.#r.forEach(t=>{let a=t.id;if(a){let n=this.#T(a);if(n){let o=this.#o.get(n);o&&this.#k(n,o)}}}),this.#i.delegateEventListener("dragenter",".blueberryLoadoutSlot",t=>{t.dataTransfer&&t.dataTransfer.types.includes("hs-amb-drag")&&(t.preventDefault(),t.stopPropagation(),t.dataTransfer.effectAllowed="move")}),this.#i?.delegateEventListener("dragover",".blueberryLoadoutSlot",t=>{t.dataTransfer&&t.dataTransfer.types.includes("hs-amb-drag")&&(t.preventDefault(),t.stopPropagation(),t.dataTransfer.effectAllowed="move")}),this.#i?.delegateEventListener("drop",".blueberryLoadoutSlot",async t=>{if(t.dataTransfer&&t.dataTransfer.types.includes("hs-amb-drag")){t.preventDefault(),t.stopPropagation();let a=this.#E(t.dataTransfer.getData("hs-amb-drag")),n=t.target,o=n.id;if(!a){c.warn(`Invalid icon ID: ${a}`,this.context);return}if(!A.HSAmbrosia.ambrosiaLoadoutIcons.has(a)){c.warn(`Could not find loadout slot entry for ${a}`,this.context);return}if(!n.classList.contains("blueberryLoadoutSlot")||!o)return;let i=this.#T(o);if(!i){c.warn(`Invalid slot ID: ${o}`,this.context);return}let r=A.HSAmbrosia.ambrosiaLoadoutIcons.get(a);this.#k(i,a),this.#o.set(i,a),this.saveState(),await e.updateQuickBar()}}),this.#i?.delegateEventListener("contextmenu",".blueberryLoadoutSlot",async t=>{t.preventDefault();let a=t.target,n=a.id,o=this.#T(n);if(!o){c.warn(`Invalid slot ID: ${n}`,this.context);return}if(!this.#o.get(o)){c.warn(`No icon found for slot ID: ${n}`,this.context);return}a.classList.remove("hs-ambrosia-slot"),a.style.backgroundImage="",this.#o.delete(o),this.saveState(),await e.updateQuickBar()}),this.#i?.delegateEventListener("click",".blueberryLoadoutSlot",async t=>{let n=t.target.id,o=this.#T(n);if(!o){c.warn(`Invalid slot ID: ${n}`,this.context);return}await e.#w(o)}),this.isInitialized=!0}async#w(e){this.#s=e;let t=I.getSetting("autoLoadoutState");t&&t.setValue(`<green>${e}</green>`),this.#n||(this.#n=await S.HookElement("header"));let a=this.#n.querySelector(`#${A.HSAmbrosia.quickBarId}`);if(a){a.querySelectorAll(".blueberryLoadoutSlot").forEach(i=>{i.classList.remove("hs-ambrosia-active-slot")});let o=a.querySelector(`#${A.HSAmbrosia.quickBarLoadoutIdPrefix}-${e}`);o&&o.classList.add("hs-ambrosia-active-slot")}else c.warn("Could not find quick bar element",this.context);let n=document.querySelector("#bbLoadoutContainer");if(n){n.querySelectorAll(".blueberryLoadoutSlot").forEach(i=>{i.classList.remove("hs-ambrosia-active-slot")});let o=n.querySelector(`#${e}`);o&&o.classList.add("hs-ambrosia-active-slot")}}#E(e){return Object.values(he).find(t=>t===e)}#T(e){return Object.values(me).find(t=>t===e)}#k(e,t){let a=document.querySelector(`#${e}`);if(!a){c.warn(`Could not find slot element for ${e}`,this.context);return}let n=A.HSAmbrosia.ambrosiaLoadoutIcons.get(t);if(!n){c.warn(`Could not find icon for ${t}`,this.context);return}a.classList.add("hs-ambrosia-slot"),a.style.backgroundImage=`url(${n.url})`}async saveState(){let e=D.getModule("HSStorage");if(e){let t=JSON.stringify(Array.from(this.#o.entries()));e.setData(A.HSAmbrosia.storageKey,t)}else c.warn("saveState - Could not find storage module",this.context)}async loadState(){let e=D.getModule("HSStorage");if(e){let a=e.getData(A.HSAmbrosia.storageKey);if(!a){c.warn("loadState - No data found",this.context);return}try{let n=JSON.parse(a);this.#o=new Map(n)}catch{c.warn("loadState - Error parsing data",this.context);return}}else c.warn("loadState - Could not find storage module",this.context);let t=I.getSetting("autoLoadoutState");t&&!this.#s?this.#s=p.removeColorTags(t.getValue()):c.warn("loadState - Could not find autoLoadoutState setting",this.context)}async createQuickBar(){let e=this;if(this.#g.forEach((t,a)=>{a.removeEventListener("click",t)}),this.#g.clear(),this.#i=await S.HookElement("#bbLoadoutContainer"),this.#n=await S.HookElement("header"),this.#i&&this.#n){let t=this.#n.querySelector("nav.navbar"),a=this.#i.cloneNode(!0);a.id=A.HSAmbrosia.quickBarId;let n=a.querySelector(".blueberryLoadoutSetting");a.querySelectorAll(".blueberryLoadoutSlot").forEach(i=>{let r=i.id;i.id=`${A.HSAmbrosia.quickBarLoadoutIdPrefix}-${r}`;let l=async function(u){await e.#U(u,r)};this.#g.set(i,l),i.addEventListener("click",l)}),n&&n.remove(),this.#n.insertBefore(a,t),y.injectStyle(this.#m,this.#d),this.#s&&await this.#w(this.#s)}}async destroyQuickBar(){this.#n||(this.#n=await S.HookElement("header"));let e=this.#n.querySelector(`#${A.HSAmbrosia.quickBarId}`);e?(this.#g.forEach((a,n)=>{n.removeEventListener("click",a)}),this.#g.clear(),e.remove(),y.removeInjectedStyle(this.#d)):c.warn("Could not find quick bar element",this.context);let t=document.querySelector("#bbLoadoutContainer");t&&t.querySelectorAll(".blueberryLoadoutSlot").forEach(a=>{a.classList.remove("hs-ambrosia-active-slot")})}async#x(){let e=await S.HookElement("#importBlueberriesButton");if(!e||document.getElementById("hs-ambrosia-extra-btn"))return;let t=document.createElement("button");t.id="hs-ambrosia-extra-btn",t.className="ambrosiaLoadoutBtn",t.textContent="Quick Import",e.parentElement?.insertBefore(t,e.nextSibling),t.addEventListener("click",()=>this.#R())}async updateQuickBar(){I.getSetting("ambrosiaQuickBar").isEnabled()&&(await this.destroyQuickBar(),await this.createQuickBar(),this.#s&&await this.#w(this.#s))}async enableAutoLoadout(){let e=this,t=I.getSetting("autoLoadoutState");if(t&&t.getValue().includes("Unknown")||!this.#s){let g=I.getSetting("autoLoadout");g&&g.isEnabled()&&g.disable(),c.warn("Could not enable auto loadout - current loadout state is not known!",this.context);return}let a=[S.HookElement("#addCode"),S.HookElement("#addCodeAll"),S.HookElement("#addCodeOne"),S.HookElement("#timeCode")],o=(await Promise.allSettled(a)).map((g,d)=>g.status==="fulfilled"?g.value:null);if(o.some(g=>g===null)){c.warn("Problem with enabling auto loadout",this.context);return}let[i,r,l,u]=o;this.#l||(this.#l=async g=>{await e.#B(g)}),this.#u||(this.#u=async g=>{await e.#N(g)}),i.removeEventListener("click",this.#l,{capture:!0}),i.addEventListener("click",this.#l,{capture:!0}),r.removeEventListener("click",this.#l,{capture:!0}),r.addEventListener("click",this.#l,{capture:!0}),l.removeEventListener("click",this.#l,{capture:!0}),l.addEventListener("click",this.#l,{capture:!0}),u.removeEventListener("click",this.#u,{capture:!0}),u.addEventListener("click",this.#u,{capture:!0}),c.log("Enabled auto loadout",this.context)}async disableAutoLoadout(){let e=this,t=[S.HookElement("#addCode"),S.HookElement("#addCodeAll"),S.HookElement("#addCodeOne"),S.HookElement("#timeCode")],n=(await Promise.allSettled(t)).map((u,g)=>u.status==="fulfilled"?u.value:null);if(n.some(u=>u===null)){c.warn("Problem with disabling auto loadout",this.context);return}let[o,i,r,l]=n;this.#l&&(o.removeEventListener("click",this.#l,{capture:!0}),i.removeEventListener("click",this.#l,{capture:!0}),r.removeEventListener("click",this.#l,{capture:!0})),this.#u&&l.removeEventListener("click",this.#u,{capture:!0}),c.log("Disabled auto loadout",this.context)}async#B(e){let t=this.#s,a=I.getSetting("autoLoadoutAdd");if(t&&a){let n=this.#I(a.getValue()),o=await S.HookElement(`#${n}`);await this.#C(),await p.hiddenAction(async()=>{o.click()})}}async#N(e){let t=this.#s,a=I.getSetting("autoLoadoutTime");if(t&&a){let n=this.#I(a.getValue()),o=await S.HookElement(`#${n}`);await this.#C(),await p.hiddenAction(async()=>{o.click()})}}async#U(e,t){let a=document.querySelector(`#${t}`);a?(await this.#C(),await p.hiddenAction(async()=>{a.click()})):c.warn(`Could not find real button for ${t}`,this.context)}async#C(){let e=await S.HookElement("#blueberryToggleMode");e&&e.innerText.includes("SAVE")&&e.click()}#I(e){let t=Object.values(me).find(a=>a===`blueberryLoadout${e}`);return t||c.warn(`Could not convert loadout ${e} to slot`,this.context),t}subscribeGameDataChanges(){let e=D.getModule("HSGameData");e&&!this.gameDataSubscriptionId&&(this.gameDataSubscriptionId=e.subscribeGameDataChange(this.gameDataCallback.bind(this)),c.debug("Subscribed to game data changes",this.context))}unsubscribeGameDataChanges(){let e=D.getModule("HSGameData");e&&this.gameDataSubscriptionId&&!this.#h&&!this.#S&&(e.unsubscribeGameDataChange(this.gameDataSubscriptionId),this.gameDataSubscriptionId=void 0,c.debug("Unsubscribed from game data changes",this.context))}async gameDataCallback(){let e=D.getModule("HSGameDataAPI");if(!e)return;let t=e.getGameData();if(t&&t.blueberryTime&&t.redAmbrosiaTime){let a=t.blueberryTime,n=t.redAmbrosiaTime,o=e.R_calculateRequiredBlueberryTime(),i=e.R_calculateRequiredRedAmbrosiaTime(),r=a/o*100,l=n/i*100,u=e.calculateAmbrosiaSpeed(),g=e.calculateBlueBerries(),d=u*g,m=t.shopUpgrades.shopAmbrosiaAccelerator,b=e.calculateLuck(),h=t.singularityChallenges.noAmbrosiaUpgrades.completions>0?1:0,w=b.total/100+h,E=(b.total-100*Math.floor(b.total/100))/100,f=0,v=0,M=0,P=d/o*100,U=P+.1,V=1/2+(3/5-1/2)*+(t.singularityChallenges.noAmbrosiaUpgrades.completions>=15)+(2/3-3/5)*+(t.singularityChallenges.noAmbrosiaUpgrades.completions>=19)+(3/4-2/3)*+(t.singularityChallenges.noAmbrosiaUpgrades.completions>=20);if(m>0&&d>0){let Q=o/d;f=Math.min(Q*V,w*.2*m),v=f*d,M=v/o*100}if(this.#h&&this.#M&&this.#p){let Q=I.getSetting("ambrosiaIdleSwapNormalLoadout"),O=I.getSetting("ambrosiaIdleSwap100Loadout");if(Q&&O){let J=Q.getValue(),F=O.getValue();if(!Number.isInteger(parseInt(J,10))||!Number.isInteger(parseInt(F,10))){let j=I.getSetting("ambrosiaIdleSwap");j&&j.disable(),c.log("Idle swap was disabled due to unconfigured loadouts",this.context);return}let z=this.#I(Q.getValue()),Y=this.#I(O.getValue()),k=U+M,C=k+U,R=100-U,B=100,H=A.HSAmbrosia.idleSwapMinRedTreshold,G=H+A.HSAmbrosia.idleSwapMinRedTreshold,W=A.HSAmbrosia.idleSwapMaxRedTreshold;if(r>=R&&r<=B||l>=W&&l<=100){if(this.#s!==Y){let j=await S.HookElement(`#${Y}`);await this.#C(),await p.hiddenAction(async()=>{j.click()})}}else if((r>=k&&r<=C||l>=H&&l<=G)&&this.#s!==z){let j=await S.HookElement(`#${z}`);await this.#C(),await p.hiddenAction(async()=>{j.click()})}}if(this.#c&&y.isModPanelOpen()){let J=document.createElement("div");for(J.innerHTML=`
                        ...
                        `,this.#c.innerHTML="";J.firstChild;)this.#c.appendChild(J.firstChild)}}this.#S?this.#A&&this.#y?(this.#A.style.width=`${r}%`,this.#y.style.width=`${l}%`):c.warnOnce(`
                        HSAmbrosia.gameDataCallback() - minibar element(s) undefined. 
                        blue: ${this.#A}, 
                        red: ${this.#y}`,"hs-minibars-undefined"):c.logOnce("HSAmbrosia.gameDataCallback() - berryMinibarsEnabled was false","hs-minibars-false")}}async enableIdleSwap(){let e=this,t=D.getModule("HSGameState");t?(this.#e=t.subscribeGameStateChange("MAIN_VIEW",this.#L.bind(this)),this.#t=t.subscribeGameStateChange("SINGULARITY_VIEW",async(a,n)=>{n.getId()===5?(this.#M=await S.HookElement("#ambrosiaProgressBar"),this.#p=await S.HookElement("#pixelProgressBar"),this.#h=!0,this.#H(),this.subscribeGameDataChanges()):(this.#h=!1,this.#D(),this.unsubscribeGameDataChanges())}),t.getCurrentUIView("SINGULARITY_VIEW").getId()===5&&t.getCurrentUIView("MAIN_VIEW").getId()===13&&(this.#M=await S.HookElement("#ambrosiaProgressBar"),this.#p=await S.HookElement("#pixelProgressBar"),this.#h=!0,this.#H(),this.subscribeGameDataChanges())):c.warn("HSAmbrosia.enableIdleSwap() - gameStateMod==undefined","hs-enable-idleswap-gamestate"),this.#c||(this.#c=document.querySelector("#hs-panel-debug-gamedata-currentambrosia"))}disableIdleSwap(){this.#h=!1,this.unsubscribeGameDataChanges();let e=D.getModule("HSGameState");e?(this.#e&&(e.unsubscribeGameStateChange("MAIN_VIEW",this.#e),this.#e=void 0),this.#t&&(e.unsubscribeGameStateChange("SINGULARITY_VIEW",this.#t),this.#t=void 0)):c.warnOnce("HSAmbrosia.disableIdleSwap() - gameStateMod==undefined","hs-disable-idleswap-gamestate"),this.#D()}#L(e,t){let a=D.getModule("HSGameState");a?e.getId()===13&&t.getId()!==13&&a.getCurrentUIView("SINGULARITY_VIEW").getId()===5&&(this.#h=!1):c.warnOnce("HSAmbrosia.gameStateCallbackMain() - gameStateMod==undefined","hs-amb-gamestate-cb")}#H(){if(document.querySelector(`#${A.HSAmbrosia.idleSwapIndicatorId}`))return;let t=document.createElement("div");t.id=A.HSAmbrosia.idleSwapIndicatorId,t.innerText="IDLE SWAP ENABLED WHILE IN THIS VIEW",y.injectHTMLElement(t,a=>{let n=document.querySelector("#singularityAmbrosia"),o=document.querySelector("#ambrosiaProgressBar");n?.insertBefore(a,o)}),y.injectStyle(this.#b,this.#f)}#D(){let e=document.querySelector(`#${A.HSAmbrosia.idleSwapIndicatorId}`);e&&e.remove(),y.removeInjectedStyle(this.#f)}async enableBerryMinibars(){if(this.#n||(this.#n=await S.HookElement("header")),!this.#n)return;let t=(await S.HookElement("#ambrosiaProgressBar")).cloneNode(!0),a=t.querySelector("#ambrosiaProgress"),n=t.querySelector("#ambrosiaProgressText");t.id=A.HSAmbrosia.blueBarId,a.id=A.HSAmbrosia.blueBarProgressId,n.id=A.HSAmbrosia.blueBarProgressTextId;let i=(await S.HookElement("#pixelProgressBar")).cloneNode(!0),r=i.querySelector("#pixelProgress"),l=i.querySelector("#pixelProgressText");i.id=A.HSAmbrosia.redBarId,r.id=A.HSAmbrosia.redBarProgressId,l.id=A.HSAmbrosia.redBarProgressTextId;let u=document.createElement("div");u.id=A.HSAmbrosia.barWrapperId,u.appendChild(t),u.appendChild(i);let g=I.getSetting("ambrosiaQuickBar"),d;g&&g.isEnabled()?d=this.#n.querySelector("#hs-ambrosia-quick-loadout-container"):d=this.#n.querySelector("nav.navbar"),this.#n.insertBefore(u,d),y.injectStyle(wt,this.#v),this.#A=a,this.#y=r,this.subscribeGameDataChanges(),this.#S=!0}async disableBerryMinibars(){this.#n||(this.#n=await S.HookElement("header"));let e=this.#n.querySelector(`#${A.HSAmbrosia.barWrapperId}`);e?e.remove():c.warn("Could not find bar wrapper element",this.context),y.removeInjectedStyle(this.#v),this.#S=!1,this.unsubscribeGameDataChanges()}async#R(){let e=null;try{e=document.querySelector(".blueberryLoadoutSlot.hs-ambrosia-active-slot");let t=await navigator.clipboard.readText();if(!t||typeof t!="string"){y.Notify("Clipboard does not contain valid loadout data",{notificationType:"warning"});return}let a=t.split(`
`).map(u=>u.trim());if(a.length===0||a.length>16){y.Notify(`Invalid number of loadouts: ${a.length}. Expected 1-16.`,{notificationType:"warning"});return}let n=document.getElementById("importBlueberries"),o=await S.HookElement("#blueberryToggleMode");if(!n)throw new Error("Import input element not found");if(!o)throw new Error("Mode toggle button not found");o.innerText.includes("LOAD ")&&o.click();let r=0,l=0;p.startDialogWatcher();for(let u=0;u<a.length;u++){let g=a[u],d=u+1;if(!g){l++;continue}let m=document.getElementById(`blueberryLoadout${d}`);if(!m){console.warn(`Loadout button ${d} not found`);continue}let b=new Blob([g],{type:"application/json"}),h=new File([b],"quick-import.json",{type:"application/json"}),w=new DataTransfer;w.items.add(h),n.files=w.files;let E=new Event("change",{bubbles:!0});n.dispatchEvent(E),await p.sleep(50),m.click(),await p.sleep(50),r++}o.click(),y.Notify(`Imported ${r} loadout(s), skipped ${l} empty slot(s)`,{notificationType:"success"})}catch(t){let a=t instanceof Error?t.message:typeof t=="string"?t:"Unknown error";console.error("Quick Import error:",t),c.error(`Quick Import failed: ${a}`,this.context,!0),y.Notify("Quick Import failed",{notificationType:"error"})}finally{await p.stopDialogWatcher(),e&&e.click()}}};var Ge=class extends L{constructor(e){super(e)}async init(){c.log("Initializing HSStats module",this.context),this.isInitialized=!0}};var Ne=class extends L{#e=-1;#t={CubeView:le,SingularityView:ce};#a={MAIN_VIEW:{currentView:new se("unknown"),previousView:new se("unknown"),viewChangeSubscribers:new Map},CUBE_VIEW:{currentView:new le("unknown"),previousView:new le("unknown"),viewChangeSubscribers:new Map},SINGULARITY_VIEW:{currentView:new ce("unknown"),previousView:new ce("unknown"),viewChangeSubscribers:new Map}};#r=["buildings","upgrades","statistics","runes","challenges","research","ants","cubes","campaigns","traits","settings","shop","singularity","event","pseudoCoins"];constructor(e){super(e)}async init(){let e=this;c.log("Initializing HSGameState module",this.context);for(let t of this.#r){let a=document.querySelector(`#${t}`);S.watchElement(a,async n=>{let{view:o,state:i}=n;if(i!=="none"){let r=new se(o);if(r.getId()!==-1)e.#a.MAIN_VIEW.previousView=e.#a.MAIN_VIEW.currentView,e.#a.MAIN_VIEW.currentView=r,c.debug(`Main UI view changed ${e.#a.MAIN_VIEW.previousView.getName()} -> ${e.#a.MAIN_VIEW.currentView.getName()}`,e.context);else{c.warn(`Main UI view ${o} not found`,e.context);return}e.#a.MAIN_VIEW.viewChangeSubscribers.forEach(l=>{try{l(e.#a.MAIN_VIEW.previousView,e.#a.MAIN_VIEW.currentView)}catch(u){c.error(`Error when trying to call MAIN VIEW change subscriber callback: ${u}`,e.context)}}),this.#i(r.getId())}},{characterData:!1,childList:!1,subtree:!1,attributes:!0,attributeOldValue:!1,attributeFilter:["style"],valueParser:(n,o)=>{for(let i of o)if(i.type==="attributes"&&i.attributeName==="style"){let r=i.target,l=r.style.getPropertyValue("display");return{view:r.id,state:l}}}})}A.HSGameState.viewProperties.forEach(async(t,a)=>{for(let n of t.subViewIds){let o=document.querySelector(`#${n}`);S.watchElement(o,async i=>{let{view:r,state:l}=i;if(l!=="none"){let u;try{let d=this.#t[t.viewClassName];if(!d)throw new Error(`Class "${t.viewClassName}" not found in viewClasses for mainViewId ${a}`);u=new d(n)}catch(d){c.warn(`Failed to instantiate sub-view ${t.viewClassName}: ${d}`,e.context);return}let g=u.getViewKey();if(u.getId()!==e.#e){e.#a[g].previousView=e.#a[g].currentView,e.#a[g].currentView=u;let d=e.#a[g].previousView,m=e.#a[g].currentView;e.#a[g].viewChangeSubscribers.forEach(b=>{try{b(d,m)}catch(h){c.error(`Error when trying to call CUBE VIEW change subscriber callback: ${h}`,e.context)}}),c.debug(`Subview changed ${d.getName()} -> ${m.getName()}`,e.context)}else{c.warn(`Subview ${r} not found`,e.context);return}}},{characterData:!1,childList:!1,subtree:!1,attributes:!0,attributeOldValue:!1,attributeFilter:["style"],valueParser:(i,r)=>{for(let l of r)if(l.type==="attributes"&&l.attributeName==="style"){let u=l.target,g=u.style.getPropertyValue("display");return{view:u.id,state:g}}}})}}),this.isInitialized=!0}subscribeGameStateChange(e,t){let a=p.uuidv4();return this.#a[e].viewChangeSubscribers.set(a,t),a}unsubscribeGameStateChange(e,t){this.#a[e].viewChangeSubscribers.has(t)?this.#a[e].viewChangeSubscribers.delete(t):c.warn(`Subscription ID ${t} not found for view key ${e}`,this.context)}async#i(e){let t=this,a=A.HSGameState.viewProperties.get(e);if(!a){c.debug(`No view properties found for main view ID ${e}`,this.context);return}(await S.HookElements(a.subViewsSelector)).forEach(async o=>{let i=o.id;if(o.style.getPropertyValue("display")!=="none"){let l;try{let g=this.#t[a.viewClassName];if(!g)throw new Error(`Class "${a.viewClassName}" not found in viewClasses for mainViewId ${e}`);l=new g(i)}catch(g){c.warn(`Failed to instantiate sub-view ${a.viewClassName} for tab ${i}: ${g}`,t.context);return}let u=l.getViewKey();if(l&&l.getId()!==this.#e){t.#a[u].previousView=t.#a[u].currentView,t.#a[u].currentView=l;let g=t.#a[u].previousView,d=t.#a[u].currentView;t.#a[u].viewChangeSubscribers.forEach(m=>{try{m(g,d)}catch(b){c.error(`Error when trying to call VIEW change subscriber callback: ${b}`,t.context)}})}else c.warn(`Sub-view tab ${i} (for ${a.viewClassName}) resolved to UNKNOWN or failed to initialize.`,t.context)}})}getCurrentUIView(e){return this.#a[e].currentView}},ue=class{#e;#t;constructor(e,t){this.#e=e,this.#t=t}getName(){return this.#e}getViewKey(){return this.#t}},se=class extends ue{#e;constructor(e){super(e,"MAIN_VIEW"),this.#e=this.getViewEnum(e)}getViewEnum(e){switch(e){case"buildings":return 1;case"upgrades":return 2;case"statistics":return 3;case"runes":return 4;case"challenges":return 5;case"research":return 6;case"ants":return 7;case"cubes":return 8;case"campaigns":return 9;case"traits":return 10;case"settings":return 11;case"shop":return 12;case"singularity":return 13;case"event":return 14;case"pseudoCoins":return 15}return-1}getId(){return this.#e}},le=class extends ue{#e;constructor(e){super(e,"CUBE_VIEW"),this.#e=this.getViewEnum(e)}getViewEnum(e){switch(e){case"cubeTab1":return 1;case"cubeTab2":return 2;case"cubeTab3":return 3;case"cubeTab4":return 4;case"cubeTab5":return 5;case"cubeTab6":return 6;case"cubeTab7":return 7}return-1}getId(){return this.#e}},ce=class extends ue{#e;constructor(e){super(e,"SINGULARITY_VIEW"),this.#e=this.getViewEnum(e)}getViewEnum(e){switch(e){case"singularitycontainer1":return 1;case"singularityContainer2":return 2;case"singularityContainer3":return 3;case"singularityContainer4":return 4;case"singularityContainer5":return 5}return-1}getId(){return this.#e}};var K=class{#e;constructor(e){this.#e=e}get patchName(){return this.#e}};var Ue=class extends K{#e=`
        ...
        }`;#t="ambrosiaViewOverflowPatch";async applyPatch(){y.injectStyle(this.#e,this.#t)}async revertPatch(){y.removeInjectedStyle(this.#t)}};var Pe=class extends K{async applyPatch(){}async revertPatch(){}};var Et=`{
...
}`;var Qe=class extends K{#e;#t;async applyPatch(){let e=this;try{this.#e=JSON.parse(Et);let t=await S.HookElement("#actualShop");t&&(this.#t||(this.#t=a=>{e.#a(a)}),t.removeDelegateEventListener("mouseover","div",this.#t),t.delegateEventListener("mouseover","div",this.#t))}catch{c.error("Failed to parse shop item map"),this.#e=void 0}}#a(e){let t;if(e.target instanceof HTMLDivElement)t=e.target;else if(e.target instanceof HTMLImageElement||e.target instanceof HTMLParagraphElement||e.target instanceof HTMLButtonElement)t=e.target.parentElement;else return;if(t.id==="actualShop")return;let a=t.querySelector("img");if(a){let n=a.id,o=this.#e?.[n],i=document.querySelector("#shopHovers"),r=i.querySelector("#hs-shopHoverName");if(r)r.innerText=o||"";else{let l=document.createElement("div");l.id="hs-shopHoverName",l.innerText=o||"",i.insertBefore(l,i.querySelector("p:nth-child(2)"))}}}async revertPatch(){if(this.#t){let t=await S.HookElement("#actualShop");t&&t.removeDelegateEventListener("mouseover","div",this.#t)}let e=document.querySelector("#hs-shopHoverName");e&&e.remove()}};var Oe=class extends K{async applyPatch(){let e=await S.HookElement("#buildingstab");e.style.color="red"}async revertPatch(){let e=await S.HookElement("#buildingstab");e.style.color=""}};var Ve=class extends L{#e={AmbrosiaViewOverflow:Ue,TestPatch:Oe,ShopItemNameMapping:Qe,IconSetCaching:Pe};#t={};constructor(e){super(e)}async init(){c.log("Initializing HSPatches module",this.context),this.isInitialized=!0}async applyPatch(e){let t=this.#e[e];if(!t){c.warn(`Patch "${e}" not found`,this.context);return}let a;this.#t[e]?(c.debug(`Patch "${e}" is already instantiated`,this.context),a=this.#t[e]):(a=new t(e),this.#t[e]=a),await a.applyPatch()}async revertPatch(e){let t=this.#e[e];if(!t){c.warn(`Patch "${e}" not found`,this.context);return}let a;this.#t[e]?a=this.#t[e]:(a=new t(e),this.#t[e]=a),await a.revertPatch()}};var Ye=class extends L{#e="Synergysave2";#t;#a;#r=!1;#i;#n;#o=`
        #savegame {
...
${o}`,this.context),y.Notify("Failed to calculate game data for heater export",{position:"top",notificationType:"error"});return}}};var Fe=class extends L{#e=new Map;#t=[5e3,15e3,3e4,6e4];constructor(e){super(e)}async init(){c.log("Initializing HSWebsocket module",this.context),this.isInitialized=!0}#a(e){let t=this.#e.get(e);if(!t){c.warn(`Tried to reconnect websocket ${e} but it doesn't exist`,this.context);return}this.#e.delete(e),this.registerWebSocket(e,t.regParams)}registerWebSocket(e,t){let a=this;if(this.#e.has(e)){c.warn(`Tried to register websocket ${e} again`,this.context);return}if(!t.url){c.error(`Tried to register websocket ${e} without a URL`,this.context);return}let n={socket:new WebSocket(t.url),reconnectionTries:0,onClose:t.onClose??p.Noop,onOpen:t.onOpen??p.Noop,onMessage:t.onMessage??p.Noop,onRetriesFailed:t.onRetriesFailed??p.Noop,regParams:t},o=async l=>{let u=a.#e.get(e);console.log("WS CLOSED",e,{code:l.code,reason:l.reason,wasClean:l.wasClean,tries:u?.reconnectionTries});let g=a.#t[++n.reconnectionTries];g!==void 0?(c.log(`Reconnecting ${e} in ${g}ms (attempt ${n.reconnectionTries})`,a.context),setTimeout(()=>{a.#a(e)},g)):(c.warn(`WebSocket ${e} failed to reconnect after ${n.reconnectionTries} tries`),await(n.onRetriesFailed??p.Noop)()),await(n.onClose??p.Noop)(l)},i=async l=>{let u=a.#e.get(e);if(!u){c.warnOnce(`wsOnOpen(): Socket ${e} not found`,a.context);return}let g;try{g=JSON.parse(l.data)}catch(d){c.warn(`Failed to parse WebSocket message for ${e}: ${d}`,this.context),g=void 0}await(u.onMessage??p.Noop)(g)},r=async l=>{let u=a.#e.get(e);if(!u){c.warnOnce(`wsOnOpen(): Socket ${e} not found`,a.context);return}u.reconnectionTries=0,c.log(`WebSocket ${e} connected successfully`,a.context),await(u.onOpen??p.Noop)(l)};n.socket.onclose=o,n.socket.onopen=r,n.socket.onmessage=i,this.#e.set(e,n),c.log(`Registered websocket ${e}`,this.context)}unregisterWebSocket(e){let t=this.#e.get(e);t?((t.socket.readyState===WebSocket.OPEN||t.socket.readyState===WebSocket.CONNECTING)&&t.socket.close(),this.#e.delete(e),c.log(`Unregistered websocket ${e}`,this.context)):c.debug(`Could not unregister websocket (Maybe you're not logged in?) ${e}`,this.context)}getWebSocket(e){return this.#e.get(e)}};var ze=class s extends L{static#e;constructor(e){super(e),s.#e=e.context}async init(){let e=this;this.isInitialized=!0}};var Ze=class{constructor(){this.timerDisplay=null;this.timerHeader=null;this.timerContent=null;this.isMinimized=!1;this.isDragging=!1;this.isResizing=!1;this.dragOffset={x:0,y:0};this.resizeStart={width:0,height:0,x:0,y:0};this.timestamps=[];this.quarksHistory=[];this.startTime=0;this.createTimerDisplay(),this.setupDragAndResize()}createTimerDisplay(){this.timerDisplay=document.createElement("div"),this.timerDisplay.id="hs-autosing-timer-display",this.timerDisplay.style.cssText=`
        ...
        `;let e=document.createElement("span");e.textContent="\u23F1\uFE0F Autosing Timer",e.style.fontWeight="bold";let t=document.createElement("button");t.textContent="\u2212",t.style.cssText=`
            ...
            align-items: center;
            justify-content: center;
        `,t.onmouseover=()=>{t.style.background="rgba(255, 255, 255, 0.3)"},t.onmouseout=()=>{t.style.background="rgba(255, 255, 255, 0.2)"},t.onclick=()=>this.toggleMinimize(),this.timerHeader.appendChild(e),this.timerHeader.appendChild(t),this.timerContent=document.createElement("div"),this.timerContent.style.cssText=`
            padding: 12px;
            background: rgba(0, 0, 0, 0.9);
        ...
        `,a.onmousedown=n=>this.startResize(n),this.timerDisplay.appendChild(this.timerHeader),this.timerDisplay.appendChild(this.timerContent),this.timerDisplay.appendChild(a),document.body.appendChild(this.timerDisplay)}setupDragAndResize(){!this.timerHeader||!this.timerDisplay||(this.timerHeader.onmousedown=e=>{(e.target===this.timerHeader||e.target.tagName==="SPAN")&&this.startDrag(e)},document.addEventListener("mousemove",e=>{this.isDragging?this.drag(e):this.isResizing&&this.resize(e)}),document.addEventListener("mouseup",()=>{this.isDragging=!1,this.isResizing=!1}))}startDrag(e){if(!this.timerDisplay)return;this.isDragging=!0;let t=this.timerDisplay.getBoundingClientRect();this.dragOffset.x=e.clientX-t.left,this.dragOffset.y=e.clientY-t.top}drag(e){if(!this.timerDisplay||!this.isDragging)return;let t=e.clientX-this.dragOffset.x,a=e.clientY-this.dragOffset.y;this.timerDisplay.style.left=`${t}px`,this.timerDisplay.style.top=`${a}px`,this.timerDisplay.style.right="auto",this.timerDisplay.style.bottom="auto"}startResize(e){if(!this.timerDisplay)return;e.preventDefault(),this.isResizing=!0;let t=this.timerDisplay.getBoundingClientRect();this.resizeStart={width:t.width,height:t.height,x:e.clientX,y:e.clientY}}resize(e){if(!this.timerDisplay||!this.isResizing)return;let t=e.clientX-this.resizeStart.x,a=e.clientY-this.resizeStart.y,n=Math.max(200,this.resizeStart.width+t),o=Math.max(100,this.resizeStart.height+a);this.timerDisplay.style.width=`${n}px`,this.timerDisplay.style.height=`${o}px`}toggleMinimize(){if(!(!this.timerContent||!this.timerDisplay))if(this.isMinimized=!this.isMinimized,this.isMinimized){this.timerContent.style.display="none",this.timerDisplay.style.height="auto";let e=this.timerHeader?.querySelector("button");e&&(e.textContent="+")}else{this.timerContent.style.display="block",this.timerDisplay.style.height="";let e=this.timerHeader?.querySelector("button");e&&(e.textContent="\u2212")}}start(){this.timestamps=[],this.quarksHistory=[],this.startTime=performance.now()}recordSingularity(e){let t=performance.now();this.timestamps.push(t),this.quarksHistory.push(e),this.updateDisplay()}getSingularityCount(){return Math.max(0,this.timestamps.length)}getLastDuration(){return this.timestamps.length<2?null:(this.timestamps[this.timestamps.length-1]-this.timestamps[this.timestamps.length-2])/1e3}getAverageLast(e){if(e<=0||this.timestamps.length<=e)return null;let t=0;for(let a=1;a<=e;a++)t+=this.timestamps[this.timestamps.length-a]-this.timestamps[this.timestamps.length-(a+1)];return t/e/1e3}getQuarksPerSecond(){if(this.quarksHistory.length<2)return null;let e=this.quarksHistory[0],a=this.quarksHistory[this.quarksHistory.length-1]-e,n=(this.timestamps[this.timestamps.length-1]-this.startTime)/1e3;return n<=0?null:a/n}getLastQuarksGained(){return this.quarksHistory.length<2?null:this.quarksHistory[this.quarksHistory.length-1]-this.quarksHistory[this.quarksHistory.length-2]}formatNumber(e){return e.toExponential(2).replace("+","")}updateDisplay(){if(!this.timerContent)return;let e=this.getSingularityCount(),t=this.getLastDuration(),a=this.getAverageLast(5),n=this.getAverageLast(10),o=this.getAverageLast(50),i=this.getAverageLast(e-1),r=this.getQuarksPerSecond(),l=this.getLastQuarksGained(),u=this.quarksHistory.length>0?this.quarksHistory[this.quarksHistory.length-1]:0,g=`<style>
...
</style>`;g+=`<div style="margin-bottom: 8px; padding-bottom: 8px; border-bottom: 1px solid #444;">
