...
.hs-export-btn:active {
    transform: translateY(0);
            ...
            <div style="margin-bottom: 4px;">Time: <span style="color: #00E676; font-weight: bold; font-size: 16px;">${this.currentLiveTime.toFixed(1)}s</span></div>`,this._currentPhaseName){let h=(performance.now()-this.currentPhaseStart)/1e3;m+=`<div>Phase: <span style="color: #FF6B6B; font-weight: bold;">${this._currentPhaseName}</span> (<span style="color: #FFD93D;">${h.toFixed(1)}s</span>)</div>`}if(m+="</div>",m+=`<div style="margin-bottom: 8px; padding-bottom: 8px; border-bottom: 1px solid #444;">
            ...
            <div style="font-size: 11px; color: #888; margin-bottom: 4px;">TIMING</div>`,t!==null&&(m+=`<div style="margin-bottom: 4px;">Last: <span style="color: #2196F3; font-weight: bold;">${t.toFixed(1)}s</span></div>`),a!==null&&(m+=`<div style="margin-bottom: 4px;">Avg (5): <span style="color: #9C27B0; font-weight: bold;">${a.toFixed(1)}s</span></div>`),n!==null&&(m+=`<div style="margin-bottom: 4px;">Avg (10): <span style="color: #19ae11; font-weight: bold;">${n.toFixed(1)}s</span></div>`),o!==null&&(m+=`<div style="margin-bottom: 4px;">Avg (50): <span style="color: #FF9800; font-weight: bold;">${o.toFixed(1)}s</span></div>`),i!==null&&(m+=`<div>Avg (All): <span class="hs-rainbow-text">${i.toFixed(1)}s</span></div>`),m+="</div>",this.phaseHistory.size>0){m+=`<div style="margin-bottom: 8px; padding-bottom: 8px; border-bottom: 1px solid #444;">
