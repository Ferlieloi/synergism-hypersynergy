...
.hs-export-btn:active {
    transform: translateY(0);
            ...
            <div>Singularities: <span style="color: #4CAF50; font-weight: bold;">${e}</span></div>
                ...
                <div style="margin-bottom: 4px;">Total: <span style="color: #FFD700; font-weight: bold;">${this.formatNumber(u)}</span></div>`,i!==null&&i>0&&(h+=`<div>Rate: <span style="color: #ffbf00; font-weight: bold;">${this.formatNumber(i)}/s</span></div>`),h+="</div>"),h+=`<div style="margin-bottom: 8px; padding-bottom: 8px; border-bottom: 1px solid #444;">
            <div style="font-size: 11px; color: #888; margin-bottom: 4px;">TIMING</div>`,t!==null&&(h+=`<div style="margin-bottom: 4px;">Last: <span style="color: #2196F3; font-weight: bold;">${t.toFixed(2)}s</span></div>`),a!==null&&(h+=`<div style="margin-bottom: 4px;">Avg (5): <span style="color: #9C27B0; font-weight: bold;">${a.toFixed(2)}s</span></div>`),n!==null&&(h+=`<div style="margin-bottom: 4px;">Avg (10): <span style="color: #19ae11; font-weight: bold;">${n.toFixed(2)}s</span></div>`),o!==null&&(h+=`<div style="margin-bottom: 4px;">Avg (50): <span style="color: #FF9800; font-weight: bold;">${o.toFixed(2)}s</span></div>`),r!==null&&(h+=`<div>Avg (All): <span class="hs-rainbow-text">${r.toFixed(2)}s</span></div>`),h+="</div>",this.phaseHistory.size>0){h+=`<div style="margin-bottom: 8px; padding-bottom: 8px; border-bottom: 1px solid #444;">
                <div style="font-size: 11px; color: #888; margin-bottom: 4px;">PHASE STATISTICS</div>`;let A=Array.from(this.phaseHistory.entries()).sort((M,E)=>M[1].totalTime-E[1].totalTime);for(let[M,E]of A){let f=this.getPhaseAverage(M);f!==null&&(h+=`<div style="margin-bottom: 2px; font-size: 12px;">
