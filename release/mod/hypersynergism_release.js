...
`)
        ...
        #e; #t; #a; #r; #i = "white-space: nowrap; user-select: all; -webkit-user-select: all; -moz-user-select: all; -ms-user-select: all;"; constructor(e) { super(e), this.#a = { attributes: !1, childList: !0, subtree: !0 }, this.#r = new MutationObserver((t, a) => { this.#s(t, a) }) } async init() { c.log("Initialising HSCodes module", this.context); let e = this; this.#t = await v.HookElement("#promocodes"), this.#t.addEventListener("click", function (t) { e.#e = document.querySelector("#promptWrapper > #prompt > label"), e.#e && (e.#o(), e.#e.innerHTML = "", e.#n()) }, { capture: !0 }), this.#e = await v.HookElement("#promptWrapper > #prompt > label"), this.#n(), this.isInitialized = !0 } #n() { this.#r?.disconnect(), this.#r?.observe(this.#e, this.#a) } #o() { this.#r?.disconnect() } #s(e, t) {
            let a = this; try {
                ...
                </div>`, document.delegateEventListener("click", "#hs-hijack-codes-wrapper > span", function (o) { let r = this.dataset.code, i = document.querySelector("#prompt_text"); r && i ? i.value = r : c.warn("Could not inject code to code input", a.context) }, !0), c.debug("Hijacked code redeem panel", this.context)
                }
            } finally { this.#n() }
        }
...

    {
        ...
        static #e = "HSUIC"; static #t(e) { if (!e) return ""; let t = ""; for (let [a, n] of e.entries()) t += `data-${a}="${n}" `; return t } static #a(e) { switch (e) { case 1: return "checkbox"; case 2: return "color"; case 3: return "number"; case 4: return "text"; case 5: return "select"; case 6: return "state" } } static #r(e) { switch (e) { case 1: return "hs-panel-input-checkbox"; case 2: return "hs-panel-input-color"; case 3: return "hs-panel-input-number"; case 4: return "hs-panel-input-text"; case 5: return "hs-panel-input-select"; case 6: return "hs-panel-input-state" } } static #i(e) { if (!e) return ""; let t = ""; for (let [a, n] of Object.entries(e)) typeof n !== void 0 && (t += ` ${a}="${n}"`); return t } static Button(e) {
            let t = e.class ?? "", a = e.text ?? "", n = e.id ?? p.domid(), o = this.#i(e.props), r = this.#t(e.data); return S.injectStyle(`#${n} {
            ${p.objectToCSS(e.styles)}
        }`), `<div class="hs-panel-btn ${t}" id="${n}"${o} ${r}>${a}</div>`
        } static Input(e) {
            let t = e.class ?? "", a = this.#a(e.type), n = this.#r(e.type), o = e.id ?? p.domid(), r = this.#i(e.props), i = this.#t(e.data); return S.injectStyle(`#${o} {
            ${p.objectToCSS(e.styles)}
        }`), `<input type="${a}" class="${n} ${t}" id="${o}"${r} ${i}></input>`
        } static Select(e, t) {
            let a = e.class ?? "", n = this.#a(e.type), o = this.#r(e.type), r = e.id ?? p.domid(), i = this.#i(e.props), l = this.#t(e.data); S.injectStyle(`#${r} {
            ${p.objectToCSS(e.styles)}
        }`); let u = t.map(d => `<option value="${d.value}" ${d.selected ? "selected" : ""}>${d.text}</option>`).join(`
`); return `<select class="${o} ${a}" id="${r}"${i} ${l}>${u}</select>`
        } static Div(e) {
            let t = e.class ?? "", a = e.id ?? p.domid(), n = "", o = this.#i(e.props), r = this.#t(e.data); return e.html && (Array.isArray(e.html) ? n = e.html.join(`
`) : n = e.html), S.injectStyle(`#${a} {
            ${p.objectToCSS(e.styles)}
        }`), `<div class="hs-panel-div ${t}" ${a ? `id="${a}"` : ""}${o} ${r}>${n}</div>`
        } static P(e) {
            let t = e.class ?? "", a = e.id ?? p.domid(), n = "", o = this.#i(e.props), r = this.#t(e.data); return e.text && (Array.isArray(e.text) ? n = e.text.join(`
`) : n = e.text), S.injectStyle(`#${a} {
            ${p.objectToCSS(e.styles)}
        }`), `<p class="hs-panel-p ${t}" ${a ? `id="${a}"` : ""}${o} ${r}>${n}</p>`
        } static Image(e) {
            let t = e.class ?? "", a = e.id ?? p.domid(), n = this.#i(e.props), o = this.#t(e.data); if (!e.src) return c.warn("HSUIC.Image: No src provided for image component", this.#e), ""; let r = e.width ? e.width : b.HSUIC.defaultImageWidth, i = e.height ? e.height : b.HSUIC.defaultImageHeight; return S.injectStyle(`#${a} {
            ${p.objectToCSS(e.styles)}
        }`), `<img src="${e.src}" width="${r}" height="${i}" class="hs-panel-img ${t}" ${a ? `id="${a}"` : ""}${n} ${o}/>`
        } static Grid(e) {
            let t = e.class ?? "", a = e.id ?? p.domid(), n = "", o = this.#i(e.props), r = this.#t(e.data); return e.html && (Array.isArray(e.html) ? n = e.html.join(`
`) : n = e.html), S.injectStyle(`#${a} {
            display: grid;
            ${p.objectToCSS(e.styles)}
        }`), `<div class="hs-panel-div ${t}" id="${a}"${o} ${r}>${n}</div>`
        } static Flex(e) {
            let t = e.class ?? "", a = e.id ?? p.domid(), n = "", o = this.#i(e.props), r = this.#t(e.data); return e.html && (Array.isArray(e.html) ? n = e.html.join(`
`) : n = e.html), S.injectStyle(`#${a} {
            display: flex;
            ...
            let t = e.class ?? "", a = e.htmlContent ?? "", n = e.data ?? [], o = e.title ?? "", r = e.id ?? p.domid(), i = this.#i(e.props), l = this.#t(e.data); return S.injectStyle(`#${r} {
            ${p.objectToCSS(e.styles)}
...
@-webkit-keyframes hs-animtext-1 {
    ...
    <div class="hs-resizer"></div>
        ...
        let t = "hs-autosing-corruption-modal", a = Object.keys(fe).map(r => `
    ...
    `).join(""), n = {
        ...
        `, title: "Configure Corruption Loadout"
            }, o = await s.Modal(n); setTimeout(() => { document.getElementById("hs-corruption-save-btn")?.addEventListener("click", () => { Object.keys(fe).forEach(r => { let i = document.getElementById(`hs-corruption-${r}`), l = Math.max(0, Math.min(16, Number(i?.value) || 0)); e[r] = l }), S.removeInjectedStyle("hs-corruption-modal-styles"), s.CloseModal(o) }) }, 0)
    } async function Mt(s, e, t, a) {
        let n = "hs-autosing-challenges-modal", o = [...e], r = x => ie.find(I => I.value === x)?.label ?? null, i = x => x.challengeNumber === 200 && x.ifJump !== void 0, l = x => `${x.toLocaleString()}ms`, u = (x, I) => `
    ...
    `, g = (x, I) => {
                let R = r(x.challengeNumber), B = !!R, D = B ? `<strong>${R}</strong>` : `Challenge ${x.challengeNumber}
    ...
    <div id="${n}" class="hs-challenges-modal-container">
        ...
        let o = !!n, r = e.length ? e[e.length - 1].endPhase : "start", i = n?.corruptions || { viscosity: 0, drought: 0, deflation: 0, extinction: 0, illiteracy: 0, recession: 0, dilation: 0, hyperchallenge: 0 }, l = n?.strat || [], u = q.indexOf(r), g = q.slice(u + 1).map((A, M) => `<option value="${A}" ${n?.endPhase === A || M === 0 ? "selected" : ""}>${A}</option>`).join(""), m = {
            htmlContent: `
        ...
        static async open(e, t) {
            let a = H.getModule("HSUI"); if (!a || !a.uiReady) return; let n = !!e, o = e ? { strategyName: e.strategyName, strategy: JSON.parse(JSON.stringify(e.strategy)) } : { strategyName: "", strategy: [] }, r = () => { for (let d = 1; d < o.strategy.length; d++) { let g = o.strategy[d - 1], m = o.strategy[d]; m.startPhase = g.endPhase } }, i = () => {
...
`; var Le = class extends L {
        #e; #t; #a = null; #r = []; #i = null; #n = null; #o = new Map; #s; #l; #u; #m = new Map; #g = `
    ...
    `; #f = "hs-ambrosia-idle-loadout-css"; #v = "hs-ambrosia-minibar-css"; #A = !1; #M; #p; #c; #S = !1; #b; #y; constructor(e) { super(e) } async init() { let e = this; c.log("Initializing HSAmbrosia module", this.context), this.#a = await v.HookElement("#blueberryUpgradeContainer"), this.#r = await v.HookElements(".blueberryLoadoutSlot"), this.#i = await v.HookElement("#bbLoadoutContainer"), this.#c = document.querySelector("#hs-panel-debug-gamedata-currentambrosia"), this.loadState(), await this.#B(), c.log("Hooking stuff", this.context); for (let [t, a] of b.HSAmbrosia.ambrosiaLoadoutIcons.entries()) { let n = document.querySelector(`#${a.draggableIconId}`); n && (n.draggable = !0, n.dataset.hsid = t, n.addEventListener("dragstart", o => { if (!o.dataTransfer) return; let r = o.currentTarget?.dataset.hsid; r && (c.log(`Drag start ${r}`, this.context), o.dataTransfer.effectAllowed = "move", o.dataTransfer.setData("hs-amb-drag", r)) })) } if (!this.#i) { c.warn("Could not find loadout container", this.context); return } this.#r.forEach(t => { let a = t.id; if (a) { let n = this.#x(a); if (n) { let o = this.#o.get(n); o && this.#N(n, o) } } }), this.#i.delegateEventListener("dragenter", ".blueberryLoadoutSlot", t => { t.dataTransfer && t.dataTransfer.types.includes("hs-amb-drag") && (t.preventDefault(), t.stopPropagation(), t.dataTransfer.effectAllowed = "move") }), this.#i?.delegateEventListener("dragover", ".blueberryLoadoutSlot", t => { t.dataTransfer && t.dataTransfer.types.includes("hs-amb-drag") && (t.preventDefault(), t.stopPropagation(), t.dataTransfer.effectAllowed = "move") }), this.#i?.delegateEventListener("drop", ".blueberryLoadoutSlot", async t => { if (t.dataTransfer && t.dataTransfer.types.includes("hs-amb-drag")) { t.preventDefault(), t.stopPropagation(); let a = this.#G(t.dataTransfer.getData("hs-amb-drag")), n = t.target, o = n.id; if (!a) { c.warn(`Invalid icon ID: ${a}`, this.context); return } if (!b.HSAmbrosia.ambrosiaLoadoutIcons.has(a)) { c.warn(`Could not find loadout slot entry for ${a}`, this.context); return } if (!n.classList.contains("blueberryLoadoutSlot") || !o) return; let r = this.#x(o); if (!r) { c.warn(`Invalid slot ID: ${o}`, this.context); return } let i = b.HSAmbrosia.ambrosiaLoadoutIcons.get(a); this.#N(r, a), this.#o.set(r, a), this.saveState(), await e.updateQuickBar() } }), this.#i?.delegateEventListener("contextmenu", ".blueberryLoadoutSlot", async t => { t.preventDefault(); let a = t.target, n = a.id, o = this.#x(n); if (!o) { c.warn(`Invalid slot ID: ${n}`, this.context); return } if (!this.#o.get(o)) { c.warn(`No icon found for slot ID: ${n}`, this.context); return } a.classList.remove("hs-ambrosia-slot"), a.style.backgroundImage = "", this.#o.delete(o), this.saveState(), await e.updateQuickBar() }), this.#i?.delegateEventListener("click", ".blueberryLoadoutSlot", async t => { let n = t.target.id, o = this.#x(n); if (!o) { c.warn(`Invalid slot ID: ${n}`, this.context); return } await e.#w(o) }), this.#n = await v.HookElement("header"), this.#n && (await this.#E(), await this.#R()), this.isInitialized = !0 } async disableBerryMinibars() { this.#n || (this.#n = await v.HookElement("header")); let e = this.#n?.querySelector(`#${b.HSAmbrosia.barWrapperId}`); e ? (e.style.display = "none", S.removeInjectedStyle(this.#v)) : c.warn("Could not find bar wrapper element", this.context), this.#S = !1, this.unsubscribeGameDataChanges() } async enableBerryMinibars() { if (this.#n || (this.#n = await v.HookElement("header")), !this.#n) return; let e = this.#n.querySelector(`#${b.HSAmbrosia.barWrapperId}`); e ? (e.style.display = "block", S.injectStyle(Et, this.#v), this.subscribeGameDataChanges(), this.#S = !0) : c.warn("Could not find minibar wrapper", this.context) } async#E() { if (!this.#n) return; if (this.#n.querySelector(`#${b.HSAmbrosia.barWrapperId}`)) { c.warn("Minibar wrapper already exists", this.context); return } let t = (await v.HookElement("#ambrosiaProgressBar")).cloneNode(!0), a = t.querySelector("#ambrosiaProgress"), n = t.querySelector("#ambrosiaProgressText"); t.id = b.HSAmbrosia.blueBarId, a.id = b.HSAmbrosia.blueBarProgressId, n.id = b.HSAmbrosia.blueBarProgressTextId; let r = (await v.HookElement("#pixelProgressBar")).cloneNode(!0), i = r.querySelector("#pixelProgress"), l = r.querySelector("#pixelProgressText"); r.id = b.HSAmbrosia.redBarId, i.id = b.HSAmbrosia.redBarProgressId, l.id = b.HSAmbrosia.redBarProgressTextId; let u = document.createElement("div"); u.id = b.HSAmbrosia.barWrapperId, u.style.display = "none", u.appendChild(t), u.appendChild(r); let g = this.#n.querySelector("#hs-ambrosia-quickbar-wrapper") || this.#n.querySelector("nav.navbar"); this.#n.insertBefore(u, g), this.#b = a, this.#y = i } async#w(e) { this.#s = e; let t = C.getSetting("autoLoadoutState"); t && t.setValue(`<green>${e}</green>`), this.#n || (this.#n = await v.HookElement("header")); let a = this.#n.querySelector(`#${b.HSAmbrosia.quickBarId}`); if (a) { a.querySelectorAll(".blueberryLoadoutSlot").forEach(r => { r.classList.remove("hs-ambrosia-active-slot") }); let o = a.querySelector(`[data-original-id="${e}"]`); o && o.classList.add("hs-ambrosia-active-slot") } else c.warn("Could not find quick bar element", this.context); let n = document.querySelector("#bbLoadoutContainer"); if (n) { n.querySelectorAll(".blueberryLoadoutSlot").forEach(r => { r.classList.remove("hs-ambrosia-active-slot") }); let o = n.querySelector(`#${e}`); o && o.classList.add("hs-ambrosia-active-slot") } } async#R() { if (!this.#n) return; let e = this; if (this.#n.querySelector(`#${b.HSAmbrosia.quickBarId}`)) { c.debug("Quickbar wrapper already exists", this.context); return } if (this.#i) { let a = this.#n.querySelector("nav.navbar"), n = this.#i.cloneNode(!0); n.id = b.HSAmbrosia.quickBarId, n.style.display = "none"; let o = n.querySelector(".blueberryLoadoutSetting"); n.querySelectorAll(".blueberryLoadoutSlot").forEach(i => { let l = i.id; i.dataset.originalId = l, i.id = `${b.HSAmbrosia.quickBarLoadoutIdPrefix}-${l}`; let u = async function (d) { await e.#U(d, l) }; this.#m.set(i, u), i.addEventListener("click", u) }), o && o.remove(), this.#n.insertBefore(n, a), S.injectStyle(this.#g, this.#d), await this.#C(), this.#s && await this.#w(this.#s) } } async showQuickBar() { this.#n || (this.#n = await v.HookElement("header")); let e = this.#n?.querySelector(`#${b.HSAmbrosia.quickBarId}`); e ? (e.style.display = "", S.injectStyle(this.#g, this.#d), await this.#C(), this.#s && await this.#w(this.#s)) : c.warn("Could not find quickbar wrapper", this.context) } async hideQuickBar() { this.#n || (this.#n = await v.HookElement("header")); let e = this.#n?.querySelector(`#${b.HSAmbrosia.quickBarId}`); e && (e.style.display = "none", S.removeInjectedStyle(this.#d)) } async#C() { let e = this.#n?.querySelector(`#${b.HSAmbrosia.quickBarId}`); if (!e) return; e.querySelectorAll(".blueberryLoadoutSlot").forEach(a => { let n = a.dataset.originalId; if (!n) return; let o = this.#x(n); if (!o) return; let r = this.#o.get(o); if (r) { let i = b.HSAmbrosia.ambrosiaLoadoutIcons.get(r); i && (a.classList.add("hs-ambrosia-slot"), a.style.backgroundImage = `url(${i.url})`) } else a.classList.remove("hs-ambrosia-slot"), a.style.backgroundImage = "" }), this.#s && await this.#w(this.#s) } #D(e, t) { let a = `${b.HSAmbrosia.quickBarLoadoutIdPrefix} -${e} `, n = document.querySelector(`#${a} `); if (!n) { c.warn(`Could not find quickbar slot element for ${e}`, this.context); return } let o = b.HSAmbrosia.ambrosiaLoadoutIcons.get(t); if (!o) { c.warn(`Could not find icon for ${t}`, this.context); return } n.classList.add("hs-ambrosia-slot"), n.style.backgroundImage = `url(${o.url})` } #G(e) { return Object.values(he).find(t => t === e) } #x(e) { return Object.values(me).find(t => t === e) } #N(e, t) { let a = document.querySelector(`#${e} `); if (!a) { c.warn(`Could not find slot element for ${e}`, this.context); return } let n = b.HSAmbrosia.ambrosiaLoadoutIcons.get(t); if (!n) { c.warn(`Could not find icon for ${t}`, this.context); return } a.classList.add("hs-ambrosia-slot"), a.style.backgroundImage = `url(${n.url})` } async saveState() { let e = H.getModule("HSStorage"); if (e) { let t = JSON.stringify(Array.from(this.#o.entries())); e.setData(b.HSAmbrosia.storageKey, t) } else c.warn("saveState - Could not find storage module", this.context) } async loadState() { let e = H.getModule("HSStorage"); if (e) { let a = e.getData(b.HSAmbrosia.storageKey); if (!a) { c.warn("loadState - No data found", this.context); return } try { let n = JSON.parse(a); this.#o = new Map(n) } catch { c.warn("loadState - Error parsing data", this.context); return } } else c.warn("loadState - Could not find storage module", this.context); let t = C.getSetting("autoLoadoutState"); t && !this.#s ? this.#s = p.removeColorTags(t.getValue()) : c.warn("loadState - Could not find autoLoadoutState setting", this.context) } async#B() { let e = await v.HookElement("#importBlueberriesButton"); if (!e || document.getElementById("hs-ambrosia-extra-btn")) return; let t = document.createElement("button"); t.id = "hs-ambrosia-extra-btn", t.className = "ambrosiaLoadoutBtn", t.textContent = "Quick Import", e.parentElement?.insertBefore(t, e.nextSibling), t.addEventListener("click", () => this.#L()) } async updateQuickBar() { C.getSetting("ambrosiaQuickBar").isEnabled() && await this.#C() } async enableAutoLoadout() { let e = this, t = C.getSetting("autoLoadoutState"); if (t && t.getValue().includes("Unknown") || !this.#s) { let d = C.getSetting("autoLoadout"); d && d.isEnabled() && d.disable(), c.warn("Could not enable auto loadout - current loadout state is not known!", this.context); return } let a = [v.HookElement("#addCode"), v.HookElement("#addCodeAll"), v.HookElement("#addCodeOne"), v.HookElement("#timeCode")], o = (await Promise.allSettled(a)).map((d, g) => d.status === "fulfilled" ? d.value : null); if (o.some(d => d === null)) { c.warn("Problem with enabling auto loadout", this.context); return } let [r, i, l, u] = o; this.#l || (this.#l = async d => { await e.#k(d) }), this.#u || (this.#u = async d => { await e.#P(d) }), r.removeEventListener("click", this.#l, { capture: !0 }), r.addEventListener("click", this.#l, { capture: !0 }), i.removeEventListener("click", this.#l, { capture: !0 }), i.addEventListener("click", this.#l, { capture: !0 }), l.removeEventListener("click", this.#l, { capture: !0 }), l.addEventListener("click", this.#l, { capture: !0 }), u.removeEventListener("click", this.#u, { capture: !0 }), u.addEventListener("click", this.#u, { capture: !0 }), c.log("Enabled auto loadout", this.context) } async disableAutoLoadout() { let e = this, t = [v.HookElement("#addCode"), v.HookElement("#addCodeAll"), v.HookElement("#addCodeOne"), v.HookElement("#timeCode")], n = (await Promise.allSettled(t)).map((u, d) => u.status === "fulfilled" ? u.value : null); if (n.some(u => u === null)) { c.warn("Problem with disabling auto loadout", this.context); return } let [o, r, i, l] = n; this.#l && (o.removeEventListener("click", this.#l, { capture: !0 }), r.removeEventListener("click", this.#l, { capture: !0 }), i.removeEventListener("click", this.#l, { capture: !0 })), this.#u && l.removeEventListener("click", this.#u, { capture: !0 }), c.log("Disabled auto loadout", this.context) } async#k(e) { let t = this.#s, a = C.getSetting("autoLoadoutAdd"); if (t && a) { let n = this.#T(a.getValue()), o = await v.HookElement(`#${n} `); await this.#I(), await p.hiddenAction(async () => { o.click() }) } } async#P(e) { let t = this.#s, a = C.getSetting("autoLoadoutTime"); if (t && a) { let n = this.#T(a.getValue()), o = await v.HookElement(`#${n} `); await this.#I(), await p.hiddenAction(async () => { o.click() }) } } async#U(e, t) { let a = document.querySelector(`#${t} `); a ? (await this.#I(), await p.hiddenAction(async () => { a.click() })) : c.warn(`Could not find real button for ${t}`, this.context) } async#I() { let e = await v.HookElement("#blueberryToggleMode"); e && e.innerText.includes("SAVE") && e.click() } #T(e) { let t = Object.values(me).find(a => a === `blueberryLoadout${e}`); return t || c.warn(`Could not convert loadout ${e} to slot`, this.context), t } subscribeGameDataChanges() { let e = H.getModule("HSGameData"); e && !this.gameDataSubscriptionId && (this.gameDataSubscriptionId = e.subscribeGameDataChange(this.gameDataCallback.bind(this)), c.debug("Subscribed to game data changes", this.context)) } unsubscribeGameDataChanges() { let e = H.getModule("HSGameData"); e && this.gameDataSubscriptionId && !this.#A && !this.#S && (e.unsubscribeGameDataChange(this.gameDataSubscriptionId), this.gameDataSubscriptionId = void 0, c.debug("Unsubscribed from game data changes", this.context)) } async gameDataCallback() {
        ...
        ACCEL %: ${w.toFixed(2)} </br>
            `, this.#c.innerHTML = ""; J.firstChild;)this.#c.appendChild(J.firstChild)
                ...
                } this.#S ? this.#b && this.#y ? (this.#b.style.width = `${i}% `, this.#y.style.width = `${l}% `) : c.warnOnce(`
        ...
        } async enableIdleSwap() { let e = this, t = H.getModule("HSGameState"); t ? (this.#e = t.subscribeGameStateChange("MAIN_VIEW", this.#V.bind(this)), this.#t = t.subscribeGameStateChange("SINGULARITY_VIEW", async (a, n) => { n.getId() === 5 ? (this.#M = await v.HookElement("#ambrosiaProgressBar"), this.#p = await v.HookElement("#pixelProgressBar"), this.#A = !0, this.#Q(), this.subscribeGameDataChanges()) : (this.#A = !1, this.#H(), this.unsubscribeGameDataChanges()) }), t.getCurrentUIView("SINGULARITY_VIEW").getId() === 5 && t.getCurrentUIView("MAIN_VIEW").getId() === 13 && (this.#M = await v.HookElement("#ambrosiaProgressBar"), this.#p = await v.HookElement("#pixelProgressBar"), this.#A = !0, this.#Q(), this.subscribeGameDataChanges())) : c.warn("HSAmbrosia.enableIdleSwap() - gameStateMod==undefined", "hs-enable-idleswap-gamestate"), this.#c || (this.#c = document.querySelector("#hs-panel-debug-gamedata-currentambrosia")) } disableIdleSwap() { this.#A = !1, this.unsubscribeGameDataChanges(); let e = H.getModule("HSGameState"); e ? (this.#e && (e.unsubscribeGameStateChange("MAIN_VIEW", this.#e), this.#e = void 0), this.#t && (e.unsubscribeGameStateChange("SINGULARITY_VIEW", this.#t), this.#t = void 0)) : c.warnOnce("HSAmbrosia.disableIdleSwap() - gameStateMod==undefined", "hs-disable-idleswap-gamestate"), this.#H() } #V(e, t) { let a = H.getModule("HSGameState"); a ? e.getId() === 13 && t.getId() !== 13 && a.getCurrentUIView("SINGULARITY_VIEW").getId() === 5 && (this.#A = !1) : c.warnOnce("HSAmbrosia.gameStateCallbackMain() - gameStateMod==undefined", "hs-amb-gamestate-cb") } #Q() { if (document.querySelector(`#${b.HSAmbrosia.idleSwapIndicatorId} `)) return; let t = document.createElement("div"); t.id = b.HSAmbrosia.idleSwapIndicatorId, t.innerText = "IDLE SWAP ENABLED WHILE IN THIS VIEW", S.injectHTMLElement(t, a => { let n = document.querySelector("#singularityAmbrosia"), o = document.querySelector("#ambrosiaProgressBar"); n?.insertBefore(a, o) }), S.injectStyle(this.#h, this.#f) } #H() { let e = document.querySelector(`#${b.HSAmbrosia.idleSwapIndicatorId} `); e && e.remove(), S.removeInjectedStyle(this.#f) } async#L() {
            let e = null; try {
...
`).map(u => u.trim()); if (a.length === 0 || a.length > 16) { S.Notify(`Invalid number of loadouts: ${a.length}. Expected 1 - 16.`, { notificationType: "warning" }); return } let n = document.getElementById("importBlueberries"), o = await v.HookElement("#blueberryToggleMode"); if (!n) throw new Error("Import input element not found"); if (!o) throw new Error("Mode toggle button not found"); o.innerText.includes("LOAD ") && o.click(); let i = 0, l = 0; p.startDialogWatcher(); for (let u = 0; u < a.length; u++) { let d = a[u], g = u + 1; if (!d) { l++; continue } let m = document.getElementById(`blueberryLoadout${g} `); if (!m) { console.warn(`Loadout button ${g} not found`); continue } let h = new Blob([d], { type: "application/json" }), A = new File([h], "quick-import.json", { type: "application/json" }), M = new DataTransfer; M.items.add(A), n.files = M.files; let E = new Event("change", { bubbles: !0 }); n.dispatchEvent(E), await p.sleep(50), m.click(), await p.sleep(50), i++ } o.click(), S.Notify(`Imported ${i} loadout(s), skipped ${l} empty slot(s)`, { notificationType: "success" })
    ...
    }; var Pe = class extends K { async applyPatch() { } async revertPatch() { } }; var It = `{
    ...
    `; #s; #l; #u = new Map; #m; #g; #d; #h; #f; #v = !1; #A; #M; #p; #c; #S; #b; #y; #E = { tokens: 0, maxTokens: 0, isAtMaxTokens: !1 }; #w = { HAPPY_HOUR_BELL: { amount: 0, ends: [], displayName: "Happy Hour Bell" } }; #R = !1; #C; #D; #G = 0; #x = 5e3; constructor(e) { super(e), this.#b = document.querySelector("#campaignTokenCount"), this.#D = new Event("click") } async init() { let e = this; c.log("Initializing HSGameData module", this.context), this.#m = document.querySelector("#singularitybtn"), this.#d = Array.from(document.querySelectorAll("#singularityChallenges > div.singularityChallenges > div")), this.#g = document.querySelector("#importFileButton"); try { let a = await (await fetch(b.Common.pseudoAPIurl)).json(); this.#A = a, this.#L() } catch { c.error("Could not fetch pseudo data", this.context) } try { let a = await (await fetch(b.Common.meAPIurl)).json(); this.#M = a, this.#Y() } catch { c.error("Could not fetch me data", this.context) } this.#p = H.getModule("HSGameDataAPI"), this.#N(), this.isInitialized = !0 } async forceUpdateAllData() { let e = Date.now(); if (e - this.#G < this.#x) { c.warn("Forced data refresh on cooldown", this.context); return } this.#G = e, await this.#k(), await this.#J(), await this.#k(), this.#T(); let t = await v.HookElement("#savegame"); t && t.dispatchEvent(this.#D), this.#C && (this.#a = JSON.parse(this.#C)), this.#L(), this.#Y(), this.#F(), this.#H() } #N() { let e = this, t = H.getModule("HSWebSocket"); t && t.registerWebSocket("consumable-event-socket", { url: b.Common.eventAPIUrl, onMessage: async a => { if (a?.type === "info-all") if (e.#B(), a.active && a.active.length > 0) { c.debug(`Caught WS event: ${a.type} - event count: ${a.active.length}}`, "WebSocket"); for (let { internalName: n, endsAt: o, name: r } of a.active) { let i = e.#w[n]; i.ends.push(o), i.amount++, i.displayName = r } e.#O() } else c.debug("Caught INFO_ALL, but no active events", this.context); else if (a?.type === "error") c.debug("Caught ERROR", this.context), e.#B(); else if (a?.type === "consumable-ended") { c.debug("Caught EVENT_ENDED", this.context); let n = e.#w[a?.consumable]; n.ends.shift(), n.amount--, e.#O() } else a?.type === "join" && c.debug("Caught JOIN (connection established)", this.context) }, onRetriesFailed: async () => { e.#B(), e.#O() } }) } #B() { for (let e of Object.keys(this.#w)) this.#w[e] = { amount: 0, ends: [], displayName: "" }; this.#O() } async#k() { c.debug("Refreshing fetched data", this.context); try { let t = await (await fetch("https://synergism.cc/stripe/upgrades")).json(); this.#A = t, this.#L() } catch { c.error("Could not fetch pseudo data", this.context) } try { let t = await (await fetch("https://synergism.cc/api/v1/users/me")).json(); this.#M = t, this.#Y() } catch { c.error("Could not fetch me data", this.context) } } #P() { if (!this.#r) return; let e = localStorage.getItem(this.#e); if (e && e !== this.#S) { this.#S = e; try { this.#a = JSON.parse(atob(e)), this.#H() } catch (t) { c.debug(`<red>Error processing save data:</red> ${t}`, this.context), this.#I() } } requestAnimationFrame(this.#P.bind(this)) } #U() { if (this.#r) { if (this.#C) try { this.#a = JSON.parse(this.#C), this.#H() } catch (e) { c.debug(`<red>Error processing save data:</red> ${e}`, this.context), this.#I() } requestAnimationFrame(this.#U.bind(this)) } } #I() { if (!this.#t) return; let e = C.getSetting("useGameData"), t = C.getSetting("stopSniffOnError"); e && t ? t.isEnabled() && (c.debug("Stopped game data sniffing on error", this.context), e.disable()) : c.debug(`maybeStopSniffOnError() - Issue with fetching settings: ${e}, ${t}`, this.context) } async enableGDS() { let e = this; this.#r || (S.injectStyle(this.#o, b.HSGameData.turboCSSId), this.#s && clearInterval(this.#s), await this.#k(), this.#c && clearInterval(this.#c), this.#c = setInterval(() => { e.#k() }, b.HSGameData.fetchedDataRefreshInterval), this.#J(), this.#y && clearInterval(this.#y), this.#E.isAtMaxTokens || (this.#y = setInterval(() => { e.#J() }, b.HSGameData.campaignTokenRefreshInterval)), this.#i || (this.#i = await v.HookElement("#savegame")), this.#n || (this.#n = await v.HookElement("#saveinfo")), this.#s = setInterval(() => { this.#i && this.#n && this.#D && this.#i.dispatchEvent(this.#D) }, b.HSGameData.turboModeSpeedMs), this.#m || (this.#m = await v.HookElement("#singularitybtn")), this.#d || (this.#d = Array.from(document.querySelectorAll("#singularityChallenges > div.singularityChallenges > div"))), this.#g || (this.#g = await v.HookElement("#importFileButton")), this.#h || (this.#h = async t => { e.#Q(t) }), this.#f || (this.#f = async t => { e.#V(t) }), this.#m.addEventListener("click", this.#h, { capture: !0 }), this.#d.forEach(t => { t.addEventListener("click", e.#h, { capture: !0 }) }), this.#g.addEventListener("click", this.#f, { capture: !0 }), c.info("GDS = ON", this.context), this.#r = !0, b.Common.experimentalGDS ? (this.#T(), this.#U()) : this.#P()) } #T() { if (this.#R) return; let e = this, t = window.btoa; window.btoa = function (a) { return a && a.length > 0 && a[0] === "{" && (e.#C = a), t(a) }, this.#R = !0 } async#V(e) { let t = C.getSetting("useGameData"); t && t.isEnabled() && (t.disable(), await S.Notify("GDS has been disabled for save file import", { position: "top", notificationType: "warning" })) } async#Q(e) { let t = e.target, a = ["noSingularityUpgrades", "oneChallengeCap", "limitedAscensions", "noOcteracts", "noAmbrosiaUpgrades", "limitedTime", "sadisticPrequel", "taxmanLastStand"]; if (t) { let n, o = t.getAttribute("style"); if (t.id && a.includes(t.id) ? o?.includes("orchid") ? n = !0 : a.map(i => document.querySelector(`#${i}`)?.getAttribute("style")?.includes("orchid")).some((i => i === !0)) ? n = !1 : n = !0 : o?.toLowerCase().includes("grayscale") ? n = !1 : n = !0, n) { let r = C.getSetting("useGameData"); if (r && r.isEnabled()) { this.#v = !0, r.disable(), await p.wait(4e3); let i = C.getSetting("useGameData"); i && this.#v && !i.isEnabled() ? (c.debug("Re-enabled GDS", this.context), i.enable()) : c.debug("GDS was already enabled (WoW fast!)", this.context), this.#v = !1 } } } } async disableGDS() { let e = this; this.#s && (clearInterval(this.#s), this.#s = void 0), this.#c && clearInterval(this.#c), this.#y && clearInterval(this.#y), S.removeInjectedStyle(b.HSGameData.turboCSSId), this.#m || (this.#m = await v.HookElement("#singularitybtn")), this.#d || (this.#d = await v.HookElements("#singularityChallenges > div.singularityChallenges > div")), this.#g || (this.#g = await v.HookElement("#importFileButton")), this.#h && (this.#m.removeEventListener("click", this.#h, { capture: !0 }), this.#d.forEach(t => { t.removeEventListener("click", e.#h, { capture: !0 }) }), this.#h = void 0), this.#f && (this.#g.removeEventListener("click", this.#f, { capture: !0 }), this.#f = void 0), c.info("GDS turbo = OFF", this.context), this.#r = !1 } subscribeGameDataChange(e) { let t = p.uuidv4(); return this.#u.set(t, e), t } unsubscribeGameDataChange(e) { this.#u.has(e) ? this.#u.delete(e) : c.warn(`Could not unsubscribe from game data change. ID ${e} not found`, this.context) } #H() { this.#p && this.#a && this.#p._updateGameData(this.#a), this.#u.forEach(e => { this.#a ? e(this.#a) : c.debug("Could not call game data change callback. No save data found", this.context) }) } #L() { this.#p && this.#A && this.#p._updatePseudoData(this.#A) } #Y() { this.#p && this.#M && this.#p._updateMeData(this.#M) } #F() { this.#p && this.#E && this.#p._updateCampaignData(this.#E) } #O() { this.#p && this.#w && this.#p._updateEventData(this.#w) } #J() { if (c.debug("Refreshing campaign data", this.context), !this.#b) { let t = document.querySelector("#campaignTokenCount"); if (t) this.#b = t; else return } let e = this.#b; if (e) { let t = e.innerText.match(/^You have (\d+) \/ (\d+) .+$/); if (t && t[1] && t[2]) { let a = parseInt(t[1], 10), n = parseInt(t[2], 10); this.#E.tokens = a, this.#E.maxTokens = n, this.#E.isAtMaxTokens = a > 0 && n > 0 && a === n, this.#F() } } this.#E.isAtMaxTokens && this.#y && (c.debug("Dynamic clear of campaign token refresh interval, player is at max", this.context), clearInterval(this.#y)) }
      ...
      ascensionCountAdditive: () => (this.gameData?.ascensionCounter > 10) ? 100 : 0
    }`}, {
        pointValue: 35, group: "ascensionCount", reward: `{
      ascensionCountAdditive: () => (this.gameData?.ascensionCounter > 10) ? this.gameData?.ascensionCounterReal * 2 : 0,
      wowCubeGain: () => 1 + 2 * Math.min(1, this.gameData?.ascensionCount / 5e8)
    }`}, { pointValue: 5, group: "constant" }, { pointValue: 10, group: "constant" }, { pointValue: 15, group: "constant" }, { pointValue: 20, group: "constant", reward: "{ wowCubeGain: () => 1 + Decimal.log(this.gameData?.ascendShards.add(1), 10) / 400 }" }, { pointValue: 25, group: "constant" }, {
        pointValue: 30, group: "constant", reward: `{
      wowCubeGain: () => 1 + 249 * Math.min(1, Decimal.log(this.gameData?.ascendShards.plus(1), 10) / 100000),
      wowTesseractGain: () => 1 + 249 * Math.min(1, Decimal.log(this.gameData?.ascendShards.plus(1), 10) / 100000)
    }`}, { pointValue: 35, group: "constant", reward: "{ wowPlatonicGain: () => 1 + 19 * Math.min(1, Decimal.log(this.gameData?.ascendShards.plus(1), 10) / 100000) }" }, { pointValue: 10, group: "challenge11", reward: "{ statTracker: () => 1 }" }, { pointValue: 20, group: "challenge11" }, { pointValue: 30, group: "challenge11" }, { pointValue: 40, group: "challenge11" }, { pointValue: 50, group: "challenge11" }, { pointValue: 60, group: "challenge11", reward: "{ ascensionCountAdditive: () => this.gameData?.ascensionCounter * 2 }" }, { pointValue: 70, group: "challenge11", reward: "{ talismanPower: () => 0.01 }" }, { pointValue: 10, group: "challenge12", reward: "{ ascensionRewardScaling: () => 1 }" }, { pointValue: 20, group: "challenge12" }, { pointValue: 30, group: "challenge12" }, { pointValue: 40, group: "challenge12" }, { pointValue: 50, group: "challenge12" }, { pointValue: 60, group: "challenge12", reward: "{ ascensionCountAdditive: () => this.gameData?.ascensionCounter * 2 }" }, { pointValue: 70, group: "challenge12", reward: "{ talismanPower: () => 0.01 }" }, { pointValue: 10, group: "challenge13" }, { pointValue: 20, group: "challenge13" }, { pointValue: 30, group: "challenge13" }, { pointValue: 40, group: "challenge13" }, { pointValue: 50, group: "challenge13" }, { pointValue: 60, group: "challenge13", reward: "{ ascensionCountAdditive: () => this.gameData?.ascensionCounter * 2 }" }, { pointValue: 70, group: "challenge13", reward: "{ talismanPower: () => 0.01 }" }, { pointValue: 10, group: "challenge14" }, { pointValue: 20, group: "challenge14" }, { pointValue: 30, group: "challenge14" }, { pointValue: 40, group: "challenge14" }, { pointValue: 50, group: "challenge14" }, {
        pointValue: 60, group: "challenge14", reward: `{
      ascensionCountAdditive: () => this.gameData?.ascensionCounter * 2,
      wowPlatonicGain: () => 1 + 2 * Math.min(1, this.gameData?.ascensionCount / 2.674e9)
...
`), r = new Blob([o], { type: "text/csv;charset=utf-8;" }), i = document.createElement("a"), l = URL.createObjectURL(r), u = new Date().toISOString().replace(/[:.]/g, "-").slice(0, -5); i.setAttribute("href", l), i.setAttribute("download", `autosing_data_${u}.csv`), i.style.visibility = "hidden", document.body.appendChild(i), i.click(), document.body.removeChild(i)
        } updateDisplay() {
...
.hs-export-btn:active {
    transform: translateY(0);
            ...
            <div style="font-size: 11px; color: #888; margin-bottom: 4px;">TIMING</div>`, t !== null && (h += `<div style="margin-bottom: 4px;">Last: <span style="color: #2196F3; font-weight: bold;">${t.toFixed(2)}s</span></div>`), a !== null && (h += `<div style="margin-bottom: 4px;">Avg (5): <span style="color: #9C27B0; font-weight: bold;">${a.toFixed(2)}s</span></div>`), n !== null && (h += `<div style="margin-bottom: 4px;">Avg (10): <span style="color: #19ae11; font-weight: bold;">${n.toFixed(2)}s</span></div>`), o !== null && (h += `<div style="margin-bottom: 4px;">Avg (50): <span style="color: #FF9800; font-weight: bold;">${o.toFixed(2)}s</span></div>`), r !== null && (h += `<div>Avg (All): <span class="hs-rainbow-text">${r.toFixed(2)}s</span></div>`), h += "</div>", this.phaseHistory.size > 0) {
...
MAX TIME: ${n.challengeMaxTime}`, this.context), await p.sleepUntilElapsed(this.prevActionTime, n.challengeWaitBefore ?? 0), await this.waitForCompletion(n.challengeNumber, n.challengeCompletions ?? 0, n.challengeMaxTime, n.challengeWaitTime)
        ...
        static #e = "HSLogger"; static #t = !1; static #a; static #r = -1; static #i = !1; static #n = new Map; static #o; static async integrateToUI(e) { let t = await e.getLogElement(); t && (this.#a = t, this.#t = !0, this.log("HSLogger integrated to UI", "HSLogger")) } static #s(e, t = "HSMain", a = 1) {
            if (this.#t) {
                let n = document.createElement("div"); n.classList.add("hs-ui-log-line"); let o = ""; switch (a) { case 1: o = ""; break; case 4: n.classList.add("hs-ui-log-line-info"), o = ""; break; case 2: o = "WARN ", n.classList.add("hs-ui-log-line-warn"); break; case 3: o = "ERROR ", n.classList.add("hs-ui-log-line-error"); break; case 5: o = "DBG ", n.classList.add("hs-ui-log-line-debug"); break; default: o = ""; break }let r = this.#i ? "" : "hs-log-ts-hidden", i = H.getModule(t), l = i && i.moduleColor ? p.parseColorTags(t.colorTag(i.moduleColor)) : t; n.innerHTML = `${o} [<span class="hs-log-ctx">${l}</span><span class="hs-log-ts ${r}"> (${p.getTime()})</span>]: ${p.parseColorTags(e)}
`; let u = p.hashCode(`${o}${l}${e}`); if (this.#r !== u) this.#a.appendChild(n); else { let g = this.#a.querySelector("div:last-child"); if (g) try { let m = g.innerHTML.match(/\(x(\d+)\)/); if (m) { let h = m[0], A = parseInt(m[1], 10); g.innerHTML = g.innerHTML.replace(h, `(x${A + 1})`) } else g.innerHTML += " (x2)" } catch (m) { console.log(m) } } let d = this.#a.querySelectorAll(".hs-ui-log-line"); if (d && d.length > b.HSLogger.logSize) { let g = this.#a.querySelector(".hs-ui-log-line:first-child"); g && g.parentElement?.removeChild(g) } s.scrollToBottom(), this.#r = u
 ...
 #hs-add-10-btn {
    ...
    border-right: none;
        ...
        #e = "HSMain"; #t; #a; #r; constructor(e) { this.#t = new H("HSModuleManager", e) } async preprocessModules() { await this.#t.preprocessModules() } async init() { c.log("Initialising Hypersynergism modules", this.#e), await this.#t.initModules(), c.log("Building UI Panel", this.#e), this.#i(), c.log("Injecting style overrides", this.#e), this.#n(), await C.syncSettings(), await S.Notify(`Hypersynergism v${b.General.currentModVersion} loaded`, { position: "top", notificationType: "success" }), this.#a = setInterval(async () => { let e = await ae.getLatestRelease(); e && c.debug(`Latest release: ${e.name} (${e.version})`, this.#e) }, b.PrivateAPI.checkIntervalMs) } #i() { let e = H.getModule("HSUI"); e && (e.updateTitle(`Hypersynergism v${b.General.currentModVersion}`), this.#o(e), this.#s(e), this.#l(e), e.renameTab(2, "Tools"), e.renameTab(3, "Settings"), e.renameTab(4, "Debug")) } #n() { S.injectStyle(Gt, "hs-override-css") } #o(e) {
            let t = oe.getCalculationDefinitions({ toolingSupport: "true" }).map(i => ({ text: i.supportsReduce ? `${i.calculationName} (C)` : i.calculationName, value: i.supportsReduce ? `${i.fnName}|c` : i.fnName })); e.replaceTabContents(2, k.Grid({
